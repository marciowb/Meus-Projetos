...
uses
  ...
  gtCstPlnEng, gtCstPDFEng, gtPDFEng, gtClasses, gtXportIntf,
  gtRvXportIntf, RpBase, RpSystem, RpDefine, RpRender, RpRenderCanvas,
  RpRenderPreview, ExtCtrls
  {$IFDEF gtPro}
...
begin
  ...
  case SaveDialog1.FilterIndex of
    ...
    {$IFDEF gtPro}
    16: gtRaveExportInterface1.Engine := FfrmProComponent.gtSVGEngine1;
    17: gtRaveExportInterface1.Engine := FfrmProComponent.gtPNGEngine1;
    18: gtRaveExportInterface1.Engine := FfrmProComponent.gtTIFFEngine1;
    {$ENDIF}
  end;
