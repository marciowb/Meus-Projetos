...
uses
  ...
  gtCstPDFEng, gtPDFEng, gtClasses, gtXportIntf,
...
begin
  ...
  case SaveDialog1.FilterIndex of
    ...
    {$IFDEF gtPro}
    16: gtAceExportInterface1.Engine := FfrmProComponent.gtSVGEngine1;
    17: gtAceExportInterface1.Engine := FfrmProComponent.gtPNGEngine1;
    18: gtAceExportInterface1.Engine := FfrmProComponent.gtTIFFEngine1;
    {$ENDIF}
  end;
  ...
  IgtDocumentEngine(gtAceExportInterface1.Engine).Preferences.UseImagesAsResources := False;
