...
interface
uses
  Classes, gtClasses, gtCstDocEng;

type

  TgtExportInterface = class(TgtComponent)
  private
    FVisible: Boolean;
  ...
  protected
    property AlreadyPrepared: Boolean read FAlreadyPrepared
      write SetAlreadyPrepared default True;
    property DocStarted: Boolean read FDocStarted write SetDocStarted
      default False;
...
procedure TgtExportInterface.OnEngineEndDoc(
...
procedure TgtExportInterface.SetEngine(
