...
// (DO NOT EDIT: machine generated header) 'Gtcstxlseng.pas' rev: 10.00
...
typedef void __fastcall (__closure *TgtOnNeedSheetName)(TgtCustomExcelEngine* Sender, AnsiString &SheetName, int SheetNo);
...
protected:
	...
	Byte __fastcall GetFillStyle(Byte AValue);
