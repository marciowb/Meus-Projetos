...
// (DO NOT EDIT: machine generated header) 'Gtcstdoceng.pas' rev: 10.00
...
typedef void __fastcall (__closure *TgtOnNeedFileNameEvent)(TgtCustomDocumentEngine* Sender, AnsiString &FileName, int PageNo);
...
typedef void __fastcall (__closure *TgtEMailErrorEvent)(TgtCustomDocumentEngine* Sender, const AnsiString ErrMsg);
...
typedef void __fastcall (__closure *TgtOnCalcVariablesEvent)(TgtCustomDocumentEngine* Sender, AnsiString Variable, AnsiString &Value);
...
typedef DynamicArray<double >  gtCstDocEng__4;
...
public:
	DynamicArray<double >  FCharSpaceArray;
...
public:
	...
	TgtPoints __fastcall GetPoints();
...
typedef DynamicArray<Types::TRect >  gtCstDocEng__11;
...
public:
	DynamicArray<Types::TRect >  FClipRects;
...
typedef DynamicArray<int >  gtCstDocEng__61;

typedef DynamicArray<TgtPoint >  gtCstDocEng__71;
...
typedef DynamicArray<Byte >  gtCstDocEng__91;

typedef DynamicArray<TgtPoint >  gtCstDocEng__02;
...
private:
	...
	Gtutils::TgtRect __fastcall GetInternalMargin();
...
__published:
	...
	__property AnsiString ReceiptRecipient = {read=FReceiptRecipient, write=FReceiptRecipient};
...
private:
	...
	WideString FAuthor;
	WideString FSubject;
	void __fastcall SetAuthor(const WideString Value);
	void __fastcall SetCreator(const WideString Value);
	void __fastcall SetKeywords(const WideString Value);
	void __fastcall SetSubject(const WideString Value);
...
__published:
	__property WideString Author = {read=FAuthor, write=SetAuthor};
	__property WideString Subject = {read=FSubject, write=SetSubject};
	__property WideString Creator = {read=FCreator, write=SetCreator};
	__property WideString Title = {read=FTitle, write=SetTitle};
	__property WideString Keywords = {read=FKeywords, write=SetKeywords};
};
...
__interface IgtDocumentSettings  : public IInterface 
{
...
public:
	...
	virtual AnsiString __fastcall GetFileDescription(void) = 0 ;
	virtual TgtDocInfo* __fastcall GetDocInfo(void) = 0 ;
	virtual AnsiString __fastcall GetFileExtension(void) = 0 ;
	...
	virtual void __fastcall SetFileDescription(const AnsiString Value) = 0 ;
	virtual void __fastcall SetDocInfo(const TgtDocInfo* Value) = 0 ;
	virtual void __fastcall SetFileExtension(const AnsiString Value) = 0 ;
	...
	__property AnsiString FileExtension = {read=GetFileExtension, write=SetFileExtension};
	__property AnsiString FileDescription = {read=GetFileDescription, write=SetFileDescription};
...
public:
	...
	virtual void __fastcall HTMLTextOut(double X, double Y, WideString HTMLStr) = 0 ;
	virtual void __fastcall TextOutV(double X, double Y, WideString Text, bool TopDown = true) = 0 ;
	virtual void __fastcall TextOut(double X, double Y, WideString Text) = 0 /* overload */;
	virtual void __fastcall TextOut(int ColumnNo, WideString Text) = 0 /* overload */;
	virtual double __fastcall TextOut(WideString Text) = 0 /* overload */;
	virtual void __fastcall TextRect(const Gtutils::TgtRect &Rect, double X, double Y, WideString Text) = 0 ;
	...
	virtual void __fastcall ExportRichText(AnsiString FilePath, double ALeft, double ATop, double ARight, double ABottom, int StartPos, int EndPos, Graphics::TColor BackgroundColor) = 0 /* overload */;
	...
	virtual void __fastcall TextBox(const Gtutils::TgtRect &TextRect, WideString Text, TgtHAlignment HAlignment, TgtVAlignment VAlignment) = 0 ;
	...
	virtual tagSIZE __fastcall TextSize(const WideString Text, Graphics::TFont* AFont) = 0 /* overload */;
	virtual tagSIZE __fastcall TextSize(const AnsiString Text, Graphics::TFont* AFont) = 0 /* overload */;
};

typedef DynamicArray<TgtParagraphItem* >  gtCstDocEng__73;

typedef DynamicArray<bool >  gtCstDocEng__83;

typedef DynamicArray<bool >  gtCstDocEng__93;

typedef DynamicArray<int >  gtCstDocEng__04;

typedef DynamicArray<DynamicArray<int > >  gtCstDocEng__14;
...
private:
	...
	DynamicArray<TgtParagraphItem* >  FParaItem;
	TgtImageSettings* FImageSettings;
	TgtTextFormatting* FTextFormatting;
	TgtTableSettings* FTableSettings;
	TgtPreferences* FPreferences;
	...
	AnsiString __fastcall GetFileExtension();
	...
	void __fastcall SetFileDescription(const AnsiString Value);
	...
	void __fastcall SetFileExtension(const AnsiString Value);
	...
	void __fastcall SetPagesToRender(const AnsiString Value);
...
protected:
	...
	DynamicArray<bool >  FIsParaStarted;
	DynamicArray<bool >  TableOnLastpage;
	DynamicArray<DynamicArray<int > >  RowsOnPage;
	int FTablenumber;
	bool FSortTextItems;
	...
	virtual void __fastcall HTMLTextOut(double X, double Y, WideString HTMLStr);
	virtual void __fastcall TextOutV(double X, double Y, WideString Text, bool TopDown = true);
	...
	virtual void __fastcall TextBox(const Gtutils::TgtRect &TextRect, WideString Text, TgtHAlignment HAlignment, TgtVAlignment VAlignment);
	...
	tagSIZE __fastcall TextSize(const WideString Text, Graphics::TFont* AFont)/* overload */;
	tagSIZE __fastcall TextSize(const AnsiString Text, Graphics::TFont* AFont)/* overload */;
	...
	int __fastcall WrapTextIntoLines(AnsiString Text, double Width, double FirstLineWidth, Classes::TStringList* Lines, bool AutoResize, Graphics::TFont* AFont)/* overload */;
	int __fastcall WrapTextIntoLines(WideString Text, double Width, double FirstLineWidth, Gtclasses::TWideStrings* Lines, bool AutoResize, Graphics::TFont* AFont)/* overload */;
	virtual WideString __fastcall ReplacePlaceHolders(WideString AText, bool AReplacePageInfo);
	virtual WideString __fastcall ReplacePageInfo(WideString AText);
	AnsiString __fastcall GetHyperLinkText(AnsiString AText, int &AStartPos);
	...
	Classes::TStream* __fastcall CreateFile(AnsiString AFileName);
	void __fastcall CancelCreate(void);
	virtual bool __fastcall CheckOutputImageFormat(TgtOutputImageFormat Value, AnsiString &S);
	...
	void __fastcall PutTrialNoteOnTop(void);
	virtual WideString __fastcall R2LString(WideString OriginalStr);
...
public:
	...
	void __fastcall ExportRichText(AnsiString FilePath, double ALeft, double ATop, double ARight, double ABottom, int StartPos, int EndPos, Graphics::TColor BackgroundColor)/* overload */;
	...
	double __fastcall TextWidth(WideString Text)/* overload */;
	double __fastcall TextHeight(WideString Text)/* overload */;
...
__published:
	...
	__property AnsiString PagesToRender = {read=FPagesToRender, write=SetPagesToRender};
...
private:
	void *__IgtDocumentEngine;	/* Gtcstdoceng::IgtDocumentEngine */
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE double CPaperDimensions[41][2];
#define CphPageNo "<%Pg#%>"
#define CphTotalPages "<%PgCnt%>"
#define CphShortDate "<%ShortDate%>"
#define CphShortTime "<%ShortTime%>"
#define CphLongDate "<%LongDate%>"
#define CphLongTime "<%LongTime%>"
#define CphAuthor "<%Author%>"
#define CphCreator "<%Creator%>"
#define CphSubject "<%Subject%>"
#define CphTitle "<%Title%>"
