...
uses
  ...
  gtUtils, gtDocResStrs, gtDocUtils;
type
...
procedure TgtExExcelEngine.AbsHorPosn(AX, AWidth: Double; var ALeft,
...
procedure TgtExExcelEngine.AbsVertPosn(AY, AHeight: Double; var ATop,
...
function TgtExExcelEngine.CheckOutputImageFormat(
...
procedure TgtExExcelEngine.DrawImage(ImageRect: TgtRect;
  AGraphic: TGraphic);
begin
  inherited;
...
procedure TgtExExcelEngine.DrawImage(ColumnNo: Integer; Width,
...
procedure TgtExExcelEngine.Ellipse(X1, Y1, X2, Y2: Double;
  IsFill: Boolean);
begin
  inherited;
...
procedure TgtExExcelEngine.EncodeFormula(AObject: TgtFormulaItem);
var
  ...
  begin
    if(((ch >= '0') and (ch <= '9')) or (Char(ch) = DecimalSeparator) ) then
      Result := True
    else
      Result := False;
  end;
    ...
    begin
      ...
      begin
       ...
       begin
          ...
          begin
            if ((AnsiContainsText(opString, DecimalSeparator))
...
procedure TgtExExcelEngine.EncodePolyLine(Points: TgtPoints;
...
procedure TgtExExcelEngine.GetCommonAttribute(var AObjectAttrib: array of byte;
  ARect: TgtRect; AObjectType: Byte);
var
...
procedure TgtExExcelEngine.Polygon(Points: array of TgtPoint;
  IsFill: Boolean);
begin
  inherited;
...
procedure TgtExExcelEngine.Rectangle(X1, Y1, X2, Y2: Double;
  IsFill: Boolean);
begin
  inherited;
