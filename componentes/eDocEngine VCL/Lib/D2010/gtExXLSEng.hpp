...
// (DO NOT EDIT: machine generated header) 'Gtexxlseng.pas' rev: 21.00
...
public:
	...
	__property System::UnicodeString Lines = {read=FLines, write=FLines};
...
private:
	...
	void __fastcall GetCommonAttribute(System::Byte *AObjectAttrib, const int AObjectAttrib_Size, const Gtutils::TgtRect &ARect, System::Byte AObjectType);
...
public:
	void __fastcall FormulaOut(int Row, int Column, System::UnicodeString Text, Gtcstdoceng::TgtHAlignment Alignment, TgtExcelFormulaType FormulaType);
