...
// (DO NOT EDIT: machine generated header) 'Gtcstspdeng.pas' rev: 21.00
...
public:
	...
	__property System::Word FormatIndex = {read=FFormatIndex, write=FFormatIndex, nodefault};
	__property Gtcstdoceng::TgtHAlignment Alignment = {read=FAlignment, write=FAlignment, nodefault};
...
protected:
	...
	StaticArray<int, 101> FColorArray;
	int FColorArraySize;
	int FColorValues;
	...
	void __fastcall WriteRecord(int ARecType, int ARecSize, System::Word *ABuf, const int ABuf_Size, int ADataSize, Classes::TStream* AStream);
	void __fastcall WriteRecordByte(int ARecType, int ARecSize, System::Byte *ABuf, const int ABuf_Size, int ADataSize, Classes::TStream* AStream);
	...
	TgtCellType __fastcall GetCellType(System::UnicodeString AText);
	...
	System::UnicodeString __fastcall GetNumberString(System::UnicodeString AText);
...
public:
	...
	HIDESBASE virtual void __fastcall TextOut(int Row, int Column, System::WideString Text, Gtcstdoceng::TgtHAlignment Alignment, TgtCellType CellType)/* overload */;
	HIDESBASE virtual void __fastcall TextOut(int Row, int Column, System::WideString Text, Gtcstdoceng::TgtHAlignment Alignment, TgtCellType CellType, bool WordWrap)/* overload */;
