...
// (DO NOT EDIT: machine generated header) 'Gtsvgeng.pas' rev: 21.00
...
private:
	typedef DynamicArray<Classes::TList*> _TgtSVGEngine__1;
...
private:
	...
	_TgtSVGEngine__1 FImgSettingList;
	Classes::TStringList* FAttachmentList;
	System::UnicodeString __fastcall GetRGBString(Graphics::TColor AColor);
	System::UnicodeString __fastcall GetSVGImage(Gtcstdoceng::TgtImageItem* AObject);
	System::UnicodeString __fastcall GetShapeStyle(Graphics::TPen* APen, Graphics::TBrush* ABrush);
	...
	System::UnicodeString __fastcall SVGChars(System::UnicodeString AString, bool AToSVG);
