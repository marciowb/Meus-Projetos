...
// (DO NOT EDIT: machine generated header) 'Gtexpdfeng.pas' rev: 21.00
...
public:
	...
	__property System::UnicodeString URI = {read=FURI, write=SetURI};
};
...
private:
	...
	TgtZoom FZoom;
	bool FNewWindow;
	void __fastcall SetFilePath(const System::UnicodeString Value);
	void __fastcall SetOptions(const TgtGoToOptions Value);
	void __fastcall SetPage(const int Value);
	void __fastcall SetRect(const Gtutils::TgtRect &Value);
	void __fastcall SetZoom(const TgtZoom Value);
...
private:
	System::UnicodeString FJavaScript;
	void __fastcall SetJavaScript(const System::UnicodeString Value);
	
public:
	__fastcall TgtAnnotJSAction(void);
	__fastcall virtual ~TgtAnnotJSAction(void);
	__property System::UnicodeString JavaScript = {read=FJavaScript, write=SetJavaScript};
};
...
private:
	...
	void __fastcall SetContents(const System::WideString Value);
...
protected:
	...
	__property Gtutils::TgtRect Rect = {read=FRect, write=SetRect};
	__property System::WideString Contents = {read=FContents, write=SetContents};
...
private:
	...
	System::Byte FBorderWidth;
	System::UnicodeString FBorderPattern;
	...
	void __fastcall SetBorderWidth(const System::Byte Value);
	void __fastcall SetBorderPattern(const System::UnicodeString Value);
...
public:
	...
	__property System::UnicodeString BorderPattern = {read=FBorderPattern, write=SetBorderPattern};
...
private:
	...
	TgtBorderStyle FBorderStyle;
	TgtIntensity FCloudIntensity;
	Gtcstdoceng::TgtPoints FVertices;
	void __fastcall SetBorderPattern(const System::UnicodeString Value);
	void __fastcall SetBorderStyle(const TgtBorderStyle Value);
	void __fastcall SetBorderWidth(const System::Byte Value);
	void __fastcall SetCloudIntensity(const TgtIntensity Value);
...
public:
	...
	Gtcstdoceng::TgtPoints __fastcall GetVertices(void);
	__property TgtBorderStyle BorderStyle = {read=FBorderStyle, write=SetBorderStyle, default=0};
	__property System::Byte BorderWidth = {read=FBorderWidth, write=SetBorderWidth, default=0};
	__property System::UnicodeString BorderPattern = {read=FBorderPattern, write=SetBorderPattern};
	__property Graphics::TColor InteriorColor = {read=FInteriorColor, write=SetInteriorColor, default=16777215};
...
private:
	...
	Gtcstdoceng::TgtPoints FQuadPoints;
...
private:
	...
	System::UnicodeString FAttachedFileName;
	void __fastcall SetAttachedFileName(const System::UnicodeString Value);
	
public:
	__fastcall TgtPDFFileAttachmentAnnot(void);
	__fastcall virtual ~TgtPDFFileAttachmentAnnot(void);
	__property System::UnicodeString AttachedFileName = {read=FAttachedFileName, write=SetAttachedFileName};
...
private:
	...
	System::UnicodeString FAltFeildName;
	bool FVisible;
	...
	void __fastcall SetAltFeildName(const System::UnicodeString Value);
...
protected:
	...
	__property Graphics::TColor BackgroundColor = {read=FBackgroundColor, write=SetBackgroundColor, default=16777215};
	__property Gtutils::TgtRect Rect = {read=FRect, write=SetRect};
	__property System::UnicodeString AltFieldName = {read=FAltFeildName, write=SetAltFeildName};
...
private:
	System::UnicodeString FNormalCaption;
	System::UnicodeString FRolloverCaption;
	System::UnicodeString FDownCaption;
	System::UnicodeString FJavaScript;
	System::UnicodeString FSubmitURL;
	TgtPushButtonAction FAction;
	TgtFormSubmitFormat FFormSubmitFormat;
	void __fastcall SetDownCaption(const System::UnicodeString Value);
	void __fastcall SetNormalCaption(const System::UnicodeString Value);
	void __fastcall SetRolloverCaption(const System::UnicodeString Value);
	void __fastcall SetAction(const TgtPushButtonAction Value);
	void __fastcall SetJavaScript(const System::UnicodeString Value);
	void __fastcall SetSubmitURL(const System::UnicodeString Value);
...
public:
	...
	__property System::UnicodeString NormalCaption = {read=FNormalCaption, write=SetNormalCaption};
	__property System::UnicodeString RolloverCaption = {read=FRolloverCaption, write=SetRolloverCaption};
	__property System::UnicodeString DownCaption = {read=FDownCaption, write=SetDownCaption};
	__property TgtPushButtonAction Action = {read=FAction, write=SetAction, default=0};
	__property System::UnicodeString JavaScript = {read=FJavaScript, write=SetJavaScript};
	__property System::UnicodeString SubmitURL = {read=FSubmitURL, write=SetSubmitURL};
...
private:
	typedef DynamicArray<System::UnicodeString> _TgtPDFFormComboBox__1;
...
public:
	...
	__property int SelectedItemIndex = {read=FSelectedItemIndex, write=SetSelectedItemIndex, default=-1};
	int __fastcall AddItem(System::UnicodeString Item);
...
private:
	typedef DynamicArray<System::UnicodeString> _TgtPDFFormListBox__1;
...
private:
	System::UnicodeString FBeforeClose;
	System::UnicodeString FBeforePrint;
	System::UnicodeString FBeforeSave;
	System::UnicodeString FAfterSave;
	System::UnicodeString FAfterPrint;
	void __fastcall SetAfterPrint(const System::UnicodeString Value);
	void __fastcall SetAfterSave(const System::UnicodeString Value);
	void __fastcall SetBeforePrint(const System::UnicodeString Value);
	void __fastcall SetBeforeSave(const System::UnicodeString Value);
	void __fastcall SetBeforeClose(const System::UnicodeString Value);
	
__published:
	__property System::UnicodeString BeforeClose = {read=FBeforeClose, write=SetBeforeClose};
	__property System::UnicodeString BeforeSave = {read=FBeforeSave, write=SetBeforeSave};
	__property System::UnicodeString AfterSave = {read=FAfterSave, write=SetAfterSave};
	__property System::UnicodeString BeforePrint = {read=FBeforePrint, write=SetBeforePrint};
	__property System::UnicodeString AfterPrint = {read=FAfterPrint, write=SetAfterPrint};
...
protected:
	...
	System::UnicodeString __fastcall GetAnnotActionDictionary(TgtAnnotAction* Action, int ObjNo);
