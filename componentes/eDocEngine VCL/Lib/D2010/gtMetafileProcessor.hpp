...
// (DO NOT EDIT: machine generated header) 'Gtmetafileprocessor.pas' rev: 21.00
...
private:
	...
	System::Byte FJustCompletedPath;
	bool FInPath;
	...
	Gtcstdoceng::TgtPoint __fastcall GetTopLeftPosition(double ReferenceX, double ReferenceY, System::UnicodeString Text, Graphics::TFont* Font, int Rotation);
	...
	System::Extended __fastcall GetSizeFromHeight(System::Extended AHeight);
	Graphics::TFontStyles __fastcall IsTextUnderlinedStrikedout(Graphics::TFont* AFont, unsigned AMapMode, const Gtutils::TgtRect &AStretchBlt, System::Extended ATextReferenceY);
	...
	System::Word __fastcall DoCharMapping(System::Word AChar);
