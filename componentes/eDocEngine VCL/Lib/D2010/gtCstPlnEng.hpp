...
// (DO NOT EDIT: machine generated header) 'Gtcstplneng.pas' rev: 21.00
...
protected:
	...
	virtual int __fastcall AddTOCItem(System::WideString Caption, int ParentNode, int PageNumber, double Top)/* overload */;
	virtual int __fastcall AddTOCItem(System::WideString Caption, int ParentNode, System::UnicodeString URL)/* overload */;
...
public:
	...
	virtual void __fastcall HTMLTextOut(double X, double Y, System::WideString HTMLText);
