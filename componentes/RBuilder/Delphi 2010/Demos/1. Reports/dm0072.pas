...
procedure Tfrm0072.varItemTotalCalc(Sender: TObject; var Value: Variant);
begin
...
procedure Tfrm0072.varOrderTotalCalc(Sender: TObject; var Value: Variant);
begin
...
procedure Tfrm0072.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure Tfrm0072.lblPreferredPrint(Sender: TObject);
begin
