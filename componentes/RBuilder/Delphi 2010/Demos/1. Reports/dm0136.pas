...
procedure Tfrm0136.FormCreate(Sender: TObject);
begin
...
procedure Tfrm0136.FormDestroy(Sender: TObject);
begin
  FCompanyList.Free;
  FContactList.Free;
  FPhoneList.Free;
...
function Tfrm0136.GetReport: TppProducer;
begin
  Result := ppReport1;
end;

function Tfrm0136.ppJITPipeline1GetDataSetName: String;
begin
  Result := 'Customer';
end;

function Tfrm0136.ppJITPipeline1GetFieldAsString(aFieldName: String): String;
begin
  Result := String(GetFieldValue(aFieldName));
end;

function Tfrm0136.ppJITPipeline1GetFieldValue(aFieldName: String): Variant;
begin
  Result := GetFieldValue(aFieldName);
end;

function Tfrm0136.GetFieldValue(const aFieldName: String): Variant;
var
  lsFieldName: String;
  lList: TStringList;
begin
...
procedure Tfrm0136.PopulateLists;
begin
