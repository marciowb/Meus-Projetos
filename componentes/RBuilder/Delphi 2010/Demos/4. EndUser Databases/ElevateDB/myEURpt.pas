...
{$ENDIF}
  ...
  SysUtils,
  Windows, Classes, Controls, Forms,  StdCtrls, ExtCtrls, edbcomps, DB,

  ppEndUsr, ppDBPipe, ppDB, ppPrnabl, ppStrtch, ppDsgnDB,
  ppRelatv, ppCtrls,
   ppRptExp, ppBands, ppCache, ppClass, ppProd,
  ppReport, ppComm, ppFormWrapper, daDataView, daQueryDataView, daElevateDB,
  ppModule, daDataModule, ppParameter;
...
type
  ...
  TmyEndUserSolution = class(TForm)
    ...
    euDatabase: TEDBDatabase;
    EDBSession1: TEDBSession;
    tblFolder: TEDBTable;
    qryItem: TEDBQuery;
    qryItemUpdate: TEDBQuery;
    tblTable: TEDBTable;
    tblField: TEDBTable;
    tblJoin: TEDBTable;
