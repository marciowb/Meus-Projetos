...
{$ENDIF}
  ...
  DBXpress, SqlExpr, Provider, ppFormWrapper, FMTBcd, DBClient, WideStrings,
  DBXMsSQL, ppParameter;
...
type
  ...
  TmyEndUserSolution = class(TForm)
    ...
    euExplorerConnection: TSQLConnection;
    ...
    tblItemitem_name: TStringField;
    tblItemitem_size: TIntegerField;
    tblItemitem_type: TIntegerField;
    tblItemmodified: TSQLTimeStampField;
    tblItemdeleted: TSQLTimeStampField;
    tblFolderfolder_id: TIntegerField;
    tblFolderfolder_name: TStringField;
    tblFolderparent_id: TIntegerField;
    tblItemUpdateitem_id: TIntegerField;
    tblItemUpdatefolder_id: TIntegerField;
    tblItemUpdateitem_name: TStringField;
    tblItemUpdateitem_size: TIntegerField;
    tblItemUpdateitem_type: TIntegerField;
    tblItemUpdatemodified: TSQLTimeStampField;
    tblItemUpdatedeleted: TSQLTimeStampField;
    tblItemUpdatetemplate: TBlobField;
    euReportConnection: TSQLConnection;
