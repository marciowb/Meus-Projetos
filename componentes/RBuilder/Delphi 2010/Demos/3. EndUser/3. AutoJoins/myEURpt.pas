...
{ By removing the 'x' which begins each of these compiler directives,
  ...
  TeeChart - adds a teechart component to the report designer component
         ...
         with Delphi 4 and 5.  It does NOT work with TeeChart 4.02,
         which must be purchased from TeeMach.

  TeeChart402 - adds a teechart component for use with TeeChart 4.02 from
         TeeMach.
...
{$IFNDEF UseDesignPath}
  ...
  // convert to short path name for paradox
  lsPathName := ExtractShortPathName(lsPathName);
