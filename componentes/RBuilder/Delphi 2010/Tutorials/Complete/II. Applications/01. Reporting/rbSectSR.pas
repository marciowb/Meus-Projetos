...
uses
  ...
  ppCtrls, ppReport, ppPrnabl, ppClass, ppStrtch, ppSubRpt, ppCache, ppProd, rbClass;
...
{------------------------------------------------------------------------------}
{ TfrmSectionSubReports.btnPreviewClick }
...
{------------------------------------------------------------------------------}
{ TfrmSectionSubReports.ppGroupHeaderBand1BeforeGenerate }

procedure TfrmSectionSubReports.ppGroupHeaderBand1BeforeGenerate(Sender: TObject);
var
...
{------------------------------------------------------------------------------}
{ TfrmSectionSubReports.ppDetailBand1BeforeGenerate }

procedure TfrmSectionSubReports.ppDetailBand1BeforeGenerate(Sender: TObject);
begin
