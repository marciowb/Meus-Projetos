...
type
  ...
  TOffice2003Scheme = (osBlue, osMetallic, osGreen, osUnknown);
   ...
   {TppOffice2003Scheme
     ...
     Singleton. Manages the Office 2003 User Scheme. The User Scheme determines
     the color scheme used to render the Office 2003 Theme.
       ...
       usMetallic          Silver
       usGreen             Green
       usAdaptive          Adapts to the XP scheme stored in the registry
     }
  TppOffice2003Scheme = class
  private
    FColorScheme: TOffice2003Scheme;
    FUserScheme: TOffice2003UserScheme;

    function GetSchemeFromRegistry: TOffice2003Scheme;
  ...
  public
    ...
    property ColorScheme: TOffice2003Scheme read FColorScheme;
    property UserScheme: TOffice2003UserScheme read GetUserScheme write
        SetUserScheme;

  end;

    {TppTBXOffice2003ThemeBase

    Abstract ancestor for Office 2003 Theme}
  TppTBXOffice2003ThemeBase = class(TppTBXTheme)
  private
    FColorScheme: TOffice2003Scheme;
  protected
  ...
  TppTBXOffice2003Theme = class(TppTBXOffice2003ThemeBase)
  private
  ...
  protected
    ...
    function GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
    function GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart; GradColor2: Boolean = False): TColor;
  ...
  public
    ...
    procedure GetMargins(MarginID: Integer; out Margins: TppTBXMargins); override;
    function  GetImageOffset(Canvas: TCanvas; const ItemInfo: TppTBXItemInfo; ImageList: TCustomImageList): TPoint; override;
    function  GetItemColor(const ItemInfo: TppTBXItemInfo): TColor; override;
    function  GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor; override;
    function  GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor; override;
    ...
    procedure GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins); override;
    ...
    procedure PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintCaption(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo; const ACaption: string; AFormat: Cardinal; Rotated: Boolean); override;
    procedure PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintDock(Canvas: TCanvas; const ClientRect, DockRect: TRect; DockPosition: Integer); override;
    procedure PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo); override;
    procedure PaintDropDownArrow(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintEditButton(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo; ButtonInfo: TppTBXEditBtnInfo); override;
    procedure PaintEditFrame(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo; const EditInfo: TppTBXEditInfo); override;
    procedure PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect; const WindowInfo: TppTBXWindowInfo); override;
    procedure PaintFrame(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintImage(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo; ImageList: TCustomImageList; ImageIndex: Integer); override;
    procedure PaintMDIButton(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo; ButtonKind: Cardinal); override;
    procedure PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo); override;
    procedure PaintMenuItemFrame(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo); override;
    procedure PaintPageScrollButton(Canvas: TCanvas; const ARect: TRect; ButtonType: Integer; Hot: Boolean); override;
    procedure PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo); override;
    procedure PaintSeparator(Canvas: TCanvas; ARect: TRect; ItemInfo: TppTBXItemInfo; Horizontal, LineSeparator: Boolean); override;
    procedure PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo); override;
  ...
  TppTBXOffice2003Menu = class(TppSubMenuItem)
  private
    FBlue: TppTBXItem;
    FMetallic: TppTBXItem;
    FGreen: TppTBXItem;
    FAdaptive: TppTBXItem;
  protected
  ...
  public
    ...
    property Blue: TppTBXItem read FBlue;
    property Metallic: TppTBXItem read FMetallic;
    property Green: TppTBXItem read FGreen;
    property Adaptive: TppTBXItem read FAdaptive;
  end;
...
function ppOffice2003Scheme: TppOffice2003Scheme;

implementation

uses
  Classes, Controls, CommCtrl, Forms, SysUtils,
...
var
  uOffice2003Scheme: TppOffice2003Scheme;

// DM
function ppOffice2003Scheme: TppOffice2003Scheme;
begin
  if uOffice2003Scheme = nil then
    uOffice2003Scheme := TppOffice2003Scheme.Create;
...
begin
  ...
  StockImgList.Handle := ImageList_LoadBitmap(HInstance, 'PPTBXGLYPHS', 16, 0, clWhite);
end;
...
{ TppTBXOffice2003Theme }

function TppTBXOffice2003Theme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXOffice2003Theme.GetIntegerMetrics(Index: Integer): Integer;
begin
  case Index of
...
function TppTBXOffice2003Theme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := DockColor;
...
function TppTBXOffice2003Theme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart; GradColor2: Boolean = False): TColor;
const
...
function TppTBXOffice2003Theme.GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXOffice2003Theme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXOffice2003Theme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

function TppTBXOffice2003Theme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetBtnColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

procedure TppTBXOffice2003Theme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXOffice2003Theme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
begin
  with Margins do
    case MarginID of
      MID_TOOLBARITEM:
...
procedure TppTBXOffice2003Theme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXOffice2003Theme.PaintCaption(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo; const ACaption: string;
...
procedure TppTBXOffice2003Theme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  X, Y: Integer;
begin
...
procedure TppTBXOffice2003Theme.PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXOffice2003Theme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
  var ItemInfo: TppTBXItemInfo; ButtonInfo: TppTBXEditBtnInfo);
var
  DC: HDC;
...
procedure TppTBXOffice2003Theme.PaintEditFrame(Canvas: TCanvas;
  const ARect: TRect; var ItemInfo: TppTBXItemInfo; const EditInfo: TppTBXEditInfo);
var
  DC: HDC;
  R: TRect;
  W: Integer;
...
procedure TppTBXOffice2003Theme.PaintDropDownArrow(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  X, Y: Integer;
begin
...
procedure TppTBXOffice2003Theme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
...
procedure TppTBXOffice2003Theme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect;
  const WindowInfo: TppTBXWindowInfo);
...
procedure TppTBXOffice2003Theme.PaintFrame(Canvas: TCanvas; const ARect: TRect;
  const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
begin
...
function TppTBXOffice2003Theme.GetImageOffset(Canvas: TCanvas;
  const ItemInfo: TppTBXItemInfo; ImageList: TCustomImageList): TPoint;
begin
  Result.X := 0;
  if not (ImageList is TppTBCustomImageList) then
    with ItemInfo do
...
procedure TppTBXOffice2003Theme.PaintImage(Canvas: TCanvas; ARect: TRect;
  const ItemInfo: TppTBXItemInfo; ImageList: TCustomImageList; ImageIndex: Integer);
var
  HiContrast: Boolean;
begin
  with ItemInfo do
  begin
    ...
    {$ENDIF}
    if ImageList is TppTBCustomImageList then
    begin
      TppTBCustomImageList(ImageList).DrawState(Canvas, ARect.Left, ARect.Top,
...
procedure TppTBXOffice2003Theme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
  const ItemInfo: TppTBXItemInfo; ButtonKind: Cardinal);
var
  Index: Integer;
begin
  PaintButton(Canvas, ARect, ItemInfo);
...
procedure TppTBXOffice2003Theme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
procedure TppTBXOffice2003Theme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  X, Y: Integer;
...
procedure TppTBXOffice2003Theme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  PR: TRect;
begin
  with Canvas do
...
procedure TppTBXOffice2003Theme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
  ItemInfo: TppTBXItemInfo; Horizontal, LineSeparator: Boolean);
var
  DC: HDC;
  IsToolbox: Boolean;
  R: TRect;
...
procedure TppTBXOffice2003Theme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXOffice2003Theme.PaintDock(Canvas: TCanvas; const ClientRect,
  DockRect: TRect; DockPosition: Integer);
begin
  FillRectEx(Canvas.Handle, DockRect, DockColor);
end;

procedure TppTBXOffice2003Theme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo);
...
procedure TppTBXOffice2003Theme.SetupColorCache;
const
...
function TppTBXOffice2003Theme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXOffice2003Theme.Create(const AName: string);
begin
  inherited;
  if CounterLock = 0 then InitializeStock;
  Inc(CounterLock);
  AddTBXSysChangeNotification(Self);
  SetColorScheme(ppOffice2003Scheme.ColorScheme);
end;

destructor TppTBXOffice2003Theme.Destroy;
begin
...
procedure TppTBXOffice2003Theme.GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
begin
  Margins.LeftWidth := 0;
  Margins.TopHeight := 0;
...
procedure TppTBXOffice2003Theme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXOffice2003Theme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  DC: HDC;
  X, Y: Integer;
  Pen, OldPen: HPen;
...
procedure TppTBXOffice2003Theme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
...
procedure TppTBXOffice2003Theme.TBXSysCommand(var Message: TMessage);
begin
...
procedure TppTBXOffice2003Menu.CreateControls;
begin
...
procedure TppTBXOffice2003Menu.DoPopup(Sender: TppTBCustomItem; FromLink: Boolean);
begin

  case ppOffice2003Scheme.UserScheme of
...
procedure TppTBXOffice2003Menu.ehItem_Click(Sender: TObject);
begin

  // set user scheme
  ppOffice2003Scheme.UserScheme := TOffice2003UserScheme(TppTBXItem(Sender).Tag);

  // set theme
  if (TppTBXItem(Sender).Parent <> nil) then
    TppTBXItem(Sender).Parent.Click;
...
procedure TppTBXOffice2003Menu.LanguageChanged;
begin
...
class function TppTBXOffice2003ThemeBase.GetSubMenu: TObject;
begin
  Result := TppTBXOffice2003Menu.Create(nil);
end;

procedure TppTBXOffice2003ThemeBase.SetColorScheme(const Value:
    TOffice2003Scheme);
begin
  FColorScheme := Value;
...
constructor TppOffice2003Scheme.Create;
begin
...
destructor TppOffice2003Scheme.Destroy;
begin
...
function TppOffice2003Scheme.GetSchemeFromRegistry: TOffice2003Scheme;
begin
  Result := GetOffice2003Scheme;

end;

function TppOffice2003Scheme.GetUserScheme: TOffice2003UserScheme;
begin

    Result := FUserScheme;
end;

procedure TppOffice2003Scheme.LoadPreferences;
var
...
procedure TppOffice2003Scheme.ResolveColorScheme;
var
  lColorScheme: TOffice2003Scheme;
begin

  if FUserScheme = usAdaptive then
    lColorScheme:= GetSchemeFromRegistry
  else
    lColorScheme := TOffice2003Scheme(FUserScheme);
  ...
  if (FColorScheme <> lColorScheme) then
    begin
      ...
      if (CurrentTheme is TppTBXOffice2003ThemeBase) then
        TppTBXOffice2003ThemeBase(CurrentTheme).ColorScheme := FColorScheme;
    end;

end;

procedure TppOffice2003Scheme.SavePreferences;
var
  lIniStorage: TppIniStorage;
begin
...
procedure TppOffice2003Scheme.SetUserScheme(const Value: TOffice2003UserScheme);
begin
  FUserScheme := Value;
...
initialization
  RegisterTBXTheme('Office2003', TppTBXOffice2003Theme);
