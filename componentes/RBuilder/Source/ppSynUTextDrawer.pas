...
{-------------------------------------------------------------------------------
 ...
 original unit: SynEditTextDrawer.pas
...
function UniversalExtTextOut(DC: HDC; X, Y: Integer; Options: TTextOutOptions;
  Rect: TRect; Str: PChar; Count: Integer; ETODist: PIntegerArray): Boolean;
const
...
procedure TheTextDrawer.ExtTextOut(X, Y: Integer; Options: TTextOutOptions;
  ARect: TRect; Text: PChar; Length: Integer);
...
function TheTextDrawer.TextExtent(Text: PChar; Count: Integer): TSize;
begin
//  Result := FStockBitmap.Canvas.TextExtent(Text);

  Windows.GetTextExtentPoint32(FStockBitmap.Canvas.Handle, Text, Count, Result);
...
begin
  Result := FStockBitmap.Canvas.TextWidth(Text);
end;

function TheTextDrawer.TextWidth(Text: PChar; Count: Integer): Integer;
begin
  Result := TextExtent(Text, Count).cX;
