...
type
  ...
  private
    ...
    FpnlFolders: TppAlignmentPanel;
    FpnlFolderTitle: TppTBXPanel;
    FpnlReports: TppAlignmentPanel;
    FpnlReportTitle: TppTBXPanel;
    FRecycleBinNode: TTreeNode;
    FsplViews: TppTBXSplitter;
    FStatusBar: TppTBXStatusBar;
    FtrvFolders: TTreeView;
  ...
  public
    ...
    procedure ehFileEmailClick(Sender: TObject); override;
    ...
    property pnlFolders: TppAlignmentPanel read FpnlFolders;
    property pnlFolderTitle: TppTBXPanel read FpnlFolderTitle;
    property pnlReports: TppAlignmentPanel read FpnlReports;
    property pnlReportTitle: TppTBXPanel read FpnlReportTitle;
    property ReportsPopupMenu: TppReportsPopupMenu read FReportsPopupMenu;
    property sbrExplorer: TppTBXStatusBar read FStatusBar;
    property splViews: TppTBXSplitter read FsplViews;
    property Toolbar: TppExplorerToolbar read FToolbar;
    property trvFolders: TTreeView read FtrvFolders;
...
procedure TppReportExplorerForm.CreateControls;
begin

  // folder tree
  FpnlFolders := TppAlignmentPanel.Create(Self);
  FpnlFolders.Parent := Self;
  FpnlFolders.Left := 0;
  FpnlFolders.Width := 185;
  FpnlFolders.Align := alLeft;
//  FpnlFolders.BevelOuter = bvNone;
  FpnlFolders.ParentColor := True;

    FpnlFolderTitle := TppTBXPanel.Create(Self);
    FpnlFolderTitle.Parent := FpnlFolders;
    FpnlFolderTitle.Height := 21;
    FpnlFolderTitle.Align := alTop;
    FpnlFolderTitle.Alignment := taLeftJustify;
    FpnlFolderTitle.BevelInner := bvLowered;
    FpnlFolderTitle.BevelOuter := bvNone;

    FtrvFolders := TTreeView.Create(Self);
    FtrvFolders.Parent := FpnlFolders;
    FtrvFolders.Top := 21;
    FtrvFolders.Align := alClient;
    FtrvFolders.DragCursor := crDefault;
    FtrvFolders.DragMode := dmAutomatic;
    FtrvFolders.Indent := 19;
    FtrvFolders.SortType := stText;
    FtrvFolders.OnChange := trvFoldersChange;
    FtrvFolders.OnCollapsing := trvFoldersCollapsing;
    FtrvFolders.OnDragDrop := trvFoldersDragDrop;
    FtrvFolders.OnDragOver := trvFoldersDragOver;
    FtrvFolders.OnEdited := trvFoldersEdited;
    FtrvFolders.OnEditing := trvFoldersEditing;


   // splitter
  FsplViews := TppTBXSplitter.Create(Self);
  FsplViews.Parent := Self;
  FsplViews.Left := 186;
//  FsplViews.ParentColor := True;


  // item list
  FpnlReports := TppAlignmentPanel.Create(Self);
  FpnlReports.Parent := Self;
  FpnlReports.Left := 188;
  FpnlReports.Width := 428;
  FpnlReports.Align := alClient;
//  FpnlReports.BevelOuter = bvNone;

    FpnlReportTitle := TppTBXPanel.Create(Self);
    FpnlReportTitle.Parent := FpnlReports;
    FpnlReportTitle.Height := 21;
    FpnlReportTitle.Align := alTop;
    FpnlReportTitle.Alignment := taLeftJustify;
    FpnlReportTitle.BevelInner := bvLowered;
    FpnlReportTitle.BevelOuter := bvNone;
  ...
  FStatusBar.Panels.Add;
  FStatusBar.Panels[0].Width := 150;
  FStatusBar.Panels[1].Width := 500;
...
//  FReportsPopupMenu.Design.Visible := FReportsPopupMenu.Design.Visible and lbVisible;
  ...
  lbVisible := (ioAllowDesign in FReportExplorer.ItemOptions);
  FMenuBar.FileMenu.Design.Visible := lbVisible;
  FReportsPopupMenu.Design.Visible := lbVisible;
  FToolbar.Design.Visible := lbVisible;
  ...
  lbVisible := (ioAllowEmail in FReportExplorer.ItemOptions);
  FMenuBar.FileMenu.Email.Visible := lbVisible;
  FToolbar.Email.Visible := lbVisible;
  FReportsPopupMenu.Email.Visible := lbVisible;
...
procedure TppReportExplorerForm.InitializeIcons;
begin
...
procedure TppReportExplorerForm.LoadMainMenu;
begin
  // menu dock
...
procedure TppReportExplorerForm.LoadPopupMenus;
begin
...
procedure TppReportExplorerForm.SaveStateInfo;
var
  lIniStorage: TppIniStorage;
begin
...
procedure TppReportExplorerForm.ehFileOpenClick(Sender: TObject);
begin
...
{------------------------------------------------------------------------------}
{ TppReportExplorerForm.SendEmail }

procedure TppReportExplorerForm.SendEmail;
var
...
begin
  ...
  try
    ...
    while lItem <> nil do
      begin
        lSelectedList.Add(lItem.Caption);
        lItem := FListView.GetNextItem(lItem, sdAll, [isSelected]);
      end;

    FReportExplorer.SendEmail(lSelectedList, FListView.FolderId);
...
procedure TppReportExplorerForm.ehFileDesignClick(Sender: TObject);
begin
  Design;
...
procedure TppReportExplorerForm.ehFilePrintClick(Sender: TObject);
begin
  Print;
...
procedure TppReportExplorerForm.ehFilePrintPreviewClick(Sender: TObject);
begin
  PrintPreview;
end; {procedure, ehFilePrintPreviewClick}

{------------------------------------------------------------------------------}
{ TppReportExplorerForm.ehFileEmailClick }

procedure TppReportExplorerForm.ehFileEmailClick(Sender: TObject);
begin
  SendEmail;
end; {procedure, ehFileEmailClick}
...
procedure TppReportExplorerForm.ehFileNewReportClick(Sender: TObject);
var
  liFolderId: Integer;
begin
...
procedure TppReportExplorerForm.ehFileDeleteClick(Sender: TObject);
var
  lNode: TTreeNode;
  lNewNode: TTreeNode;
  liFolderId: Integer;
...
procedure TppReportExplorerForm.ehViewListClick(Sender: TObject);
begin
  SetViewStyle(True);
...
procedure TppReportExplorerForm.ehViewDetailsClick(Sender: TObject);
begin
  SetViewStyle(False);
...
procedure TppReportExplorerForm.ehViewToolbarClick(Sender: TObject);
begin
...
procedure TppReportExplorerForm.ehViewStatusBarClick(Sender: TObject);
begin
...
procedure TppReportExplorerForm.ehFileCloseClick(Sender: TObject);
begin
  Close;
...
procedure TppReportExplorerForm.ehHelpAboutClick(Sender: TObject);
var
...
procedure TppReportExplorerForm.ehHelpTopicsClick(Sender: TObject);
var
...
begin
  ...
  if Value then
    ...
    begin
      ...
      FReportsPopupMenu.Details.Checked := True;
...
procedure TppReportExplorerForm.ehFileNewFolderClick(Sender: TObject);
var
  lItem: TTreeNode;
  lsName: String;
  liFolderId: Integer;
...
procedure TppReportExplorerForm.trvFoldersChange(Sender: TObject; Node: TTreeNode);
begin
  if (trvFolders.Selected <> nil) then
...
procedure TppReportExplorerForm.ehFileRenameClick(Sender: TObject);
var
  lNode: TTreeNode;
begin
...
procedure TppReportExplorerForm.ListDragOverEvent(Sender, Source: TObject; X,Y: Integer; State: TDragState; var Accept: Boolean);
begin
...
procedure TppReportExplorerForm.ehUpOneLevelClick(Sender: TObject);
var
  lItem: TTreeNode;
begin
...
begin
  ...
  if (FListView.ItemType = itReport) then
    FReportExplorer.CurrentItemName := FListView.Selected.Caption
  else
    FReportExplorer.CurrentItemName := '';
...
begin
  ...
  FToolbar.Open.Enabled := lbEnabled and (ioAllowDesign in FReportExplorer.ItemOptions);
  FToolbar.Design.Enabled := lbEnabled and (ioAllowDesign in FReportExplorer.ItemOptions);
  FToolbar.Print.Enabled := lbEnabled;
  FToolbar.PrintPreview.Enabled := lbEnabled;
  FToolbar.Email.Enabled := lbEnabled;

  FMenuBar.FileMenu.Open.Enabled := lbEnabled and (ioAllowDesign in FReportExplorer.ItemOptions);
  ...
  FMenuBar.FileMenu.Email.Enabled := lbEnabled;

  FReportsPopupMenu.Open.Enabled := lbEnabled and (ioAllowDesign in FReportExplorer.ItemOptions);
  ...
  FReportsPopupMenu.Email.Enabled := lbEnabled;
...
procedure TppReportExplorerForm.ehEmptyRecycleBinClick(Sender: TObject);
begin
...
procedure TppReportExplorerForm.ehFoldersPopup(Sender: TObject);
var
  lNode: TTreeNode;
  liFolderId: Integer;
begin
