...
{-------------------------------------------------------------------------------
 ...
 original unit: SynEditMiscProcs.pas
...
begin
  Result := S;
  if ppCharInSet(Result[1], ['T', 't']) then //ClassName is never empty so no AV possible
