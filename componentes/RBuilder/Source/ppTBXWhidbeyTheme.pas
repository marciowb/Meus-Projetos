...
type
  ...
  TppTBXWhidbeyTheme = class(TppTBXTheme)
  private
  ...
  protected
    { Internal Methods }
    function GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart):
      TColor;
    function GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart):
      TColor;
  public
    ...
    function GetImageOffset(Canvas: TCanvas; const ItemInfo: TppTBXItemInfo;
    ...
    function GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
      override;
    ...
    procedure GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
      override;
    ...
    procedure PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo:
      TppTBXItemInfo); override;
    procedure PaintCaption(Canvas: TCanvas; const ARect: TRect; const ItemInfo:
      TppTBXItemInfo; const ACaption: string; AFormat: Cardinal; Rotated:
      Boolean);
      override;
    ...
    procedure PaintImage(Canvas: TCanvas; ARect: TRect; const ItemInfo:
      TppTBXItemInfo; ImageList: TCustomImageList; ImageIndex: Integer); override;
    procedure PaintMDIButton(Canvas: TCanvas; ARect: TRect; const ItemInfo:
      TppTBXItemInfo; ButtonKind: Cardinal); override;
...
begin
  if RegisterTheme then
    RegisterTBXTheme(cThemeName, TppTBXWhidbeyTheme)
  else
...
begin
  ...
  StockImgList.Handle := ImageList_LoadBitmap(HInstance, 'PPTBXGLYPHS', 16, 0,
    clWhite);
...
function TppTBXWhidbeyTheme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXWhidbeyTheme.GetIntegerMetrics(Index: Integer): Integer;
const
  DEFAULT = -1;
begin
  case Index of
...
function TppTBXWhidbeyTheme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := clBtnFace;
...
function TppTBXWhidbeyTheme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart:
  TItemPart): TColor;
const
...
function TppTBXWhidbeyTheme.GetPartColor(const ItemInfo: TppTBXItemInfo;
...
function TppTBXWhidbeyTheme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
...
function TppTBXWhidbeyTheme.GetItemTextColor(const ItemInfo: TppTBXItemInfo):
  TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

function TppTBXWhidbeyTheme.GetItemImageBackground(const ItemInfo:
  TppTBXItemInfo): TColor;
begin
...
procedure TppTBXWhidbeyTheme.GetViewBorder(ViewType: Integer; out Border:
  TPoint);
const
...
procedure TppTBXWhidbeyTheme.GetMargins(MarginID: Integer; out Margins:
  TppTBXMargins);
begin
  with Margins do
    case MarginID of
...
procedure TppTBXWhidbeyTheme.PaintBackgnd(Canvas: TCanvas; const ADockRect,
...
procedure TppTBXWhidbeyTheme.PaintCaption(Canvas: TCanvas;
...
procedure TppTBXWhidbeyTheme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const
...
procedure TppTBXWhidbeyTheme.PaintChevron(Canvas: TCanvas; ARect: TRect; const
  ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXWhidbeyTheme.PaintEditButton(Canvas: TCanvas; const ARect:
  TRect;
...
procedure TppTBXWhidbeyTheme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXWhidbeyTheme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXWhidbeyTheme.PaintButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXWhidbeyTheme.PaintFloatingBorder(Canvas: TCanvas; const ARect:
  TRect;
...
procedure TppTBXWhidbeyTheme.PaintFrame(Canvas: TCanvas; const ARect: TRect;
  const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
function TppTBXWhidbeyTheme.GetImageOffset(Canvas: TCanvas;
...
procedure TppTBXWhidbeyTheme.PaintImage(Canvas: TCanvas; ARect: TRect;
  const ItemInfo: TppTBXItemInfo; ImageList: TCustomImageList; ImageIndex:
  Integer);
var
  HiContrast: Boolean;
begin
...
procedure TppTBXWhidbeyTheme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXWhidbeyTheme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
procedure TppTBXWhidbeyTheme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect;
  var ItemInfo: TppTBXItemInfo);
var
  R, R2: TRect;
  X, Y, I: Integer;
  ArrowWidth: Integer;
...
procedure TppTBXWhidbeyTheme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const
...
procedure TppTBXWhidbeyTheme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXWhidbeyTheme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect;
  const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXWhidbeyTheme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect;
...
procedure TppTBXWhidbeyTheme.PaintDock(Canvas: TCanvas; const ClientRect,
  DockRect: TRect; DockPosition: Integer);
begin
  GradientFill(Canvas, DockRect, gradCol2, clBtnFace, TGLeftRight);
end;

procedure TppTBXWhidbeyTheme.SetupColorCache;
var
  DC: HDC;
...
function TppTBXWhidbeyTheme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXWhidbeyTheme.Create(const AName: string);
begin
  inherited;
...
destructor TppTBXWhidbeyTheme.Destroy;
begin
...
procedure TppTBXWhidbeyTheme.GetViewMargins(ViewType: Integer;
  out Margins: TppTBXMargins);
begin
  Margins.LeftWidth := 0;
  Margins.TopHeight := 0;
...
procedure TppTBXWhidbeyTheme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXWhidbeyTheme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind,
...
procedure TppTBXWhidbeyTheme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part:
  Integer);
var
  D, Sz: integer;
...
procedure TppTBXWhidbeyTheme.TBXSysCommand(var Message: TMessage);
begin
...
{$IFNDEF DTM_Package}
initialization
  RegisterTBXTheme('Whidbey', TppTBXWhidbeyTheme);
{$ENDIF}
