...
type
  TppTBAnimationDirection = set of (tbadLeft, tbadRight, tbadDown, tbadUp);

procedure StartAnimation(const AWnd: HWND; const ATime: Integer; const ABlend:
    Boolean; const ADirection: TppTBAnimationDirection);
procedure StepAnimation(const Msg: TMessage);
procedure EndAnimation(const Wnd: HWND);
...
type
  ...
  TAnimateThreadFuncData = record
    ...
    Size: TPoint;
    LastPos: TPoint;
    Direction: TppTBAnimationDirection;
