...
{-------------------------------------------------------------------------------
 ...
 original unit: SynEditMiscClasses.pas
...
$Id: SynEditMiscClasses.pas,v 1.35.2.7 2008/02/09 13:13:34 maelh Exp $
...
begin
  ...
  Str(Line : fAutoSizeDigitCount, lsLineNumber);

  Result := String(lsLineNumber);
