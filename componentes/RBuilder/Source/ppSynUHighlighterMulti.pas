...
{-------------------------------------------------------------------------------
 ...
 original unit: SynHighlighterMulti.pas
...
$Id: SynHighlighterMulti.pas,v 1.34.2.10 2007/12/24 13:59:57 maelh Exp $
...
function TSynMultiSyn.IsIdentChar(AChar: Char): Boolean;
begin
  if CurrScheme >= 0 then
