...
type
  TppTBXDefaultTheme = class(TppTBXTheme)
  private
...
constructor TppTBXDefaultTheme.Create;
begin
  inherited;
...
destructor TppTBXDefaultTheme.Destroy;
begin
  RemoveTBXSysChangeNotification(Self);
  inherited;
end;

function TppTBXDefaultTheme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXDefaultTheme.GetIntegerMetrics(Index: Integer): Integer;
const
  DEFAULT = -1;
var
  Sz: TSize;
...
function TppTBXDefaultTheme.GetViewColor(ViewType: Integer): TColor;
begin
  Result := ToolbarColor;
...
function TppTBXDefaultTheme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
var
  IsMenuItem: Boolean;
begin
  with ItemInfo do
...
function TppTBXDefaultTheme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
var
...
function TppTBXDefaultTheme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
var
...
procedure TppTBXDefaultTheme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXDefaultTheme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
var
  R, R2: TRect;
begin
  with Margins do
...
procedure TppTBXDefaultTheme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXDefaultTheme.PaintCaption(Canvas: TCanvas;
...
procedure TppTBXDefaultTheme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  X, Y: Integer;
begin
...
procedure TppTBXDefaultTheme.PaintChevron(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXDefaultTheme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXDefaultTheme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXDefaultTheme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXDefaultTheme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
  XPPart: array [TppTBXComboPart] of Integer = (TP_BUTTON, TP_DROPDOWNBUTTON,
...
procedure TppTBXDefaultTheme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect; const WindowInfo: TppTBXWindowInfo);
const
...
procedure TppTBXDefaultTheme.PaintFrame(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  E, Embedded: Boolean;
...
function TppTBXDefaultTheme.GetImageOffset(Canvas: TCanvas; const ItemInfo: TppTBXItemInfo;
...
procedure TppTBXDefaultTheme.PaintImage(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXDefaultTheme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXDefaultTheme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
begin
...
procedure TppTBXDefaultTheme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
...
procedure TppTBXDefaultTheme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  DC: HDC;
begin
  DC := Canvas.Handle;
...
procedure TppTBXDefaultTheme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXDefaultTheme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXDefaultTheme.PaintDock(Canvas: TCanvas; const ClientRect, DockRect: TRect; DockPosition: Integer);
var
  R: TRect;
begin
...
procedure TppTBXDefaultTheme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo);
var
  DC: HDC;
  Sz: Integer;
  R2: TRect;
...
function TppTBXDefaultTheme.GetPopupShadowType: Integer;
begin
  Result := PST_WINDOWSXP;
end;

procedure TppTBXDefaultTheme.GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
begin
  with Margins do
...
procedure TppTBXDefaultTheme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXDefaultTheme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  DC: HDC;
  X, Y, Flags: Integer;
  C: TColor;
...
procedure TppTBXDefaultTheme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
var
  DC: HDC;
...
procedure TppTBXDefaultTheme.SetupColorCache;
begin
...
procedure TppTBXDefaultTheme.TBXSysCommand(var Message: TMessage);
begin
