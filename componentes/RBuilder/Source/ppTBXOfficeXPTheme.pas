...
type
  ...
  TppTBXOfficeXPTheme = class(TppTBXTheme)
  private
  ...
  protected
    ...
    function GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
  public
...
uses
  Classes, Controls, Commctrl, Forms,
...
function TppTBXOfficeXPTheme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXOfficeXPTheme.GetIntegerMetrics(Index: Integer): Integer;
const
  DEFAULT = -1;
begin
  case Index of
...
function TppTBXOfficeXPTheme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := clBtnFace;
...
function TppTBXOfficeXPTheme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXOfficeXPTheme.GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXOfficeXPTheme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXOfficeXPTheme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

function TppTBXOfficeXPTheme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetBtnColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

procedure TppTBXOfficeXPTheme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXOfficeXPTheme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
begin
  with Margins do
    case MarginID of
      MID_TOOLBARITEM:
...
procedure TppTBXOfficeXPTheme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintCaption(Canvas: TCanvas;
...
procedure TppTBXOfficeXPTheme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  X, Y: Integer;
begin
...
procedure TppTBXOfficeXPTheme.PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXOfficeXPTheme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXOfficeXPTheme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXOfficeXPTheme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
begin
...
procedure TppTBXOfficeXPTheme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintFrame(Canvas: TCanvas; const ARect: TRect;
...
function TppTBXOfficeXPTheme.GetImageOffset(Canvas: TCanvas;
...
procedure TppTBXOfficeXPTheme.PaintImage(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
procedure TppTBXOfficeXPTheme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  X, Y: Integer;
...
procedure TppTBXOfficeXPTheme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  PR: TRect;
begin
  with Canvas do
...
procedure TppTBXOfficeXPTheme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOfficeXPTheme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXOfficeXPTheme.PaintDock(Canvas: TCanvas; const ClientRect,
  DockRect: TRect; DockPosition: Integer);
begin
  // this theme does not support dock painting
end;

procedure TppTBXOfficeXPTheme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo);
...
procedure TppTBXOfficeXPTheme.SetupColorCache;
var
  DC: HDC;
...
function TppTBXOfficeXPTheme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXOfficeXPTheme.Create(const AName: string);
begin
  inherited;
...
destructor TppTBXOfficeXPTheme.Destroy;
begin
...
procedure TppTBXOfficeXPTheme.GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
begin
  Margins.LeftWidth := 0;
  Margins.TopHeight := 0;
...
procedure TppTBXOfficeXPTheme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXOfficeXPTheme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  DC: HDC;
  X, Y: Integer;
  Pen, OldPen: HPen;
...
procedure TppTBXOfficeXPTheme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
var
  D, Sz, I: Integer;
  DC: HDC;
...
procedure TppTBXOfficeXPTheme.TBXSysCommand(var Message: TMessage);
begin
  if Message.WParam = TSC_VIEWCHANGE then SetupColorCache;
end;

initialization
  RegisterTBXTheme('OfficeXP', TppTBXOfficeXPTheme);
