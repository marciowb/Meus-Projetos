...
(*
**  Read data from stream and raise EStream error if EOF
*)
...
begin
  raise EStreamError.Create(sInvalidStream);
end;
...
begin
  ...
  FBuffer[0] := FBufferCount-1; // Block size excluding the count
...
begin
  ...
  if FHistogram.Count = 0 then Exit;
