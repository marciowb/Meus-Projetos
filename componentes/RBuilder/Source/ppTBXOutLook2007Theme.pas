...
uses
  Windows, Messages, Graphics, ImgList,
...
//  TOffice2007Scheme = (osBlue, osSilver, osBlack, osUnknown);
  ...
  TppTBXOutlook2007Theme = class(TppTBXOffice2007ThemeBase)
  private
...
{ TppTBXOutlook2007Theme }

function TppTBXOutlook2007Theme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXOutlook2007Theme.GetIntegerMetrics(Index: Integer): Integer;
begin
  case Index of
...
function TppTBXOutlook2007Theme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := DockColor;
...
function TppTBXOutlook2007Theme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart; GradColor2: Boolean = False): TColor;
const
...
function TppTBXOutlook2007Theme.GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXOutlook2007Theme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXOutlook2007Theme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

function TppTBXOutlook2007Theme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetBtnColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

procedure TppTBXOutlook2007Theme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXOutlook2007Theme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
begin
  with Margins do
    case MarginID of
      MID_TOOLBARITEM:
...
procedure TppTBXOutlook2007Theme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintCaption(Canvas: TCanvas;
...
procedure TppTBXOutlook2007Theme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  X, Y: Integer;
begin
...
procedure TppTBXOutlook2007Theme.PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXOutlook2007Theme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXOutlook2007Theme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXOutlook2007Theme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
...
procedure TppTBXOutlook2007Theme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintFrame(Canvas: TCanvas; const ARect: TRect;
...
function TppTBXOutlook2007Theme.GetImageOffset(Canvas: TCanvas;
...
procedure TppTBXOutlook2007Theme.PaintImage(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
procedure TppTBXOutlook2007Theme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  X, Y: Integer;
...
procedure TppTBXOutlook2007Theme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  PR: TRect;
begin
  with Canvas do
...
procedure TppTBXOutlook2007Theme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOutlook2007Theme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXOutlook2007Theme.PaintDock(Canvas: TCanvas; const ClientRect,
  DockRect: TRect; DockPosition: Integer);
begin
  FillRectEx(Canvas.Handle, DockRect, DockColor);
end;

procedure TppTBXOutlook2007Theme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo);
...
procedure TppTBXOutlook2007Theme.SetupColorCache;
const
...
function TppTBXOutlook2007Theme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXOutlook2007Theme.Create(const AName: string);
begin
  inherited;
...
destructor TppTBXOutlook2007Theme.Destroy;
begin
...
class function TppTBXOutlook2007Theme.GetSubMenu: TObject;
begin
  Result := TppTBXOffice2007Menu.Create(nil);
end;

procedure TppTBXOutlook2007Theme.GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
begin
  Margins.LeftWidth := 0;
  Margins.TopHeight := 0;
...
procedure TppTBXOutlook2007Theme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXOutlook2007Theme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  DC: HDC;
  X, Y: Integer;
  Pen, OldPen: HPen;
...
procedure TppTBXOutlook2007Theme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
...
procedure TppTBXOutlook2007Theme.TBXSysCommand(var Message: TMessage);
begin
  if Message.WParam = TSC_VIEWCHANGE then SetupColorCache;
end;

initialization
  RegisterTBXTheme('Outlook2007', TppTBXOutlook2007Theme);
