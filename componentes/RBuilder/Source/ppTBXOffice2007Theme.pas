...
uses
  Windows, Messages, Graphics, Classes, ImgList,
...
type
  ...
  TppTBXOffice2007Menu = class(TppSubMenuItem)
  private
    FBlue: TppTBXItem;
    FSilver: TppTBXItem;
    FBlack: TppTBXItem;
  ...
  public
    ...
    property Silver: TppTBXItem read FSilver;
    property Black: TppTBXItem read FBlack;
  ...
  {TppTBXOffice2007ThemeBase

    Abstract ancestor for Office 2007 and Outlook 2007 themes}
  TppTBXOffice2007ThemeBase = class(TppTBXTheme)
  private
    FColorScheme: TOffice2007Scheme;
  protected
  ...
  {TppTBXOffice2007Theme}
  TppTBXOffice2007Theme = class(TppTBXOffice2007ThemeBase)
  private
...
var
  r: TRect;
begin
  FillGradient(DC,ARect, Color2, Color1,tGTopBottom);
end;
 }
procedure PaintGradientBig(DC: HDC; const ARect: TRect; Color1, Color2: TColor);
var
...
function TppTBXOffice2007Theme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXOffice2007Theme.GetIntegerMetrics(Index: Integer): Integer;
begin
  case Index of
...
function TppTBXOffice2007Theme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := DockColor;
...
function TppTBXOffice2007Theme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart; GradColor2: Boolean = False): TColor;
const
...
function TppTBXOffice2007Theme.GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXOffice2007Theme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXOffice2007Theme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

function TppTBXOffice2007Theme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetBtnColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

procedure TppTBXOffice2007Theme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXOffice2007Theme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
begin
  with Margins do
    case MarginID of
      MID_TOOLBARITEM:
...
procedure TppTBXOffice2007Theme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXOffice2007Theme.PaintCaption(Canvas: TCanvas;
...
{$IFDEF NewerVersion}
procedure TppTBXOffice2007Theme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  X, Y: Integer;
  C: TColor;
...
procedure TppTBXOffice2007Theme.PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXOffice2007Theme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXOffice2007Theme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXOffice2007Theme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXOffice2007Theme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
    ...
    begin
      ...
      begin
       ...
       if ItemInfo.HoverKind<>hkNone then  begin
          InflateRect(R, -1, -1);
          FillGradient(Canvas,R, GetBtnColor(ItemInfo, ipBody,true), clwhite,tGTopBottom);
          InflateRect(R, 1, 1);
...
procedure TppTBXOffice2007Theme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect;
...
{$IFDEF Original}
procedure TppTBXOffice2007Theme.PaintFrame(Canvas: TCanvas; const ARect: TRect;
...
function TppTBXOffice2007Theme.GetImageOffset(Canvas: TCanvas;
...
procedure TppTBXOffice2007Theme.PaintImage(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOffice2007Theme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOffice2007Theme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  R: TRect;
begin
...
procedure TppTBXOffice2007Theme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  X, Y: Integer;
...
procedure TppTBXOffice2007Theme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  PR: TRect;
begin
  with Canvas do
...
procedure TppTBXOffice2007Theme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXOffice2007Theme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
...
procedure TppTBXOffice2007Theme.PaintDock(Canvas: TCanvas; const ClientRect,
...
procedure TppTBXOffice2007Theme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect; const DockPanelInfo: TppTBXDockPanelInfo);
...
procedure TppTBXOffice2007Theme.SetupColorCache;
const
...
function TppTBXOffice2007Theme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXOffice2007Theme.Create(const AName: string);
begin
  inherited;
...
destructor TppTBXOffice2007Theme.Destroy;
begin
...
class function TppTBXOffice2007Theme.GetSubMenu: TObject;
begin
  Result := TppTBXOffice2007Menu.Create(nil);
end;

procedure TppTBXOffice2007Theme.GetViewMargins(ViewType: Integer; out Margins: TppTBXMargins);
begin
  Margins.LeftWidth := 0;
  Margins.TopHeight := 0;
...
procedure TppTBXOffice2007Theme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXOffice2007Theme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  DC: HDC;
  X, Y: Integer;
  Pen, OldPen: HPen;
...
procedure TppTBXOffice2007Theme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
...
procedure TppTBXOffice2007Theme.TBXSysCommand(var Message: TMessage);
begin
...
procedure TppTBXOffice2007Menu.CreateControls;
begin
...
procedure TppTBXOffice2007Menu.DoPopup(Sender: TppTBCustomItem; FromLink: Boolean);
begin
...
procedure TppTBXOffice2007Menu.ehItem_Click(Sender: TObject);
begin

  ppOffice2007Scheme.UserScheme := TOffice2007UserScheme(TppTBXItem(Sender).Tag);
...
procedure TppTBXOffice2007Menu.LanguageChanged;
begin
...
begin
  ...
  if (FColorScheme <> lColorScheme) then
    begin
      ...
      if (CurrentTheme is TppTBXOffice2007ThemeBase) then
        TppTBXOffice2007ThemeBase(CurrentTheme).ColorScheme := FColorScheme;
    end;
...
procedure TppTBXOffice2007ThemeBase.SetColorScheme(const Value: TOffice2007Scheme);
begin
  FColorScheme := Value;
...
initialization
  if not IsTBXThemeAvailable('Office2007') then
    RegisterTBXTheme('Office2007', TppTBXOffice2007Theme);
