...
uses
  Windows, Messages, Graphics, ppTBXThemes, ImgList,
  ppTBXDefaultTheme;
...
type
  ...
  TppTBXAluminumTheme = class(TppTBXDefaultTheme)
  protected
    DockColor: TColor;
    MenuBarColor: TColor;
    ToolbarColor: TColor;
...
function TppTBXAluminumTheme.GetBooleanMetrics(Index: Integer): Boolean;
begin
  case Index of
...
function TppTBXAluminumTheme.GetViewColor(AViewType: Integer): TColor;
begin
  Result := ToolbarColor;
...
function TppTBXAluminumTheme.GetItemColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXAluminumTheme.GetIntegerMetrics(Index: Integer): Integer;
begin
  case Index of
...
function TppTBXAluminumTheme.GetItemTextColor(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetPartColor(ItemInfo, ipText);
end;

procedure TppTBXAluminumTheme.GetViewBorder(ViewType: Integer; out Border: TPoint);
const
...
procedure TppTBXAluminumTheme.PaintBackgnd(Canvas: TCanvas; const ADockRect, ARect, AClipRect: TRect;
...
procedure TppTBXAluminumTheme.PaintCaption(Canvas: TCanvas; const ARect: TRect;
  const ItemInfo: TppTBXItemInfo; const ACaption: string; AFormat: Cardinal; Rotated: Boolean);
var
  R: TRect;
  C, C2: TColor;
...
procedure TppTBXAluminumTheme.PaintCheckMark(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  X, Y: Integer;
begin
...
procedure TppTBXAluminumTheme.PaintDropDownArrow(Canvas: TCanvas;
...
procedure TppTBXAluminumTheme.PaintButton(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
  RL, RR: Integer;
...
procedure TppTBXAluminumTheme.PaintChevron(Canvas: TCanvas; ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXAluminumTheme.PaintFloatingBorder(Canvas: TCanvas; const ARect: TRect; const WindowInfo: TppTBXWindowInfo);
const
...
procedure TppTBXAluminumTheme.PaintFrame(Canvas: TCanvas; const ARect: TRect; const ItemInfo: TppTBXItemInfo);
var
  DC: HDC;
  R: TRect;
...
procedure TppTBXAluminumTheme.PaintEditButton(Canvas: TCanvas; const ARect: TRect;
...
procedure TppTBXAluminumTheme.PaintEditFrame(Canvas: TCanvas;
...
procedure TppTBXAluminumTheme.PaintImage(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXAluminumTheme.PaintMenuItemFrame(Canvas: TCanvas;
  const ARect: TRect; const ItemInfo: TppTBXItemInfo);
const
...
procedure TppTBXAluminumTheme.PaintMenuItem(Canvas: TCanvas; const ARect: TRect; var ItemInfo: TppTBXItemInfo);
const
  ZERO_RECT: TRect = (Left: 0; Top: 0; Right: 0; Bottom: 0);
var
  DC: HDC;
...
procedure TppTBXAluminumTheme.PaintPopupNCArea(Canvas: TCanvas; R: TRect; const PopupInfo: TppTBXPopupInfo);
var
  PR: TRect;
  DC: HDC;
  C: TColor;
...
procedure TppTBXAluminumTheme.PaintSeparator(Canvas: TCanvas; ARect: TRect;
...
procedure TppTBXAluminumTheme.PaintToolbarNCArea(Canvas: TCanvas; R: TRect; const ToolbarInfo: TppTBXToolbarInfo);
const
  Pattern: array [0..15] of Byte = ($C6, 0, $6C, 0, $38, 0, $38, 0, $6C, 0, $C6, 0, 0, 0, 0, 0);
var
  DC: HDC;
...
procedure TppTBXAluminumTheme.PaintMDIButton(Canvas: TCanvas; ARect: TRect;
...
function TppTBXAluminumTheme.GetPopupShadowType: Integer;
begin
  Result := PST_OFFICEXP;
end;

constructor TppTBXAluminumTheme.Create(const AName: string);
begin
  inherited;
...
destructor TppTBXAluminumTheme.Destroy;
begin
  Dec(CounterLock);
...
procedure TppTBXAluminumTheme.PaintDock(Canvas: TCanvas; const ClientRect,
  DockRect: TRect; DockPosition: Integer);
begin
  BrushedFill(Canvas.Handle, @(ClientRect.TopLeft), DockRect, DockColor, 8);
end;

procedure TppTBXAluminumTheme.PaintDockPanelNCArea(Canvas: TCanvas; R: TRect;
  const DockPanelInfo: TppTBXDockPanelInfo);
var
  DC: HDC;
  Sz: Integer;
  R2: TRect;
...
procedure TppTBXAluminumTheme.PaintPageScrollButton(Canvas: TCanvas;
...
procedure TppTBXAluminumTheme.PaintFrameControl(Canvas: TCanvas; R: TRect; Kind, State: Integer; Params: Pointer);
var
  X, Y: Integer;
...
procedure TppTBXAluminumTheme.PaintStatusBar(Canvas: TCanvas; R: TRect; Part: Integer);
var
  DC: HDC;
  D, Sz, I: Integer;
  Lo, Hi: TColor;
...
procedure TppTBXAluminumTheme.SetupColorCache;
var
  DC: HDC;
...
function TppTBXAluminumTheme.GetBtnColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXAluminumTheme.GetPartColor(const ItemInfo: TppTBXItemInfo; ItemPart: TItemPart): TColor;
const
...
function TppTBXAluminumTheme.GetItemImageBackground(const ItemInfo: TppTBXItemInfo): TColor;
begin
  Result := GetBtnColor(ItemInfo, ipBody);
  if Result = clNone then Result := GetViewColor(ItemInfo.ViewType);
end;

function TppTBXAluminumTheme.GetImageOffset(Canvas: TCanvas;
...
procedure TppTBXAluminumTheme.GetMargins(MarginID: Integer; out Margins: TppTBXMargins);
begin
  inherited;
...
RegisterTBXTheme('Aluminum', TppTBXAluminumTheme);
