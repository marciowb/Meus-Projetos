...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_40_PREPARATION/run/JvPageListTreeView.pas $';
    Revision: '$Revision: 12628 $';
    Date: '$Date: 2009-12-28 11:22:09 +0100 (lun., 28 d̩c. 2009) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
