...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvControlActionsEngineCxGrid.pas 12749 2010-04-04 13:55:21Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile:
      '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_40_PREPARATION/run/JvControlActionsEngineCxGrid.pas $';
    Revision: '$Revision: 12749 $';
    Date: '$Date: 2010-04-04 15:55:21 +0200 (dim., 04 avr. 2010) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
