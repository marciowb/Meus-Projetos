...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_40_PREPARATION/run/JvCombobox.pas $';
    Revision: '$Revision: 12823 $';
    Date: '$Date: 2010-08-13 13:11:53 +0200 (ven., 13 aoÃ»t 2010) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
