...
The Initial Developer of the Original Code is Peter Thˆrnqvist [peter3 at sourceforge dot net]
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_40_PREPARATION/run/JvSpellIntf.pas $';
