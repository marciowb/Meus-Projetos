...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPanel.pas 12771 2010-05-16 12:57:02Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/branches/JVCL3_40_PREPARATION/run/JvPanel.pas $';
    Revision: '$Revision: 12771 $';
    Date: '$Date: 2010-05-16 14:57:02 +0200 (dim., 16 mai 2010) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
