...
{**************************************************************************************************}
{                                                                                                  }
{ Last modified: $Date:: 2010-09-10 18:23:10 +0200 (ven. 10 sept. 2010)                          $ }
{ Revision:      $Rev:: 3336                                                                     $ }
...
const
  ...
  JclVersionBuild   = 3845; // build number, days since march 1, 2000
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net:443/svnroot/jcl/tags/JCL-2.2-Build3845/jcl/source/common/JclBase.pas $';
    Revision: '$Revision: 3336 $';
    Date: '$Date: 2010-09-10 18:23:10 +0200 (ven. 10 sept. 2010) $';
