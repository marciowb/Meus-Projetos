...
uses
  ...
  Commctrl, Forms, PictureContainer, Dialogs, Printers
{$IFDEF DELPHI3_LVL}
  , Comobj, ActiveX
{$ELSE}
  , OleAuto, OleCtnrs
...
const
  ...
  BLD_VER = 0; // Build nr.
  DATE_VER = 'Jul, 2010'; // Month version
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            taCenter: rect.Left := rect.Left + ((Columns[parr[i + 1]].Width - SmallImages.Width - (Canvas.TextWidth(s))) div 2);
            taRightJustify: rect.Left := rect.Left + Columns[parr[i + 1]].Width - SmallImages.Width - Canvas.TextWidth(s) - 2;
            end;
...
{$ENDIF}
      ...
      if Pos('{\', s) = 1 then
        ...
        begin
          ...
          begin
            ...
            HTMLDrawEx(Canvas, s, DrwRect, TImageList(SmallImages), 0, 0, -1, -1, 1, False, False, False, False, True, False, WordWrap, 0.0,
    ...
    begin
      ...
      if pos('</', s) > 0 then
      begin
        HTMLDrawEx(Canvas, s, TmpRct, TImagelist(SmallImages), 0, 0, -1, -1, 1, False, False, False, False, True, False, WordWrap, 0.0,
          FURLColor, clNone, clNone, clGray, Anchor, Stripped, FA, XSize, YSize, ml, hl, hr, FImageCache, FContainer,0);
