...
uses
  ...
  tmsUFlxFormats, tmsUFlxMessages, BaseGrid, AdvObj, tmsUXlsPictures, ShellAPI, Dialogs, Controls, Printers, tmsXlsMessages,
...
begin
  ...
  if Options.ExportCellMargins then
    begin XYOffset.X := 0; XYOffset.Y := 0; end
  else XYOffset := CurrentGrid.XYOffset;
