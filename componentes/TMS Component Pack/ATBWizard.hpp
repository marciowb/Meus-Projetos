...
// (DO NOT EDIT: machine generated header) 'Atbwizard.pas' rev: 21.00
...
public:
	...
	__fastcall TATBUnitCreator(Toolsapi::_di_IOTAModule AOwner, System::UnicodeString UnitIdent, System::UnicodeString ClassName, System::UnicodeString aFileName, bool AIsMainForm);
public:
...
public:
	__fastcall TBaseFile(const System::UnicodeString ModuleName, const System::UnicodeString FormName, const System::UnicodeString AncestorName);
public:
...
public:
	/* TBaseFile.Create */ inline __fastcall TUnitFile(const System::UnicodeString ModuleName, const System::UnicodeString FormName, const System::UnicodeString AncestorName) : TBaseFile(ModuleName, FormName, AncestorName) { }
...
protected:
	...
	System::TDateTime __fastcall GetAge(void);
public:
	/* TBaseFile.Create */ inline __fastcall TFormFile(const System::UnicodeString ModuleName, const System::UnicodeString FormName, const System::UnicodeString AncestorName) : TBaseFile(ModuleName, FormName, AncestorName) { }
