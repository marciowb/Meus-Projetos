...
// (DO NOT EDIT: machine generated header) 'Guimotions.pas' rev: 21.00
...
typedef StaticArray<TCustomVertex, 400> TVertexArray;

class DELPHICLASS TGUIMotionsImage;
typedef DynamicArray<TGUIMotionsImage*> TGUIMotionsImageArray;
...
static const Byte CountVertices = 0xc8;
static const Word D3DFVF_CUSTOMVERTEX = 0x142;
