...
type
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure Draw(g: TGPGraphics; r: TRect; TotalCapacity: Double; Items: TCapacityItems; CapacityDes, DesFormat, FreeDes, FreeDesFormat: string);
    function GetInsideRectF(r: TRect): TGPRectF;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
  published
    property BackGroundFill: TGDIPFill read FBackGroundFill write SetBackGroundFill;
...
function DrawGDIPText(graphics: TGPGraphics; Alignment: TAlignment; RF: TGPRectF; Caption:string; WideCaption: widestring; AFont: TFont; Enabled: Boolean; RealDraw: Boolean; AntiAlias: TAntiAlias; OutLineClr: TColor; Shadow: Boolean): TGPRectF;
var
  w,h: Integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        SB2 := TGPSolidBrush.Create(ColorToARGB(clBlack));
...
begin
  ...
  k := StartLeft;
  j := Round(FBarRect.Width / Divisions);
...
begin
  DrawGDIPText(g, taLeftJustify, FCapDesRect, CapacityDes, '', CapacityFont, True, True, aaAntiAlias, clWhite, True);
  DrawGDIPText(g, taLeftJustify, FCapFormatRect, DesFormat, '', CapacityFont, True, True, aaAntiAlias, clWhite, True);
end;
...
begin
  ...
  begin
    ...
    DrawGDIPText(g, taLeftJustify, Items[I].FDesRect, Items[I].Description, '', LegendFont, True, True, aaAntiAlias, clWhite, True);
    DrawGDIPText(g, taLeftJustify, Items[I].FFormatRect, Items[I].LegendFormat, '', LegendFont, True, True, aaAntiAlias, clWhite, True);
  end;
  DrawMark(FFreeMarkPT, Color, clWhite{Items[I].ColorTo});
  DrawGDIPText(g, taLeftJustify, FFreeDesRect, FreeDes, '', LegendFont, True, True, aaAntiAlias, clWhite, True);
  DrawGDIPText(g, taLeftJustify, FFreeFormatRect, FreeDesFormat, '', LegendFont, True, True, aaAntiAlias, clWhite, True);
end;

//------------------------------------------------------------------------------

procedure TGDIPCapacityBar.Draw(g: TGPGraphics; r: TRect; TotalCapacity: Double;
  Items: TCapacityItems; CapacityDes, DesFormat, FreeDes, FreeDesFormat: string);
var
  bg: TGPRectF;
  i: Integer;
begin
...
begin
  ...
  GetTextSize(g, R2, FreeFormat, LegendFont, FFreeFormatRect);  // Format
