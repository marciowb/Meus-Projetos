...
begin
  ...
  begin
    ...
    {$IFDEF TMSDOTNET}
    DrawText(TListBox(Control).Canvas.Handle, TListBox(Control).Items[Index], -1, Rect, DT_SINGLELINE or DT_VCENTER or DT_NOPREFIX);
    {$ENDIF}
  end;
...
//   TAdvFontType = (aftBitmap, aftTrueType, aftPostScript, aftPrinter);
  ...
  begin
    ...
    {$IFDEF TMSDOTNET}
    DrawText(TListBox(Control).Canvas.Handle, s, -1, Rect, DT_SINGLELINE or DT_VCENTER or DT_NOPREFIX);
    {$ENDIF}
  end;
