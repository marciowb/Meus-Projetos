...
type
  ...
  {$ENDIF}
    ...
    function GetXYToHour(X, Y: Integer): Integer;
    function GetXYToMinute(X, Y: Integer): Integer;
...
function TAdvWatch.GetXYToHour(X, Y: Integer): Integer;
begin
  Result := Round(GetXYToMinute(X, Y) / 5);
...
function TAdvWatch.GetXYToMinute(X, Y: Integer): Integer;
var
  //R: TRect;
  CP: TPoint;
  a, b, m: Double;
