...
begin
  ...
  pmsOffice2003Classic:
    ...
    begin
      ...
      DefaultItem.Color := $FDF6EF;
      DefaultItem.ColorTo := $F0DAC7;
      DefaultItem.SelectColor := $6CD0FF;
      DefaultItem.SelectColorTo := clNone;
      DefaultItem.CaptionBkg := $5B391E;
      DefaultItem.CaptionBkgTo := $5B391E;
      DefaultItem.TrackColor := clBlue;
    ...
    begin
      ...
      DefaultItem.Color := $BFBFBF;
      DefaultItem.ColorTo := $919191;
      DefaultItem.SelectColor := $6CD0FF;
      DefaultItem.SelectColorTo := clNone;
      DefaultItem.CaptionBkg := $5B391E;
      DefaultItem.CaptionBkgTo := $5B391E;
