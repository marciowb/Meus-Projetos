...
uses
  ...
  ExtCtrls, Grids, DBGrids, FormScript, atPascal, atBasic, AdvMemo, advmbs;
...
begin
  ...
  with atBasicFormScripter1.SystemLibrary do
  begin
...
begin
   TDBEdit(atBasicFormScripter1.CurrentObject).EditText := atBasicFormScripter1.GetInputArgAsString(0);
end;
