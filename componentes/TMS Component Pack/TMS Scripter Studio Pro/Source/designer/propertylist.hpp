...
// (DO NOT EDIT: machine generated header) 'Propertylist.pas' rev: 21.00
...
#define tkOrdinals (Set<Typinfo::TTypeKind, tkUnknown, tkProcedure> () << tkInteger << tkChar << tkEnumeration << tkSet << tkClass << tkWChar )
#define tkChars (Set<Typinfo::TTypeKind, tkUnknown, tkProcedure> () << tkChar << tkWChar )
#define tkStrings (Set<Typinfo::TTypeKind, tkUnknown, tkProcedure> () << tkString << tkLString << tkWString << tkUString )
