...
// (DO NOT EDIT: machine generated header) 'FormDesigner.pas' rev: 22.00
...
typedef System::Set<TGrabPosition, TGrabPosition::gpNone, TGrabPosition::gpRightBottom>  TGrabPositions;
...
private:
	System::StaticArray<TGrabHandle*, 9> FItems;
...
typedef System::Set<TAlignmentPaletteOption, TAlignmentPaletteOption::apAutoShow, TAlignmentPaletteOption::apFlatButtons>  TAlignmentPaletteOptions;
...
typedef System::Set<TLinePosition, TLinePosition::lpLeft, TLinePosition::lpBottom>  TLinePositions;
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word WM_SECONDARYPAINT = 0x7e8;
static const System::Word WM_DESIGNERMDOWN = 0x7e9;
