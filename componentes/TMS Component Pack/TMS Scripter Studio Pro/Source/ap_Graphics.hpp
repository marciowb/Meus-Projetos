...
// (DO NOT EDIT: machine generated header) 'ap_Graphics.pas' rev: 22.00
...
public:
	...
	void __fastcall __TCustomCanvasArcTo(Atscript::TatVirtualMachine* AMachine);
	void __fastcall __TCustomCanvasAngleArc(Atscript::TatVirtualMachine* AMachine);
	...
	void __fastcall __TCanvasArcTo(Atscript::TatVirtualMachine* AMachine);
	void __fastcall __TCanvasAngleArc(Atscript::TatVirtualMachine* AMachine);
...
private:
	...
	Graphics::TFontQuality FQuality;
...
__published:
	...
	__property Graphics::TFontQuality Quality = {read=FQuality, write=FQuality, nodefault};
public:
