...
// (DO NOT EDIT: machine generated header) 'IDEMain.pas' rev: 22.00
...
typedef System::Set<TRemovedZone, TRemovedZone::mzFrame, TRemovedZone::mzRightBottom>  TRemovedZones;
