...
begin
  with AMachine do
  begin
    TfrmIBFilterFieldEditor(CurrentObject).lstFieldListClick(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TfrmIBFilterFieldEditor(CurrentObject).edtAliasChange(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TfrmIBFilterFieldEditor(CurrentObject).btnAddClick(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TfrmIBFilterFieldEditor(CurrentObject).btnRemoveClick(TObject(Integer(GetInputArg(0))));
  end;
end;
