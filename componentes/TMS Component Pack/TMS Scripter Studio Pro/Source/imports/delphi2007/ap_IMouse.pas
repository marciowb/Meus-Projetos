...
begin
  with AMachine do
  begin
AResult := TPanningWindow(CurrentObject).StartPanning(VarToInteger(GetInputArg(0)),TControl(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IMouse.StartPan(VarToInteger(GetInputArg(0)),TControl(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
