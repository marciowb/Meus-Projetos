...
begin
  ...
  begin
case InputArgCount of
1: AResult := Integer(TScreen(CurrentObject).MonitorFromWindow(VarToInteger(GetInputArg(0))));
2: AResult := Integer(TScreen(CurrentObject).MonitorFromWindow(VarToInteger(GetInputArg(0)),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Forms.SetCustomFormGlassFrame(TCustomForm(Integer(GetInputArg(0))),TGlassFrame(Integer(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Forms.GetCustomFormGlassFrame(TCustomForm(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Forms.SetApplicationMainFormOnTaskBar(TApplication(Integer(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Forms.GetApplicationMainFormOnTaskBar(TApplication(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SetCustomFormGlassFrame',2,tkNone,nil,__SetCustomFormGlassFrame,false,0);
    DefineMethod('GetCustomFormGlassFrame',1,tkClass,TGlassFrame,__GetCustomFormGlassFrame,false,0);
    DefineMethod('SetApplicationMainFormOnTaskBar',2,tkNone,nil,__SetApplicationMainFormOnTaskBar,false,0);
    DefineMethod('GetApplicationMainFormOnTaskBar',1,tkVariant,nil,__GetApplicationMainFormOnTaskBar,false,0);
