...
begin
  with AMachine do
  begin
AResult := Integer(TTabListClass(CurrentClass.ClassRef).Create(TTabSet(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TTabList,__TTabListCreate,true,0);
  ...
  begin
    ...
    DefineMethod('ItemAtPos',2,tkInteger,nil,__TTabSetItemAtPos,false,1);
