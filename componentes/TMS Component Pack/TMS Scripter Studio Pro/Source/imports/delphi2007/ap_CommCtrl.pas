...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := CommCtrl.ComboBox_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ComboBox_GetCueBannerText',3,tkVariant,nil,__ComboBox_GetCueBannerText,false,0).SetVarArgs([2]);
