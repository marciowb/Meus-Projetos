...
begin
  ...
  begin
    ...
    DefineMethod('WebColorNameToColor',1,tkEnumeration,nil,__WebColorNameToColor,false,0);
    DefineMethod('WebColorStrToColor',1,tkEnumeration,nil,__WebColorStrToColor,false,0);
