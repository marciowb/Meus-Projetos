...
begin
  with AMachine do
  begin
AResult := Integer(TServiceClass(CurrentClass.ClassRef).CreateNew(TComponent(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('CreateNew',2,tkClass,TService,__TServiceCreateNew,true,0);
