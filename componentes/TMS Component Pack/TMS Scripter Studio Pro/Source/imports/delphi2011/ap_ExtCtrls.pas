...
begin
  with AMachine do
  begin
    TCustomButtonedEdit(CurrentObject).Images:=TCustomImageList(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTrayIcon(CurrentObject).Icons:=TCustomImageList(Integer(GetInputArg(0)));
  end;
end;
