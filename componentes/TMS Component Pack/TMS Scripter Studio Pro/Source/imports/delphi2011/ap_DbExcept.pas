...
begin
  ...
  begin
    DefineMethod('FormShow',1,tkNone,nil,__TDbEngineErrorDlgFormShow,false);
    DefineMethod('BackClick',1,tkNone,nil,__TDbEngineErrorDlgBackClick,false);
    DefineMethod('NextClick',1,tkNone,nil,__TDbEngineErrorDlgNextClick,false);
    DefineMethod('FormCreate',1,tkNone,nil,__TDbEngineErrorDlgFormCreate,false);
    DefineMethod('DetailsBtnClick',1,tkNone,nil,__TDbEngineErrorDlgDetailsBtnClick,false);
    DefineMethod('FormDestroy',1,tkNone,nil,__TDbEngineErrorDlgFormDestroy,false);
    DefineMethod('HookExceptions',0,tkNone,nil,__TDbEngineErrorDlgHookExceptions,false);
    DefineMethod('ShowException',1,tkEnumeration,nil,__TDbEngineErrorDlgShowException,false);
