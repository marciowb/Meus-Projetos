...
type
  TatDBClientLibrary = class(TatScripterLibrary)
    ...
    procedure __TCustomClientDataSetBookmarkValid(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomClientDataSetCompareBookmarks(AMachine: TatVirtualMachine);
...
procedure TatDBClientLibrary.__TCustomClientDataSetBookmarkValid(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomClientDataSet(CurrentObject).BookmarkValid(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBClientLibrary.__TCustomClientDataSetCompareBookmarks(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomClientDataSet(CurrentObject).CompareBookmarks(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('BookmarkValid',1,tkVariant,nil,__TCustomClientDataSetBookmarkValid,false,0);
    ...
    DefineMethod('CompareBookmarks',2,tkInteger,nil,__TCustomClientDataSetCompareBookmarks,false,0);
