...
begin
  ...
  begin
    Case InputArgCount of
      2: TCustomIniFile(CurrentObject).ReadSubSections(GetInputArg(0),TStrings(Integer(GetInputArg(1))));
      3: TCustomIniFile(CurrentObject).ReadSubSections(GetInputArg(0),TStrings(Integer(GetInputArg(1))),GetInputArg(2));
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ReadSubSections',3,tkNone,nil,__TCustomIniFileReadSubSections,false,1);
  ...
  begin
    ...
    DefineProp('Encoding',tkVariant,__GetTMemIniFileEncoding,__SetTMemIniFileEncoding,nil,false,0);
  end;
