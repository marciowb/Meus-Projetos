...
type
  TatDelphiSystemLibrary = class(TatScripterLibrary)
    ...
    procedure __Random(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := TObjectClass(CurrentClass.ClassRef).UnitName;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TObject(CurrentObject).Equals(TObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TObject(CurrentObject).ToString;
    ReturnOutputArg(AResult);
  end;
end;
...
1: AResult := System.MonitorEnter(TObject(Integer(GetInputArg(0))));
2: AResult := System.MonitorEnter(TObject(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.MonitorTryEnter(TObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.MonitorExit(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.MonitorWait(TObject(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.MonitorPulse(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    System.MonitorPulseAll(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.GetMinimumBlockAlignment;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.SetMinimumBlockAlignment(GetInputArg(0));
  end;
end;
...
procedure TatDelphiSystemLibrary.__Random(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.Random(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(System.UnicodeToUtf8(PAnsiChar(VarToStr(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(System.Utf8ToUnicode(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.UTF8ToString(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Equals',1,tkVariant,nil,__TObjectEquals,false,0);
  ...
  begin
    DefineMethod('MonitorEnter',2,tkVariant,nil,__MonitorEnter,false,1);
    DefineMethod('MonitorTryEnter',1,tkVariant,nil,__MonitorTryEnter,false,0);
    DefineMethod('MonitorExit',1,tkNone,nil,__MonitorExit,false,0);
    DefineMethod('MonitorWait',2,tkVariant,nil,__MonitorWait,false,0);
    DefineMethod('MonitorPulse',1,tkNone,nil,__MonitorPulse,false,0);
    DefineMethod('MonitorPulseAll',1,tkNone,nil,__MonitorPulseAll,false,0);
    ...
    DefineMethod('GetMemoryManagerState',1,tkNone,nil,__GetMemoryManagerState,false,0).SetVarArgs([0]);
    DefineMethod('GetMinimumBlockAlignment',0,tkEnumeration,nil,__GetMinimumBlockAlignment,false,0);
    DefineMethod('SetMinimumBlockAlignment',1,tkNone,nil,__SetMinimumBlockAlignment,false,0);
    ...
    DefineMethod('MoveChars',3,tkNone,nil,__MoveChars,false,0).SetVarArgs([1]);
    ...
    DefineMethod('UTF8EncodeToShortString',1,tkVariant,nil,__UTF8EncodeToShortString,false,0);
    DefineMethod('UTF8Decode',1,tkVariant,nil,__UTF8Decode,false,0);
    DefineMethod('UTF8ToWideString',1,tkVariant,nil,__UTF8ToWideString,false,0);
    DefineMethod('UTF8ToUnicodeString',1,tkVariant,nil,__UTF8ToUnicodeString,false,0);
    DefineMethod('UTF8ToString',1,tkVariant,nil,__UTF8ToString,false,0);
    ...
    DefineMethod('Int',1,tkVariant,nil,__Int,false,0);
    DefineMethod('Frac',1,tkVariant,nil,__Frac,false,0);
    DefineMethod('Exp',1,tkVariant,nil,__Exp,false,0);
    DefineMethod('Cos',1,tkVariant,nil,__Cos,false,0);
    DefineMethod('Sin',1,tkVariant,nil,__Sin,false,0);
    DefineMethod('Ln',1,tkVariant,nil,__Ln,false,0);
    DefineMethod('ArcTan',1,tkVariant,nil,__ArcTan,false,0);
    DefineMethod('Sqrt',1,tkVariant,nil,__Sqrt,false,0);
    ...
    DefineMethod('StringElementSize',1,tkInteger,nil,__StringElementSize,false,0);
    DefineMethod('StringCodePage',1,tkInteger,nil,__StringCodePage,false,0);
    DefineMethod('StringRefCount',1,tkInteger,nil,__StringRefCount,false,0);
    DefineMethod('SetCodePage',3,tkNone,nil,__SetCodePage,false,1).SetVarArgs([0]);
    DefineMethod('Pos',2,tkInteger,nil,__Pos,false,0);
    ...
    DefineMethod('StringOfChar',2,tkVariant,nil,__StringOfChar,false,0);
    ...
    DefineMethod('SetMultiByteConversionCodePage',1,tkNone,nil,__SetMultiByteConversionCodePage,false,0);
