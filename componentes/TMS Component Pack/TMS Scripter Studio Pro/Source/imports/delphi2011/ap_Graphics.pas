...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).BrushCopy(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TBitmap(Integer(GetInputArg(1))),TRectWrapper(integer(GetInputArg(2))).ObjToRec,GetInputArg(3));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).Draw(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),TGraphic(Integer(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).FloodFill(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),GetInputArg(2),GetInputArg(3));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).StretchDraw(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TGraphic(Integer(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(tagSIZEWrapper.Create(TCustomCanvas(CurrentObject).TextExtent(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomCanvas(CurrentObject).TextHeight(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).TextOut(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomCanvas(CurrentObject).TextWidth(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomCanvas(CurrentObject).CanvasOrientation);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomCanvas(CurrentObject).Pixels[VarToInteger(GetArrayIndex(0)),VarToInteger(GetArrayIndex(1))]);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCanvas(CurrentObject).Pixels[VarToInteger(GetArrayIndex(0)),VarToInteger(GetArrayIndex(1))]:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TGraphic(CurrentObject).Equals(TObject(integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGraphic(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TPicture(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TMetafile(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TMetafile(CurrentObject).ReleaseHandle;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TMetafile(CurrentObject).Handle);
  end;
end;
...
begin
  with AMachine do
  begin
    TMetafile(CurrentObject).Handle:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    TBitmap(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TBitmap(CurrentObject).LoadFromResourceName(GetInputArg(0),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    TBitmap(CurrentObject).LoadFromResourceID(GetInputArg(0),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TBitmap(CurrentObject).AlphaFormat);
  end;
end;
...
begin
  with AMachine do
  begin
    TBitmap(CurrentObject).AlphaFormat:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    TIcon(CurrentObject).AssignTo(TPersistent(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TIcon(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TIcon(CurrentObject).LoadFromResourceName(GetInputArg(0),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    TIcon(CurrentObject).LoadFromResourceID(GetInputArg(0),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Arc',8,tkNone,nil,__TCustomCanvasArc,false,0);
    DefineMethod('ArcTo',8,tkNone,nil,__TCustomCanvasArcTo,false,0);
    DefineMethod('AngleArc',5,tkNone,nil,__TCustomCanvasAngleArc,false,0);
    DefineMethod('BrushCopy',4,tkNone,nil,__TCustomCanvasBrushCopy,false,0);
    DefineMethod('Chord',8,tkNone,nil,__TCustomCanvasChord,false,0);
    DefineMethod('Draw',3,tkNone,nil,__TCustomCanvasDraw,false,0);
    DefineMethod('DrawFocusRect',1,tkNone,nil,__TCustomCanvasDrawFocusRect,false,0);
    DefineMethod('Ellipse',4,tkNone,nil,__TCustomCanvasEllipse,false,0);
    DefineMethod('FillRect',1,tkNone,nil,__TCustomCanvasFillRect,false,0);
    DefineMethod('FloodFill',4,tkNone,nil,__TCustomCanvasFloodFill,false,0);
    DefineMethod('FrameRect',1,tkNone,nil,__TCustomCanvasFrameRect,false,0);
    DefineMethod('LineTo',2,tkNone,nil,__TCustomCanvasLineTo,false,0);
    DefineMethod('Lock',0,tkNone,nil,__TCustomCanvasLock,false,0);
    DefineMethod('MoveTo',2,tkNone,nil,__TCustomCanvasMoveTo,false,0);
    DefineMethod('Pie',8,tkNone,nil,__TCustomCanvasPie,false,0);
    DefineMethod('Rectangle',4,tkNone,nil,__TCustomCanvasRectangle,false,0);
    DefineMethod('Refresh',0,tkNone,nil,__TCustomCanvasRefresh,false,0);
    DefineMethod('RoundRect',6,tkNone,nil,__TCustomCanvasRoundRect,false,0);
    DefineMethod('StretchDraw',2,tkNone,nil,__TCustomCanvasStretchDraw,false,0);
    DefineMethod('TextExtent',1,tkVariant,nil,__TCustomCanvasTextExtent,false,0);
    DefineMethod('TextHeight',1,tkInteger,nil,__TCustomCanvasTextHeight,false,0);
    DefineMethod('TextOut',3,tkNone,nil,__TCustomCanvasTextOut,false,0);
    DefineMethod('TextRect',3,tkNone,nil,__TCustomCanvasTextRect,false,1).SetVarArgs([0,1]);
    DefineMethod('TextWidth',1,tkInteger,nil,__TCustomCanvasTextWidth,false,0);
  ...
  begin
    ...
    DefineMethod('ArcTo',8,tkNone,nil,__TCanvasArcTo,false,0);
    DefineMethod('AngleArc',5,tkNone,nil,__TCanvasAngleArc,false,0);
    ...
    DefineMethod('TextRect',3,tkNone,nil,__TCanvasTextRect,false,1).SetVarArgs([0,1]);
  ...
  begin
    ...
    DefineMethod('Equals',1,tkVariant,nil,__TGraphicEquals,false,0);
    ...
    DefineMethod('SetSize',2,tkNone,nil,__TGraphicSetSize,false,0);
  ...
  begin
    ...
    DefineMethod('ReleaseHandle',0,tkVariant,nil,__TMetafileReleaseHandle,false,0);
    DefineMethod('SetSize',2,tkNone,nil,__TMetafileSetSize,false,0);
    ...
    DefineProp('Handle',tkVariant,__GetTMetafileHandle,__SetTMetafileHandle,nil,false,0);
  ...
  begin
    ...
    DefineMethod('SetSize',2,tkNone,nil,__TBitmapSetSize,false,0);
  ...
  begin
    ...
    DefineMethod('AssignTo',1,tkNone,nil,__TIconAssignTo,false,0);
    ...
    DefineMethod('SetSize',2,tkNone,nil,__TIconSetSize,false,0);
    DefineMethod('LoadFromResourceName',2,tkNone,nil,__TIconLoadFromResourceName,false,0);
    DefineMethod('LoadFromResourceID',2,tkNone,nil,__TIconLoadFromResourceID,false,0);
