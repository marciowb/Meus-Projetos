...
type
  TatOleCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTOleControlDefaultDispatch(AMachine: TatVirtualMachine);
...
procedure TatOleCtrlsLibrary.__GetTOleControlDefaultDispatch(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TOleControl(CurrentObject).DefaultDispatch);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineProp('DefaultDispatch',tkVariant,__GetTOleControlDefaultDispatch,nil,nil,false,0);
