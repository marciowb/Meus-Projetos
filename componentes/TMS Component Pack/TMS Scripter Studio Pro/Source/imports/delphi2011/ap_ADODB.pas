...
type
  TatADODBLibrary = class(TatScripterLibrary)
    ...
    procedure __TCustomADODataSetBookmarkValid(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomADODataSetCompareBookmarks(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomADODataSetGetBlobFieldData(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
    TADOConnection(CurrentObject).GetProcedureNames(TWideStrings(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TADOConnection(CurrentObject).GetFieldNames(GetInputArg(0),TWideStrings(Integer(GetInputArg(1))));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: TADOConnection(CurrentObject).GetTableNames(TWideStrings(Integer(GetInputArg(0))));
      2: TADOConnection(CurrentObject).GetTableNames(TWideStrings(Integer(GetInputArg(0))),GetInputArg(1));
    end;
  end;
end;
...
procedure TatADODBLibrary.__TCustomADODataSetBookmarkValid(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomADODataSet(CurrentObject).BookmarkValid(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatADODBLibrary.__TCustomADODataSetCompareBookmarks(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomADODataSet(CurrentObject).CompareBookmarks(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatADODBLibrary.__TCustomADODataSetGetBlobFieldData(AMachine: TatVirtualMachine);
  var
...
AResult := Integer(TCustomADODataSet(CurrentObject).GetBlobFieldData(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
    TCustomADODataSet(CurrentObject).GetDetailLinkFields(TList(Integer(GetInputArg(0))),TList(Integer(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ADODB.GetProviderNames(TWideStrings(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ADODB.PromptDataSource(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ADODB.PromptDataLinkFile(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := Integer(ADODB.GetDataLinkFiles(TWideStrings(Integer(GetInputArg(0)))));
2: AResult := Integer(ADODB.GetDataLinkFiles(TWideStrings(Integer(GetInputArg(0))),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Execute',3,tkNone,nil,__TADOConnectionExecute,false,1).SetVarArgs([1]);
    ...
    DefineMethod('Open',2,tkNone,nil,__TADOConnectionOpen,false,0);
  ...
  begin
    ...
    DefineMethod('BookmarkValid',1,tkVariant,nil,__TCustomADODataSetBookmarkValid,false,0);
    ...
    DefineMethod('CompareBookmarks',2,tkInteger,nil,__TCustomADODataSetCompareBookmarks,false,0);
    ...
    DefineMethod('GetBlobFieldData',2,tkInteger,nil,__TCustomADODataSetGetBlobFieldData,false,0).SetVarArgs([1]);
    DefineMethod('GetDetailLinkFields',2,tkNone,nil,__TCustomADODataSetGetDetailLinkFields,false,0);
