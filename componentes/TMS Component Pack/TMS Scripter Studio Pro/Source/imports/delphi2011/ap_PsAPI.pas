...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleBaseName(GetInputArg(0),GetInputArg(1),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleBaseNameA(GetInputArg(0),GetInputArg(1),PAnsiChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleBaseNameW(GetInputArg(0),GetInputArg(1),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleFileNameEx(GetInputArg(0),GetInputArg(1),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleFileNameExA(GetInputArg(0),GetInputArg(1),PAnsiChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleFileNameExW(GetInputArg(0),GetInputArg(1),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := PsAPI.EmptyWorkingSet(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := PsAPI.InitializeProcessForWsWatch(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
