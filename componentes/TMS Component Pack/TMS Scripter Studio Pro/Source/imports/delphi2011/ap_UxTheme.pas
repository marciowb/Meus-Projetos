...
begin
  with AMachine do
  begin
AResult := UxTheme.OpenThemeDataEx(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UxTheme.DrawThemeTextEx(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),GetInputArg(4),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),Param7,Param8);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := UxTheme.SetWindowThemeNonClientAttributes(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UxTheme.GetThemeBitmap(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),Param5);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := UxTheme.BufferedPaintInit;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UxTheme.BufferedPaintUnInit;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UxTheme.EndBufferedPaint(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UxTheme.GetBufferedPaintTargetRect(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(UxTheme.GetBufferedPaintTargetDC(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(UxTheme.GetBufferedPaintDC(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UxTheme.BufferedPaintMakeOpaque(GetInputArg(0),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UxTheme.BufferedPaintStopAllAnimations(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UxTheme.EndBufferedAnimation(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param5 := VarToInteger(GetInputArg(5));
AResult := UxTheme.GetThemeTransitionDuration(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),Param5);
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('BeginPanningFeedback',1,tkVariant,nil,__BeginPanningFeedback,false,0);
    DefineMethod('UpdatePanningFeedback',4,tkVariant,nil,__UpdatePanningFeedback,false,0);
    DefineMethod('EndPanningFeedback',2,tkVariant,nil,__EndPanningFeedback,false,0);
    DefineMethod('OpenThemeDataEx',3,tkVariant,nil,__OpenThemeDataEx,false,0);
    DefineMethod('DrawThemeTextEx',9,tkVariant,nil,__DrawThemeTextEx,false,0).SetVarArgs([7,8]);
    DefineMethod('SetWindowThemeNonClientAttributes',3,tkVariant,nil,__SetWindowThemeNonClientAttributes,false,0);
    DefineMethod('GetThemeBitmap',6,tkVariant,nil,__GetThemeBitmap,false,0).SetVarArgs([5]);
    DefineMethod('BufferedPaintInit',0,tkVariant,nil,__BufferedPaintInit,false,0);
    DefineMethod('BufferedPaintUnInit',0,tkVariant,nil,__BufferedPaintUnInit,false,0);
    DefineMethod('EndBufferedPaint',2,tkVariant,nil,__EndBufferedPaint,false,0);
    DefineMethod('GetBufferedPaintTargetRect',2,tkVariant,nil,__GetBufferedPaintTargetRect,false,0).SetVarArgs([1]);
    ...
    DefineMethod('BufferedPaintMakeOpaque',2,tkVariant,nil,__BufferedPaintMakeOpaque,false,0);
    DefineMethod('BufferedPaintStopAllAnimations',1,tkVariant,nil,__BufferedPaintStopAllAnimations,false,0);
    DefineMethod('EndBufferedAnimation',2,tkVariant,nil,__EndBufferedAnimation,false,0);
    ...
    DefineMethod('GetThemeTransitionDuration',6,tkVariant,nil,__GetThemeTransitionDuration,false,0).SetVarArgs([5]);
    AddConsts1;
    AddConsts2;
