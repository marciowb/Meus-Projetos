...
AResult := IOleControl(CurrentObject).GetControlInfo(Param0);
...
begin
  with AMachine do
  begin
AResult := IOleControl(CurrentObject).OnAmbientPropertyChange(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleControl(CurrentObject).FreezeEvents(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleControlSite(CurrentObject).OnControlInfoChanged;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleControlSite(CurrentObject).LockInPlaceActive(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleControlSite(CurrentObject).GetExtendedControl(Param0);
    ReturnOutputArg(AResult);
...
AResult := IOleControlSite(CurrentObject).TransformCoords(Param0,Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IOleControlSite(CurrentObject).OnFocus(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleControlSite(CurrentObject).ShowPropertyFrame;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ISimpleFrameSite(CurrentObject).PreMessageFilter(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4,Param5);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param4 := VarToInteger(GetInputArg(4));
AResult := ISimpleFrameSite(CurrentObject).PostMessageFilter(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4,VarToInteger(GetInputArg(5)));
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStreamInit(CurrentObject).IsDirty;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStreamInit(CurrentObject).Load(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStreamInit(CurrentObject).Save(IStream(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IPersistStreamInit(CurrentObject).GetSizeMax(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IPersistStreamInit(CurrentObject).InitNew;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyNotifySink(CurrentObject).OnChanged(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyNotifySink(CurrentObject).OnRequestEdit(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IProvideClassInfo(CurrentObject).GetClassInfo(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IConnectionPointContainer(CurrentObject).EnumConnectionPoints(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IConnectionPointContainer(CurrentObject).FindConnectionPoint(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IEnumConnectionPoints(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumConnectionPoints(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumConnectionPoints(Integer(GetInputArg(0)));
AResult := IEnumConnectionPoints(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IConnectionPoint(CurrentObject).GetConnectionInterface(Param0);
    ReturnOutputArg(AResult);
...
AResult := IConnectionPoint(CurrentObject).GetConnectionPointContainer(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IConnectionPoint(CurrentObject).Advise(IUnknown(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IConnectionPoint(CurrentObject).Unadvise(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IConnectionPoint(CurrentObject).EnumConnections(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumConnections(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumConnections(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumConnections(Integer(GetInputArg(0)));
AResult := IEnumConnections(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IClassFactory2(CurrentObject).GetLicInfo(Param0);
    ReturnOutputArg(AResult);
...
AResult := IClassFactory2(CurrentObject).RequestLicKey(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
AResult := IClassFactory2(CurrentObject).CreateInstanceLic(IUnknown(Integer(GetInputArg(0))),IUnknown(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),Param4);
    ReturnOutputArg(AResult);
...
AResult := ISpecifyPropertyPages(CurrentObject).GetPages(Param0);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := IPerPropertyBrowsing(CurrentObject).GetDisplayString(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
AResult := IPerPropertyBrowsing(CurrentObject).MapPropertyToPage(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
AResult := IPerPropertyBrowsing(CurrentObject).GetPredefinedStrings(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
...
AResult := IPerPropertyBrowsing(CurrentObject).GetPredefinedValue(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IPropertyPageSite(CurrentObject).OnStatusChange(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IPropertyPageSite(CurrentObject).GetLocaleID(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IPropertyPageSite(CurrentObject).GetPageContainer(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).SetPageSite(IPropertyPageSite(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Activate(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec,GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Deactivate;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IPropertyPage(CurrentObject).GetPageInfo(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).SetObjects(VarToInteger(GetInputArg(0)),IUnknown(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Show(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Move(TRectWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).IsPageDirty;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Apply;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage(CurrentObject).Help(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPropertyPage2(CurrentObject).EditProperty(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IFont(CurrentObject).get_Name(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Name(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IFont(CurrentObject).get_Size(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Size(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IFont(CurrentObject).get_Bold(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Bold(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IFont(CurrentObject).get_Italic(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Italic(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IFont(CurrentObject).get_Underline(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Underline(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IFont(CurrentObject).get_Strikethrough(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Strikethrough(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IFont(CurrentObject).get_Weight(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Weight(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IFont(CurrentObject).get_Charset(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).put_Charset(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IFont(CurrentObject).get_hFont(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IFont(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).IsEqual(IFont(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).SetRatio(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IFont(CurrentObject).QueryTextMetrics(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).AddRefHfont(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IFont(CurrentObject).ReleaseHfont(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_Handle(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_hPal(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_Type(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_Width(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_Height(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPicture(CurrentObject).Render(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),VarToInteger(GetInputArg(7)),VarToInteger(GetInputArg(8)),TRectWrapper(integer(GetInputArg(9))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPicture(CurrentObject).set_hPal(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IPicture(CurrentObject).get_CurDC(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IPicture(CurrentObject).SelectPicture(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IPicture(CurrentObject).get_KeepOriginalFormat(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPicture(CurrentObject).put_KeepOriginalFormat(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPicture(CurrentObject).PictureChanged;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := IPicture(CurrentObject).SaveAsFile(IStream(Integer(GetInputArg(0))),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPicture(CurrentObject).get_Attributes(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := OleCtl.OleCreatePropertyFrameIndirect(Param0);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := OleCtl.OleTranslateColor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
Param2 := GetInputArg(2);
AResult := OleCtl.OleCreateFontIndirect(Param0,TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
...
AResult := OleCtl.OleCreatePictureIndirect(Param0,TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,GetInputArg(2),Param3);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := OleCtl.OleLoadPicture(IStream(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),GetInputArg(2),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(OleCtl.OleIconToCursor(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetControlInfo',1,tkVariant,nil,__IOleControlGetControlInfo,false,0).SetVarArgs([0]);
    DefineMethod('OnAmbientPropertyChange',1,tkVariant,nil,__IOleControlOnAmbientPropertyChange,false,0);
    DefineMethod('FreezeEvents',1,tkVariant,nil,__IOleControlFreezeEvents,false,0);
  end;
  With Scripter.DefineClass(IOleControlSite) do
  begin
    DefineMethod('OnControlInfoChanged',0,tkVariant,nil,__IOleControlSiteOnControlInfoChanged,false,0);
    DefineMethod('LockInPlaceActive',1,tkVariant,nil,__IOleControlSiteLockInPlaceActive,false,0);
    DefineMethod('GetExtendedControl',1,tkVariant,nil,__IOleControlSiteGetExtendedControl,false,0).SetVarArgs([0]);
    DefineMethod('TransformCoords',3,tkVariant,nil,__IOleControlSiteTransformCoords,false,0).SetVarArgs([0,1]);
    DefineMethod('OnFocus',1,tkVariant,nil,__IOleControlSiteOnFocus,false,0);
    DefineMethod('ShowPropertyFrame',0,tkVariant,nil,__IOleControlSiteShowPropertyFrame,false,0);
  end;
  With Scripter.DefineClass(ISimpleFrameSite) do
  begin
    DefineMethod('PreMessageFilter',6,tkVariant,nil,__ISimpleFrameSitePreMessageFilter,false,0).SetVarArgs([4,5]);
    DefineMethod('PostMessageFilter',6,tkVariant,nil,__ISimpleFrameSitePostMessageFilter,false,0).SetVarArgs([4]);
  end;
  With Scripter.DefineClass(IPersistStreamInit) do
  begin
    DefineMethod('IsDirty',0,tkVariant,nil,__IPersistStreamInitIsDirty,false,0);
    DefineMethod('Load',1,tkVariant,nil,__IPersistStreamInitLoad,false,0);
    DefineMethod('Save',2,tkVariant,nil,__IPersistStreamInitSave,false,0);
    DefineMethod('GetSizeMax',1,tkVariant,nil,__IPersistStreamInitGetSizeMax,false,0).SetVarArgs([0]);
    DefineMethod('InitNew',0,tkVariant,nil,__IPersistStreamInitInitNew,false,0);
  end;
  With Scripter.DefineClass(IPropertyNotifySink) do
  begin
    DefineMethod('OnChanged',1,tkVariant,nil,__IPropertyNotifySinkOnChanged,false,0);
    DefineMethod('OnRequestEdit',1,tkVariant,nil,__IPropertyNotifySinkOnRequestEdit,false,0);
  end;
  With Scripter.DefineClass(IProvideClassInfo) do
  begin
    DefineMethod('GetClassInfo',1,tkVariant,nil,__IProvideClassInfoGetClassInfo,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IConnectionPointContainer) do
  begin
    DefineMethod('EnumConnectionPoints',1,tkVariant,nil,__IConnectionPointContainerEnumConnectionPoints,false,0).SetVarArgs([0]);
    DefineMethod('FindConnectionPoint',2,tkVariant,nil,__IConnectionPointContainerFindConnectionPoint,false,0).SetVarArgs([1]);
  end;
  With Scripter.DefineClass(IEnumConnectionPoints) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumConnectionPointsSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumConnectionPointsReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumConnectionPointsClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IConnectionPoint) do
  begin
    DefineMethod('GetConnectionInterface',1,tkVariant,nil,__IConnectionPointGetConnectionInterface,false,0).SetVarArgs([0]);
    DefineMethod('GetConnectionPointContainer',1,tkVariant,nil,__IConnectionPointGetConnectionPointContainer,false,0).SetVarArgs([0]);
    DefineMethod('Advise',2,tkVariant,nil,__IConnectionPointAdvise,false,0).SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkVariant,nil,__IConnectionPointUnadvise,false,0);
    DefineMethod('EnumConnections',1,tkVariant,nil,__IConnectionPointEnumConnections,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumConnections) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumConnectionsSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumConnectionsReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumConnectionsClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IClassFactory2) do
  begin
    DefineMethod('GetLicInfo',1,tkVariant,nil,__IClassFactory2GetLicInfo,false,0).SetVarArgs([0]);
    DefineMethod('RequestLicKey',2,tkVariant,nil,__IClassFactory2RequestLicKey,false,0).SetVarArgs([1]);
    DefineMethod('CreateInstanceLic',5,tkVariant,nil,__IClassFactory2CreateInstanceLic,false,0).SetVarArgs([4]);
  end;
  With Scripter.DefineClass(ISpecifyPropertyPages) do
  begin
    DefineMethod('GetPages',1,tkVariant,nil,__ISpecifyPropertyPagesGetPages,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPerPropertyBrowsing) do
  begin
    DefineMethod('GetDisplayString',2,tkVariant,nil,__IPerPropertyBrowsingGetDisplayString,false,0).SetVarArgs([1]);
    DefineMethod('MapPropertyToPage',2,tkVariant,nil,__IPerPropertyBrowsingMapPropertyToPage,false,0).SetVarArgs([1]);
    DefineMethod('GetPredefinedStrings',3,tkVariant,nil,__IPerPropertyBrowsingGetPredefinedStrings,false,0).SetVarArgs([1,2]);
    DefineMethod('GetPredefinedValue',3,tkVariant,nil,__IPerPropertyBrowsingGetPredefinedValue,false,0).SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IPropertyPageSite) do
  begin
    DefineMethod('OnStatusChange',1,tkVariant,nil,__IPropertyPageSiteOnStatusChange,false,0);
    DefineMethod('GetLocaleID',1,tkVariant,nil,__IPropertyPageSiteGetLocaleID,false,0).SetVarArgs([0]);
    DefineMethod('GetPageContainer',1,tkVariant,nil,__IPropertyPageSiteGetPageContainer,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPropertyPage) do
  begin
    DefineMethod('SetPageSite',1,tkVariant,nil,__IPropertyPageSetPageSite,false,0);
    DefineMethod('Activate',3,tkVariant,nil,__IPropertyPageActivate,false,0);
    DefineMethod('Deactivate',0,tkVariant,nil,__IPropertyPageDeactivate,false,0);
    DefineMethod('GetPageInfo',1,tkVariant,nil,__IPropertyPageGetPageInfo,false,0).SetVarArgs([0]);
    DefineMethod('SetObjects',2,tkVariant,nil,__IPropertyPageSetObjects,false,0);
    DefineMethod('Show',1,tkVariant,nil,__IPropertyPageShow,false,0);
    DefineMethod('Move',1,tkVariant,nil,__IPropertyPageMove,false,0);
    DefineMethod('IsPageDirty',0,tkVariant,nil,__IPropertyPageIsPageDirty,false,0);
    DefineMethod('Apply',0,tkVariant,nil,__IPropertyPageApply,false,0);
    DefineMethod('Help',1,tkVariant,nil,__IPropertyPageHelp,false,0);
  end;
  With Scripter.DefineClass(IPropertyPage2) do
  begin
    DefineMethod('EditProperty',1,tkVariant,nil,__IPropertyPage2EditProperty,false,0);
  end;
  With Scripter.DefineClass(IFont) do
  begin
    DefineMethod('get_Name',1,tkVariant,nil,__IFontget_Name,false,0).SetVarArgs([0]);
    DefineMethod('put_Name',1,tkVariant,nil,__IFontput_Name,false,0);
    DefineMethod('get_Size',1,tkVariant,nil,__IFontget_Size,false,0).SetVarArgs([0]);
    DefineMethod('put_Size',1,tkVariant,nil,__IFontput_Size,false,0);
    DefineMethod('get_Bold',1,tkVariant,nil,__IFontget_Bold,false,0).SetVarArgs([0]);
    DefineMethod('put_Bold',1,tkVariant,nil,__IFontput_Bold,false,0);
    DefineMethod('get_Italic',1,tkVariant,nil,__IFontget_Italic,false,0).SetVarArgs([0]);
    DefineMethod('put_Italic',1,tkVariant,nil,__IFontput_Italic,false,0);
    DefineMethod('get_Underline',1,tkVariant,nil,__IFontget_Underline,false,0).SetVarArgs([0]);
    DefineMethod('put_Underline',1,tkVariant,nil,__IFontput_Underline,false,0);
    DefineMethod('get_Strikethrough',1,tkVariant,nil,__IFontget_Strikethrough,false,0).SetVarArgs([0]);
    DefineMethod('put_Strikethrough',1,tkVariant,nil,__IFontput_Strikethrough,false,0);
    DefineMethod('get_Weight',1,tkVariant,nil,__IFontget_Weight,false,0).SetVarArgs([0]);
    DefineMethod('put_Weight',1,tkVariant,nil,__IFontput_Weight,false,0);
    DefineMethod('get_Charset',1,tkVariant,nil,__IFontget_Charset,false,0).SetVarArgs([0]);
    DefineMethod('put_Charset',1,tkVariant,nil,__IFontput_Charset,false,0);
    DefineMethod('get_hFont',1,tkVariant,nil,__IFontget_hFont,false,0).SetVarArgs([0]);
    DefineMethod('Clone',1,tkVariant,nil,__IFontClone,false,0).SetVarArgs([0]);
    DefineMethod('IsEqual',1,tkVariant,nil,__IFontIsEqual,false,0);
    DefineMethod('SetRatio',2,tkVariant,nil,__IFontSetRatio,false,0);
    DefineMethod('QueryTextMetrics',1,tkVariant,nil,__IFontQueryTextMetrics,false,0).SetVarArgs([0]);
    DefineMethod('AddRefHfont',1,tkVariant,nil,__IFontAddRefHfont,false,0);
    DefineMethod('ReleaseHfont',1,tkVariant,nil,__IFontReleaseHfont,false,0);
  end;
  ...
  begin
    DefineMethod('get_Handle',1,tkVariant,nil,__IPictureget_Handle,false,0).SetVarArgs([0]);
    DefineMethod('get_hPal',1,tkVariant,nil,__IPictureget_hPal,false,0).SetVarArgs([0]);
    DefineMethod('get_Type',1,tkVariant,nil,__IPictureget_Type,false,0).SetVarArgs([0]);
    DefineMethod('get_Width',1,tkVariant,nil,__IPictureget_Width,false,0).SetVarArgs([0]);
    DefineMethod('get_Height',1,tkVariant,nil,__IPictureget_Height,false,0).SetVarArgs([0]);
    DefineMethod('Render',10,tkVariant,nil,__IPictureRender,false,0);
    DefineMethod('set_hPal',1,tkVariant,nil,__IPictureset_hPal,false,0);
    DefineMethod('get_CurDC',1,tkVariant,nil,__IPictureget_CurDC,false,0).SetVarArgs([0]);
    DefineMethod('SelectPicture',3,tkVariant,nil,__IPictureSelectPicture,false,0).SetVarArgs([1,2]);
    DefineMethod('get_KeepOriginalFormat',1,tkVariant,nil,__IPictureget_KeepOriginalFormat,false,0).SetVarArgs([0]);
    DefineMethod('put_KeepOriginalFormat',1,tkVariant,nil,__IPictureput_KeepOriginalFormat,false,0);
    DefineMethod('PictureChanged',0,tkVariant,nil,__IPicturePictureChanged,false,0);
    DefineMethod('SaveAsFile',3,tkVariant,nil,__IPictureSaveAsFile,false,0).SetVarArgs([2]);
    DefineMethod('get_Attributes',1,tkVariant,nil,__IPictureget_Attributes,false,0);
  end;
  ...
  begin
    DefineMethod('OleCreatePropertyFrameIndirect',1,tkVariant,nil,__OleCreatePropertyFrameIndirect,false,0).SetVarArgs([0]);
    DefineMethod('OleTranslateColor',3,tkVariant,nil,__OleTranslateColor,false,0).SetVarArgs([2]);
    DefineMethod('OleCreateFontIndirect',3,tkVariant,nil,__OleCreateFontIndirect,false,0).SetVarArgs([0,2]);
    DefineMethod('OleCreatePictureIndirect',4,tkVariant,nil,__OleCreatePictureIndirect,false,0).SetVarArgs([0,3]);
    DefineMethod('OleLoadPicture',5,tkVariant,nil,__OleLoadPicture,false,0).SetVarArgs([4]);
