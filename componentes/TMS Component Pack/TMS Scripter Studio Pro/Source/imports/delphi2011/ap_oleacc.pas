...
type
  TatoleaccLibrary = class(TatScripterLibrary)
    procedure __LresultFromObject(AMachine: TatVirtualMachine);
    ...
    procedure __CreateAccessibleProxy(AMachine: TatVirtualMachine);
...
procedure TatoleaccLibrary.__LresultFromObject(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(oleacc.LresultFromObject(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),GetInputArg(2)));
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := oleacc.AccessibleObjectFromWindow(GetInputArg(0),VarToInteger(GetInputArg(1)),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
AResult := oleacc.CreateStdAccessibleProxy(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := oleacc.CreateStdAccessibleProxyA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := oleacc.CreateStdAccessibleProxyW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;

procedure TatoleaccLibrary.__CreateAccessibleProxy(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := oleacc.CreateAccessibleProxy(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('LresultFromObject',3,tkInteger,nil,__LresultFromObject,false,0);
    DefineMethod('ObjectFromLresult',4,tkInteger,nil,__ObjectFromLresult,false,0).SetVarArgs([3]);
    DefineMethod('AccessibleObjectFromWindow',4,tkVariant,nil,__AccessibleObjectFromWindow,false,0).SetVarArgs([3]);
    DefineMethod('CreateStdAccessibleProxy',5,tkVariant,nil,__CreateStdAccessibleProxy,false,0).SetVarArgs([4]);
    DefineMethod('CreateStdAccessibleProxyA',5,tkVariant,nil,__CreateStdAccessibleProxyA,false,0).SetVarArgs([4]);
    DefineMethod('CreateStdAccessibleProxyW',5,tkVariant,nil,__CreateStdAccessibleProxyW,false,0).SetVarArgs([4]);
    DefineMethod('CreateAccessibleProxy',2,tkVariant,nil,__CreateAccessibleProxy,false,0);
