...
begin
  with AMachine do
  begin
AResult := TDragObject(CurrentObject).Instance;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMarginsClass(CurrentClass.ClassRef).Create(TControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomGestureCollectionItem(CurrentObject).GestureID);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).GestureID:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomGestureCollectionItem(CurrentObject).GestureType);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomGestureCollectionItem(CurrentObject).Name);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).Name:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollectionItem(CurrentObject).Action));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).Action:=TBasicAction(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureCollection(CurrentObject).AddGesture);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureCollection(CurrentObject).FindGesture(GetInputArgAsString(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomGestureCollection(CurrentObject).GetUniqueGestureID;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureCollection(CurrentObject).RemoveGesture(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollection(CurrentObject).GestureManager));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TCustomGestureCollectionItem(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomGestureManager(CurrentObject).AddRecordedGesture(TCustomGestureCollectionItem(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureManager(CurrentObject).FindCustomGesture(GetInputArgAsString(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureManager(CurrentObject).FindGesture(TControl(Integer(GetInputArg(0))),GetInputArgAsString(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).RegisterControl(TControl(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).RemoveRecordedGesture(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomGestureManager(CurrentObject).SelectGesture(TControl(Integer(GetInputArg(0))),GetInputArgAsString(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).UnregisterControl(TControl(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).UnselectGesture(TControl(Integer(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    PropValueSet := TCustomGestureManager(CurrentObject).StandardGestures[TControl(Integer(GetArrayIndex(0)))];
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;
...
begin
  ...
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomGestureManager(CurrentObject).StandardGestures[TControl(Integer(GetArrayIndex(0)))]:=TempVar;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomTouchManagerClass(CurrentClass.ClassRef).Create(TControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).ChangeNotification(TControl(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomTouchManager(CurrentObject).FindGesture(GetInputArgAsString(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).RemoveChangeNotification(TControl(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomTouchManager(CurrentObject).SelectGesture(GetInputArgAsString(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).UnselectGesture(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTouchManager(CurrentObject).GestureEngine));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).GestureEngine:=TCustomGestureEngine(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTouchManager(CurrentObject).GestureManager));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).GestureManager:=TCustomGestureManager(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).SetParentComponent(TComponent(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).Touch));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Touch:=TTouchManager(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).GetTabControlList(TList(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TWinControl(CurrentObject).Padding));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).Padding:=TPadding(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomTransparentControlClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomPanningWindow(CurrentObject).StartPanning(GetInputArg(0),TControl(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMouse(CurrentObject).CreatePanningWindow);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMouse(CurrentObject).PanningWindow));
  end;
end;
...
begin
  with AMachine do
  begin
    TMouse(CurrentObject).PanningWindow:=TCustomPanningWindow(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomListControlClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomHintWindowClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomHintWindow(CurrentObject).HintParent));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHintWindow(CurrentObject).HintParent:=TCustomHint(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHintWindow(CurrentObject).Title);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHintWindow(CurrentObject).Description);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomHintShowHideThreadClass(CurrentClass.ClassRef).Create(TCustomHintWindow(Integer(GetInputArg(0))),TCustomHint(Integer(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomHintClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).PaintHint(TCustomHintWindow(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).NCPaintHint(TCustomHintWindow(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).SetHintSize(TCustomHintWindow(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHint(CurrentObject).Title);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).Title:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHint(CurrentObject).Description);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).Description:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    TBalloonHint(CurrentObject).PaintHint(TCustomHintWindow(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TBalloonHint(CurrentObject).SetHintSize(TCustomHintWindow(Integer(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Instance',0,tkVariant,nil,__TDragObjectInstance,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TMargins,__TMarginsCreate,true,0);
    DefineMethod('SetControlBounds',5,tkNone,nil,__TMarginsSetControlBounds,false,1);
    DefineMethod('SetBounds',4,tkNone,nil,__TMarginsSetBounds,false,0);
  ...
  begin
    ...
    DefineMethod('FindGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomGestureCollectionFindGesture,false,0);
    DefineMethod('GetUniqueGestureID',0,tkEnumeration,nil,__TCustomGestureCollectionGetUniqueGestureID,false,0);
    DefineMethod('RemoveGesture',1,tkNone,nil,__TCustomGestureCollectionRemoveGesture,false,0);
  ...
  begin
    DefineMethod('AddRecordedGesture',1,tkEnumeration,nil,__TCustomGestureManagerAddRecordedGesture,false,0);
    DefineMethod('FindCustomGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomGestureManagerFindCustomGesture,false,0);
    DefineMethod('FindGesture',2,tkClass,TCustomGestureCollectionItem,__TCustomGestureManagerFindGesture,false,0);
    DefineMethod('RegisterControl',1,tkNone,nil,__TCustomGestureManagerRegisterControl,false,0);
    DefineMethod('RemoveRecordedGesture',1,tkNone,nil,__TCustomGestureManagerRemoveRecordedGesture,false,0);
    DefineMethod('SelectGesture',2,tkVariant,nil,__TCustomGestureManagerSelectGesture,false,0);
    DefineMethod('UnregisterControl',1,tkNone,nil,__TCustomGestureManagerUnregisterControl,false,0);
    DefineMethod('UnselectGesture',2,tkNone,nil,__TCustomGestureManagerUnselectGesture,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomTouchManager,__TCustomTouchManagerCreate,true,0);
    DefineMethod('Destroy',0,tkNone,nil,__TCustomTouchManagerDestroy,false,0);
    DefineMethod('ChangeNotification',1,tkNone,nil,__TCustomTouchManagerChangeNotification,false,0);
    DefineMethod('FindGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomTouchManagerFindGesture,false,0);
    DefineMethod('RemoveChangeNotification',1,tkNone,nil,__TCustomTouchManagerRemoveChangeNotification,false,0);
    DefineMethod('SelectGesture',1,tkVariant,nil,__TCustomTouchManagerSelectGesture,false,0);
    DefineMethod('UnselectGesture',1,tkNone,nil,__TCustomTouchManagerUnselectGesture,false,0);
  ...
  begin
    ...
    DefineMethod('SetDesignVisible',1,tkNone,nil,__TControlSetDesignVisible,false,0);
    DefineMethod('SetParentComponent',1,tkNone,nil,__TControlSetParentComponent,false,0);
  ...
  begin
    ...
    DefineMethod('GetTabControlList',1,tkNone,nil,__TWinControlGetTabControlList,false,0);
    ...
    DefineMethod('SetDesignVisible',1,tkNone,nil,__TWinControlSetDesignVisible,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomTransparentControl,__TCustomTransparentControlCreate,true,0);
  ...
  begin
    ...
    DefineMethod('StartPanning',2,tkVariant,nil,__TCustomPanningWindowStartPanning,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomListControl,__TCustomListControlCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomHintWindow,__TCustomHintWindowCreate,true,0);
    DefineMethod('AutoSize',0,tkNone,nil,__TCustomHintWindowAutoSize,false,0);
    DefineMethod('PositionAt',1,tkNone,nil,__TCustomHintWindowPositionAt,false,0);
  ...
  begin
    DefineMethod('Create',2,tkClass,TCustomHintShowHideThread,__TCustomHintShowHideThreadCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomHint,__TCustomHintCreate,true,0);
    ...
    DefineMethod('PaintHint',1,tkNone,nil,__TCustomHintPaintHint,false,0);
    DefineMethod('NCPaintHint',2,tkNone,nil,__TCustomHintNCPaintHint,false,0);
    DefineMethod('SetHintSize',1,tkNone,nil,__TCustomHintSetHintSize,false,0);
  ...
  begin
    DefineMethod('PaintHint',1,tkNone,nil,__TBalloonHintPaintHint,false,0);
    DefineMethod('SetHintSize',1,tkNone,nil,__TBalloonHintSetHintSize,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('IsVCLControl',1,tkVariant,nil,__IsVCLControl,false,0);
    ...
    DefineMethod('PerformBufferedPrintClient',2,tkNone,nil,__PerformBufferedPrintClient,false,0);
    ...
    DefineMethod('Imm32SetCompositionFont',2,tkVariant,nil,__Imm32SetCompositionFont,false,0).SetVarArgs([1]);
    ...
    AddConstant('efMouseEvents',efMouseEvents);
    AddConstant('efTouchEvents',efTouchEvents);
