...
Param1 := GetInputArg(1);
AResult := DBCommon.NextSQLTokenEx(Param0,Param1,GetInputArg(2),GetInputArg(3));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := DBCommon.GetTableNameFromSQLEx(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := DBCommon.MetaDataFromUnicode(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := DBCommon.MetaDataToUnicode(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SQLRequiresParams',1,tkVariant,nil,__SQLRequiresParams,false,0);
    DefineMethod('NextSQLTokenEx',4,tkEnumeration,nil,__NextSQLTokenEx,false,0).SetVarArgs([0,1]);
    DefineMethod('GetTableNameFromSQLEx',2,tkVariant,nil,__GetTableNameFromSQLEx,false,0);
    DefineMethod('MetaDataFromUnicode',1,tkVariant,nil,__MetaDataFromUnicode,false,0);
    DefineMethod('MetaDataToUnicode',1,tkVariant,nil,__MetaDataToUnicode,false,0);
