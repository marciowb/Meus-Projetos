...
type
  ...
  published
    ...
    property ClassID: TCLSID read FClassID write FClassID;
...
begin
  with AMachine do
  begin
AResult := TOleContainer(CurrentObject).GetIconMetaPict;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    OleCtnrs.DestroyMetaPict(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetIconMetaPict',0,tkVariant,nil,__TOleContainerGetIconMetaPict,false,0);
