...
begin
  with AMachine do
  begin
AResult := TClipboard(CurrentObject).GetAsHandle(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TClipboard(CurrentObject).SetAsHandle(VarToInteger(GetInputArg(0)),GetInputArg(1));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetAsHandle',1,tkVariant,nil,__TClipboardGetAsHandle,false,0);
