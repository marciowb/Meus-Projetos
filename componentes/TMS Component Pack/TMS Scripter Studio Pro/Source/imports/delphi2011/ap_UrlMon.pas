...
type
  TatUrlMonLibrary = class(TatScripterLibrary)
    ...
    procedure __HlinkGoBack(AMachine: TatVirtualMachine);
    procedure __HlinkGoForward(AMachine: TatVirtualMachine);
    procedure __HlinkNavigateString(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := UrlMon.GetClassURL(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
...
begin
  with AMachine do
  begin
AResult := UrlMon.RegisterMediaTypes(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UrlMon.ObtainUserAgentString(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatUrlMonLibrary.__HlinkGoBack(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := UrlMon.HlinkGoBack(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatUrlMonLibrary.__HlinkGoForward(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := UrlMon.HlinkGoForward(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatUrlMonLibrary.__HlinkNavigateString(AMachine: TatVirtualMachine);
  var
...
begin
  with AMachine do
  begin
AResult := UrlMon.HlinkNavigateString(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UrlMon.CoInternetCompareUrl(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UrlMon.CoInternetGetProtocolFlags(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
...
AResult := UrlMon.CoInternetGetSecurityUrl(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param5 := VarToInteger(GetInputArg(5));
AResult := UrlMon.OInetParseUrl(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6)));
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
begin
  ...
  begin
Param5 := VarToInteger(GetInputArg(5));
AResult := UrlMon.OInetCombineUrl(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6)));
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UrlMon.OInetCompareUrl(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := UrlMon.CopyStgMedium(tagSTGMEDIUMWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
...
AResult := UrlMon.CopyBindInfo(_tagBINDINFOWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
...
AResult := UrlMon.GetSoftwareUpdateInfo(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := UrlMon.SetSoftwareUpdateAdvertisementState(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UrlMon.IsLoggingEnabled(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UrlMon.IsLoggingEnabledA(PAnsiChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetClassURL',2,tkVariant,nil,__GetClassURL,false,0);
    DefineMethod('RegisterMediaTypes',3,tkVariant,nil,__RegisterMediaTypes,false,0);
    DefineMethod('ObtainUserAgentString',3,tkVariant,nil,__ObtainUserAgentString,false,0).SetVarArgs([2]);
    DefineMethod('HlinkGoBack',1,tkVariant,nil,__HlinkGoBack,false,0);
    DefineMethod('HlinkGoForward',1,tkVariant,nil,__HlinkGoForward,false,0);
    DefineMethod('HlinkNavigateString',2,tkVariant,nil,__HlinkNavigateString,false,0);
    DefineMethod('CoInternetParseUrl',7,tkVariant,nil,__CoInternetParseUrl,false,0).SetVarArgs([5]);
    DefineMethod('CoInternetCombineUrl',7,tkVariant,nil,__CoInternetCombineUrl,false,0).SetVarArgs([5]);
    DefineMethod('CoInternetCompareUrl',3,tkVariant,nil,__CoInternetCompareUrl,false,0);
    DefineMethod('CoInternetGetProtocolFlags',3,tkVariant,nil,__CoInternetGetProtocolFlags,false,0).SetVarArgs([1]);
    DefineMethod('CoInternetGetSecurityUrl',4,tkVariant,nil,__CoInternetGetSecurityUrl,false,0).SetVarArgs([1]);
    DefineMethod('OInetParseUrl',7,tkVariant,nil,__OInetParseUrl,false,0).SetVarArgs([5]);
    DefineMethod('OInetCombineUrl',7,tkVariant,nil,__OInetCombineUrl,false,0).SetVarArgs([5]);
    DefineMethod('OInetCompareUrl',3,tkVariant,nil,__OInetCompareUrl,false,0);
    DefineMethod('CopyStgMedium',2,tkVariant,nil,__CopyStgMedium,false,0).SetVarArgs([1]);
    DefineMethod('CopyBindInfo',2,tkVariant,nil,__CopyBindInfo,false,0).SetVarArgs([1]);
    ...
    DefineMethod('GetSoftwareUpdateInfo',2,tkVariant,nil,__GetSoftwareUpdateInfo,false,0).SetVarArgs([1]);
    DefineMethod('SetSoftwareUpdateAdvertisementState',4,tkVariant,nil,__SetSoftwareUpdateAdvertisementState,false,0);
