...
begin
  with AMachine do
  begin
    ReturnOutputArg(TAppletApplication(CurrentObject).ControlPanelHandle);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CtlPanel.CPlApplet(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineProp('ControlPanelHandle',tkVariant,__GetTAppletApplicationControlPanelHandle,nil,nil,false,0);
  end;
