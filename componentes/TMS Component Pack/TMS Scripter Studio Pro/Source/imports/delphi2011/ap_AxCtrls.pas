...
type
  TatAxCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __TActiveXControlCreateAggregated(AMachine: TatVirtualMachine);
    procedure __TActiveXControlCreateFromFactory(AMachine: TatVirtualMachine);
    ...
    procedure __TActiveFormControlCreateAggregated(AMachine: TatVirtualMachine);
    procedure __TActiveFormControlCreateFromFactory(AMachine: TatVirtualMachine);
    ...
    procedure __TPropertyPageImplCreate(AMachine: TatVirtualMachine);
    ...
    procedure __TActiveXPropertyPageFactoryCreateComObject(AMachine: TatVirtualMachine);
    ...
    procedure __EnumDispatchProperties(AMachine: TatVirtualMachine);
  ...
  TatAxCtrlsDispatcher = class(TatEventDispatcher)
  private
    procedure __TDefinePropertyPage(const GUID: TGUID);
  end;
...
begin
  with AMachine do
  begin
AResult := Integer(TActiveXControlClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatAxCtrlsLibrary.__TActiveXControlCreateAggregated(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TActiveXControlClass(CurrentClass.ClassRef).CreateAggregated(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatAxCtrlsLibrary.__TActiveXControlCreateFromFactory(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TActiveXControlClass(CurrentClass.ClassRef).CreateFromFactory(TComObjectFactory(Integer(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := TActiveXControl(CurrentObject).ObjQueryInterface(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TActiveXControl(CurrentObject).ConnectionPoint));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TActiveXControlFactory(CurrentObject).CreateControl(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TActiveFormControlClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatAxCtrlsLibrary.__TActiveFormControlCreateAggregated(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TActiveFormControlClass(CurrentClass.ClassRef).CreateAggregated(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatAxCtrlsLibrary.__TActiveFormControlCreateFromFactory(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TActiveFormControlClass(CurrentClass.ClassRef).CreateFromFactory(TComObjectFactory(Integer(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := TActiveFormControl(CurrentObject).ObjQueryInterface(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TActiveFormClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TActiveForm(CurrentObject).ConnectionPoint));
  end;
end;
...
procedure TatAxCtrlsLibrary.__TPropertyPageImplCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TPropertyPageImplClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatAxCtrlsLibrary.__TActiveXPropertyPageFactoryCreateComObject(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TActiveXPropertyPageFactory(CurrentObject).CreateComObject(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TOleGraphicClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TOleGraphic(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
  end;
end;
...
procedure TatAxCtrlsDispatcher.__TDefinePropertyPage(const GUID: TGUID);
begin
  if DoOnExecuteEvent then
  begin
    if AssignedMethod(BeforeCall) then
      TDefinePropertyPage(BeforeCall)(GUID);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [TGUIDWrapper.Create(GUID)]);
    if AssignedMethod(AfterCall) then
      TDefinePropertyPage(AfterCall)(GUID);
  end;
end;

procedure TatAxCtrlsLibrary.__EnumDispatchProperties(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    AxCtrls.EnumDispatchProperties(GetInputArg(0),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),TStrings(Integer(GetInputArg(3))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('CreateAggregated',1,tkClass,TActiveXControl,__TActiveXControlCreateAggregated,true,0);
    DefineMethod('CreateFromFactory',2,tkClass,TActiveXControl,__TActiveXControlCreateFromFactory,true,0);
    ...
    DefineMethod('ObjQueryInterface',2,tkVariant,nil,__TActiveXControlObjQueryInterface,false,0).SetVarArgs([1]);
  ...
  begin
    ...
    DefineMethod('CreateControl',1,tkClass,TWinControl,__TActiveXControlFactoryCreateControl,false,0);
  ...
  begin
    ...
    DefineMethod('CreateAggregated',1,tkClass,TActiveFormControl,__TActiveFormControlCreateAggregated,true,0);
    DefineMethod('CreateFromFactory',2,tkClass,TActiveFormControl,__TActiveFormControlCreateFromFactory,true,0);
    ...
    DefineMethod('ObjQueryInterface',2,tkVariant,nil,__TActiveFormControlObjQueryInterface,false,0).SetVarArgs([1]);
  end;
  With Scripter.DefineClass(TActiveForm) do
  begin
    DefineMethod('Create',1,tkClass,TActiveForm,__TActiveFormCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TPropertyPageImpl,__TPropertyPageImplCreate,true,0);
  ...
  begin
    DefineMethod('CreateComObject',1,tkClass,TComObject,__TActiveXPropertyPageFactoryCreateComObject,false,0);
  end;
  ...
  DefineEventAdapter(TypeInfo(TDefinePropertyPage), TatAxCtrlsDispatcher, @TatAxCtrlsDispatcher.__TDefinePropertyPage);
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('EnumDispatchProperties',4,tkNone,nil,__EnumDispatchProperties,false,0);
