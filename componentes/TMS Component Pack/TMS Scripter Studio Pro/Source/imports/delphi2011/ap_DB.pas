...
type
  TatDBLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTFieldAsBytes(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsBytes(AMachine: TatVirtualMachine);
    ...
    procedure __GetTInterfaceFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTInterfaceFieldValue(AMachine: TatVirtualMachine);
    procedure __TIDispatchFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTIDispatchFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTIDispatchFieldValue(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsBytes(AMachine: TatVirtualMachine);
    procedure __SetTParamAsBytes(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetBookmarkValid(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetCompareBookmarks(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetFreeBookmark(AMachine: TatVirtualMachine);
    procedure __TDataSetGetBookmark(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetGetBlobFieldData(AMachine: TatVirtualMachine);
    procedure __TDataSetGetFieldList(AMachine: TatVirtualMachine);
    procedure __TDataSetGetFieldNames(AMachine: TatVirtualMachine);
    procedure __TDataSetGotoBookmark(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := Integer(TFieldsEnumeratorClass(CurrentClass.ClassRef).Create(TFields(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TFieldsEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TFieldsEnumerator(CurrentObject).Current));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TFields(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDefaultLookupListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).SetParentComponent(TComponent(Integer(GetInputArg(0))));
  end;
end;
...
procedure TatDBLibrary.__GetTFieldAsBytes(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TField(CurrentObject).AsBytes);
  end;
end;

procedure TatDBLibrary.__SetTFieldAsBytes(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsBytes:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TLongWordFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TShortintFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TByteFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TUnsignedAutoIncFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TSingleFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TExtendedFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TSQLTimeStampOffsetFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TMemoField(CurrentObject).GetAsString;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TMemoField(CurrentObject).SetAsString(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TWideMemoFieldClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetField(CurrentObject).Assign(TPersistent(Integer(GetInputArg(0))));
  end;
end;
...
procedure TatDBLibrary.__GetTInterfaceFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TInterfaceField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTInterfaceFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TInterfaceField(CurrentObject).Value:=GetInputArg(0);
  end;
end;
...
procedure TatDBLibrary.__GetTIDispatchFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TIDispatchField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTIDispatchFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TIDispatchField(CurrentObject).Value:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).SetDataSet(TDataSet(Integer(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).SetParams(TParams(Integer(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      2: TParam(CurrentObject).SetStream(TStream(Integer(GetInputArg(0))),GetInputArg(1));
      3: TParam(CurrentObject).SetStream(TStream(Integer(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)));
    end;
  end;
end;
...
procedure TatDBLibrary.__GetTParamAsBytes(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TParam(CurrentObject).AsBytes);
  end;
end;

procedure TatDBLibrary.__SetTParamAsBytes(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsBytes:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsDataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsDataSet:=TDataSet(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TParam(CurrentObject).AsObject));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsObject:=TObject(integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsParams));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsParams:=TParams(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsStream));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsStream:=TStream(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParams(CurrentObject).AddParameter);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamObjectClass(CurrentClass.ClassRef).Create(TObject(integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetBookmarkValid(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDataSet(CurrentObject).BookmarkValid(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetCompareBookmarks(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).CompareBookmarks(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetFreeBookmark(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).FreeBookmark(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__TDataSetGetBookmark(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDataSet(CurrentObject).GetBookmark;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetGetBlobFieldData(AMachine: TatVirtualMachine);
  var
...
AResult := Integer(TDataSet(CurrentObject).GetBlobFieldData(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
procedure TatDBLibrary.__TDataSetGotoBookmark(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GotoBookmark(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).CopyFields(TDataSet(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).Translate(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineProp('OriginalException',tkVariant,__GetEUpdateErrorOriginalException,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TFieldsEnumerator,__TFieldsEnumeratorCreate,true,0);
  ...
  begin
    ...
    DefineMethod('Add',2,tkNone,nil,__TDefaultLookupListAdd,false,0);
    DefineMethod('Clear',0,tkNone,nil,__TDefaultLookupListClear,false,0);
    DefineMethod('ValueOfKey',1,tkVariant,nil,__TDefaultLookupListValueOfKey,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('SetParentComponent',1,tkNone,nil,__TFieldSetParentComponent,false,0);
    ...
    DefineProp('AsBytes',tkVariant,__GetTFieldAsBytes,__SetTFieldAsBytes,nil,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TLongWordField,__TLongWordFieldCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TShortintField,__TShortintFieldCreate,true,0);
  end;
  With Scripter.DefineClass(TByteField) do
  begin
    DefineMethod('Create',1,tkClass,TByteField,__TByteFieldCreate,true,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TUnsignedAutoIncField,__TUnsignedAutoIncFieldCreate,true,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TSingleField,__TSingleFieldCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TExtendedField,__TExtendedFieldCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TSQLTimeStampOffsetField,__TSQLTimeStampOffsetFieldCreate,true,0);
  ...
  begin
    ...
    DefineMethod('SetAsString',1,tkNone,nil,__TMemoFieldSetAsString,false,0);
    DefineMethod('SetAsWideString',1,tkNone,nil,__TMemoFieldSetAsWideString,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TWideMemoField,__TWideMemoFieldCreate,true,0);
  ...
  begin
    ...
    DefineMethod('Assign',1,tkNone,nil,__TDataSetFieldAssign,false,0);
  ...
  begin
    ...
    DefineProp('Value',tkVariant,__GetTInterfaceFieldValue,__SetTInterfaceFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TIDispatchField) do
  begin
    DefineMethod('Create',1,tkClass,TIDispatchField,__TIDispatchFieldCreate,true,0);
    DefineProp('Value',tkVariant,__GetTIDispatchFieldValue,__SetTIDispatchFieldValue,nil,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('SetDataSet',2,tkNone,nil,__TParamSetDataSet,false,0);
    DefineMethod('SetParams',2,tkNone,nil,__TParamSetParams,false,0);
    DefineMethod('SetStream',3,tkNone,nil,__TParamSetStream,false,1);
    ...
    DefineProp('AsBytes',tkVariant,__GetTParamAsBytes,__SetTParamAsBytes,nil,false,0);
    ...
    DefineProp('AsObject',tkVariant,__GetTParamAsObject,__SetTParamAsObject,nil,false,0);
  ...
  begin
    DefineMethod('Create',3,tkClass,TParamObject,__TParamObjectCreate,true,0);
  ...
  begin
    ...
    DefineMethod('BookmarkValid',1,tkVariant,nil,__TDataSetBookmarkValid,false,0);
    ...
    DefineMethod('CompareBookmarks',2,tkInteger,nil,__TDataSetCompareBookmarks,false,0);
    ...
    DefineMethod('FreeBookmark',1,tkNone,nil,__TDataSetFreeBookmark,false,0);
    DefineMethod('GetBookmark',0,tkVariant,nil,__TDataSetGetBookmark,false,0);
    ...
    DefineMethod('GetBlobFieldData',2,tkInteger,nil,__TDataSetGetBlobFieldData,false,0).SetVarArgs([1]);
    ...
    DefineMethod('GotoBookmark',1,tkNone,nil,__TDataSetGotoBookmark,false,0);
    ...
    DefineMethod('CopyFields',1,tkInteger,nil,__TDataSetCopyFields,false,0);
