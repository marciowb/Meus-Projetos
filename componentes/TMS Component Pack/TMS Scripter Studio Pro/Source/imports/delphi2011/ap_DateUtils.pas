...
begin
  ...
  begin
case InputArgCount of
1: AResult := TTimeZone(CurrentObject).GetDisplayName(GetInputArg(0));
2: AResult := TTimeZone(CurrentObject).GetDisplayName(GetInputArg(0),GetInputArg(1));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := TTimeZone(CurrentObject).GetAbbreviation(GetInputArg(0));
2: AResult := TTimeZone(CurrentObject).GetAbbreviation(GetInputArg(0),GetInputArg(1));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TTimeZone(CurrentObject).GetLocalTimeType(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TTimeZone(CurrentObject).ID);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TTimeZone(CurrentObject).DisplayName);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TTimeZone(CurrentObject).Abbreviation);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TTimeZone(CurrentObject).Local));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('ToUniversalTime',2,tkVariant,nil,__TTimeZoneToUniversalTime,false,1);
    DefineMethod('ToLocalTime',1,tkVariant,nil,__TTimeZoneToLocalTime,false,0);
    DefineMethod('GetDisplayName',2,tkVariant,nil,__TTimeZoneGetDisplayName,false,1);
    DefineMethod('GetAbbreviation',2,tkVariant,nil,__TTimeZoneGetAbbreviation,false,1);
    DefineMethod('GetLocalTimeType',1,tkEnumeration,nil,__TTimeZoneGetLocalTimeType,false,0);
    DefineMethod('IsStandardTime',2,tkVariant,nil,__TTimeZoneIsStandardTime,false,1);
    DefineMethod('IsInvalidTime',1,tkVariant,nil,__TTimeZoneIsInvalidTime,false,0);
    DefineMethod('IsAmbiguousTime',1,tkVariant,nil,__TTimeZoneIsAmbiguousTime,false,0);
    DefineMethod('IsDaylightTime',2,tkVariant,nil,__TTimeZoneIsDaylightTime,false,1);
  ...
  begin
    ...
    DefineMethod('IsAM',1,tkVariant,nil,__IsAM,false,0);
    ...
    DefineMethod('DateTimeInRange',4,tkVariant,nil,__DateTimeInRange,false,1);
    DefineMethod('DateInRange',4,tkVariant,nil,__DateInRange,false,1);
    DefineMethod('TimeInRange',4,tkVariant,nil,__TimeInRange,false,1);
