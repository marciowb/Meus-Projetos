...
Param0 := GetInputArg(0);
    Case InputArgCount of
      2: StrHlpr.WideFromPChar(Param0,PAnsiChar(VarToStr(GetInputArg(1))));
      3: StrHlpr.WideFromPChar(Param0,PAnsiChar(VarToStr(GetInputArg(1))),GetInputArg(2));
    end;
    SetInputArg(0,Param0);
  end;
end;
...
Param0 := GetInputArg(0);
    Case InputArgCount of
      2: StrHlpr.UnicodeFromPChar(Param0,PAnsiChar(VarToStr(GetInputArg(1))));
      3: StrHlpr.UnicodeFromPChar(Param0,PAnsiChar(VarToStr(GetInputArg(1))),GetInputArg(2));
    end;
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
    StrHlpr.UnicodeFromUTF8(Param0,PAnsiChar(VarToStr(GetInputArg(1))));
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
    StrHlpr.WideFromUTF8(Param0,PAnsiChar(VarToStr(GetInputArg(1))));
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('WideFromPChar',3,tkNone,nil,__WideFromPChar,false,1).SetVarArgs([0]);
    ...
    DefineMethod('UnicodeFromPChar',3,tkNone,nil,__UnicodeFromPChar,false,1).SetVarArgs([0]);
    ...
    DefineMethod('UnicodeFromUTF8',2,tkNone,nil,__UnicodeFromUTF8,false,0).SetVarArgs([0]);
    DefineMethod('WideFromUTF8',2,tkNone,nil,__WideFromUTF8,false,0).SetVarArgs([0]);
  end;
end;
