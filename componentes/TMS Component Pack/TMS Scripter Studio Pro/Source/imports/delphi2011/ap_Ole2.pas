...
AResult := IUnknown(CurrentObject).QueryInterface(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
...
AResult := IClassFactory(CurrentObject).CreateInstance(IUnknown(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IClassFactory(CurrentObject).LockServer(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := IMarshal(CurrentObject).UnmarshalInterface(IStream(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IMarshal(CurrentObject).ReleaseMarshalData(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IMarshal(CurrentObject).DisconnectObject(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumUnknown(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumUnknown(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumUnknown(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IBindCtx(CurrentObject).RegisterObjectBound(IUnknown(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IBindCtx(CurrentObject).RevokeObjectBound(IUnknown(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IBindCtx(CurrentObject).ReleaseBoundObjects;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IBindCtx(CurrentObject).SetBindOptions(Param0);
    ReturnOutputArg(AResult);
...
if not Assigned(Param0Rec) or not (Param0Rec is tagBIND_OPTSWrapper) then 
  Param0Rec := tagBIND_OPTSWrapper.Create(Param0);
Param0 := tagBIND_OPTSWrapper(Param0Rec).ObjToRec;
AResult := IBindCtx(CurrentObject).GetBindOptions(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagBIND_OPTSWrapper.Create(Param0)));
  end;
end;
...
AResult := IBindCtx(CurrentObject).GetRunningObjectTable(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IBindCtx(CurrentObject).RegisterObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),IUnknown(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IBindCtx(CurrentObject).GetObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
...
AResult := IBindCtx(CurrentObject).EnumObjectParam(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IBindCtx(CurrentObject).RevokeObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumMoniker(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumMoniker(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumMoniker(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IRunnableObject(CurrentObject).GetRunningClass(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IRunnableObject(CurrentObject).Run(IBindCtx(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRunnableObject(CurrentObject).LockRunning(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRunnableObject(CurrentObject).SetContainedObject(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IRunningObjectTable(CurrentObject).Register(VarToInteger(GetInputArg(0)),Param1,IMoniker(Integer(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
...
begin
  with AMachine do
  begin
AResult := IRunningObjectTable(CurrentObject).Revoke(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRunningObjectTable(CurrentObject).IsRunning(IMoniker(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := IUnknown(Integer(GetInputArg(1)));
AResult := IRunningObjectTable(CurrentObject).GetObject(IMoniker(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := IRunningObjectTable(CurrentObject).NoteChangeTime(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
if not Assigned(Param1Rec) or not (Param1Rec is _FILETIMEWrapper) then 
  Param1Rec := _FILETIMEWrapper.Create(Param1);
Param1 := _FILETIMEWrapper(Param1Rec).ObjToRec;
AResult := IRunningObjectTable(CurrentObject).GetTimeOfLastChange(IMoniker(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(_FILETIMEWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumMoniker(Integer(GetInputArg(0)));
AResult := IRunningObjectTable(CurrentObject).EnumRunning(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is TGUIDWrapper) then 
  Param0Rec := TGUIDWrapper.Create(Param0);
Param0 := TGUIDWrapper(Param0Rec).ObjToRec;
AResult := IPersist(CurrentObject).GetClassID(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TGUIDWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStream(CurrentObject).IsDirty;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStream(CurrentObject).Load(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStream(CurrentObject).Save(IStream(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IPersistStream(CurrentObject).GetSizeMax(Param0);
    ReturnOutputArg(AResult);
...
AResult := IMoniker(CurrentObject).BindToObject(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := IMoniker(CurrentObject).BindToStorage(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
AResult := IMoniker(CurrentObject).Reduce(IBindCtx(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,Param3);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := IMoniker(CurrentObject).ComposeWith(IMoniker(Integer(GetInputArg(0))),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := IMoniker(CurrentObject).Enum(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IMoniker(CurrentObject).IsEqual(IMoniker(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IMoniker(CurrentObject).Hash(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IMoniker(CurrentObject).IsRunning(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),IMoniker(Integer(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IMoniker(CurrentObject).GetTimeOfLastChange(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
...
AResult := IMoniker(CurrentObject).Inverse(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IMoniker(CurrentObject).CommonPrefixWith(IMoniker(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := IMoniker(Integer(GetInputArg(1)));
AResult := IMoniker(CurrentObject).RelativePathTo(IMoniker(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := IMoniker(CurrentObject).GetDisplayName(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
...
AResult := IMoniker(CurrentObject).ParseDisplayName(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),Param3,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IMoniker(CurrentObject).IsSystemMoniker(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumString(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumString(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumString(Integer(GetInputArg(0)));
AResult := IEnumString(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := IStream(CurrentObject).Seek(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStream(CurrentObject).SetSize(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := GetInputArg(2);
Param3 := GetInputArg(3);
AResult := IStream(CurrentObject).CopyTo(IStream(Integer(GetInputArg(0))),GetInputArg(1),Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
    SetInputArg(3,Param3);
  end;
...
begin
  with AMachine do
  begin
AResult := IStream(CurrentObject).Commit(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStream(CurrentObject).Revert;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStream(CurrentObject).LockRegion(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStream(CurrentObject).UnlockRegion(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IStream(CurrentObject).Stat(Param0,VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
...
AResult := IStream(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumStatStg(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumStatStg(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumStatStg(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IStorage(CurrentObject).CreateStream(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
AResult := IStorage(CurrentObject).CreateStorage(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).MoveElementTo(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),IStorage(Integer(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).Commit(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).Revert;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).DestroyElement(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).RenameElement(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).SetElementTimes(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).SetClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IStorage(CurrentObject).SetStateBits(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagSTATSTGWrapper) then 
  Param0Rec := tagSTATSTGWrapper.Create(Param0);
Param0 := tagSTATSTGWrapper(Param0Rec).ObjToRec;
AResult := IStorage(CurrentObject).Stat(Param0,VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagSTATSTGWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistFile(CurrentObject).IsDirty;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistFile(CurrentObject).Load(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistFile(CurrentObject).Save(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistFile(CurrentObject).SaveCompleted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IPersistFile(CurrentObject).GetCurFile(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).IsDirty;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).InitNew(IStorage(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).Load(IStorage(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).Save(IStorage(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).SaveCompleted(IStorage(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IPersistStorage(CurrentObject).HandsOffStorage;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ILockBytes(CurrentObject).Flush;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ILockBytes(CurrentObject).SetSize(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ILockBytes(CurrentObject).LockRegion(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ILockBytes(CurrentObject).UnlockRegion(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagSTATSTGWrapper) then 
  Param0Rec := tagSTATSTGWrapper.Create(Param0);
Param0 := tagSTATSTGWrapper(Param0Rec).ObjToRec;
AResult := ILockBytes(CurrentObject).Stat(Param0,VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagSTATSTGWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumFormatEtc(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumFormatEtc(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumFormatEtc(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumStatData(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumStatData(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumStatData(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRootStorage(CurrentObject).SwitchToFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagSTGMEDIUMWrapper) then 
  Param1Rec := tagSTGMEDIUMWrapper.Create(Param1);
Param1 := tagSTGMEDIUMWrapper(Param1Rec).ObjToRec;
AResult := IDataObject(CurrentObject).GetData(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(1,integer(tagSTGMEDIUMWrapper.Create(Param1)));
  end;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagSTGMEDIUMWrapper) then 
  Param1Rec := tagSTGMEDIUMWrapper.Create(Param1);
Param1 := tagSTGMEDIUMWrapper(Param1Rec).ObjToRec;
AResult := IDataObject(CurrentObject).GetDataHere(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(1,integer(tagSTGMEDIUMWrapper.Create(Param1)));
  end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagFORMATETCWrapper) then 
  Param0Rec := tagFORMATETCWrapper.Create(Param0);
Param0 := tagFORMATETCWrapper(Param0Rec).ObjToRec;
AResult := IDataObject(CurrentObject).QueryGetData(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
  end;
end;
...
AResult := IDataObject(CurrentObject).GetCanonicalFormatEtc(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
...
if not Assigned(Param1Rec) or not (Param1Rec is tagSTGMEDIUMWrapper) then 
  Param1Rec := tagSTGMEDIUMWrapper.Create(Param1);
Param1 := tagSTGMEDIUMWrapper(Param1Rec).ObjToRec;
AResult := IDataObject(CurrentObject).SetData(Param0,Param1,GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(1,integer(tagSTGMEDIUMWrapper.Create(Param1)));
  end;
...
AResult := IDataObject(CurrentObject).EnumFormatEtc(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
Param0 := tagFORMATETCWrapper(Param0Rec).ObjToRec;
Param3 := VarToInteger(GetInputArg(3));
AResult := IDataObject(CurrentObject).DAdvise(Param0,VarToInteger(GetInputArg(1)),IAdviseSink(Integer(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(3,Integer(Param3));
  end;
...
begin
  with AMachine do
  begin
AResult := IDataObject(CurrentObject).DUnadvise(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumStatData(Integer(GetInputArg(0)));
AResult := IDataObject(CurrentObject).EnumDAdvise(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IDataAdviseHolder(CurrentObject).Advise(IDataObject(Integer(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)),IAdviseSink(Integer(GetInputArg(3))),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagFORMATETCWrapper.Create(Param1)));
    SetInputArg(4,Integer(Param4));
  end;
...
begin
  with AMachine do
  begin
AResult := IDataAdviseHolder(CurrentObject).Unadvise(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumStatData(Integer(GetInputArg(0)));
AResult := IDataAdviseHolder(CurrentObject).EnumAdvise(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IDataAdviseHolder(CurrentObject).SendOnDataChange(IDataObject(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IRpcChannelBuffer(CurrentObject).GetBuffer(Param0,TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
...
AResult := IRpcChannelBuffer(CurrentObject).SendReceive(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagRPCOLEMESSAGEWrapper.Create(Param0)));
    SetInputArg(1,Integer(Param1));
  end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagRPCOLEMESSAGEWrapper) then 
  Param0Rec := tagRPCOLEMESSAGEWrapper.Create(Param0);
Param0 := tagRPCOLEMESSAGEWrapper(Param0Rec).ObjToRec;
AResult := IRpcChannelBuffer(CurrentObject).FreeBuffer(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagRPCOLEMESSAGEWrapper.Create(Param0)));
  end;
end;
...
Param0 := VarToInteger(GetInputArg(0));
Param1 := GetInputArg(1);
AResult := IRpcChannelBuffer(CurrentObject).GetDestCtx(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(1,Param1);
  end;
...
begin
  with AMachine do
  begin
AResult := IRpcChannelBuffer(CurrentObject).IsConnected;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRpcProxyBuffer(CurrentObject).Connect(IRpcChannelBuffer(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IRpcStubBuffer(CurrentObject).Connect(IUnknown(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagRPCOLEMESSAGEWrapper) then 
  Param0Rec := tagRPCOLEMESSAGEWrapper.Create(Param0);
Param0 := tagRPCOLEMESSAGEWrapper(Param0Rec).ObjToRec;
AResult := IRpcStubBuffer(CurrentObject).Invoke(Param0,IRpcChannelBuffer(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagRPCOLEMESSAGEWrapper.Create(Param0)));
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := IRpcStubBuffer(CurrentObject).DebugServerQueryInterface(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
Param3 := GetInputArg(3);
AResult := IPSFactoryBuffer(CurrentObject).CreateProxy(IUnknown(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Param3);
  end;
...
AResult := IPSFactoryBuffer(CurrentObject).CreateStub(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetGuid(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetTypeFlags(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetDocString(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetHelpContext(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetVersion(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ICreateTypeInfo(CurrentObject).AddRefTypeInfo(ITypeInfo(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := ICreateTypeInfo(CurrentObject).AddFuncDesc(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).AddImplType(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetImplTypeFlags(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetAlignment(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetSchema(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ICreateTypeInfo(CurrentObject).AddVarDesc(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetVarName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ICreateTypeInfo(CurrentObject).SetTypeDescAlias(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).DefineFuncAsDllEntry(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetFuncDocString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetVarDocString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetFuncHelpContext(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetVarHelpContext(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).SetMops(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ICreateTypeInfo(CurrentObject).SetTypeIdldesc(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ICreateTypeInfo(CurrentObject).LayOut;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ICreateTypeLib(CurrentObject).CreateTypeInfo(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetName(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetVersion(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetGuid(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetDocString(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetHelpFileName(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetHelpContext(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetLcid(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SetLibFlags(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateTypeLib(CurrentObject).SaveAllChanges;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IDispatch(CurrentObject).GetTypeInfoCount(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IDispatch(CurrentObject).GetTypeInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := IEnumVariant(CurrentObject).Next(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := IEnumVariant(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumVariant(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumVariant(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := ITypeComp(CurrentObject).Bind(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,Param4,Param5);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
    SetInputArg(4,Integer(Param4));
...
AResult := ITypeComp(CurrentObject).BindType(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := ITypeInfo(CurrentObject).GetTypeComp(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ITypeInfo(CurrentObject).GetRefTypeOfImplType(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ITypeInfo(CurrentObject).GetImplTypeFlags(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
Param4 := VarToInteger(GetInputArg(4));
AResult := ITypeInfo(CurrentObject).GetDllEntry(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,Param3,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(2,WideCharToString(Param2));
...
AResult := ITypeInfo(CurrentObject).GetRefTypeInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ITypeInfo(CurrentObject).CreateInstance(IUnknown(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
AResult := ITypeInfo(CurrentObject).GetMops(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
Param1 := VarToInteger(GetInputArg(1));
AResult := ITypeInfo(CurrentObject).GetContainingTypeLib(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(1,Integer(Param1));
  end;
...
begin
  ...
  begin
Param1 := ITypeInfo(Integer(GetInputArg(1)));
AResult := ITypeLib(CurrentObject).GetTypeInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ITypeLib(CurrentObject).GetTypeInfoType(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := ITypeInfo(Integer(GetInputArg(1)));
AResult := ITypeLib(CurrentObject).GetTypeInfoOfGuid(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param0 := ITypeComp(Integer(GetInputArg(0)));
AResult := ITypeLib(CurrentObject).GetTypeComp(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ITypeLib(CurrentObject).IsName(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is TGUIDWrapper) then 
  Param0Rec := TGUIDWrapper.Create(Param0);
Param0 := TGUIDWrapper(Param0Rec).ObjToRec;
AResult := IErrorInfo(CurrentObject).GetGUID(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TGUIDWrapper.Create(Param0)));
  end;
end;
...
begin
  ...
  begin
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))));
AResult := IErrorInfo(CurrentObject).GetSource(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))));
AResult := IErrorInfo(CurrentObject).GetDescription(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))));
AResult := IErrorInfo(CurrentObject).GetHelpFile(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IErrorInfo(CurrentObject).GetHelpContext(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateErrorInfo(CurrentObject).SetGUID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateErrorInfo(CurrentObject).SetSource(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateErrorInfo(CurrentObject).SetDescription(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateErrorInfo(CurrentObject).SetHelpFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ICreateErrorInfo(CurrentObject).SetHelpContext(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ISupportErrorInfo(CurrentObject).InterfaceSupportsErrorInfo(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := IOleAdviseHolder(CurrentObject).Advise(IAdviseSink(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleAdviseHolder(CurrentObject).Unadvise(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumStatData(Integer(GetInputArg(0)));
AResult := IOleAdviseHolder(CurrentObject).EnumAdvise(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleAdviseHolder(CurrentObject).SendOnRename(IMoniker(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleAdviseHolder(CurrentObject).SendOnSave;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleAdviseHolder(CurrentObject).SendOnClose;
    ReturnOutputArg(AResult);
  end;
end;
...
Param0 := tagFORMATETCWrapper(Param0Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := IOleCache(CurrentObject).Cache(Param0,VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := IOleCache(CurrentObject).Uncache(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumStatData(Integer(GetInputArg(0)));
AResult := IOleCache(CurrentObject).EnumCache(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleCache(CurrentObject).InitCache(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagSTGMEDIUMWrapper) then 
  Param1Rec := tagSTGMEDIUMWrapper.Create(Param1);
Param1 := tagSTGMEDIUMWrapper(Param1Rec).ObjToRec;
AResult := IOleCache(CurrentObject).SetData(Param0,Param1,GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(1,integer(tagSTGMEDIUMWrapper.Create(Param1)));
  end;
...
begin
  with AMachine do
  begin
AResult := IOleCache2(CurrentObject).DiscardCache(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleCacheControl(CurrentObject).OnRun(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleCacheControl(CurrentObject).OnStop;
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(Integer(GetInputArg(3)));
AResult := IParseDisplayName(CurrentObject).ParseDisplayName(IBindCtx(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := IOleContainer(CurrentObject).EnumObjects(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleContainer(CurrentObject).LockContainer(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleClientSite(CurrentObject).SaveObject;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := IOleClientSite(CurrentObject).GetMoniker(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := IOleClientSite(CurrentObject).GetContainer(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleClientSite(CurrentObject).ShowObject;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleClientSite(CurrentObject).OnShowWindow(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleClientSite(CurrentObject).RequestNewObjectLayout;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).SetClientSite(IOleClientSite(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleObject(CurrentObject).GetClientSite(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).SetHostNames(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).Close(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).SetMoniker(VarToInteger(GetInputArg(0)),IMoniker(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := IOleObject(CurrentObject).GetMoniker(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).InitFromData(IDataObject(Integer(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleObject(CurrentObject).GetClipboardData(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := IOleObject(CurrentObject).EnumVerbs(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).Update;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).IsUpToDate;
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is TGUIDWrapper) then 
  Param0Rec := TGUIDWrapper.Create(Param0);
Param0 := TGUIDWrapper(Param0Rec).ObjToRec;
AResult := IOleObject(CurrentObject).GetUserClassID(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TGUIDWrapper.Create(Param0)));
  end;
end;
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := IOleObject(CurrentObject).GetUserType(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).SetExtent(VarToInteger(GetInputArg(0)),TPointWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleObject(CurrentObject).GetExtent(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := IOleObject(CurrentObject).Advise(IAdviseSink(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleObject(CurrentObject).Unadvise(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumStatData(Integer(GetInputArg(0)));
AResult := IOleObject(CurrentObject).EnumAdvise(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := IOleObject(CurrentObject).GetMiscStatus(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := IOleObject(CurrentObject).SetColorScheme(Param0);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IOleWindow(CurrentObject).GetWindow(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleWindow(CurrentObject).ContextSensitiveHelp(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).SetUpdateOptions(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IOleLink(CurrentObject).GetUpdateOptions(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).SetSourceMoniker(IMoniker(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IMoniker(Integer(GetInputArg(0)));
AResult := IOleLink(CurrentObject).GetSourceMoniker(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).SetSourceDisplayName(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))));
AResult := IOleLink(CurrentObject).GetSourceDisplayName(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).BindToSource(VarToInteger(GetInputArg(0)),IBindCtx(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).BindIfRunning;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleLink(CurrentObject).GetBoundSource(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).UnbindSource;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleLink(CurrentObject).Update(IBindCtx(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleItemContainer(CurrentObject).GetObject(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),IBindCtx(Integer(GetInputArg(2))),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := IOleItemContainer(CurrentObject).GetObjectStorage(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),IBindCtx(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleItemContainer(CurrentObject).IsRunning(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleInPlaceUIWindow(CurrentObject).GetBorder(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceUIWindow(CurrentObject).RequestBorderSpace(TRectWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceUIWindow(CurrentObject).SetActiveObject(IOleInPlaceActiveObject(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleInPlaceActiveObject(CurrentObject).TranslateAccelerator(Param0);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceActiveObject(CurrentObject).OnFrameWindowActivate(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceActiveObject(CurrentObject).OnDocWindowActivate(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceActiveObject(CurrentObject).ResizeBorder(TRectWrapper(integer(GetInputArg(0))).ObjToRec,IOleInPlaceUIWindow(Integer(GetInputArg(1))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceActiveObject(CurrentObject).EnableModeless(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleInPlaceFrame(CurrentObject).InsertMenus(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceFrame(CurrentObject).SetMenu(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceFrame(CurrentObject).RemoveMenus(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceFrame(CurrentObject).SetStatusText(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceFrame(CurrentObject).EnableModeless(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagMSGWrapper) then 
  Param0Rec := tagMSGWrapper.Create(Param0);
Param0 := tagMSGWrapper(Param0Rec).ObjToRec;
AResult := IOleInPlaceFrame(CurrentObject).TranslateAccelerator(Param0,VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagMSGWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceObject(CurrentObject).InPlaceDeactivate;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceObject(CurrentObject).UIDeactivate;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceObject(CurrentObject).SetObjectRects(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TRectWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceObject(CurrentObject).ReactivateAndUndo;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).CanInPlaceActivate;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).OnInPlaceActivate;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).OnUIActivate;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleInPlaceSite(CurrentObject).GetWindowContext(Param0,Param1,Param2,Param3,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(1,Integer(Param1));
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).Scroll(TPointWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).OnUIDeactivate(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).OnInPlaceDeactivate;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).DiscardUndoState;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).DeactivateAndUndo;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleInPlaceSite(CurrentObject).OnPosRectChange(TRectWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IViewObject(CurrentObject).Unfreeze(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IViewObject(CurrentObject).SetAdvise(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),IAdviseSink(Integer(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IDropSource(CurrentObject).QueryContinueDrag(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IDropSource(CurrentObject).GiveFeedback(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := IDropTarget(CurrentObject).DragEnter(IDataObject(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),TPointWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := IDropTarget(CurrentObject).DragOver(VarToInteger(GetInputArg(0)),TPointWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IDropTarget(CurrentObject).DragLeave;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := IDropTarget(CurrentObject).Drop(IDataObject(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),TPointWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumOleVerb(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumOleVerb(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := IEnumOleVerb(Integer(GetInputArg(0)));
AResult := IEnumOleVerb(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).SetInPlaceSite(IOleInPlaceSite(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleDocumentView(CurrentObject).GetInPlaceSite(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := IUnknown(Integer(GetInputArg(0)));
AResult := IOleDocumentView(CurrentObject).GetDocument(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).SetRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is TRectWrapper) then 
  Param0Rec := TRectWrapper.Create(Param0);
Param0 := TRectWrapper(Param0Rec).ObjToRec;
AResult := IOleDocumentView(CurrentObject).GetRect(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TRectWrapper.Create(Param0)));
  end;
end;
...
Param2 := GetInputArg(2);
Param3 := GetInputArg(3);
AResult := IOleDocumentView(CurrentObject).SetRectComplex(Param0,Param1,Param2,Param3);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).Show(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).UIActivate(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).Open;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).CloseView(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).SaveViewState(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentView(CurrentObject).ApplyViewState(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IOleDocumentView(CurrentObject).Clone(IOleInPlaceSite(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
Param1 := IOleDocumentView(Integer(GetInputArg(1)));
Param2 := VarToInteger(GetInputArg(2));
AResult := IEnumOleDocumentViews(CurrentObject).Next(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := IEnumOleDocumentViews(CurrentObject).Skip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IEnumOleDocumentViews(CurrentObject).Reset;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := IEnumOleDocumentViews(CurrentObject).Clone(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
AResult := IOleDocument(CurrentObject).CreateView(IOleInPlaceSite(Integer(GetInputArg(0))),IStream(Integer(GetInputArg(1))),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := IOleDocument(CurrentObject).GetDocMiscStatus(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
Param0 := IEnumOleDocumentViews(Integer(GetInputArg(0)));
Param1 := IOleDocumentView(Integer(GetInputArg(1)));
AResult := IOleDocument(CurrentObject).EnumViews(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(1,Integer(Param1));
  end;
...
begin
  with AMachine do
  begin
AResult := IOleDocumentSite(CurrentObject).ActivateMe(IOleDocumentView(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.Succeeded(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.Failed(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.ResultCode(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.ResultFacility(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.ResultSeverity(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.MakeResult(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.CoGetMalloc(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoRegisterMallocSpy(IMallocSpy(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoRevokeMallocSpy;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param4 := VarToInteger(GetInputArg(4));
AResult := Ole2.CoRegisterClassObject(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoRevokeClassObject(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.CoUnmarshalInterface(IStream(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoReleaseMarshalData(IStream(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoDisconnectObject(IUnknown(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoLockObjectExternal(IUnknown(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.CoMarshalInterThreadInterfaceInStream(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.CoGetInterfaceAndReleaseStream(IStream(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := IUnknown(Integer(GetInputArg(1)));
AResult := Ole2.CoCreateFreeThreadedMarshaler(IUnknown(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoLoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Ole2.CoFreeLibrary(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Ole2.CoCreateInstance(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := Ole2.StringFromCLSID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
AResult := Ole2.CLSIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := Ole2.StringFromIID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.IIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := Ole2.ProgIDFromCLSID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.CLSIDFromProgID(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is TGUIDWrapper) then 
  Param0Rec := TGUIDWrapper.Create(Param0);
Param0 := TGUIDWrapper(Param0Rec).ObjToRec;
AResult := Ole2.CoCreateGuid(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TGUIDWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _FILETIMEWrapper) then 
  Param0Rec := _FILETIMEWrapper.Create(Param0);
Param0 := _FILETIMEWrapper(Param0Rec).ObjToRec;
AResult := Ole2.CoFileTimeNow(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_FILETIMEWrapper.Create(Param0)));
  end;
end;
...
AResult := Ole2.CoRegisterMessageFilter(IMessageFilter(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.CoGetTreatAsClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoTreatAsClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.CreateDataAdviseHolder(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.CreateDataCache(IUnknown(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
AResult := Ole2.StgCreateDocfile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := IStorage(Integer(GetInputArg(3)));
AResult := Ole2.StgCreateDocfileOnILockBytes(ILockBytes(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.StgIsStorageFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.StgIsStorageILockBytes(ILockBytes(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.StgSetTimes(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.BindMoniker(IMoniker(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(Integer(GetInputArg(3)));
AResult := Ole2.MkParseDisplayName(IBindCtx(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := Ole2.MonikerRelativePathTo(IMoniker(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),Param2,GetInputArg(3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := Ole2.MonikerCommonPrefixWith(IMoniker(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := Ole2.CreateBindCtx(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := Ole2.CreateGenericComposite(IMoniker(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.GetClassFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
Param1 := IMoniker(Integer(GetInputArg(1)));
AResult := Ole2.CreateFileMoniker(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(Integer(GetInputArg(2)));
AResult := Ole2.CreateItemMoniker(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param0 := IMoniker(Integer(GetInputArg(0)));
AResult := Ole2.CreateAntiMoniker(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param1 := IMoniker(Integer(GetInputArg(1)));
AResult := Ole2.CreatePointerMoniker(IUnknown(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := Ole2.GetRunningObjectTable(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := Ole2.VariantClear(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := Ole2.VariantCopy(Param0,GetInputArg(1));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := Ole2.VariantCopyInd(Param0,GetInputArg(1));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := Ole2.VariantChangeType(Param0,GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := Ole2.VariantChangeTypeEx(Param0,GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Ole2.VarUI1FromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Ole2.VarUI1FromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarUI1FromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Ole2.VarI2FromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Ole2.VarI2FromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI2FromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Ole2.VarI4FromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Ole2.VarI4FromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Ole2.VarI4FromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.VarR4FromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.VarR4FromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR4FromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.VarR8FromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.VarR8FromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarR8FromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.VarDateFromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.VarDateFromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarDateFromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.VarCyFromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.VarCyFromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarCyFromBool(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromUI1(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromI2(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromI4(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromR4(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromR8(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromDate(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.VarBoolFromCy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.VarBoolFromStr(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.VarBoolFromDisp(IDispatch(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
AResult := Ole2.LoadTypeLib(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := Ole2.LoadRegTypeLib(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
AResult := Ole2.QueryPathOfRegTypeLib(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Ole2.RegisterTypeLib(ITypeLib(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.CreateTypeLib(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
Param3 := GetInputArg(3);
Param4 := VarToInteger(GetInputArg(4));
AResult := Ole2.DispGetParam(Param0,VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,Param4);
    ReturnOutputArg(AResult);
...
Param1 := GetInputArg(1);
Param3 := GetInputArg(3);
AResult := Ole2.DispGetIDsOfNames(ITypeInfo(Integer(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
    SetInputArg(3,Param3);
  end;
...
Param2 := ITypeInfo(Integer(GetInputArg(2)));
AResult := Ole2.CreateDispTypeInfo(Param0,VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Ole2.RegisterActiveObject(IUnknown(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.SetErrorInfo(VarToInteger(GetInputArg(0)),IErrorInfo(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.GetErrorInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
AResult := Ole2.CreateErrorInfo(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.ReadClassStg(IStorage(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.WriteClassStg(IStorage(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.ReadClassStm(IStream(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.WriteClassStm(IStream(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.WriteFmtUserTypeStg(IStorage(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := VarToInteger(GetInputArg(1));
Param2 := StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2))));
AResult := Ole2.ReadFmtUserTypeStg(IStorage(Integer(GetInputArg(0))),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,WideCharToString(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleQueryLinkFromData(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleQueryCreateFromData(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.OleLoad(IStorage(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,IOleClientSite(Integer(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSave(IPersistStorage(Integer(GetInputArg(0))),IStorage(Integer(GetInputArg(1))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Ole2.OleLoadFromStream(IStream(Integer(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSaveToStream(IPersistStream(Integer(GetInputArg(0))),IStream(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSetContainedObject(IUnknown(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleNoteObjectVisible(IUnknown(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.RegisterDragDrop(VarToInteger(GetInputArg(0)),IDropTarget(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.RevokeDragDrop(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Ole2.DoDragDrop(IDataObject(Integer(GetInputArg(0))),IDropSource(Integer(GetInputArg(1))),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSetClipboard(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.OleGetClipboard(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleFlushClipboard;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleIsCurrentClipboard(IDataObject(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSetMenuDescriptor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),IOleInPlaceFrame(Integer(GetInputArg(3))),IOleInPlaceActiveObject(Integer(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleDestroyMenuDescriptor(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleDuplicateData(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleDraw(IUnknown(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleRun(IUnknown(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleLockRunning(IUnknown(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Ole2.CreateOleAdviseHolder(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Ole2.OleCreateDefaultHandler(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
AResult := Ole2.OleCreateEmbeddingHelper(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(Integer(GetInputArg(1))),VarToInteger(GetInputArg(2)),IClassFactory(Integer(GetInputArg(3))),TGUIDWrapper(integer(GetInputArg(4))).ObjToRec,Param5);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Ole2.OleGetIconOfFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleGetIconOfClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleMetafilePictFromIconAndLabel(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2))));
AResult := Ole2.OleRegGetUserType(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,WideCharToString(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Ole2.OleRegGetMiscStatus(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := Ole2.OleRegEnumFormatEtc(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := Ole2.OleRegEnumVerbs(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.GetHGlobalFromILockBytes(ILockBytes(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
AResult := Ole2.CreateILockBytesOnHGlobal(GetInputArg(0),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Ole2.GetHGlobalFromStream(IStream(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  ...
  begin
Param2 := IStream(Integer(GetInputArg(2)));
AResult := Ole2.CreateStreamOnHGlobal(GetInputArg(0),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.OleDoAutoConvert(IStorage(Integer(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Ole2.OleGetAutoConvert(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleSetAutoConvert(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,TGUIDWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.GetConvertStg(IStorage(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.SetConvertStg(IStorage(Integer(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('QueryInterface',2,tkVariant,nil,__IUnknownQueryInterface,false,0).SetVarArgs([1]);
  ...
  begin
    DefineMethod('CreateInstance',3,tkVariant,nil,__IClassFactoryCreateInstance,false,0).SetVarArgs([2]);
    DefineMethod('LockServer',1,tkVariant,nil,__IClassFactoryLockServer,false,0);
  end;
  With Scripter.DefineClass(IMarshal) do
  begin
    DefineMethod('UnmarshalInterface',3,tkVariant,nil,__IMarshalUnmarshalInterface,false,0).SetVarArgs([2]);
    DefineMethod('ReleaseMarshalData',1,tkVariant,nil,__IMarshalReleaseMarshalData,false,0);
    DefineMethod('DisconnectObject',1,tkVariant,nil,__IMarshalDisconnectObject,false,0);
  end;
  ...
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumUnknownSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumUnknownReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumUnknownClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IBindCtx) do
  begin
    DefineMethod('RegisterObjectBound',1,tkVariant,nil,__IBindCtxRegisterObjectBound,false,0);
    DefineMethod('RevokeObjectBound',1,tkVariant,nil,__IBindCtxRevokeObjectBound,false,0);
    DefineMethod('ReleaseBoundObjects',0,tkVariant,nil,__IBindCtxReleaseBoundObjects,false,0);
    DefineMethod('SetBindOptions',1,tkVariant,nil,__IBindCtxSetBindOptions,false,0).SetVarArgs([0]);
    DefineMethod('GetBindOptions',1,tkVariant,nil,__IBindCtxGetBindOptions,false,0).SetVarArgs([0]);
    DefineMethod('GetRunningObjectTable',1,tkVariant,nil,__IBindCtxGetRunningObjectTable,false,0).SetVarArgs([0]);
    DefineMethod('RegisterObjectParam',2,tkVariant,nil,__IBindCtxRegisterObjectParam,false,0);
    DefineMethod('GetObjectParam',2,tkVariant,nil,__IBindCtxGetObjectParam,false,0).SetVarArgs([1]);
    DefineMethod('EnumObjectParam',1,tkVariant,nil,__IBindCtxEnumObjectParam,false,0).SetVarArgs([0]);
    DefineMethod('RevokeObjectParam',1,tkVariant,nil,__IBindCtxRevokeObjectParam,false,0);
  end;
  With Scripter.DefineClass(IEnumMoniker) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumMonikerSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumMonikerReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumMonikerClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IRunnableObject) do
  begin
    DefineMethod('GetRunningClass',1,tkVariant,nil,__IRunnableObjectGetRunningClass,false,0).SetVarArgs([0]);
    DefineMethod('Run',1,tkVariant,nil,__IRunnableObjectRun,false,0);
    DefineMethod('IsRunning',0,tkVariant,nil,__IRunnableObjectIsRunning,false,0);
    DefineMethod('LockRunning',2,tkVariant,nil,__IRunnableObjectLockRunning,false,0);
    DefineMethod('SetContainedObject',1,tkVariant,nil,__IRunnableObjectSetContainedObject,false,0);
  end;
  With Scripter.DefineClass(IRunningObjectTable) do
  begin
    DefineMethod('Register',4,tkVariant,nil,__IRunningObjectTableRegister,false,0).SetVarArgs([1,3]);
    DefineMethod('Revoke',1,tkVariant,nil,__IRunningObjectTableRevoke,false,0);
    DefineMethod('IsRunning',1,tkVariant,nil,__IRunningObjectTableIsRunning,false,0);
    DefineMethod('GetObject',2,tkVariant,nil,__IRunningObjectTableGetObject,false,0).SetVarArgs([1]);
    DefineMethod('NoteChangeTime',2,tkVariant,nil,__IRunningObjectTableNoteChangeTime,false,0).SetVarArgs([1]);
    DefineMethod('GetTimeOfLastChange',2,tkVariant,nil,__IRunningObjectTableGetTimeOfLastChange,false,0).SetVarArgs([1]);
    DefineMethod('EnumRunning',1,tkVariant,nil,__IRunningObjectTableEnumRunning,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersist) do
  begin
    DefineMethod('GetClassID',1,tkVariant,nil,__IPersistGetClassID,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistStream) do
  begin
    DefineMethod('IsDirty',0,tkVariant,nil,__IPersistStreamIsDirty,false,0);
    DefineMethod('Load',1,tkVariant,nil,__IPersistStreamLoad,false,0);
    DefineMethod('Save',2,tkVariant,nil,__IPersistStreamSave,false,0);
    DefineMethod('GetSizeMax',1,tkVariant,nil,__IPersistStreamGetSizeMax,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IMoniker) do
  begin
    DefineMethod('BindToObject',4,tkVariant,nil,__IMonikerBindToObject,false,0).SetVarArgs([3]);
    DefineMethod('BindToStorage',4,tkVariant,nil,__IMonikerBindToStorage,false,0).SetVarArgs([3]);
    DefineMethod('Reduce',4,tkVariant,nil,__IMonikerReduce,false,0).SetVarArgs([2,3]);
    DefineMethod('ComposeWith',3,tkVariant,nil,__IMonikerComposeWith,false,0).SetVarArgs([2]);
    DefineMethod('Enum',2,tkVariant,nil,__IMonikerEnum,false,0).SetVarArgs([1]);
    DefineMethod('IsEqual',1,tkVariant,nil,__IMonikerIsEqual,false,0);
    DefineMethod('Hash',1,tkVariant,nil,__IMonikerHash,false,0).SetVarArgs([0]);
    DefineMethod('IsRunning',3,tkVariant,nil,__IMonikerIsRunning,false,0);
    DefineMethod('GetTimeOfLastChange',3,tkVariant,nil,__IMonikerGetTimeOfLastChange,false,0).SetVarArgs([2]);
    DefineMethod('Inverse',1,tkVariant,nil,__IMonikerInverse,false,0).SetVarArgs([0]);
    DefineMethod('CommonPrefixWith',2,tkVariant,nil,__IMonikerCommonPrefixWith,false,0).SetVarArgs([1]);
    DefineMethod('RelativePathTo',2,tkVariant,nil,__IMonikerRelativePathTo,false,0).SetVarArgs([1]);
    DefineMethod('GetDisplayName',3,tkVariant,nil,__IMonikerGetDisplayName,false,0).SetVarArgs([2]);
    DefineMethod('ParseDisplayName',5,tkVariant,nil,__IMonikerParseDisplayName,false,0).SetVarArgs([3,4]);
    DefineMethod('IsSystemMoniker',1,tkVariant,nil,__IMonikerIsSystemMoniker,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumString) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumStringSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumStringReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumStringClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IStream) do
  begin
    DefineMethod('Seek',3,tkVariant,nil,__IStreamSeek,false,0).SetVarArgs([2]);
    DefineMethod('SetSize',1,tkVariant,nil,__IStreamSetSize,false,0);
    DefineMethod('CopyTo',4,tkVariant,nil,__IStreamCopyTo,false,0).SetVarArgs([2,3]);
    DefineMethod('Commit',1,tkVariant,nil,__IStreamCommit,false,0);
    DefineMethod('Revert',0,tkVariant,nil,__IStreamRevert,false,0);
    DefineMethod('LockRegion',3,tkVariant,nil,__IStreamLockRegion,false,0);
    DefineMethod('UnlockRegion',3,tkVariant,nil,__IStreamUnlockRegion,false,0);
    DefineMethod('Stat',2,tkVariant,nil,__IStreamStat,false,0).SetVarArgs([0]);
    DefineMethod('Clone',1,tkVariant,nil,__IStreamClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumStatStg) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumStatStgSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumStatStgReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumStatStgClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IStorage) do
  begin
    DefineMethod('CreateStream',5,tkVariant,nil,__IStorageCreateStream,false,0).SetVarArgs([4]);
    DefineMethod('CreateStorage',5,tkVariant,nil,__IStorageCreateStorage,false,0).SetVarArgs([4]);
    DefineMethod('MoveElementTo',4,tkVariant,nil,__IStorageMoveElementTo,false,0);
    DefineMethod('Commit',1,tkVariant,nil,__IStorageCommit,false,0);
    DefineMethod('Revert',0,tkVariant,nil,__IStorageRevert,false,0);
    DefineMethod('DestroyElement',1,tkVariant,nil,__IStorageDestroyElement,false,0);
    DefineMethod('RenameElement',2,tkVariant,nil,__IStorageRenameElement,false,0);
    DefineMethod('SetElementTimes',4,tkVariant,nil,__IStorageSetElementTimes,false,0);
    DefineMethod('SetClass',1,tkVariant,nil,__IStorageSetClass,false,0);
    DefineMethod('SetStateBits',2,tkVariant,nil,__IStorageSetStateBits,false,0);
    DefineMethod('Stat',2,tkVariant,nil,__IStorageStat,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistFile) do
  begin
    DefineMethod('IsDirty',0,tkVariant,nil,__IPersistFileIsDirty,false,0);
    DefineMethod('Load',2,tkVariant,nil,__IPersistFileLoad,false,0);
    DefineMethod('Save',2,tkVariant,nil,__IPersistFileSave,false,0);
    DefineMethod('SaveCompleted',1,tkVariant,nil,__IPersistFileSaveCompleted,false,0);
    DefineMethod('GetCurFile',1,tkVariant,nil,__IPersistFileGetCurFile,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistStorage) do
  begin
    DefineMethod('IsDirty',0,tkVariant,nil,__IPersistStorageIsDirty,false,0);
    DefineMethod('InitNew',1,tkVariant,nil,__IPersistStorageInitNew,false,0);
    DefineMethod('Load',1,tkVariant,nil,__IPersistStorageLoad,false,0);
    DefineMethod('Save',2,tkVariant,nil,__IPersistStorageSave,false,0);
    DefineMethod('SaveCompleted',1,tkVariant,nil,__IPersistStorageSaveCompleted,false,0);
    DefineMethod('HandsOffStorage',0,tkVariant,nil,__IPersistStorageHandsOffStorage,false,0);
  end;
  With Scripter.DefineClass(ILockBytes) do
  begin
    DefineMethod('Flush',0,tkVariant,nil,__ILockBytesFlush,false,0);
    DefineMethod('SetSize',1,tkVariant,nil,__ILockBytesSetSize,false,0);
    DefineMethod('LockRegion',3,tkVariant,nil,__ILockBytesLockRegion,false,0);
    DefineMethod('UnlockRegion',3,tkVariant,nil,__ILockBytesUnlockRegion,false,0);
    DefineMethod('Stat',2,tkVariant,nil,__ILockBytesStat,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumFormatEtc) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumFormatEtcSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumFormatEtcReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumFormatEtcClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumStatData) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumStatDataSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumStatDataReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumStatDataClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IRootStorage) do
  begin
    DefineMethod('SwitchToFile',1,tkVariant,nil,__IRootStorageSwitchToFile,false,0);
  end;
  ...
  begin
    DefineMethod('GetData',2,tkVariant,nil,__IDataObjectGetData,false,0).SetVarArgs([0,1]);
    DefineMethod('GetDataHere',2,tkVariant,nil,__IDataObjectGetDataHere,false,0).SetVarArgs([0,1]);
    DefineMethod('QueryGetData',1,tkVariant,nil,__IDataObjectQueryGetData,false,0).SetVarArgs([0]);
    DefineMethod('GetCanonicalFormatEtc',2,tkVariant,nil,__IDataObjectGetCanonicalFormatEtc,false,0).SetVarArgs([0,1]);
    DefineMethod('SetData',3,tkVariant,nil,__IDataObjectSetData,false,0).SetVarArgs([0,1]);
    DefineMethod('EnumFormatEtc',2,tkVariant,nil,__IDataObjectEnumFormatEtc,false,0).SetVarArgs([1]);
    DefineMethod('DAdvise',4,tkVariant,nil,__IDataObjectDAdvise,false,0).SetVarArgs([0,3]);
    DefineMethod('DUnadvise',1,tkVariant,nil,__IDataObjectDUnadvise,false,0);
    DefineMethod('EnumDAdvise',1,tkVariant,nil,__IDataObjectEnumDAdvise,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IDataAdviseHolder) do
  begin
    DefineMethod('Advise',5,tkVariant,nil,__IDataAdviseHolderAdvise,false,0).SetVarArgs([1,4]);
    DefineMethod('Unadvise',1,tkVariant,nil,__IDataAdviseHolderUnadvise,false,0);
    DefineMethod('EnumAdvise',1,tkVariant,nil,__IDataAdviseHolderEnumAdvise,false,0).SetVarArgs([0]);
    DefineMethod('SendOnDataChange',3,tkVariant,nil,__IDataAdviseHolderSendOnDataChange,false,0);
  end;
  ...
  begin
    DefineMethod('GetBuffer',2,tkVariant,nil,__IRpcChannelBufferGetBuffer,false,0).SetVarArgs([0]);
    DefineMethod('SendReceive',2,tkVariant,nil,__IRpcChannelBufferSendReceive,false,0).SetVarArgs([0,1]);
    DefineMethod('FreeBuffer',1,tkVariant,nil,__IRpcChannelBufferFreeBuffer,false,0).SetVarArgs([0]);
    DefineMethod('GetDestCtx',2,tkVariant,nil,__IRpcChannelBufferGetDestCtx,false,0).SetVarArgs([0,1]);
    DefineMethod('IsConnected',0,tkVariant,nil,__IRpcChannelBufferIsConnected,false,0);
  end;
  With Scripter.DefineClass(IRpcProxyBuffer) do
  begin
    DefineMethod('Connect',1,tkVariant,nil,__IRpcProxyBufferConnect,false,0);
    DefineMethod('Disconnect',0,tkNone,nil,__IRpcProxyBufferDisconnect,false,0);
  end;
  With Scripter.DefineClass(IRpcStubBuffer) do
  begin
    DefineMethod('Connect',1,tkVariant,nil,__IRpcStubBufferConnect,false,0);
    DefineMethod('Disconnect',0,tkNone,nil,__IRpcStubBufferDisconnect,false,0);
    DefineMethod('Invoke',2,tkVariant,nil,__IRpcStubBufferInvoke,false,0).SetVarArgs([0]);
    ...
    DefineMethod('DebugServerQueryInterface',1,tkVariant,nil,__IRpcStubBufferDebugServerQueryInterface,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPSFactoryBuffer) do
  begin
    DefineMethod('CreateProxy',4,tkVariant,nil,__IPSFactoryBufferCreateProxy,false,0).SetVarArgs([2,3]);
    DefineMethod('CreateStub',3,tkVariant,nil,__IPSFactoryBufferCreateStub,false,0).SetVarArgs([2]);
  end;
  With Scripter.DefineClass(ICreateTypeInfo) do
  begin
    DefineMethod('SetGuid',1,tkVariant,nil,__ICreateTypeInfoSetGuid,false,0);
    DefineMethod('SetTypeFlags',1,tkVariant,nil,__ICreateTypeInfoSetTypeFlags,false,0);
    DefineMethod('SetDocString',1,tkVariant,nil,__ICreateTypeInfoSetDocString,false,0);
    DefineMethod('SetHelpContext',1,tkVariant,nil,__ICreateTypeInfoSetHelpContext,false,0);
    DefineMethod('SetVersion',2,tkVariant,nil,__ICreateTypeInfoSetVersion,false,0);
    DefineMethod('AddRefTypeInfo',2,tkVariant,nil,__ICreateTypeInfoAddRefTypeInfo,false,0).SetVarArgs([1]);
    DefineMethod('AddFuncDesc',2,tkVariant,nil,__ICreateTypeInfoAddFuncDesc,false,0).SetVarArgs([1]);
    DefineMethod('AddImplType',2,tkVariant,nil,__ICreateTypeInfoAddImplType,false,0);
    DefineMethod('SetImplTypeFlags',2,tkVariant,nil,__ICreateTypeInfoSetImplTypeFlags,false,0);
    DefineMethod('SetAlignment',1,tkVariant,nil,__ICreateTypeInfoSetAlignment,false,0);
    DefineMethod('SetSchema',1,tkVariant,nil,__ICreateTypeInfoSetSchema,false,0);
    DefineMethod('AddVarDesc',2,tkVariant,nil,__ICreateTypeInfoAddVarDesc,false,0).SetVarArgs([1]);
    DefineMethod('SetVarName',2,tkVariant,nil,__ICreateTypeInfoSetVarName,false,0);
    DefineMethod('SetTypeDescAlias',1,tkVariant,nil,__ICreateTypeInfoSetTypeDescAlias,false,0).SetVarArgs([0]);
    DefineMethod('DefineFuncAsDllEntry',3,tkVariant,nil,__ICreateTypeInfoDefineFuncAsDllEntry,false,0);
    DefineMethod('SetFuncDocString',2,tkVariant,nil,__ICreateTypeInfoSetFuncDocString,false,0);
    DefineMethod('SetVarDocString',2,tkVariant,nil,__ICreateTypeInfoSetVarDocString,false,0);
    DefineMethod('SetFuncHelpContext',2,tkVariant,nil,__ICreateTypeInfoSetFuncHelpContext,false,0);
    DefineMethod('SetVarHelpContext',2,tkVariant,nil,__ICreateTypeInfoSetVarHelpContext,false,0);
    DefineMethod('SetMops',2,tkVariant,nil,__ICreateTypeInfoSetMops,false,0);
    DefineMethod('SetTypeIdldesc',1,tkVariant,nil,__ICreateTypeInfoSetTypeIdldesc,false,0).SetVarArgs([0]);
    DefineMethod('LayOut',0,tkVariant,nil,__ICreateTypeInfoLayOut,false,0);
  end;
  With Scripter.DefineClass(ICreateTypeLib) do
  begin
    DefineMethod('CreateTypeInfo',3,tkVariant,nil,__ICreateTypeLibCreateTypeInfo,false,0).SetVarArgs([2]);
    DefineMethod('SetName',1,tkVariant,nil,__ICreateTypeLibSetName,false,0);
    DefineMethod('SetVersion',2,tkVariant,nil,__ICreateTypeLibSetVersion,false,0);
    DefineMethod('SetGuid',1,tkVariant,nil,__ICreateTypeLibSetGuid,false,0);
    DefineMethod('SetDocString',1,tkVariant,nil,__ICreateTypeLibSetDocString,false,0);
    DefineMethod('SetHelpFileName',1,tkVariant,nil,__ICreateTypeLibSetHelpFileName,false,0);
    DefineMethod('SetHelpContext',1,tkVariant,nil,__ICreateTypeLibSetHelpContext,false,0);
    DefineMethod('SetLcid',1,tkVariant,nil,__ICreateTypeLibSetLcid,false,0);
    DefineMethod('SetLibFlags',1,tkVariant,nil,__ICreateTypeLibSetLibFlags,false,0);
    DefineMethod('SaveAllChanges',0,tkVariant,nil,__ICreateTypeLibSaveAllChanges,false,0);
  end;
  With Scripter.DefineClass(IDispatch) do
  begin
    DefineMethod('GetTypeInfoCount',1,tkVariant,nil,__IDispatchGetTypeInfoCount,false,0).SetVarArgs([0]);
    DefineMethod('GetTypeInfo',3,tkVariant,nil,__IDispatchGetTypeInfo,false,0).SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IEnumVariant) do
  begin
    DefineMethod('Next',3,tkVariant,nil,__IEnumVariantNext,false,0).SetVarArgs([1,2]);
    DefineMethod('Skip',1,tkVariant,nil,__IEnumVariantSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumVariantReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumVariantClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(ITypeComp) do
  begin
    DefineMethod('Bind',6,tkVariant,nil,__ITypeCompBind,false,0).SetVarArgs([3,4,5]);
    DefineMethod('BindType',4,tkVariant,nil,__ITypeCompBindType,false,0).SetVarArgs([2,3]);
  end;
  With Scripter.DefineClass(ITypeInfo) do
  begin
    DefineMethod('GetTypeComp',1,tkVariant,nil,__ITypeInfoGetTypeComp,false,0).SetVarArgs([0]);
    DefineMethod('GetRefTypeOfImplType',2,tkVariant,nil,__ITypeInfoGetRefTypeOfImplType,false,0).SetVarArgs([1]);
    DefineMethod('GetImplTypeFlags',2,tkVariant,nil,__ITypeInfoGetImplTypeFlags,false,0).SetVarArgs([1]);
    DefineMethod('GetDllEntry',5,tkVariant,nil,__ITypeInfoGetDllEntry,false,0).SetVarArgs([2,3,4]);
    DefineMethod('GetRefTypeInfo',2,tkVariant,nil,__ITypeInfoGetRefTypeInfo,false,0).SetVarArgs([1]);
    DefineMethod('CreateInstance',3,tkVariant,nil,__ITypeInfoCreateInstance,false,0).SetVarArgs([2]);
    DefineMethod('GetMops',2,tkVariant,nil,__ITypeInfoGetMops,false,0).SetVarArgs([1]);
    DefineMethod('GetContainingTypeLib',2,tkVariant,nil,__ITypeInfoGetContainingTypeLib,false,0).SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(ITypeLib) do
  begin
    DefineMethod('GetTypeInfoCount',0,tkInteger,nil,__ITypeLibGetTypeInfoCount,false,0);
    DefineMethod('GetTypeInfo',2,tkVariant,nil,__ITypeLibGetTypeInfo,false,0).SetVarArgs([1]);
    DefineMethod('GetTypeInfoType',2,tkVariant,nil,__ITypeLibGetTypeInfoType,false,0).SetVarArgs([1]);
    DefineMethod('GetTypeInfoOfGuid',2,tkVariant,nil,__ITypeLibGetTypeInfoOfGuid,false,0).SetVarArgs([1]);
    DefineMethod('GetTypeComp',1,tkVariant,nil,__ITypeLibGetTypeComp,false,0).SetVarArgs([0]);
    DefineMethod('IsName',3,tkVariant,nil,__ITypeLibIsName,false,0).SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IErrorInfo) do
  begin
    DefineMethod('GetGUID',1,tkVariant,nil,__IErrorInfoGetGUID,false,0).SetVarArgs([0]);
    DefineMethod('GetSource',1,tkVariant,nil,__IErrorInfoGetSource,false,0).SetVarArgs([0]);
    DefineMethod('GetDescription',1,tkVariant,nil,__IErrorInfoGetDescription,false,0).SetVarArgs([0]);
    DefineMethod('GetHelpFile',1,tkVariant,nil,__IErrorInfoGetHelpFile,false,0).SetVarArgs([0]);
    DefineMethod('GetHelpContext',1,tkVariant,nil,__IErrorInfoGetHelpContext,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(ICreateErrorInfo) do
  begin
    DefineMethod('SetGUID',1,tkVariant,nil,__ICreateErrorInfoSetGUID,false,0);
    DefineMethod('SetSource',1,tkVariant,nil,__ICreateErrorInfoSetSource,false,0);
    DefineMethod('SetDescription',1,tkVariant,nil,__ICreateErrorInfoSetDescription,false,0);
    DefineMethod('SetHelpFile',1,tkVariant,nil,__ICreateErrorInfoSetHelpFile,false,0);
    DefineMethod('SetHelpContext',1,tkVariant,nil,__ICreateErrorInfoSetHelpContext,false,0);
  end;
  With Scripter.DefineClass(ISupportErrorInfo) do
  begin
    DefineMethod('InterfaceSupportsErrorInfo',1,tkVariant,nil,__ISupportErrorInfoInterfaceSupportsErrorInfo,false,0);
  end;
  With Scripter.DefineClass(IOleAdviseHolder) do
  begin
    DefineMethod('Advise',2,tkVariant,nil,__IOleAdviseHolderAdvise,false,0).SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkVariant,nil,__IOleAdviseHolderUnadvise,false,0);
    DefineMethod('EnumAdvise',1,tkVariant,nil,__IOleAdviseHolderEnumAdvise,false,0).SetVarArgs([0]);
    DefineMethod('SendOnRename',1,tkVariant,nil,__IOleAdviseHolderSendOnRename,false,0);
    DefineMethod('SendOnSave',0,tkVariant,nil,__IOleAdviseHolderSendOnSave,false,0);
    DefineMethod('SendOnClose',0,tkVariant,nil,__IOleAdviseHolderSendOnClose,false,0);
  end;
  With Scripter.DefineClass(IOleCache) do
  begin
    DefineMethod('Cache',3,tkVariant,nil,__IOleCacheCache,false,0).SetVarArgs([0,2]);
    DefineMethod('Uncache',1,tkVariant,nil,__IOleCacheUncache,false,0);
    DefineMethod('EnumCache',1,tkVariant,nil,__IOleCacheEnumCache,false,0).SetVarArgs([0]);
    DefineMethod('InitCache',1,tkVariant,nil,__IOleCacheInitCache,false,0);
    DefineMethod('SetData',3,tkVariant,nil,__IOleCacheSetData,false,0).SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(IOleCache2) do
  begin
    DefineMethod('DiscardCache',1,tkVariant,nil,__IOleCache2DiscardCache,false,0);
  end;
  With Scripter.DefineClass(IOleCacheControl) do
  begin
    DefineMethod('OnRun',1,tkVariant,nil,__IOleCacheControlOnRun,false,0);
    DefineMethod('OnStop',0,tkVariant,nil,__IOleCacheControlOnStop,false,0);
  end;
  With Scripter.DefineClass(IParseDisplayName) do
  begin
    DefineMethod('ParseDisplayName',4,tkVariant,nil,__IParseDisplayNameParseDisplayName,false,0).SetVarArgs([2,3]);
  end;
  With Scripter.DefineClass(IOleContainer) do
  begin
    DefineMethod('EnumObjects',2,tkVariant,nil,__IOleContainerEnumObjects,false,0).SetVarArgs([1]);
    DefineMethod('LockContainer',1,tkVariant,nil,__IOleContainerLockContainer,false,0);
  end;
  With Scripter.DefineClass(IOleClientSite) do
  begin
    DefineMethod('SaveObject',0,tkVariant,nil,__IOleClientSiteSaveObject,false,0);
    DefineMethod('GetMoniker',3,tkVariant,nil,__IOleClientSiteGetMoniker,false,0).SetVarArgs([2]);
    DefineMethod('GetContainer',1,tkVariant,nil,__IOleClientSiteGetContainer,false,0).SetVarArgs([0]);
    DefineMethod('ShowObject',0,tkVariant,nil,__IOleClientSiteShowObject,false,0);
    DefineMethod('OnShowWindow',1,tkVariant,nil,__IOleClientSiteOnShowWindow,false,0);
    DefineMethod('RequestNewObjectLayout',0,tkVariant,nil,__IOleClientSiteRequestNewObjectLayout,false,0);
  end;
  With Scripter.DefineClass(IOleObject) do
  begin
    DefineMethod('SetClientSite',1,tkVariant,nil,__IOleObjectSetClientSite,false,0);
    DefineMethod('GetClientSite',1,tkVariant,nil,__IOleObjectGetClientSite,false,0).SetVarArgs([0]);
    DefineMethod('SetHostNames',2,tkVariant,nil,__IOleObjectSetHostNames,false,0);
    DefineMethod('Close',1,tkVariant,nil,__IOleObjectClose,false,0);
    DefineMethod('SetMoniker',2,tkVariant,nil,__IOleObjectSetMoniker,false,0);
    DefineMethod('GetMoniker',3,tkVariant,nil,__IOleObjectGetMoniker,false,0).SetVarArgs([2]);
    DefineMethod('InitFromData',3,tkVariant,nil,__IOleObjectInitFromData,false,0);
    DefineMethod('GetClipboardData',2,tkVariant,nil,__IOleObjectGetClipboardData,false,0).SetVarArgs([1]);
    DefineMethod('EnumVerbs',1,tkVariant,nil,__IOleObjectEnumVerbs,false,0).SetVarArgs([0]);
    DefineMethod('Update',0,tkVariant,nil,__IOleObjectUpdate,false,0);
    DefineMethod('IsUpToDate',0,tkVariant,nil,__IOleObjectIsUpToDate,false,0);
    DefineMethod('GetUserClassID',1,tkVariant,nil,__IOleObjectGetUserClassID,false,0).SetVarArgs([0]);
    DefineMethod('GetUserType',2,tkVariant,nil,__IOleObjectGetUserType,false,0).SetVarArgs([1]);
    DefineMethod('SetExtent',2,tkVariant,nil,__IOleObjectSetExtent,false,0);
    DefineMethod('GetExtent',2,tkVariant,nil,__IOleObjectGetExtent,false,0).SetVarArgs([1]);
    DefineMethod('Advise',2,tkVariant,nil,__IOleObjectAdvise,false,0).SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkVariant,nil,__IOleObjectUnadvise,false,0);
    DefineMethod('EnumAdvise',1,tkVariant,nil,__IOleObjectEnumAdvise,false,0).SetVarArgs([0]);
    DefineMethod('GetMiscStatus',2,tkVariant,nil,__IOleObjectGetMiscStatus,false,0).SetVarArgs([1]);
    DefineMethod('SetColorScheme',1,tkVariant,nil,__IOleObjectSetColorScheme,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleWindow) do
  begin
    DefineMethod('GetWindow',1,tkVariant,nil,__IOleWindowGetWindow,false,0).SetVarArgs([0]);
    DefineMethod('ContextSensitiveHelp',1,tkVariant,nil,__IOleWindowContextSensitiveHelp,false,0);
  end;
  With Scripter.DefineClass(IOleLink) do
  begin
    DefineMethod('SetUpdateOptions',1,tkVariant,nil,__IOleLinkSetUpdateOptions,false,0);
    DefineMethod('GetUpdateOptions',1,tkVariant,nil,__IOleLinkGetUpdateOptions,false,0).SetVarArgs([0]);
    DefineMethod('SetSourceMoniker',2,tkVariant,nil,__IOleLinkSetSourceMoniker,false,0);
    DefineMethod('GetSourceMoniker',1,tkVariant,nil,__IOleLinkGetSourceMoniker,false,0).SetVarArgs([0]);
    DefineMethod('SetSourceDisplayName',1,tkVariant,nil,__IOleLinkSetSourceDisplayName,false,0);
    DefineMethod('GetSourceDisplayName',1,tkVariant,nil,__IOleLinkGetSourceDisplayName,false,0).SetVarArgs([0]);
    DefineMethod('BindToSource',2,tkVariant,nil,__IOleLinkBindToSource,false,0);
    DefineMethod('BindIfRunning',0,tkVariant,nil,__IOleLinkBindIfRunning,false,0);
    DefineMethod('GetBoundSource',1,tkVariant,nil,__IOleLinkGetBoundSource,false,0).SetVarArgs([0]);
    DefineMethod('UnbindSource',0,tkVariant,nil,__IOleLinkUnbindSource,false,0);
    DefineMethod('Update',1,tkVariant,nil,__IOleLinkUpdate,false,0);
  end;
  With Scripter.DefineClass(IOleItemContainer) do
  begin
    DefineMethod('GetObject',5,tkVariant,nil,__IOleItemContainerGetObject,false,0).SetVarArgs([4]);
    DefineMethod('GetObjectStorage',4,tkVariant,nil,__IOleItemContainerGetObjectStorage,false,0).SetVarArgs([3]);
    DefineMethod('IsRunning',1,tkVariant,nil,__IOleItemContainerIsRunning,false,0);
  end;
  With Scripter.DefineClass(IOleInPlaceUIWindow) do
  begin
    DefineMethod('GetBorder',1,tkVariant,nil,__IOleInPlaceUIWindowGetBorder,false,0).SetVarArgs([0]);
    DefineMethod('RequestBorderSpace',1,tkVariant,nil,__IOleInPlaceUIWindowRequestBorderSpace,false,0);
    DefineMethod('SetActiveObject',2,tkVariant,nil,__IOleInPlaceUIWindowSetActiveObject,false,0);
  end;
  With Scripter.DefineClass(IOleInPlaceActiveObject) do
  begin
    DefineMethod('TranslateAccelerator',1,tkVariant,nil,__IOleInPlaceActiveObjectTranslateAccelerator,false,0).SetVarArgs([0]);
    DefineMethod('OnFrameWindowActivate',1,tkVariant,nil,__IOleInPlaceActiveObjectOnFrameWindowActivate,false,0);
    DefineMethod('OnDocWindowActivate',1,tkVariant,nil,__IOleInPlaceActiveObjectOnDocWindowActivate,false,0);
    DefineMethod('ResizeBorder',3,tkVariant,nil,__IOleInPlaceActiveObjectResizeBorder,false,0);
    DefineMethod('EnableModeless',1,tkVariant,nil,__IOleInPlaceActiveObjectEnableModeless,false,0);
  end;
  With Scripter.DefineClass(IOleInPlaceFrame) do
  begin
    DefineMethod('InsertMenus',2,tkVariant,nil,__IOleInPlaceFrameInsertMenus,false,0).SetVarArgs([1]);
    DefineMethod('SetMenu',3,tkVariant,nil,__IOleInPlaceFrameSetMenu,false,0);
    DefineMethod('RemoveMenus',1,tkVariant,nil,__IOleInPlaceFrameRemoveMenus,false,0);
    DefineMethod('SetStatusText',1,tkVariant,nil,__IOleInPlaceFrameSetStatusText,false,0);
    DefineMethod('EnableModeless',1,tkVariant,nil,__IOleInPlaceFrameEnableModeless,false,0);
    DefineMethod('TranslateAccelerator',2,tkVariant,nil,__IOleInPlaceFrameTranslateAccelerator,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleInPlaceObject) do
  begin
    DefineMethod('InPlaceDeactivate',0,tkVariant,nil,__IOleInPlaceObjectInPlaceDeactivate,false,0);
    DefineMethod('UIDeactivate',0,tkVariant,nil,__IOleInPlaceObjectUIDeactivate,false,0);
    DefineMethod('SetObjectRects',2,tkVariant,nil,__IOleInPlaceObjectSetObjectRects,false,0);
    DefineMethod('ReactivateAndUndo',0,tkVariant,nil,__IOleInPlaceObjectReactivateAndUndo,false,0);
  end;
  With Scripter.DefineClass(IOleInPlaceSite) do
  begin
    DefineMethod('CanInPlaceActivate',0,tkVariant,nil,__IOleInPlaceSiteCanInPlaceActivate,false,0);
    DefineMethod('OnInPlaceActivate',0,tkVariant,nil,__IOleInPlaceSiteOnInPlaceActivate,false,0);
    DefineMethod('OnUIActivate',0,tkVariant,nil,__IOleInPlaceSiteOnUIActivate,false,0);
    DefineMethod('GetWindowContext',5,tkVariant,nil,__IOleInPlaceSiteGetWindowContext,false,0).SetVarArgs([0,1,2,3,4]);
    DefineMethod('Scroll',1,tkVariant,nil,__IOleInPlaceSiteScroll,false,0);
    DefineMethod('OnUIDeactivate',1,tkVariant,nil,__IOleInPlaceSiteOnUIDeactivate,false,0);
    DefineMethod('OnInPlaceDeactivate',0,tkVariant,nil,__IOleInPlaceSiteOnInPlaceDeactivate,false,0);
    DefineMethod('DiscardUndoState',0,tkVariant,nil,__IOleInPlaceSiteDiscardUndoState,false,0);
    DefineMethod('DeactivateAndUndo',0,tkVariant,nil,__IOleInPlaceSiteDeactivateAndUndo,false,0);
    DefineMethod('OnPosRectChange',1,tkVariant,nil,__IOleInPlaceSiteOnPosRectChange,false,0);
  end;
  With Scripter.DefineClass(IViewObject) do
  begin
    DefineMethod('Unfreeze',1,tkVariant,nil,__IViewObjectUnfreeze,false,0);
    DefineMethod('SetAdvise',3,tkVariant,nil,__IViewObjectSetAdvise,false,0);
  end;
  ...
  begin
    DefineMethod('QueryContinueDrag',2,tkVariant,nil,__IDropSourceQueryContinueDrag,false,0);
    DefineMethod('GiveFeedback',1,tkVariant,nil,__IDropSourceGiveFeedback,false,0);
  end;
  With Scripter.DefineClass(IDropTarget) do
  begin
    DefineMethod('DragEnter',4,tkVariant,nil,__IDropTargetDragEnter,false,0).SetVarArgs([3]);
    DefineMethod('DragOver',3,tkVariant,nil,__IDropTargetDragOver,false,0).SetVarArgs([2]);
    DefineMethod('DragLeave',0,tkVariant,nil,__IDropTargetDragLeave,false,0);
    DefineMethod('Drop',4,tkVariant,nil,__IDropTargetDrop,false,0).SetVarArgs([3]);
  end;
  With Scripter.DefineClass(IEnumOleVerb) do
  begin
    DefineMethod('Skip',1,tkVariant,nil,__IEnumOleVerbSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumOleVerbReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumOleVerbClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleDocumentView) do
  begin
    DefineMethod('SetInPlaceSite',1,tkVariant,nil,__IOleDocumentViewSetInPlaceSite,false,0);
    DefineMethod('GetInPlaceSite',1,tkVariant,nil,__IOleDocumentViewGetInPlaceSite,false,0).SetVarArgs([0]);
    DefineMethod('GetDocument',1,tkVariant,nil,__IOleDocumentViewGetDocument,false,0).SetVarArgs([0]);
    DefineMethod('SetRect',1,tkVariant,nil,__IOleDocumentViewSetRect,false,0);
    DefineMethod('GetRect',1,tkVariant,nil,__IOleDocumentViewGetRect,false,0).SetVarArgs([0]);
    DefineMethod('SetRectComplex',4,tkVariant,nil,__IOleDocumentViewSetRectComplex,false,0);
    DefineMethod('Show',1,tkVariant,nil,__IOleDocumentViewShow,false,0);
    DefineMethod('UIActivate',1,tkVariant,nil,__IOleDocumentViewUIActivate,false,0);
    DefineMethod('Open',0,tkVariant,nil,__IOleDocumentViewOpen,false,0);
    DefineMethod('CloseView',1,tkVariant,nil,__IOleDocumentViewCloseView,false,0);
    DefineMethod('SaveViewState',1,tkVariant,nil,__IOleDocumentViewSaveViewState,false,0);
    DefineMethod('ApplyViewState',1,tkVariant,nil,__IOleDocumentViewApplyViewState,false,0);
    DefineMethod('Clone',2,tkVariant,nil,__IOleDocumentViewClone,false,0).SetVarArgs([1]);
  end;
  With Scripter.DefineClass(IEnumOleDocumentViews) do
  begin
    DefineMethod('Next',3,tkVariant,nil,__IEnumOleDocumentViewsNext,false,0).SetVarArgs([1,2]);
    DefineMethod('Skip',1,tkVariant,nil,__IEnumOleDocumentViewsSkip,false,0);
    DefineMethod('Reset',0,tkVariant,nil,__IEnumOleDocumentViewsReset,false,0);
    DefineMethod('Clone',1,tkVariant,nil,__IEnumOleDocumentViewsClone,false,0).SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleDocument) do
  begin
    DefineMethod('CreateView',4,tkVariant,nil,__IOleDocumentCreateView,false,0).SetVarArgs([3]);
    DefineMethod('GetDocMiscStatus',1,tkVariant,nil,__IOleDocumentGetDocMiscStatus,false,0).SetVarArgs([0]);
    DefineMethod('EnumViews',2,tkVariant,nil,__IOleDocumentEnumViews,false,0).SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(IOleDocumentSite) do
  begin
    DefineMethod('ActivateMe',1,tkVariant,nil,__IOleDocumentSiteActivateMe,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('MakeResult',3,tkVariant,nil,__MakeResult,false,0);
    ...
    DefineMethod('CoGetMalloc',2,tkVariant,nil,__CoGetMalloc,false,0).SetVarArgs([1]);
    DefineMethod('CoGetCurrentProcess',0,tkInteger,nil,__CoGetCurrentProcess,false,0);
    DefineMethod('CoRegisterMallocSpy',1,tkVariant,nil,__CoRegisterMallocSpy,false,0);
    DefineMethod('CoRevokeMallocSpy',0,tkVariant,nil,__CoRevokeMallocSpy,false,0);
    DefineMethod('CoRegisterClassObject',5,tkVariant,nil,__CoRegisterClassObject,false,0).SetVarArgs([4]);
    DefineMethod('CoRevokeClassObject',1,tkVariant,nil,__CoRevokeClassObject,false,0);
    DefineMethod('CoUnmarshalInterface',3,tkVariant,nil,__CoUnmarshalInterface,false,0).SetVarArgs([2]);
    DefineMethod('CoReleaseMarshalData',1,tkVariant,nil,__CoReleaseMarshalData,false,0);
    DefineMethod('CoDisconnectObject',2,tkVariant,nil,__CoDisconnectObject,false,0);
    DefineMethod('CoLockObjectExternal',3,tkVariant,nil,__CoLockObjectExternal,false,0);
    DefineMethod('CoIsHandlerConnected',1,tkVariant,nil,__CoIsHandlerConnected,false,0);
    DefineMethod('CoMarshalInterThreadInterfaceInStream',3,tkVariant,nil,__CoMarshalInterThreadInterfaceInStream,false,0).SetVarArgs([2]);
    DefineMethod('CoGetInterfaceAndReleaseStream',3,tkVariant,nil,__CoGetInterfaceAndReleaseStream,false,0).SetVarArgs([2]);
    DefineMethod('CoCreateFreeThreadedMarshaler',2,tkVariant,nil,__CoCreateFreeThreadedMarshaler,false,0).SetVarArgs([1]);
    DefineMethod('CoLoadLibrary',2,tkVariant,nil,__CoLoadLibrary,false,0);
    ...
    DefineMethod('CoCreateInstance',5,tkVariant,nil,__CoCreateInstance,false,0).SetVarArgs([4]);
    DefineMethod('StringFromCLSID',2,tkVariant,nil,__StringFromCLSID,false,0).SetVarArgs([1]);
    DefineMethod('CLSIDFromString',2,tkVariant,nil,__CLSIDFromString,false,0).SetVarArgs([1]);
    DefineMethod('StringFromIID',2,tkVariant,nil,__StringFromIID,false,0).SetVarArgs([1]);
    DefineMethod('IIDFromString',2,tkVariant,nil,__IIDFromString,false,0).SetVarArgs([1]);
    DefineMethod('CoIsOle1Class',1,tkVariant,nil,__CoIsOle1Class,false,0);
    DefineMethod('ProgIDFromCLSID',2,tkVariant,nil,__ProgIDFromCLSID,false,0).SetVarArgs([1]);
    DefineMethod('CLSIDFromProgID',2,tkVariant,nil,__CLSIDFromProgID,false,0).SetVarArgs([1]);
    DefineMethod('StringFromGUID2',3,tkInteger,nil,__StringFromGUID2,false,0);
    DefineMethod('CoCreateGuid',1,tkVariant,nil,__CoCreateGuid,false,0).SetVarArgs([0]);
    ...
    DefineMethod('CoFileTimeNow',1,tkVariant,nil,__CoFileTimeNow,false,0).SetVarArgs([0]);
    DefineMethod('CoRegisterMessageFilter',2,tkVariant,nil,__CoRegisterMessageFilter,false,0).SetVarArgs([1]);
    DefineMethod('CoGetTreatAsClass',2,tkVariant,nil,__CoGetTreatAsClass,false,0).SetVarArgs([1]);
    DefineMethod('CoTreatAsClass',2,tkVariant,nil,__CoTreatAsClass,false,0);
    DefineMethod('CreateDataAdviseHolder',1,tkVariant,nil,__CreateDataAdviseHolder,false,0).SetVarArgs([0]);
    DefineMethod('CreateDataCache',4,tkVariant,nil,__CreateDataCache,false,0).SetVarArgs([3]);
    DefineMethod('StgCreateDocfile',4,tkVariant,nil,__StgCreateDocfile,false,0).SetVarArgs([3]);
    DefineMethod('StgCreateDocfileOnILockBytes',4,tkVariant,nil,__StgCreateDocfileOnILockBytes,false,0).SetVarArgs([3]);
    DefineMethod('StgIsStorageFile',1,tkVariant,nil,__StgIsStorageFile,false,0);
    DefineMethod('StgIsStorageILockBytes',1,tkVariant,nil,__StgIsStorageILockBytes,false,0);
    DefineMethod('StgSetTimes',4,tkVariant,nil,__StgSetTimes,false,0);
    DefineMethod('BindMoniker',4,tkVariant,nil,__BindMoniker,false,0).SetVarArgs([3]);
    DefineMethod('MkParseDisplayName',4,tkVariant,nil,__MkParseDisplayName,false,0).SetVarArgs([2,3]);
    DefineMethod('MonikerRelativePathTo',4,tkVariant,nil,__MonikerRelativePathTo,false,0).SetVarArgs([2]);
    DefineMethod('MonikerCommonPrefixWith',3,tkVariant,nil,__MonikerCommonPrefixWith,false,0).SetVarArgs([2]);
    DefineMethod('CreateBindCtx',2,tkVariant,nil,__CreateBindCtx,false,0).SetVarArgs([1]);
    DefineMethod('CreateGenericComposite',3,tkVariant,nil,__CreateGenericComposite,false,0).SetVarArgs([2]);
    DefineMethod('GetClassFile',2,tkVariant,nil,__GetClassFile,false,0).SetVarArgs([1]);
    DefineMethod('CreateFileMoniker',2,tkVariant,nil,__CreateFileMoniker,false,0).SetVarArgs([1]);
    DefineMethod('CreateItemMoniker',3,tkVariant,nil,__CreateItemMoniker,false,0).SetVarArgs([2]);
    DefineMethod('CreateAntiMoniker',1,tkVariant,nil,__CreateAntiMoniker,false,0).SetVarArgs([0]);
    DefineMethod('CreatePointerMoniker',2,tkVariant,nil,__CreatePointerMoniker,false,0).SetVarArgs([1]);
    DefineMethod('GetRunningObjectTable',2,tkVariant,nil,__GetRunningObjectTable,false,0).SetVarArgs([1]);
    ...
    DefineMethod('VariantClear',1,tkVariant,nil,__VariantClear,false,0).SetVarArgs([0]);
    DefineMethod('VariantCopy',2,tkVariant,nil,__VariantCopy,false,0).SetVarArgs([0]);
    DefineMethod('VariantCopyInd',2,tkVariant,nil,__VariantCopyInd,false,0).SetVarArgs([0]);
    DefineMethod('VariantChangeType',4,tkVariant,nil,__VariantChangeType,false,0).SetVarArgs([0]);
    DefineMethod('VariantChangeTypeEx',5,tkVariant,nil,__VariantChangeTypeEx,false,0).SetVarArgs([0]);
    DefineMethod('VarUI1FromI2',2,tkVariant,nil,__VarUI1FromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromI4',2,tkVariant,nil,__VarUI1FromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromR4',2,tkVariant,nil,__VarUI1FromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromR8',2,tkVariant,nil,__VarUI1FromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromCy',2,tkVariant,nil,__VarUI1FromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromDate',2,tkVariant,nil,__VarUI1FromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarUI1FromStr',4,tkVariant,nil,__VarUI1FromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarUI1FromDisp',3,tkVariant,nil,__VarUI1FromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarUI1FromBool',2,tkVariant,nil,__VarUI1FromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromUI1',2,tkVariant,nil,__VarI2FromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromI4',2,tkVariant,nil,__VarI2FromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromR4',2,tkVariant,nil,__VarI2FromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromR8',2,tkVariant,nil,__VarI2FromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromCy',2,tkVariant,nil,__VarI2FromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromDate',2,tkVariant,nil,__VarI2FromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarI2FromStr',4,tkVariant,nil,__VarI2FromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarI2FromDisp',3,tkVariant,nil,__VarI2FromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarI2FromBool',2,tkVariant,nil,__VarI2FromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromUI1',2,tkVariant,nil,__VarI4FromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromI2',2,tkVariant,nil,__VarI4FromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromR4',2,tkVariant,nil,__VarI4FromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromR8',2,tkVariant,nil,__VarI4FromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromCy',2,tkVariant,nil,__VarI4FromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromDate',2,tkVariant,nil,__VarI4FromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarI4FromStr',4,tkVariant,nil,__VarI4FromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarI4FromDisp',3,tkVariant,nil,__VarI4FromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarI4FromBool',2,tkVariant,nil,__VarI4FromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromUI1',2,tkVariant,nil,__VarR4FromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromI2',2,tkVariant,nil,__VarR4FromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromI4',2,tkVariant,nil,__VarR4FromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromR8',2,tkVariant,nil,__VarR4FromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromCy',2,tkVariant,nil,__VarR4FromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromDate',2,tkVariant,nil,__VarR4FromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarR4FromStr',4,tkVariant,nil,__VarR4FromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarR4FromDisp',3,tkVariant,nil,__VarR4FromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarR4FromBool',2,tkVariant,nil,__VarR4FromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromUI1',2,tkVariant,nil,__VarR8FromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromI2',2,tkVariant,nil,__VarR8FromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromI4',2,tkVariant,nil,__VarR8FromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromR4',2,tkVariant,nil,__VarR8FromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromCy',2,tkVariant,nil,__VarR8FromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromDate',2,tkVariant,nil,__VarR8FromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarR8FromStr',4,tkVariant,nil,__VarR8FromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarR8FromDisp',3,tkVariant,nil,__VarR8FromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarR8FromBool',2,tkVariant,nil,__VarR8FromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromUI1',2,tkVariant,nil,__VarDateFromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromI2',2,tkVariant,nil,__VarDateFromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromI4',2,tkVariant,nil,__VarDateFromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromR4',2,tkVariant,nil,__VarDateFromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromR8',2,tkVariant,nil,__VarDateFromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromCy',2,tkVariant,nil,__VarDateFromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarDateFromStr',4,tkVariant,nil,__VarDateFromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarDateFromDisp',3,tkVariant,nil,__VarDateFromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarDateFromBool',2,tkVariant,nil,__VarDateFromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromUI1',2,tkVariant,nil,__VarCyFromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromI2',2,tkVariant,nil,__VarCyFromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromI4',2,tkVariant,nil,__VarCyFromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromR4',2,tkVariant,nil,__VarCyFromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromR8',2,tkVariant,nil,__VarCyFromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromDate',2,tkVariant,nil,__VarCyFromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarCyFromStr',4,tkVariant,nil,__VarCyFromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarCyFromDisp',3,tkVariant,nil,__VarCyFromDisp,false,0).SetVarArgs([2]);
    DefineMethod('VarCyFromBool',2,tkVariant,nil,__VarCyFromBool,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromUI1',2,tkVariant,nil,__VarBoolFromUI1,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromI2',2,tkVariant,nil,__VarBoolFromI2,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromI4',2,tkVariant,nil,__VarBoolFromI4,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromR4',2,tkVariant,nil,__VarBoolFromR4,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromR8',2,tkVariant,nil,__VarBoolFromR8,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromDate',2,tkVariant,nil,__VarBoolFromDate,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromCy',2,tkVariant,nil,__VarBoolFromCy,false,0).SetVarArgs([1]);
    DefineMethod('VarBoolFromStr',4,tkVariant,nil,__VarBoolFromStr,false,0).SetVarArgs([3]);
    DefineMethod('VarBoolFromDisp',3,tkVariant,nil,__VarBoolFromDisp,false,0).SetVarArgs([2]);
    ...
    DefineMethod('LoadTypeLib',2,tkVariant,nil,__LoadTypeLib,false,0).SetVarArgs([1]);
    DefineMethod('LoadRegTypeLib',5,tkVariant,nil,__LoadRegTypeLib,false,0).SetVarArgs([4]);
    DefineMethod('QueryPathOfRegTypeLib',5,tkVariant,nil,__QueryPathOfRegTypeLib,false,0).SetVarArgs([4]);
    DefineMethod('RegisterTypeLib',3,tkVariant,nil,__RegisterTypeLib,false,0);
    DefineMethod('CreateTypeLib',3,tkVariant,nil,__CreateTypeLib,false,0).SetVarArgs([2]);
    DefineMethod('DispGetParam',5,tkVariant,nil,__DispGetParam,false,0).SetVarArgs([0,3,4]);
    DefineMethod('DispGetIDsOfNames',4,tkVariant,nil,__DispGetIDsOfNames,false,0).SetVarArgs([1,3]);
    DefineMethod('CreateDispTypeInfo',3,tkVariant,nil,__CreateDispTypeInfo,false,0).SetVarArgs([0,2]);
    DefineMethod('RegisterActiveObject',4,tkVariant,nil,__RegisterActiveObject,false,0).SetVarArgs([3]);
    DefineMethod('SetErrorInfo',2,tkVariant,nil,__SetErrorInfo,false,0);
    DefineMethod('GetErrorInfo',2,tkVariant,nil,__GetErrorInfo,false,0).SetVarArgs([1]);
    DefineMethod('CreateErrorInfo',1,tkVariant,nil,__CreateErrorInfo,false,0).SetVarArgs([0]);
    DefineMethod('OaBuildVersion',0,tkInteger,nil,__OaBuildVersion,false,0);
    DefineMethod('OleBuildVersion',0,tkVariant,nil,__OleBuildVersion,false,0);
    DefineMethod('ReadClassStg',2,tkVariant,nil,__ReadClassStg,false,0).SetVarArgs([1]);
    DefineMethod('WriteClassStg',2,tkVariant,nil,__WriteClassStg,false,0);
    DefineMethod('ReadClassStm',2,tkVariant,nil,__ReadClassStm,false,0).SetVarArgs([1]);
    DefineMethod('WriteClassStm',2,tkVariant,nil,__WriteClassStm,false,0);
    DefineMethod('WriteFmtUserTypeStg',3,tkVariant,nil,__WriteFmtUserTypeStg,false,0);
    DefineMethod('ReadFmtUserTypeStg',3,tkVariant,nil,__ReadFmtUserTypeStg,false,0).SetVarArgs([1,2]);
    DefineMethod('OleUninitialize',0,tkNone,nil,__OleUninitialize,false,0);
    DefineMethod('OleQueryLinkFromData',1,tkVariant,nil,__OleQueryLinkFromData,false,0);
    DefineMethod('OleQueryCreateFromData',1,tkVariant,nil,__OleQueryCreateFromData,false,0);
    DefineMethod('OleLoad',4,tkVariant,nil,__OleLoad,false,0).SetVarArgs([3]);
    DefineMethod('OleSave',3,tkVariant,nil,__OleSave,false,0);
    DefineMethod('OleLoadFromStream',3,tkVariant,nil,__OleLoadFromStream,false,0).SetVarArgs([2]);
    DefineMethod('OleSaveToStream',2,tkVariant,nil,__OleSaveToStream,false,0);
    DefineMethod('OleSetContainedObject',2,tkVariant,nil,__OleSetContainedObject,false,0);
    DefineMethod('OleNoteObjectVisible',2,tkVariant,nil,__OleNoteObjectVisible,false,0);
    DefineMethod('RegisterDragDrop',2,tkVariant,nil,__RegisterDragDrop,false,0);
    DefineMethod('RevokeDragDrop',1,tkVariant,nil,__RevokeDragDrop,false,0);
    DefineMethod('DoDragDrop',4,tkVariant,nil,__DoDragDrop,false,0).SetVarArgs([3]);
    DefineMethod('OleSetClipboard',1,tkVariant,nil,__OleSetClipboard,false,0);
    DefineMethod('OleGetClipboard',1,tkVariant,nil,__OleGetClipboard,false,0).SetVarArgs([0]);
    DefineMethod('OleFlushClipboard',0,tkVariant,nil,__OleFlushClipboard,false,0);
    DefineMethod('OleIsCurrentClipboard',1,tkVariant,nil,__OleIsCurrentClipboard,false,0);
    DefineMethod('OleCreateMenuDescriptor',2,tkInteger,nil,__OleCreateMenuDescriptor,false,0).SetVarArgs([1]);
    DefineMethod('OleSetMenuDescriptor',5,tkVariant,nil,__OleSetMenuDescriptor,false,0);
    DefineMethod('OleDestroyMenuDescriptor',1,tkVariant,nil,__OleDestroyMenuDescriptor,false,0);
    DefineMethod('OleDuplicateData',3,tkVariant,nil,__OleDuplicateData,false,0);
    DefineMethod('OleDraw',4,tkVariant,nil,__OleDraw,false,0);
    DefineMethod('OleRun',1,tkVariant,nil,__OleRun,false,0);
    DefineMethod('OleIsRunning',1,tkVariant,nil,__OleIsRunning,false,0);
    DefineMethod('OleLockRunning',3,tkVariant,nil,__OleLockRunning,false,0);
    DefineMethod('ReleaseStgMedium',1,tkNone,nil,__ReleaseStgMedium,false,0).SetVarArgs([0]);
    DefineMethod('CreateOleAdviseHolder',1,tkVariant,nil,__CreateOleAdviseHolder,false,0).SetVarArgs([0]);
    DefineMethod('OleCreateDefaultHandler',4,tkVariant,nil,__OleCreateDefaultHandler,false,0).SetVarArgs([3]);
    DefineMethod('OleCreateEmbeddingHelper',6,tkVariant,nil,__OleCreateEmbeddingHelper,false,0).SetVarArgs([5]);
    DefineMethod('OleGetIconOfFile',2,tkVariant,nil,__OleGetIconOfFile,false,0);
    DefineMethod('OleGetIconOfClass',3,tkVariant,nil,__OleGetIconOfClass,false,0);
    DefineMethod('OleMetafilePictFromIconAndLabel',4,tkVariant,nil,__OleMetafilePictFromIconAndLabel,false,0);
    DefineMethod('OleRegGetUserType',3,tkVariant,nil,__OleRegGetUserType,false,0).SetVarArgs([2]);
    DefineMethod('OleRegGetMiscStatus',3,tkVariant,nil,__OleRegGetMiscStatus,false,0).SetVarArgs([2]);
    DefineMethod('OleRegEnumFormatEtc',3,tkVariant,nil,__OleRegEnumFormatEtc,false,0).SetVarArgs([2]);
    DefineMethod('OleRegEnumVerbs',2,tkVariant,nil,__OleRegEnumVerbs,false,0).SetVarArgs([1]);
    DefineMethod('GetHGlobalFromILockBytes',2,tkVariant,nil,__GetHGlobalFromILockBytes,false,0).SetVarArgs([1]);
    DefineMethod('CreateILockBytesOnHGlobal',3,tkVariant,nil,__CreateILockBytesOnHGlobal,false,0).SetVarArgs([2]);
    DefineMethod('GetHGlobalFromStream',2,tkVariant,nil,__GetHGlobalFromStream,false,0).SetVarArgs([1]);
    DefineMethod('CreateStreamOnHGlobal',3,tkVariant,nil,__CreateStreamOnHGlobal,false,0).SetVarArgs([2]);
    DefineMethod('OleDoAutoConvert',2,tkVariant,nil,__OleDoAutoConvert,false,0).SetVarArgs([1]);
    DefineMethod('OleGetAutoConvert',2,tkVariant,nil,__OleGetAutoConvert,false,0).SetVarArgs([1]);
    DefineMethod('OleSetAutoConvert',2,tkVariant,nil,__OleSetAutoConvert,false,0);
    DefineMethod('GetConvertStg',1,tkVariant,nil,__GetConvertStg,false,0);
    DefineMethod('SetConvertStg',2,tkVariant,nil,__SetConvertStg,false,0);
