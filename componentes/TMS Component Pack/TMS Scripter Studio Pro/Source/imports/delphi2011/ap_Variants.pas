...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomVariantType(CurrentObject).VarType);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarType(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarAsType(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarIsType(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarAsError(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarTypeIsValidArrayType(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarTypeIsValidElementType(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.VarOverflowError(GetInputArg(0),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.VarRangeCheckError(GetInputArg(0),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.VarResultCheck(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.HandleConversionException(GetInputArg(0),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Variants.VarTypeAsText(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineProp('VarType',tkVariant,__GetTCustomVariantTypeVarType,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('VarType',1,tkVariant,nil,__VarType,false,0);
