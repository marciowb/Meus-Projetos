...
type
  ...
  published
    property PowerSetting: TGUID read FPowerSetting write FPowerSetting;
...
begin
  with AMachine do
  begin
AResult := Windows.FreeLibrary(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathName(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Windows.GetProcessHandleCount(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
...
AResult := Windows.GetThreadIOPendingFlag(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Windows.CheckRemoteDebuggerPresent(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.LockFile(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.UnlockFile(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFileType(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.FindClose(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CloseHandle(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Windows.OpenFile(PAnsiChar(VarToStr(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Windows.UnregisterWait(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.UnregisterWaitEx(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateTimerQueue;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.ChangeTimerQueueTimer(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueueTimer(GetInputArg(0),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueueEx(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CancelTimerQueueTimer(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueue(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.LoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.FindResource(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetCurrentDirectory(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetCurrentDirectory(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetDllDirectory(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetDllDirectoryA(PAnsiChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetDllDirectoryW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.GetDllDirectory(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.GetDllDirectoryA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.GetDllDirectoryW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.RemoveDirectory(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.RemoveDirectoryTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.RemoveDirectoryTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.RemoveDirectoryTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Windows.GetFullPathNameTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),Param3,GetInputArg(4)));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
Param3 := PAnsiChar(VarToStr(GetInputArg(3)));
AResult := Integer(Windows.GetFullPathNameTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PAnsiChar(VarToStr(GetInputArg(2))),Param3,GetInputArg(4)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3))));
AResult := Integer(Windows.GetFullPathNameTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),Param3,GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,WideCharToString(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetFileAttributesTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetFileAttributesTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.SetFileAttributesTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFileAttributes(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteFileTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteFileTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.DeleteFileTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Windows.FindFirstFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
...
if not Assigned(Param1Rec) or not (Param1Rec is _WIN32_FIND_DATAWWrapper) then 
  Param1Rec := _WIN32_FIND_DATAWWrapper.Create(Param1);
Param1 := _WIN32_FIND_DATAWWrapper(Param1Rec).ObjToRec;
AResult := Windows.FindNextFile(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(_WIN32_FIND_DATAWWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CopyFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.MoveFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.MoveFileTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.MoveFileTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.MoveFileTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateHardLinkTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateHardLinkTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateHardLinkTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLink(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkTransacted(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkTransactedA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFinalPathNameByHandle(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFinalPathNameByHandleA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFinalPathNameByHandleW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Windows.AdjustTokenPrivileges(GetInputArg(0),GetInputArg(1),_TOKEN_PRIVILEGESWrapper(integer(GetInputArg(2))).ObjToRec,VarToInteger(GetInputArg(3)),Param4,Param5);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameEx(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameExA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameExW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CopyMetaFile(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CopyEnhMetaFile(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetClipboardFormatName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOem(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.OemToChar(PAnsiChar(VarToStr(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemBuff(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemBuffA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemBuffW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(Windows.CharUpper(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharUpperA(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharUpperBuff(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharUpperBuffA(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(Windows.CharLower(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharLowerA(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharLowerBuff(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharLowerBuffA(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(Windows.CharNext(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextA(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(Windows.CharPrev(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextExA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextEx(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevEx(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevExA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.AnsiToOem(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.OemToAnsi(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.AnsiToOemBuff(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiUpper(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.AnsiUpperBuff(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiLower(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.AnsiLowerBuff(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiNext(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiPrev(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CloseTouchInputHandle(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.MessageBox(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.MessageBoxEx(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.FindWindow(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CopyImage(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.LoadString(GetInputArg(0),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.HtmlHelp(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.HtmlHelpA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.LCIDToLocaleName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.LocaleNameToLCID(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLocaleInfoEx(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.FoldString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Windows.RegOpenUserClassesRoot(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('MAKELANGID',2,tkInteger,nil,__MAKELANGID,false,0);
    DefineMethod('PRIMARYLANGID',1,tkInteger,nil,__PRIMARYLANGID,false,0);
    DefineMethod('SUBLANGID',1,tkInteger,nil,__SUBLANGID,false,0);
    DefineMethod('MAKELCID',2,tkInteger,nil,__MAKELCID,false,0);
    DefineMethod('MAKESORTLCID',3,tkInteger,nil,__MAKESORTLCID,false,0);
    DefineMethod('LANGIDFROMLCID',1,tkInteger,nil,__LANGIDFROMLCID,false,0);
    DefineMethod('SORTIDFROMLCID',1,tkInteger,nil,__SORTIDFROMLCID,false,0);
    DefineMethod('SORTVERSIONFROMLCID',1,tkInteger,nil,__SORTVERSIONFROMLCID,false,0);
    ...
    DefineMethod('InterlockedExchangeAdd',2,tkInteger,nil,__InterlockedExchangeAdd,false,0);
    ...
    DefineMethod('GlobalMemoryStatusEx',1,tkVariant,nil,__GlobalMemoryStatusEx,false,0).SetVarArgs([0]);
    DefineMethod('GetLongPathName',3,tkInteger,nil,__GetLongPathName,false,0);
    DefineMethod('GetLongPathNameA',3,tkInteger,nil,__GetLongPathNameA,false,0);
    DefineMethod('GetLongPathNameW',3,tkInteger,nil,__GetLongPathNameW,false,0);
    DefineMethod('GetLongPathNameTransacted',4,tkInteger,nil,__GetLongPathNameTransacted,false,0);
    DefineMethod('GetLongPathNameTransactedA',4,tkInteger,nil,__GetLongPathNameTransactedA,false,0);
    DefineMethod('GetLongPathNameTransactedW',4,tkInteger,nil,__GetLongPathNameTransactedW,false,0);
    DefineMethod('GetProcessHandleCount',2,tkVariant,nil,__GetProcessHandleCount,false,0).SetVarArgs([1]);
    DefineMethod('ExitProcess',1,tkNone,nil,__ExitProcess,false,0);
    DefineMethod('GetThreadIOPendingFlag',2,tkVariant,nil,__GetThreadIOPendingFlag,false,0).SetVarArgs([1]);
    DefineMethod('ExitThread',1,tkNone,nil,__ExitThread,false,0);
    DefineMethod('CheckRemoteDebuggerPresent',2,tkVariant,nil,__CheckRemoteDebuggerPresent,false,0).SetVarArgs([1]);
    ...
    DefineMethod('GetSystemRegistryQuota',2,tkVariant,nil,__GetSystemRegistryQuota,false,0).SetVarArgs([0,1]);
    DefineMethod('GetSystemTimes',3,tkVariant,nil,__GetSystemTimes,false,0).SetVarArgs([0,1,2]);
    DefineMethod('GetNativeSystemInfo',1,tkNone,nil,__GetNativeSystemInfo,false,0).SetVarArgs([0]);
    DefineMethod('GetDynamicTimeZoneInformation',1,tkInteger,nil,__GetDynamicTimeZoneInformation,false,0).SetVarArgs([0]);
    DefineMethod('SetDynamicTimeZoneInformation',1,tkInteger,nil,__SetDynamicTimeZoneInformation,false,0);
    ...
    DefineMethod('UnregisterWait',1,tkVariant,nil,__UnregisterWait,false,0);
    DefineMethod('UnregisterWaitEx',2,tkVariant,nil,__UnregisterWaitEx,false,0);
    DefineMethod('WT_SET_MAX_THREADPOOL_THREADS',2,tkInteger,nil,__WT_SET_MAX_THREADPOOL_THREADS,false,0);
    DefineMethod('CreateTimerQueue',0,tkVariant,nil,__CreateTimerQueue,false,0);
    DefineMethod('ChangeTimerQueueTimer',4,tkVariant,nil,__ChangeTimerQueueTimer,false,0);
    DefineMethod('DeleteTimerQueueTimer',3,tkVariant,nil,__DeleteTimerQueueTimer,false,0);
    DefineMethod('DeleteTimerQueueEx',2,tkVariant,nil,__DeleteTimerQueueEx,false,0);
    DefineMethod('CancelTimerQueueTimer',2,tkVariant,nil,__CancelTimerQueueTimer,false,0);
    DefineMethod('DeleteTimerQueue',1,tkVariant,nil,__DeleteTimerQueue,false,0);
    DefineMethod('LoadLibrary',1,tkVariant,nil,__LoadLibrary,false,0);
    ...
    DefineMethod('FindResource',3,tkVariant,nil,__FindResource,false,0);
    ...
    DefineMethod('SetDllDirectory',1,tkVariant,nil,__SetDllDirectory,false,0);
    DefineMethod('SetDllDirectoryA',1,tkVariant,nil,__SetDllDirectoryA,false,0);
    DefineMethod('SetDllDirectoryW',1,tkVariant,nil,__SetDllDirectoryW,false,0);
    DefineMethod('GetDllDirectory',2,tkVariant,nil,__GetDllDirectory,false,0);
    DefineMethod('GetDllDirectoryA',2,tkVariant,nil,__GetDllDirectoryA,false,0);
    DefineMethod('GetDllDirectoryW',2,tkVariant,nil,__GetDllDirectoryW,false,0);
    DefineMethod('RemoveDirectory',1,tkVariant,nil,__RemoveDirectory,false,0);
    DefineMethod('RemoveDirectoryTransacted',2,tkVariant,nil,__RemoveDirectoryTransacted,false,0);
    DefineMethod('RemoveDirectoryTransactedA',2,tkVariant,nil,__RemoveDirectoryTransactedA,false,0);
    DefineMethod('RemoveDirectoryTransactedW',2,tkVariant,nil,__RemoveDirectoryTransactedW,false,0);
    DefineMethod('GetFullPathNameTransacted',5,tkInteger,nil,__GetFullPathNameTransacted,false,0).SetVarArgs([3]);
    DefineMethod('GetFullPathNameTransactedA',5,tkInteger,nil,__GetFullPathNameTransactedA,false,0).SetVarArgs([3]);
    DefineMethod('GetFullPathNameTransactedW',5,tkInteger,nil,__GetFullPathNameTransactedW,false,0).SetVarArgs([3]);
    DefineMethod('SetFileAttributesTransacted',3,tkVariant,nil,__SetFileAttributesTransacted,false,0);
    DefineMethod('SetFileAttributesTransactedA',3,tkVariant,nil,__SetFileAttributesTransactedA,false,0);
    DefineMethod('SetFileAttributesTransactedW',3,tkVariant,nil,__SetFileAttributesTransactedW,false,0);
    ...
    DefineMethod('DeleteFileTransacted',2,tkVariant,nil,__DeleteFileTransacted,false,0);
    DefineMethod('DeleteFileTransactedA',2,tkVariant,nil,__DeleteFileTransactedA,false,0);
    DefineMethod('DeleteFileTransactedW',2,tkVariant,nil,__DeleteFileTransactedW,false,0);
    DefineMethod('FindFirstFile',2,tkVariant,nil,__FindFirstFile,false,0).SetVarArgs([1]);
    ...
    DefineMethod('MoveFileTransacted',4,tkVariant,nil,__MoveFileTransacted,false,0);
    DefineMethod('MoveFileTransactedA',4,tkVariant,nil,__MoveFileTransactedA,false,0);
    DefineMethod('MoveFileTransactedW',4,tkVariant,nil,__MoveFileTransactedW,false,0);
    DefineMethod('CreateHardLinkTransacted',4,tkVariant,nil,__CreateHardLinkTransacted,false,0);
    DefineMethod('CreateHardLinkTransactedA',4,tkVariant,nil,__CreateHardLinkTransactedA,false,0);
    DefineMethod('CreateHardLinkTransactedW',4,tkVariant,nil,__CreateHardLinkTransactedW,false,0);
    DefineMethod('CreateSymbolicLink',3,tkVariant,nil,__CreateSymbolicLink,false,0);
    DefineMethod('CreateSymbolicLinkA',3,tkVariant,nil,__CreateSymbolicLinkA,false,0);
    DefineMethod('CreateSymbolicLinkW',3,tkVariant,nil,__CreateSymbolicLinkW,false,0);
    DefineMethod('CreateSymbolicLinkTransacted',4,tkVariant,nil,__CreateSymbolicLinkTransacted,false,0);
    DefineMethod('CreateSymbolicLinkTransactedA',4,tkVariant,nil,__CreateSymbolicLinkTransactedA,false,0);
    DefineMethod('CreateSymbolicLinkTransactedW',4,tkVariant,nil,__CreateSymbolicLinkTransactedW,false,0);
    DefineMethod('GetFinalPathNameByHandle',4,tkInteger,nil,__GetFinalPathNameByHandle,false,0);
    DefineMethod('GetFinalPathNameByHandleA',4,tkInteger,nil,__GetFinalPathNameByHandleA,false,0);
    DefineMethod('GetFinalPathNameByHandleW',4,tkInteger,nil,__GetFinalPathNameByHandleW,false,0);
    DefineMethod('AdjustTokenPrivileges',6,tkVariant,nil,__AdjustTokenPrivileges,false,0).SetVarArgs([4,5]);
    DefineMethod('GetComputerNameEx',3,tkVariant,nil,__GetComputerNameEx,false,0).SetVarArgs([2]);
    DefineMethod('GetComputerNameExA',3,tkVariant,nil,__GetComputerNameExA,false,0).SetVarArgs([2]);
    DefineMethod('GetComputerNameExW',3,tkVariant,nil,__GetComputerNameExW,false,0).SetVarArgs([2]);
    DefineMethod('VerifyVersionInfo',3,tkVariant,nil,__VerifyVersionInfo,false,0).SetVarArgs([0]);
    DefineMethod('VerifyVersionInfoA',3,tkVariant,nil,__VerifyVersionInfoA,false,0).SetVarArgs([0]);
    DefineMethod('VerifyVersionInfoW',3,tkVariant,nil,__VerifyVersionInfoW,false,0).SetVarArgs([0]);
    DefineMethod('CopyMetaFile',2,tkInteger,nil,__CopyMetaFile,false,0);
    DefineMethod('GetRandomRgn',3,tkInteger,nil,__GetRandomRgn,false,0);
    ...
    DefineMethod('GET_APPCOMMAND_LPARAM',1,tkInteger,nil,__GET_APPCOMMAND_LPARAM,false,0);
    DefineMethod('GET_DEVICE_LPARAM',1,tkInteger,nil,__GET_DEVICE_LPARAM,false,0);
    DefineMethod('GET_MOUSEORKEY_LPARAM',1,tkInteger,nil,__GET_MOUSEORKEY_LPARAM,false,0);
    DefineMethod('GET_FLAGS_LPARAM',1,tkInteger,nil,__GET_FLAGS_LPARAM,false,0);
    DefineMethod('GET_KEYSTATE_LPARAM',1,tkInteger,nil,__GET_KEYSTATE_LPARAM,false,0);
    DefineMethod('GetMouseMovePointsEx',5,tkInteger,nil,__GetMouseMovePointsEx,false,0).SetVarArgs([1,2]);
    DefineMethod('PointToLParam',1,tkInteger,nil,__PointToLParam,false,0);
    ...
    DefineMethod('GetWindowPlacement',2,tkVariant,nil,__GetWindowPlacement,false,0).SetVarArgs([1]);
    DefineMethod('SetWindowPlacement',2,tkVariant,nil,__SetWindowPlacement,false,0);
    DefineMethod('GetWindowDisplayAffinity',2,tkVariant,nil,__GetWindowDisplayAffinity,false,0).SetVarArgs([1]);
    DefineMethod('SetWindowDisplayAffinity',2,tkVariant,nil,__SetWindowDisplayAffinity,false,0);
    ...
    DefineMethod('AddClipboardFormatListener',1,tkVariant,nil,__AddClipboardFormatListener,false,0);
    DefineMethod('RemoveClipboardFormatListener',1,tkVariant,nil,__RemoveClipboardFormatListener,false,0);
    ...
    DefineMethod('CloseTouchInputHandle',1,tkVariant,nil,__CloseTouchInputHandle,false,0);
    DefineMethod('RegisterTouchWindow',2,tkVariant,nil,__RegisterTouchWindow,false,0);
    DefineMethod('UnregisterTouchWindow',1,tkVariant,nil,__UnregisterTouchWindow,false,0);
    DefineMethod('CalculatePopupWindowPosition',5,tkVariant,nil,__CalculatePopupWindowPosition,false,0).SetVarArgs([4]);
    DefineMethod('GetWindowDC',1,tkInteger,nil,__GetWindowDC,false,0);
    DefineMethod('InvalidateRect',3,tkVariant,nil,__InvalidateRect,false,0);
    DefineMethod('ValidateRect',2,tkVariant,nil,__ValidateRect,false,0);
    DefineMethod('RedrawWindow',4,tkVariant,nil,__RedrawWindow,false,0);
    ...
    DefineMethod('SetPhysicalCursorPos',2,tkVariant,nil,__SetPhysicalCursorPos,false,0);
    DefineMethod('GetPhysicalCursorPos',1,tkVariant,nil,__GetPhysicalCursorPos,false,0).SetVarArgs([0]);
    ...
    DefineMethod('LogicalToPhysicalPoint',2,tkVariant,nil,__LogicalToPhysicalPoint,false,0).SetVarArgs([1]);
    DefineMethod('PhysicalToLogicalPoint',2,tkVariant,nil,__PhysicalToLogicalPoint,false,0).SetVarArgs([1]);
    DefineMethod('WindowFromPhysicalPoint',1,tkInteger,nil,__WindowFromPhysicalPoint,false,0);
    ...
    DefineMethod('CopyImage',5,tkVariant,nil,__CopyImage,false,0);
    ...
    DefineMethod('SystemParametersInfo',4,tkVariant,nil,__SystemParametersInfo,false,0).SetVarArgs([2]);
    DefineMethod('BlockInput',1,tkVariant,nil,__BlockInput,false,0);
    ...
    DefineMethod('GetCPInfoEx',3,tkVariant,nil,__GetCPInfoEx,false,0).SetVarArgs([2]);
    DefineMethod('GetCPInfoExA',3,tkVariant,nil,__GetCPInfoExA,false,0).SetVarArgs([2]);
    DefineMethod('GetCPInfoExW',3,tkVariant,nil,__GetCPInfoExW,false,0).SetVarArgs([2]);
    DefineMethod('LCIDToLocaleName',4,tkInteger,nil,__LCIDToLocaleName,false,0);
    DefineMethod('LocaleNameToLCID',2,tkInteger,nil,__LocaleNameToLCID,false,0);
    DefineMethod('GetLocaleInfoEx',4,tkInteger,nil,__GetLocaleInfoEx,false,0);
    ...
    DefineMethod('GetWindowLongPtr',2,tkInteger,nil,__GetWindowLongPtr,false,0);
    DefineMethod('SetWindowLongPtr',3,tkInteger,nil,__SetWindowLongPtr,false,0);
    DefineMethod('GetWindowLongPtrA',2,tkInteger,nil,__GetWindowLongPtrA,false,0);
    DefineMethod('SetWindowLongPtrA',3,tkInteger,nil,__SetWindowLongPtrA,false,0);
    DefineMethod('GetWindowLongPtrW',2,tkInteger,nil,__GetWindowLongPtrW,false,0);
    DefineMethod('SetWindowLongPtrW',3,tkInteger,nil,__SetWindowLongPtrW,false,0);
    DefineMethod('GID_ROTATE_ANGLE_TO_ARGUMENT',1,tkInteger,nil,__GID_ROTATE_ANGLE_TO_ARGUMENT,false,0);
    DefineMethod('GID_ROTATE_ANGLE_FROM_ARGUMENT',1,tkVariant,nil,__GID_ROTATE_ANGLE_FROM_ARGUMENT,false,0);
    DefineMethod('GetGestureInfo',2,tkVariant,nil,__GetGestureInfo,false,0).SetVarArgs([1]);
    DefineMethod('CloseGestureInfoHandle',1,tkVariant,nil,__CloseGestureInfoHandle,false,0);
    DefineMethod('RotateAngleFromArgument',1,tkVariant,nil,__RotateAngleFromArgument,false,0);
    DefineMethod('InertiaVectorFromArgument',1,tkVariant,nil,__InertiaVectorFromArgument,false,0);
    AddConsts1;
