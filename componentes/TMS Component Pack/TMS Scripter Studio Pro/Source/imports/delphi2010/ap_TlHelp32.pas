...
begin
  ...
  begin
    ...
    DefineMethod('Process32FirstA',2,tkVariant,nil,__Process32FirstA,false,0).SetVarArgs([1]);
    DefineMethod('Process32NextA',2,tkVariant,nil,__Process32NextA,false,0).SetVarArgs([1]);
    ...
    DefineMethod('Module32FirstA',2,tkVariant,nil,__Module32FirstA,false,0).SetVarArgs([1]);
    DefineMethod('Module32NextA',2,tkVariant,nil,__Module32NextA,false,0).SetVarArgs([1]);
