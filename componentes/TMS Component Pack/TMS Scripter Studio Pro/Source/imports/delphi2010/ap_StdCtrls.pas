...
begin
  with AMachine do
  begin
AResult := TCustomEdit(CurrentObject).GetControlsAlignment;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).SetSelText(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomEdit(CurrentObject).Alignment);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).Alignment:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomEdit(CurrentObject).TextHint);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).TextHint:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomComboBoxStringsClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomComboBox(CurrentObject).TextHint);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomComboBox(CurrentObject).TextHint:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    TImageMargins(CurrentObject).Assign(TPersistent(Integer(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SetSelText',1,tkNone,nil,__TCustomEditSetSelText,false,0);
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TImageMarginsAssign,false,0);
  end;
