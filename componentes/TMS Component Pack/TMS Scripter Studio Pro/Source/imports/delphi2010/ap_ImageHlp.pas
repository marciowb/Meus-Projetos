...
AResult := Integer(ImageHlp.MapFileAndCheckSum(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,Param2));
...
Param1 := VarToInteger(GetInputArg(1));
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ImageHlp.MapFileAndCheckSumA(PAnsiChar(VarToStr(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.TouchFileTimes(GetInputArg(0),_SYSTEMTIMEWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SplitSymbols(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.FindDebugInfoFile(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.FindExecutableImage(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.BindImage(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ImageHlp.ReBaseImage(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),GetInputArg(2),GetInputArg(3),GetInputArg(4),VarToInteger(GetInputArg(5)),Param6,Param7,Param8,Param9,VarToInteger(GetInputArg(10)));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SearchTreeForFile(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.MakeSureDirectoryPathExists(PAnsiChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.UnDecorateSymbolName(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.GetTimestampForLoadedLibrary(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymCleanup(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ImageHlp.SymGetModuleInfo(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.SymGetModuleBase(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymInitialize(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymGetSearchPath(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymSetSearchPath(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.SymLoadModule(GetInputArg(0),GetInputArg(1),PAnsiChar(VarToStr(GetInputArg(2))),PAnsiChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymUnloadModule(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.ImageRemoveCertificate(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ImageHlp.ImageGetCertificateHeader(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    ...
    DefineMethod('FindDebugInfoFile',3,tkVariant,nil,__FindDebugInfoFile,false,0);
    DefineMethod('FindExecutableImage',3,tkVariant,nil,__FindExecutableImage,false,0);
    ...
    DefineMethod('SymLoadModule',6,tkInteger,nil,__SymLoadModule,false,0);
    ...
    DefineMethod('ImageGetCertificateHeader',3,tkVariant,nil,__ImageGetCertificateHeader,false,0).SetVarArgs([2]);
