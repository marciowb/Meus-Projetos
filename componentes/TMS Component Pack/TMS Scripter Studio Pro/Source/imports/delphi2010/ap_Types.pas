...
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(Types.SplitRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),VarToInteger(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('PtInCircle',3,tkVariant,nil,__PtInCircle,false,0);
    ...
    DefineMethod('RectWidth',1,tkInteger,nil,__RectWidth,false,0);
    DefineMethod('RectHeight',1,tkInteger,nil,__RectHeight,false,0);
    DefineMethod('SplitRect',3,tkVariant,nil,__SplitRect,false,0);
    DefineMethod('CenteredRect',2,tkVariant,nil,__CenteredRect,false,0);
