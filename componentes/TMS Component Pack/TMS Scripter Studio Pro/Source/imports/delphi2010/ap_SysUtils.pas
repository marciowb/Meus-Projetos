...
begin
  with AMachine do
  begin
AResult := Integer(Exception(CurrentObject).GetBaseException);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Exception(CurrentObject).ToString;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ExceptionClass(CurrentClass.ClassRef).RaiseOuterException(Exception(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ExceptionClass(CurrentClass.ClassRef).ThrowOuterException(Exception(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(Exception(CurrentObject).BaseException));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(Exception(CurrentObject).InnerException));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Exception(CurrentObject).StackTrace);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TEncodingClass(CurrentClass.ClassRef).IsStandardEncoding(TEncoding(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TEncoding(CurrentObject).GetByteCount(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TEncodingClass(CurrentClass.ClassRef).GetEncoding(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).ASCII));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).BigEndianUnicode));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).Default));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).Unicode));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).UTF7));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TEncoding(CurrentObject).UTF8));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMBCSEncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TUTF7EncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TUTF8EncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TUnicodeEncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := PAnsiChar(VarToStr(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := SysUtils.UIntToStr(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.FileSetDate(GetInputArgAsString(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.TextPos(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.HashName(PAnsiChar(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := SysUtils.IsLeadChar(VarToStr(GetInputArg(0))[1]);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := SysUtils.CharInSet(VarToStr(GetInputArg(0))[1],Param1);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.ByteLength(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('RaiseOuterException',1,tkNone,nil,__ExceptionRaiseOuterException,true,0);
    DefineMethod('ThrowOuterException',1,tkNone,nil,__ExceptionThrowOuterException,true,0);
  ...
  begin
    ...
    DefineMethod('IsStandardEncoding',1,tkVariant,nil,__TEncodingIsStandardEncoding,true,0);
    DefineMethod('GetByteCount',1,tkInteger,nil,__TEncodingGetByteCount,false,0);
    DefineMethod('GetEncoding',1,tkClass,TEncoding,__TEncodingGetEncoding,true,0);
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TEncodingGetMaxByteCount,false,0);
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TEncodingGetMaxCharCount,false,0);
  ...
  begin
    ...
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TMBCSEncodingGetMaxByteCount,false,0);
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TMBCSEncodingGetMaxCharCount,false,0);
  end;
  With Scripter.DefineClass(TUTF7Encoding) do
  begin
    DefineMethod('Create',0,tkClass,TUTF7Encoding,__TUTF7EncodingCreate,true,0);
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUTF7EncodingGetMaxByteCount,false,0);
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUTF7EncodingGetMaxCharCount,false,0);
  end;
  With Scripter.DefineClass(TUTF8Encoding) do
  begin
    DefineMethod('Create',0,tkClass,TUTF8Encoding,__TUTF8EncodingCreate,true,0);
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUTF8EncodingGetMaxByteCount,false,0);
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUTF8EncodingGetMaxCharCount,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUnicodeEncodingGetMaxByteCount,false,0);
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUnicodeEncodingGetMaxCharCount,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('UIntToStr',1,tkVariant,nil,__UIntToStr,false,0);
    ...
    DefineMethod('TextPos',2,tkVariant,nil,__TextPos,false,0);
    ...
    DefineMethod('AnsiStrAlloc',1,tkVariant,nil,__AnsiStrAlloc,false,0);
    DefineMethod('WideStrAlloc',1,tkVariant,nil,__WideStrAlloc,false,0);
    ...
    DefineMethod('HashName',1,tkInteger,nil,__HashName,false,0);
    ...
    DefineMethod('ElementToCharLen',2,tkInteger,nil,__ElementToCharLen,false,0);
    DefineMethod('CharToByteLen',2,tkInteger,nil,__CharToByteLen,false,0);
    DefineMethod('CharToElementLen',2,tkInteger,nil,__CharToElementLen,false,0);
    DefineMethod('ByteToCharIndex',2,tkInteger,nil,__ByteToCharIndex,false,0);
    DefineMethod('ElementToCharIndex',2,tkInteger,nil,__ElementToCharIndex,false,0);
    DefineMethod('CharToByteIndex',2,tkInteger,nil,__CharToByteIndex,false,0);
    DefineMethod('CharToElementIndex',2,tkInteger,nil,__CharToElementIndex,false,0);
    ...
    DefineMethod('IsLeadChar',1,tkVariant,nil,__IsLeadChar,false,0);
    DefineMethod('CharInSet',2,tkVariant,nil,__CharInSet,false,0);
    ...
    DefineMethod('ByteLength',1,tkInteger,nil,__ByteLength,false,0);
