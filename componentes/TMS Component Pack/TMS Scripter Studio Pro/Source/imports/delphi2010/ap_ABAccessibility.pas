...
type
  TatABAccessibilityLibrary = class(TatScripterLibrary)
    ...
    procedure __TActionMenuBarAccessibilityGet_accChild(AMachine: TatVirtualMachine);
...
procedure TatABAccessibilityLibrary.__TActionMenuBarAccessibilityGet_accChild(AMachine: TatVirtualMachine);
  var
  Param0: OleVariant;
  Param1: IDispatch;
  AResult: variant;
...
AResult := TActionMenuBarAccessibility(CurrentObject).Get_accChild(Param0,Param1);
    ReturnOutputArg(AResult);
...
Param0 := GetInputArg(0);
Param1 := GetInputArg(1);
AResult := TActionMenuBarAccessibility(CurrentObject).Get_accState(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
    SetInputArg(1,Param1);
  end;
...
Param0 := GetInputArg(0);
Param1 := GetInputArg(1);
AResult := TActionMenuBarAccessibility(CurrentObject).Get_accRole(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
    SetInputArg(1,Param1);
  end;
...
Param0 := GetInputArg(0);
Param1 := GetInputArg(1);
AResult := TActionMenuBarAccessibility(CurrentObject).Get_accDescription(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
    SetInputArg(1,Param1);
  end;
...
begin
  ...
  begin
    DefineMethod('Get_accChild',2,tkVariant,nil,__TActionMenuBarAccessibilityGet_accChild,false,0).SetVarArgs([0,1]);
    DefineMethod('Get_accState',2,tkVariant,nil,__TActionMenuBarAccessibilityGet_accState,false,0).SetVarArgs([0,1]);
    DefineMethod('Get_accRole',2,tkVariant,nil,__TActionMenuBarAccessibilityGet_accRole,false,0).SetVarArgs([0,1]);
    DefineMethod('Get_accDescription',2,tkVariant,nil,__TActionMenuBarAccessibilityGet_accDescription,false,0).SetVarArgs([0,1]);
  end;
