...
type
  TatBDERegLibrary = class(TatScripterLibrary)
    ...
    procedure __TDefaultSessionSprigItemClass(AMachine: TatVirtualMachine);
    ...
    procedure __TImpliedSessionSprigItemClass(AMachine: TatVirtualMachine);
    ...
    procedure __TDatabaseSprigPaletteOverTo(AMachine: TatVirtualMachine);
    ...
    procedure __TImpliedDatabaseSprigItemClass(AMachine: TatVirtualMachine);
    ...
    procedure __TDBDataSetSprigPaletteOverTo(AMachine: TatVirtualMachine);
...
procedure TatBDERegLibrary.__TDefaultSessionSprigItemClass(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDefaultSessionSprig(CurrentObject).ItemClass;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatBDERegLibrary.__TImpliedSessionSprigItemClass(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TImpliedSessionSprig(CurrentObject).ItemClass;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatBDERegLibrary.__TDatabaseSprigPaletteOverTo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDatabaseSprigClass(CurrentClass.ClassRef).PaletteOverTo(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatBDERegLibrary.__TImpliedDatabaseSprigItemClass(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TImpliedDatabaseSprig(CurrentObject).ItemClass;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatBDERegLibrary.__TDBDataSetSprigPaletteOverTo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDBDataSetSprigClass(CurrentClass.ClassRef).PaletteOverTo(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ItemClass',0,tkVariant,nil,__TDefaultSessionSprigItemClass,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('ItemClass',0,tkVariant,nil,__TImpliedSessionSprigItemClass,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('PaletteOverTo',2,tkVariant,nil,__TDatabaseSprigPaletteOverTo,true,0);
  end;
  ...
  begin
    ...
    DefineMethod('ItemClass',0,tkVariant,nil,__TImpliedDatabaseSprigItemClass,false,0);
  ...
  begin
    ...
    DefineMethod('PaletteOverTo',2,tkVariant,nil,__TDBDataSetSprigPaletteOverTo,true,0);
  end;
