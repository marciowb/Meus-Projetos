...
type
  TatShLwApiLibrary = class(TatScripterLibrary)
    ...
    procedure __SHSetThreadRef(AMachine: TatVirtualMachine);
    procedure __SHGetThreadRef(AMachine: TatVirtualMachine);
...
AResult := ShLwApi.SHStrDup(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := ShLwApi.SHStrDupA(PAnsiChar(VarToStr(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))));
AResult := ShLwApi.SHStrDupW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,WideCharToString(Param1));
  end;
end;
...
AResult := ShLwApi.UrlCombine(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := ShLwApi.UrlCombineA(PAnsiChar(VarToStr(GetInputArg(0))),PAnsiChar(VarToStr(GetInputArg(1))),PAnsiChar(VarToStr(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShLwApi.UrlUnescapeInPlace(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShLwApi.UrlUnescapeInPlaceA(PAnsiChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShLwApi.UrlUnescapeInPlaceW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteUSValue(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteUSValueA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteUSValueW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteEmptyUSKey(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteEmptyUSKeyA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegDeleteEmptyUSKeyW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShLwApi.SHRegCloseUSKey(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ShLwApi.AssocQueryKey(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),Param4);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param4 := VarToInteger(GetInputArg(4));
AResult := ShLwApi.AssocQueryKeyA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(VarToStr(GetInputArg(2))),PAnsiChar(VarToStr(GetInputArg(3))),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  ...
  begin
Param4 := VarToInteger(GetInputArg(4));
AResult := ShLwApi.AssocQueryKeyW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShLwApi.SHAutoComplete(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatShLwApiLibrary.__SHSetThreadRef(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ShLwApi.SHSetThreadRef(GetInputArg(0));
  end;
end;

procedure TatShLwApiLibrary.__SHGetThreadRef(AMachine: TatVirtualMachine);
  var
  Param0: IUnknown;
begin
  with AMachine do
...
begin
  ...
  begin
    ...
    DefineMethod('SHStrDup',2,tkVariant,nil,__SHStrDup,false,0).SetVarArgs([1]);
    DefineMethod('SHStrDupA',2,tkVariant,nil,__SHStrDupA,false,0).SetVarArgs([1]);
    DefineMethod('SHStrDupW',2,tkVariant,nil,__SHStrDupW,false,0).SetVarArgs([1]);
    ...
    DefineMethod('UrlCombine',5,tkVariant,nil,__UrlCombine,false,0).SetVarArgs([3]);
    DefineMethod('UrlCombineA',5,tkVariant,nil,__UrlCombineA,false,0).SetVarArgs([3]);
    DefineMethod('UrlCombineW',5,tkVariant,nil,__UrlCombineW,false,0).SetVarArgs([3]);
    ...
    DefineMethod('UrlUnescapeInPlace',2,tkVariant,nil,__UrlUnescapeInPlace,false,0);
    DefineMethod('UrlUnescapeInPlaceA',2,tkVariant,nil,__UrlUnescapeInPlaceA,false,0);
    DefineMethod('UrlUnescapeInPlaceW',2,tkVariant,nil,__UrlUnescapeInPlaceW,false,0);
    ...
    DefineMethod('AssocQueryKey',5,tkVariant,nil,__AssocQueryKey,false,0).SetVarArgs([4]);
    DefineMethod('AssocQueryKeyA',5,tkVariant,nil,__AssocQueryKeyA,false,0).SetVarArgs([4]);
    DefineMethod('AssocQueryKeyW',5,tkVariant,nil,__AssocQueryKeyW,false,0).SetVarArgs([4]);
    DefineMethod('SHAutoComplete',2,tkVariant,nil,__SHAutoComplete,false,0);
    DefineMethod('SHSetThreadRef',1,tkNone,nil,__SHSetThreadRef,false,0);
    DefineMethod('SHGetThreadRef',1,tkNone,nil,__SHGetThreadRef,false,0).SetVarArgs([0]);
    ...
    AddConstant('ASSOCF_INIT_IGNOREUNKNOWN',ASSOCF_INIT_IGNOREUNKNOWN);
