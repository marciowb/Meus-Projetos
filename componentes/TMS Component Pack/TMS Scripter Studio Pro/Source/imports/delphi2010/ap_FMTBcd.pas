...
type
  TatFMTBcdLibrary = class(TatScripterLibrary)
    procedure __BcdFromBytes(AMachine: TatVirtualMachine);
    procedure __BcdToBytes(AMachine: TatVirtualMachine);
...
procedure TatFMTBcdLibrary.__BcdFromBytes(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := integer(TBcdWrapper.Create(FMTBcd.BcdFromBytes(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatFMTBcdLibrary.__BcdToBytes(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := FMTBcd.BcdToBytes(TBcdWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := FMTBcd.RoundAt(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('BcdFromBytes',1,tkVariant,nil,__BcdFromBytes,false,0);
    DefineMethod('BcdToBytes',1,tkVariant,nil,__BcdToBytes,false,0);
    ...
    DefineMethod('VarFMTBcd',0,tkVariant,nil,__VarFMTBcd,false,0);
    ...
    DefineMethod('OldCurrToBCD',4,tkVariant,nil,__OldCurrToBCD,false,2).SetVarArgs([1]);
    ...
    DefineMethod('OldBCDToCurr',2,tkVariant,nil,__OldBCDToCurr,false,0).SetVarArgs([1]);
    ...
    DefineMethod('RoundAt',2,tkVariant,nil,__RoundAt,false,0);
