...
procedure TatAxCtrlsLibrary.__TConnectionPointsCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
procedure TatAxCtrlsLibrary.__GetTConnectionPointsController(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
