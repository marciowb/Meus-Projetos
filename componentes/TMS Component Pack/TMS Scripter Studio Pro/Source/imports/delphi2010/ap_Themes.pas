...
begin
  with AMachine do
  begin
AResult := Integer(TThemeServices(CurrentObject).ColorToRGB(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TThemeServices(CurrentObject).DrawIcon(VarToInteger(GetInputArg(0)),TThemedElementDetailsWrapper(integer(GetInputArg(1))).ObjToRec,TRectWrapper(integer(GetInputArg(2))).ObjToRec,GetInputArg(3),VarToInteger(GetInputArg(4)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TThemeServices(CurrentObject).Theme[GetArrayIndex(0)]);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ColorToRGB',1,tkInteger,nil,__TThemeServicesColorToRGB,false,0);
    DefineMethod('ContentRect',3,tkVariant,nil,__TThemeServicesContentRect,false,0);
    DefineMethod('DrawEdge',5,tkNone,nil,__TThemeServicesDrawEdge,false,0);
    DefineMethod('DrawElement',3,tkNone,nil,__TThemeServicesDrawElement,false,0);
    ...
    DefineProp('Theme',tkVariant,__GetTThemeServicesTheme,nil,nil,false,1);
