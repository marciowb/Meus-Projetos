...
begin
  with AMachine do
  begin
AResult := Integer(TCustomActionMenuBar(CurrentObject).CreateControl(TActionClientItem(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionMenuBar(CurrentObject).PopupStack));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomActionPopupMenu(CurrentObject).CreateControl(TActionClientItem(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomActionMainMenuBar(CurrentObject).CreateControl(TActionClientItem(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionMenuBarCreateControl,false,0);
  ...
  begin
    ...
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionPopupMenuDesignWndProc,false,0).SetVarArgs([0]);
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionPopupMenuCreateControl,false,0);
  ...
  begin
    ...
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionMainMenuBarCreateControl,false,0);
    ...
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionMainMenuBarDesignWndProc,false,0).SetVarArgs([0]);
