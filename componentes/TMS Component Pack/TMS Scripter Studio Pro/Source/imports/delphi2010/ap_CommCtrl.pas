...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Create(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Destroy(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_GetImageCount(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_SetImageCount(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_Add(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_ReplaceIcon(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_SetBkColor(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_GetBkColor(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_SetOverlayImage(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_AddIcon(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Draw(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Replace(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_AddMasked(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_DrawEx(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),VarToInteger(GetInputArg(7)),VarToInteger(GetInputArg(8)),VarToInteger(GetInputArg(9)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Remove(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_GetIcon(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadImage(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadImageA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadImageW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_Copy(GetInputArg(0),VarToInteger(GetInputArg(1)),GetInputArg(2),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_BeginDrag(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_SetDragCursorImage(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    CommCtrl.ImageList_RemoveAll(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_ExtractIcon(GetInputArg(0),GetInputArg(1),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadBitmap(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadBitmapA(GetInputArg(0),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_LoadBitmapW(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := CommCtrl.ImageList_GetIconSize(GetInputArg(0),Param1,Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_SetIconSize(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := CommCtrl.ImageList_GetImageInfo(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Merge(GetInputArg(0),VarToInteger(GetInputArg(1)),GetInputArg(2),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ImageList_Duplicate(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_SetImageList(VarToInteger(GetInputArg(0)),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_GetImageList(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_CreateDragImage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.CreateStatusWindow(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.CreateStatusWindowA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.CreateUpDownControl(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),GetInputArg(7),VarToInteger(GetInputArg(8)),VarToInteger(GetInputArg(9)),VarToInteger(GetInputArg(10)),VarToInteger(GetInputArg(11))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetImageList(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetImageList(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetStringWidth(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetStringWidthA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_CreateDragImage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),TPointWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetItemText(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetItemTextA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetItemText(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetItemTextA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetISearchString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetISearchStringA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetGroupHeaderImageList(VarToInteger(GetInputArg(0)),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetGroupHeaderImageList(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetEmptyText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetItemIndexState(VarToInteger(GetInputArg(0)),tagLVITEMINDEXWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_GetImageList(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_SetImageList(VarToInteger(GetInputArg(0)),GetInputArg(1),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_GetISearchString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_GetISearchStringA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Animate_Create(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Animate_OpenEx(VarToInteger(GetInputArg(0)),GetInputArg(1),PChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.DateTime_SetFormat(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.DateTime_SetFormatA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Button_SetNote(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := CommCtrl.Button_GetNote(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Edit_SetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Edit_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ComboBox_SetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ComboBox_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := CommCtrl.LoadIconMetric(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
AResult := CommCtrl.LoadIconWithScaleDown(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.DrawShadowText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec,VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),VarToInteger(GetInputArg(7)),VarToInteger(GetInputArg(8))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ImageList_Create',5,tkVariant,nil,__ImageList_Create,false,0);
    ...
    DefineMethod('ImageList_LoadImage',7,tkVariant,nil,__ImageList_LoadImage,false,0);
    DefineMethod('ImageList_LoadImageA',7,tkVariant,nil,__ImageList_LoadImageA,false,0);
    DefineMethod('ImageList_LoadImageW',7,tkVariant,nil,__ImageList_LoadImageW,false,0);
    ...
    DefineMethod('ImageList_LoadBitmap',5,tkVariant,nil,__ImageList_LoadBitmap,false,0);
    DefineMethod('ImageList_LoadBitmapA',5,tkVariant,nil,__ImageList_LoadBitmapA,false,0);
    DefineMethod('ImageList_LoadBitmapW',5,tkVariant,nil,__ImageList_LoadBitmapW,false,0);
    ...
    DefineMethod('ImageList_Merge',6,tkVariant,nil,__ImageList_Merge,false,0);
    DefineMethod('ImageList_Duplicate',1,tkVariant,nil,__ImageList_Duplicate,false,0);
    ...
    DefineMethod('Header_InsertItemA',3,tkInteger,nil,__Header_InsertItemA,false,0);
    DefineMethod('Header_InsertItemW',3,tkInteger,nil,__Header_InsertItemW,false,0);
    ...
    DefineMethod('Header_GetItemA',3,tkVariant,nil,__Header_GetItemA,false,0).SetVarArgs([2]);
    DefineMethod('Header_GetItemW',3,tkVariant,nil,__Header_GetItemW,false,0).SetVarArgs([2]);
    DefineMethod('Header_SetItem',3,tkVariant,nil,__Header_SetItem,false,0);
    DefineMethod('Header_SetItemA',3,tkVariant,nil,__Header_SetItemA,false,0);
    DefineMethod('Header_SetItemW',3,tkVariant,nil,__Header_SetItemW,false,0);
    DefineMethod('Header_SetImageList',2,tkVariant,nil,__Header_SetImageList,false,0);
    DefineMethod('Header_GetImageList',1,tkVariant,nil,__Header_GetImageList,false,0);
    DefineMethod('Header_OrderToIndex',2,tkInteger,nil,__Header_OrderToIndex,false,0);
    DefineMethod('Header_CreateDragImage',2,tkVariant,nil,__Header_CreateDragImage,false,0);
    ...
    DefineMethod('Header_SetBitmapMargin',2,tkInteger,nil,__Header_SetBitmapMargin,false,0);
    DefineMethod('Header_GetBitmapMargin',1,tkInteger,nil,__Header_GetBitmapMargin,false,0);
    DefineMethod('Header_SetFilterChangeTimeout',2,tkInteger,nil,__Header_SetFilterChangeTimeout,false,0);
    DefineMethod('Header_EditFilter',3,tkInteger,nil,__Header_EditFilter,false,0);
    DefineMethod('Header_ClearFilter',2,tkInteger,nil,__Header_ClearFilter,false,0);
    DefineMethod('Header_ClearAllFilters',1,tkInteger,nil,__Header_ClearAllFilters,false,0);
    DefineMethod('Header_GetItemDropDownRect',3,tkVariant,nil,__Header_GetItemDropDownRect,false,0).SetVarArgs([2]);
    DefineMethod('Header_GetOverflowRect',2,tkVariant,nil,__Header_GetOverflowRect,false,0).SetVarArgs([1]);
    DefineMethod('Header_GetFocusedItem',1,tkInteger,nil,__Header_GetFocusedItem,false,0);
    DefineMethod('Header_SetFocusedItem',2,tkVariant,nil,__Header_SetFocusedItem,false,0);
    ...
    DefineMethod('ListView_SetUnicodeFormat',2,tkVariant,nil,__ListView_SetUnicodeFormat,false,0);
    ...
    DefineMethod('ListView_GetImageList',2,tkVariant,nil,__ListView_GetImageList,false,0);
    DefineMethod('ListView_SetImageList',3,tkVariant,nil,__ListView_SetImageList,false,0);
    ...
    DefineMethod('ListView_CreateDragImage',3,tkVariant,nil,__ListView_CreateDragImage,false,0);
    ...
    DefineMethod('ListView_SetSelectedColumn',2,tkInteger,nil,__ListView_SetSelectedColumn,false,0);
    DefineMethod('ListView_SetView',2,tkInteger,nil,__ListView_SetView,false,0);
    DefineMethod('ListView_GetView',1,tkInteger,nil,__ListView_GetView,false,0);
    DefineMethod('ListView_InsertGroup',3,tkInteger,nil,__ListView_InsertGroup,false,0);
    DefineMethod('ListView_SetGroupInfo',3,tkInteger,nil,__ListView_SetGroupInfo,false,0);
    DefineMethod('ListView_GetGroupInfo',3,tkInteger,nil,__ListView_GetGroupInfo,false,0).SetVarArgs([2]);
    DefineMethod('ListView_RemoveGroup',2,tkInteger,nil,__ListView_RemoveGroup,false,0);
    DefineMethod('ListView_MoveGroup',3,tkInteger,nil,__ListView_MoveGroup,false,0);
    DefineMethod('ListView_GetGroupCount',1,tkInteger,nil,__ListView_GetGroupCount,false,0);
    DefineMethod('ListView_GetGroupInfoByIndex',3,tkInteger,nil,__ListView_GetGroupInfoByIndex,false,0).SetVarArgs([2]);
    DefineMethod('ListView_MoveItemToGroup',3,tkInteger,nil,__ListView_MoveItemToGroup,false,0);
    DefineMethod('ListView_GetGroupRect',4,tkInteger,nil,__ListView_GetGroupRect,false,0).SetVarArgs([3]);
    DefineMethod('ListView_SetGroupMetrics',2,tkInteger,nil,__ListView_SetGroupMetrics,false,0);
    DefineMethod('ListView_GetGroupMetrics',2,tkInteger,nil,__ListView_GetGroupMetrics,false,0).SetVarArgs([1]);
    DefineMethod('ListView_EnableGroupView',2,tkInteger,nil,__ListView_EnableGroupView,false,0);
    DefineMethod('ListView_InsertGroupSorted',2,tkInteger,nil,__ListView_InsertGroupSorted,false,0);
    DefineMethod('ListView_RemoveAllGroups',1,tkInteger,nil,__ListView_RemoveAllGroups,false,0);
    DefineMethod('ListView_HasGroup',2,tkInteger,nil,__ListView_HasGroup,false,0);
    DefineMethod('ListView_SetGroupState',4,tkInteger,nil,__ListView_SetGroupState,false,0);
    DefineMethod('ListView_GetGroupState',3,tkInteger,nil,__ListView_GetGroupState,false,0);
    DefineMethod('ListView_GetFocusedGroup',1,tkInteger,nil,__ListView_GetFocusedGroup,false,0);
    DefineMethod('ListView_SetTileViewInfo',2,tkInteger,nil,__ListView_SetTileViewInfo,false,0);
    DefineMethod('ListView_GetTileViewInfo',2,tkInteger,nil,__ListView_GetTileViewInfo,false,0).SetVarArgs([1]);
    DefineMethod('ListView_SetTileInfo',2,tkInteger,nil,__ListView_SetTileInfo,false,0);
    DefineMethod('ListView_GetTileInfo',2,tkInteger,nil,__ListView_GetTileInfo,false,0).SetVarArgs([1]);
    DefineMethod('ListView_SetInsertMark',2,tkVariant,nil,__ListView_SetInsertMark,false,0);
    DefineMethod('ListView_GetInsertMark',2,tkVariant,nil,__ListView_GetInsertMark,false,0).SetVarArgs([1]);
    DefineMethod('ListView_InsertMarkHitTest',3,tkInteger,nil,__ListView_InsertMarkHitTest,false,0);
    DefineMethod('ListView_GetInsertMarkRect',2,tkInteger,nil,__ListView_GetInsertMarkRect,false,0).SetVarArgs([1]);
    DefineMethod('ListView_SetInsertMarkColor',2,tkInteger,nil,__ListView_SetInsertMarkColor,false,0);
    DefineMethod('ListView_GetInsertMarkColor',1,tkInteger,nil,__ListView_GetInsertMarkColor,false,0);
    DefineMethod('ListView_SetInfoTip',2,tkVariant,nil,__ListView_SetInfoTip,false,0);
    DefineMethod('ListView_GetSelectedColumn',1,tkInteger,nil,__ListView_GetSelectedColumn,false,0);
    DefineMethod('ListView_IsGroupViewEnabled',1,tkVariant,nil,__ListView_IsGroupViewEnabled,false,0);
    DefineMethod('ListView_GetOutlineColor',1,tkInteger,nil,__ListView_GetOutlineColor,false,0);
    DefineMethod('ListView_SetOutlineColor',2,tkInteger,nil,__ListView_SetOutlineColor,false,0);
    DefineMethod('ListView_CancelEditLabel',1,tkInteger,nil,__ListView_CancelEditLabel,false,0);
    DefineMethod('ListView_MapIndexToID',2,tkInteger,nil,__ListView_MapIndexToID,false,0);
    DefineMethod('ListView_MapIDToIndex',2,tkInteger,nil,__ListView_MapIDToIndex,false,0);
    DefineMethod('ListView_IsItemVisible',2,tkInteger,nil,__ListView_IsItemVisible,false,0);
    DefineMethod('ListView_SetGroupHeaderImageList',2,tkVariant,nil,__ListView_SetGroupHeaderImageList,false,0);
    DefineMethod('ListView_GetGroupHeaderImageList',1,tkVariant,nil,__ListView_GetGroupHeaderImageList,false,0);
    DefineMethod('ListView_GetEmptyText',3,tkVariant,nil,__ListView_GetEmptyText,false,0);
    DefineMethod('ListView_GetFooterRect',2,tkVariant,nil,__ListView_GetFooterRect,false,0).SetVarArgs([1]);
    DefineMethod('ListView_GetFooterInfo',2,tkVariant,nil,__ListView_GetFooterInfo,false,0).SetVarArgs([1]);
    DefineMethod('ListView_GetFooterItemRect',3,tkVariant,nil,__ListView_GetFooterItemRect,false,0).SetVarArgs([2]);
    DefineMethod('ListView_GetFooterItem',3,tkVariant,nil,__ListView_GetFooterItem,false,0).SetVarArgs([2]);
    DefineMethod('ListView_GetItemIndexRect',5,tkVariant,nil,__ListView_GetItemIndexRect,false,0).SetVarArgs([4]);
    DefineMethod('ListView_SetItemIndexState',4,tkVariant,nil,__ListView_SetItemIndexState,false,0);
    DefineMethod('ListView_GetNextItemIndex',3,tkVariant,nil,__ListView_GetNextItemIndex,false,0).SetVarArgs([1]);
    ...
    DefineMethod('TreeView_GetImageList',2,tkVariant,nil,__TreeView_GetImageList,false,0);
    DefineMethod('TreeView_SetImageList',3,tkVariant,nil,__TreeView_SetImageList,false,0);
    ...
    DefineMethod('TreeView_SetLineColor',2,tkInteger,nil,__TreeView_SetLineColor,false,0);
    DefineMethod('TreeView_GetLineColor',1,tkInteger,nil,__TreeView_GetLineColor,false,0);
    DefineMethod('TreeView_SetExtendedStyle',3,tkInteger,nil,__TreeView_SetExtendedStyle,false,0);
    DefineMethod('TreeView_GetExtendedStyle',1,tkInteger,nil,__TreeView_GetExtendedStyle,false,0);
    DefineMethod('TreeView_SetAutoScrollInfo',3,tkInteger,nil,__TreeView_SetAutoScrollInfo,false,0);
    DefineMethod('TreeView_GetSelectedCount',1,tkInteger,nil,__TreeView_GetSelectedCount,false,0);
    DefineMethod('TabCtrl_HitTest',2,tkInteger,nil,__TabCtrl_HitTest,false,0);
    ...
    DefineMethod('Button_GetIdealSize',2,tkVariant,nil,__Button_GetIdealSize,false,0).SetVarArgs([1]);
    DefineMethod('Button_SetImageList',2,tkVariant,nil,__Button_SetImageList,false,0);
    DefineMethod('Button_GetImageList',2,tkVariant,nil,__Button_GetImageList,false,0).SetVarArgs([1]);
    DefineMethod('Button_SetTextMargin',2,tkVariant,nil,__Button_SetTextMargin,false,0);
    DefineMethod('Button_GetTextMargin',2,tkVariant,nil,__Button_GetTextMargin,false,0).SetVarArgs([1]);
    DefineMethod('Button_SetDropDownState',2,tkVariant,nil,__Button_SetDropDownState,false,0);
    DefineMethod('Button_SetSplitInfo',2,tkVariant,nil,__Button_SetSplitInfo,false,0);
    DefineMethod('Button_GetSplitInfo',2,tkVariant,nil,__Button_GetSplitInfo,false,0).SetVarArgs([1]);
    DefineMethod('Button_SetNote',2,tkVariant,nil,__Button_SetNote,false,0);
    DefineMethod('Button_GetNote',3,tkVariant,nil,__Button_GetNote,false,0).SetVarArgs([2]);
    DefineMethod('Button_GetNoteLength',1,tkInteger,nil,__Button_GetNoteLength,false,0);
    DefineMethod('Button_SetElevationRequiredState',2,tkInteger,nil,__Button_SetElevationRequiredState,false,0);
    DefineMethod('Edit_SetCueBannerText',2,tkVariant,nil,__Edit_SetCueBannerText,false,0);
    DefineMethod('Edit_GetCueBannerText',3,tkVariant,nil,__Edit_GetCueBannerText,false,0);
    DefineMethod('Edit_ShowBalloonTip',2,tkVariant,nil,__Edit_ShowBalloonTip,false,0);
    DefineMethod('Edit_HideBalloonTip',1,tkVariant,nil,__Edit_HideBalloonTip,false,0);
    DefineMethod('Edit_SetHilite',3,tkNone,nil,__Edit_SetHilite,false,0);
    DefineMethod('Edit_GetHilite',1,tkInteger,nil,__Edit_GetHilite,false,0);
    DefineMethod('ComboBox_SetMinVisible',2,tkVariant,nil,__ComboBox_SetMinVisible,false,0);
    DefineMethod('ComboBox_GetMinVisible',1,tkInteger,nil,__ComboBox_GetMinVisible,false,0);
    DefineMethod('ComboBox_SetCueBannerText',2,tkVariant,nil,__ComboBox_SetCueBannerText,false,0);
    DefineMethod('ComboBox_GetCueBannerText',3,tkVariant,nil,__ComboBox_GetCueBannerText,false,0);
    ...
    DefineMethod('DefSubclassProc',4,tkInteger,nil,__DefSubclassProc,false,0);
    DefineMethod('LoadIconMetric',4,tkVariant,nil,__LoadIconMetric,false,0).SetVarArgs([3]);
    DefineMethod('LoadIconWithScaleDown',5,tkVariant,nil,__LoadIconWithScaleDown,false,0).SetVarArgs([4]);
    DefineMethod('DrawShadowText',9,tkInteger,nil,__DrawShadowText,false,0);
    AddConsts1;
    AddConsts2;
    AddConsts3;
