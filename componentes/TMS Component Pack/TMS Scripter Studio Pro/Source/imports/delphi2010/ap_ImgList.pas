...
begin
  with AMachine do
  begin
AResult := Integer(TCustomImageList(CurrentObject).AddImage(TCustomImageList(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).GetBitmap(VarToInteger(GetInputArg(0)),TBitmap(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).ResInstLoad(GetInputArg(0),GetInputArg(1),GetInputArg(2),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomImageList(CurrentObject).Handle);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).Handle:=GetInputArg(0);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('AddImage',2,tkInteger,nil,__TCustomImageListAddImage,false,0);
    ...
    DefineMethod('GetBitmap',2,tkVariant,nil,__TCustomImageListGetBitmap,false,0);
    ...
    DefineMethod('SetSize',2,tkNone,nil,__TCustomImageListSetSize,false,0);
    ...
    DefineProp('Handle',tkVariant,__GetTCustomImageListHandle,__SetTCustomImageListHandle,nil,false,0);
