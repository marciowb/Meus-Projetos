...
type
  ...
  published
    property Lineage: TGUID read FLineage write FLineage;
  ...
  published
    property Itf: IUnknown read FItf write FItf;
  ...
  published
    property fmtid: TFmtID read Ffmtid write Ffmtid;
    property clsid: TClsID read Fclsid write Fclsid;
  ...
  published
    property catid: TGUID read Fcatid write Fcatid;
  ...
  published
    property cbSize: LongInt read FcbSize write FcbSize;
    property pUnkEventSink: IUnknown read FpUnkEventSink write FpUnkEventSink;
...
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FpUnkEventSink := ARecord.pUnkEventSink;
...
begin
  result.cbSize := FcbSize;
  result.pUnkEventSink := FpUnkEventSink;
...
begin
  with AMachine do
  begin
AResult := ActiveX.Succeeded(GetInputArg(0));
...
begin
  with AMachine do
  begin
AResult := ActiveX.Failed(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.ResultCode(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.ResultFacility(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.ResultSeverity(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.MakeResult(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoRevokeMallocSpy;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__CoRegisterClassObject(AMachine: TatVirtualMachine);
  var
  Param4: Longint;
  AResult: variant;
begin
...
AResult := ActiveX.CoRegisterClassObject(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoRevokeClassObject(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoResumeClassObjects;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoSuspendClassObjects;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActiveXLibrary.__CoDisconnectObject(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.CoDisconnectObject(GetInputArg(0),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__CoLockObjectExternal(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.CoLockObjectExternal(GetInputArg(0),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__CoIsHandlerConnected(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.CoIsHandlerConnected(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__CoCreateFreeThreadedMarshaler(AMachine: TatVirtualMachine);
  var
  Param1: IUnknown;
  AResult: variant;
begin
...
AResult := ActiveX.CoCreateFreeThreadedMarshaler(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoLoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ActiveX.CoFreeLibrary(GetInputArg(0));
  end;
end;
...
procedure TatActiveXLibrary.__CoCopyProxy(AMachine: TatVirtualMachine);
  var
  Param1: IUnknown;
  AResult: variant;
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := ActiveX.CoCopyProxy(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoImpersonateClient;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.CoRevertToSelf;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__CoSwitchCallContext(AMachine: TatVirtualMachine);
  var
  Param1: IUnknown;
  AResult: variant;
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := ActiveX.CoSwitchCallContext(GetInputArg(0),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;

procedure TatActiveXLibrary.__CoCreateInstance(AMachine: TatVirtualMachine);
  var
  Param4: Variant;
  AResult: variant;
begin
...
AResult := ActiveX.CoCreateInstance(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
...
AResult := ActiveX.CoFileTimeNow(Param0);
    ReturnOutputArg(AResult);
...
procedure TatActiveXLibrary.__CreateDataCache(AMachine: TatVirtualMachine);
  var
  Param3: Variant;
  AResult: variant;
begin
...
AResult := ActiveX.CreateDataCache(GetInputArg(0),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ActiveX.StgIsStorageFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.StgSetTimes(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := ActiveX.VariantClear(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := ActiveX.VariantCopy(Param0,GetInputArg(1));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := ActiveX.VariantCopyInd(Param0,GetInputArg(1));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := ActiveX.VariantChangeType(Param0,GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
Param0 := GetInputArg(0);
AResult := ActiveX.VariantChangeTypeEx(Param0,GetInputArg(1),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
  end;
end;

procedure TatActiveXLibrary.__VarUI1FromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Byte;
  AResult: variant;
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := ActiveX.VarUI1FromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatActiveXLibrary.__VarI2FromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Smallint;
  AResult: variant;
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := ActiveX.VarI2FromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatActiveXLibrary.__VarI4FromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Longint;
  AResult: variant;
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := ActiveX.VarI4FromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatActiveXLibrary.__VarR4FromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Single;
  AResult: variant;
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ActiveX.VarR4FromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;

procedure TatActiveXLibrary.__VarR8FromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Double;
  AResult: variant;
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ActiveX.VarR8FromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;

procedure TatActiveXLibrary.__VarDateFromDisp(AMachine: TatVirtualMachine);
  var
  Param2: TOleDate;
  AResult: variant;
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ActiveX.VarDateFromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;

procedure TatActiveXLibrary.__VarCyFromDisp(AMachine: TatVirtualMachine);
  var
  Param2: Currency;
  AResult: variant;
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ActiveX.VarCyFromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;

procedure TatActiveXLibrary.__VarBoolFromDisp(AMachine: TatVirtualMachine);
  var
  Param2: TOleBool;
  AResult: variant;
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := ActiveX.VarBoolFromDisp(GetInputArg(0),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.LHashValOfNameSysA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param3 := GetInputArg(3);
Param4 := VarToInteger(GetInputArg(4));
AResult := ActiveX.DispGetParam(tagDISPPARAMSWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
    SetInputArg(4,Integer(Param4));
  end;
...
procedure TatActiveXLibrary.__RegisterActiveObject(AMachine: TatVirtualMachine);
  var
  Param3: Longint;
  AResult: variant;
begin
...
AResult := ActiveX.RegisterActiveObject(GetInputArg(0),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleBuildVersion;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActiveXLibrary.__OleSetContainedObject(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.OleSetContainedObject(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__OleNoteObjectVisible(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.OleNoteObjectVisible(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.RevokeDragDrop(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleFlushClipboard;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleDestroyMenuDescriptor(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleDuplicateData(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__OleDraw(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.OleDraw(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__OleRun(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.OleRun(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActiveXLibrary.__OleLockRunning(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ActiveX.OleLockRunning(GetInputArg(0),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActiveXLibrary.__OleCreateDefaultHandler(AMachine: TatVirtualMachine);
  var
  Param3: Variant;
  AResult: variant;
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := ActiveX.OleCreateDefaultHandler(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleGetIconOfFile(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleMetafilePictFromIconAndLabel(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),StringToWideChar(VarToStr(GetInputArg(2)),Param2Buf,Length(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ActiveX.OleCreatePropertyFrameIndirect(tagOCPFIPARAMSWrapper(integer(GetInputArg(0))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := ActiveX.OleTranslateColor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.OleIconToCursor(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('CoResumeClassObjects',0,tkVariant,nil,__CoResumeClassObjects,false,0);
    DefineMethod('CoSuspendClassObjects',0,tkVariant,nil,__CoSuspendClassObjects,false,0);
    ...
    DefineMethod('CoGetPSClsid',2,tkVariant,nil,__CoGetPSClsid,false,0).SetVarArgs([1]);
    DefineMethod('CoRegisterPSClsid',2,tkVariant,nil,__CoRegisterPSClsid,false,0);
    ...
    DefineMethod('CoCopyProxy',2,tkVariant,nil,__CoCopyProxy,false,0).SetVarArgs([1]);
    DefineMethod('CoImpersonateClient',0,tkVariant,nil,__CoImpersonateClient,false,0);
    DefineMethod('CoRevertToSelf',0,tkVariant,nil,__CoRevertToSelf,false,0);
    DefineMethod('CoSwitchCallContext',2,tkVariant,nil,__CoSwitchCallContext,false,0).SetVarArgs([1]);
    ...
    DefineMethod('UnRegisterTypeLib',5,tkVariant,nil,__UnRegisterTypeLib,false,0);
    DefineMethod('DispGetParam',5,tkVariant,nil,__DispGetParam,false,0).SetVarArgs([3,4]);
    ...
    DefineMethod('OleCreatePropertyFrameIndirect',1,tkVariant,nil,__OleCreatePropertyFrameIndirect,false,0);
    DefineMethod('OleTranslateColor',3,tkVariant,nil,__OleTranslateColor,false,0).SetVarArgs([2]);
    DefineMethod('OleCreateFontIndirect',3,tkVariant,nil,__OleCreateFontIndirect,false,0).SetVarArgs([2]);
    DefineMethod('OleCreatePictureIndirect',4,tkVariant,nil,__OleCreatePictureIndirect,false,0).SetVarArgs([3]);
