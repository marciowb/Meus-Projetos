...
// (DO NOT EDIT: machine generated header) 'Ap_windows.pas' rev: 21.00
...
class DELPHICLASS _BLENDFUNCTIONWrapper;
class PASCALIMPLEMENTATION _BLENDFUNCTIONWrapper : public Atscript::TatRecordWrapper
{
	typedef Atscript::TatRecordWrapper inherited;
	
private:
	System::Byte FBlendOp;
	System::Byte FBlendFlags;
	System::Byte FSourceConstantAlpha;
	System::Byte FAlphaFormat;
	
public:
	__fastcall _BLENDFUNCTIONWrapper(_BLENDFUNCTION ARecord);
	_BLENDFUNCTION __fastcall ObjToRec(void);
	
__published:
	__property System::Byte BlendOp = {read=FBlendOp, write=FBlendOp, nodefault};
	__property System::Byte BlendFlags = {read=FBlendFlags, write=FBlendFlags, nodefault};
	__property System::Byte SourceConstantAlpha = {read=FSourceConstantAlpha, write=FSourceConstantAlpha, nodefault};
	__property System::Byte AlphaFormat = {read=FAlphaFormat, write=FAlphaFormat, nodefault};
public:
	/* TObject.Destroy */ inline __fastcall virtual ~_BLENDFUNCTIONWrapper(void) { }
