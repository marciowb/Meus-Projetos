...
begin
  with AMachine do
  begin
    ComObj.CreateRegKey(GetInputArg(0),GetInputArg(1),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
    ComObj.DeleteRegKey(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ComObj.GetRegStringValue(GetInputArg(0),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('CreateRegKey',3,tkNone,nil,__CreateRegKey,false,0);
    DefineMethod('DeleteRegKey',1,tkNone,nil,__DeleteRegKey,false,0);
    DefineMethod('GetRegStringValue',2,tkVariant,nil,__GetRegStringValue,false,0);
