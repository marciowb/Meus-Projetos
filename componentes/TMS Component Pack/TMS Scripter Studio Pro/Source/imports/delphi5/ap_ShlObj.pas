...
begin
  with AMachine do
  begin
Param0 := SHELLFLAGSTATEWrapper(integer(GetInputArg(0))).ObjToRec;
...
begin
  ...
  begin
    DefineMethod('SHGetSpecialFolderPathA',4,tkVariant,nil,__SHGetSpecialFolderPathA,false);
    DefineMethod('SHGetSpecialFolderPathW',4,tkVariant,nil,__SHGetSpecialFolderPathW,false);
    DefineMethod('SHGetSpecialFolderPath',4,tkVariant,nil,__SHGetSpecialFolderPath,false);
    DefineMethod('SHLoadInProc',1,tkInteger,nil,__SHLoadInProc,false);
    DefineMethod('SHGetSettings',2,tkNone,nil,__SHGetSettings,false).SetVarArgs([0]);
