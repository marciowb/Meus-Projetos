...
type
  TatControlsLibrary = class(TatScripterLibrary)
    ...
    procedure __TWinControlMouseWheelHandler(AMachine: TatVirtualMachine);
...
procedure TatControlsLibrary.__TWinControlMouseWheelHandler(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TMessage;
begin
...
Param0 := TMessageWrapper(Param0Rec).ObjToRec;
    TWinControl(CurrentObject).MouseWheelHandler(Param0);
...
begin
  ...
  begin
    ...
    DefineMethod('ControlAtPos',3,tkClass,TControl,__TWinControlControlAtPos,false,1);
    ...
    DefineMethod('MouseWheelHandler',1,tkNone,nil,__TWinControlMouseWheelHandler,false,0).SetVarArgs([0]);
