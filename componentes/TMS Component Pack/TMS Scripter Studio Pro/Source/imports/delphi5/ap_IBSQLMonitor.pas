...
type
  TatIBSQLMonitorLibrary = class(TatScripterLibrary)
    ...
    procedure __AddWriter(AMachine: TatVirtualMachine);
    procedure __RemoveWriter(AMachine: TatVirtualMachine);
...
procedure TatIBSQLMonitorLibrary.__AddWriter(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    IBSQLMonitor.AddWriter;
  end;
end;

procedure TatIBSQLMonitorLibrary.__RemoveWriter(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    IBSQLMonitor.RemoveWriter;
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('AddWriter',0,tkNone,nil,__AddWriter,false,0);
    DefineMethod('RemoveWriter',0,tkNone,nil,__RemoveWriter,false,0);
