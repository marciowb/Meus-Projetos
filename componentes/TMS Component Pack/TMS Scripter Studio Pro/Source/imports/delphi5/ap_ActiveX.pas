...
procedure TatActiveXLibrary.__VarUI1FromCy(AMachine: TatVirtualMachine);
  var
  Param1: Byte;
  AResult: variant;
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(ActiveX.VarUI1FromCy(GetInputArg(0),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;

procedure TatActiveXLibrary.__VarUI1FromDate(AMachine: TatVirtualMachine);
  var
  Param1: Byte;
  AResult: variant;
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(ActiveX.VarUI1FromDate(GetInputArg(0),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
