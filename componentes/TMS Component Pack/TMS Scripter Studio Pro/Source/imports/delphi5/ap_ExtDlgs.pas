...
type
  TatExtDlgsLibrary = class(TatScripterLibrary)
    ...
    procedure __TOpenPictureDialogDestroy(AMachine: TatVirtualMachine);
...
procedure TatExtDlgsLibrary.__TOpenPictureDialogDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TOpenPictureDialog(CurrentObject).Destroy;
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Destroy',0,tkNone,nil,__TOpenPictureDialogDestroy,false,0);
