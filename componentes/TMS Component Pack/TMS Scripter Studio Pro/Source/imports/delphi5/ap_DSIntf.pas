...
type
  ...
  published
    ...
    property bCalculated: Bool read FbCalculated write FbCalculated;
  ...
  published
    ...
    property bUnique: Bool read FbUnique write FbUnique;
  end;
