...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TFileListBox,__TFileListBoxCreate,true,0);
    ...
    DefineMethod('ApplyFilePath',1,tkNone,nil,__TFileListBoxApplyFilePath,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TDirectoryListBox,__TDirectoryListBoxCreate,true,0);
    DefineMethod('Destroy',0,tkNone,nil,__TDirectoryListBoxDestroy,false,0);
    DefineMethod('DisplayCase',1,tkVariant,nil,__TDirectoryListBoxDisplayCase,false,0);
    DefineMethod('FileCompareText',2,tkInteger,nil,__TDirectoryListBoxFileCompareText,false,0);
    DefineMethod('GetItemPath',1,tkVariant,nil,__TDirectoryListBoxGetItemPath,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TDriveComboBox,__TDriveComboBoxCreate,true,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TFilterComboBox,__TFilterComboBoxCreate,true,0);
  ...
  begin
    DefineMethod('ProcessPath',4,tkNone,nil,__ProcessPath,false,0).SetVarArgs([1,2,3]);
    DefineMethod('MinimizeName',3,tkVariant,nil,__MinimizeName,false,0);
    DefineMethod('SelectDirectory',3,tkVariant,nil,__SelectDirectory,false,0).SetVarArgs([0]);
