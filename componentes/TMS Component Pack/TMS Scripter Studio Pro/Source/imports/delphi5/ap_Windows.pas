...
type
  TatWindowsLibrary = class(TatScripterLibrary)
    ...
    procedure ___lclose(AMachine: TatVirtualMachine);
...
procedure TatWindowsLibrary.___lclose(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows._lclose(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('_lclose',1,tkInteger,nil,___lclose,false,0);
