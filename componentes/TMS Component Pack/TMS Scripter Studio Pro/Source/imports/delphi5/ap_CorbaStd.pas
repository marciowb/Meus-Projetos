...
begin
  ...
  begin
    DefineMethod('AS_ApplyUpdates',5,tkVariant,nil,__TAppServerStubAS_ApplyUpdates,false,0).SetVarArgs([3,4]);
    DefineMethod('AS_GetRecords',7,tkVariant,nil,__TAppServerStubAS_GetRecords,false,0).SetVarArgs([2,5,6]);
    DefineMethod('AS_DataRequest',2,tkVariant,nil,__TAppServerStubAS_DataRequest,false,0);
    DefineMethod('AS_GetProviderNames',0,tkVariant,nil,__TAppServerStubAS_GetProviderNames,false,0);
    DefineMethod('AS_GetParams',2,tkVariant,nil,__TAppServerStubAS_GetParams,false,0).SetVarArgs([1]);
    DefineMethod('AS_RowRequest',4,tkVariant,nil,__TAppServerStubAS_RowRequest,false,0).SetVarArgs([3]);
    DefineMethod('AS_Execute',4,tkNone,nil,__TAppServerStubAS_Execute,false,0).SetVarArgs([2,3]);
  end;
