...
begin
  ...
  begin
    ...
    AddConstant('DSQL_cancel',DSQL_cancel);
    AddConstant('IBASE_DLL',IBASE_DLL);
    AddConstant('IBXML_DLL',IBXML_DLL);
    ...
    AddConstant('blr_rows',blr_rows);
    AddConstant('blr_ties',blr_ties);
    AddConstant('blr_percent',blr_percent);
    ...
    AddConstant('isc_dpb_gbak_ods_version',isc_dpb_gbak_ods_version);
    AddConstant('isc_dpb_gbak_ods_minor_version',isc_dpb_gbak_ods_minor_version);
