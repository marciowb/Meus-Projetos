...
procedure TatFormsLibrary.__TDataModuleCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
procedure TatFormsLibrary.__TDataModuleCreateNew(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
procedure TatFormsLibrary.__TDataModuleDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__TDataModuleAfterConstruction(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__TDataModuleBeforeDestruction(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__GetTDataModuleDesignOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__SetTDataModuleDesignOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__GetTDataModuleDesignSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatFormsLibrary.__SetTDataModuleDesignSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
begin
  with AMachine do
  begin
AResult := Integer(TApplication(CurrentObject).MessageBox(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Forms.GetParentForm(TControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Forms.ValidParentForm(TControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('MessageBox',3,tkInteger,nil,__TApplicationMessageBox,false,0);
  ...
  begin
    DefineMethod('GetParentForm',1,tkClass,TCustomForm,__GetParentForm,false,0);
    DefineMethod('ValidParentForm',1,tkClass,TCustomForm,__ValidParentForm,false,0);
    DefineMethod('IsAccel',2,tkVariant,nil,__IsAccel,false,0);
    DefineMethod('Subclass3DWnd',1,tkVariant,nil,__Subclass3DWnd,false,0);
    DefineMethod('Subclass3DDlg',2,tkNone,nil,__Subclass3DDlg,false,0);
    DefineMethod('SetAutoSubClass',1,tkNone,nil,__SetAutoSubClass,false,0);
