...
type
  TatSysInitLibrary = class(TatScripterLibrary)
    procedure ___GetTls(AMachine: TatVirtualMachine);
    procedure ___InitExe(AMachine: TatVirtualMachine);
...
procedure TatSysInitLibrary.___GetTls(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    SysInit._GetTls;
...
procedure TatSysInitLibrary.___InitExe(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    SysInit._InitExe;
...
begin
  ...
  begin
    DefineMethod('_GetTls',0,tkNone,nil,___GetTls,false);
    DefineMethod('_InitExe',0,tkNone,nil,___InitExe,false);
    DefineMethod('VclInit',4,tkNone,nil,__VclInit,false);
    DefineMethod('VclExit',0,tkNone,nil,__VclExit,false);
