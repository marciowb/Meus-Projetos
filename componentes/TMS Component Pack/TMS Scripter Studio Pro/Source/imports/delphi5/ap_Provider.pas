...
type
  ...
  private
    ...
    procedure __TProviderDataEvent( Sender: TObject;  DataSet: TClientDataSet);
    procedure __TBeforeUpdateRecordEvent( Sender: TObject;  SourceDS: TDataSet;  DeltaDS: TClientDataSet;  UpdateKind: TUpdateKind; var Applied: Boolean);
    procedure __TAfterUpdateRecordEvent( Sender: TObject;  SourceDS: TDataSet;  DeltaDS: TClientDataSet;  UpdateKind: TUpdateKind);
    procedure __TResolverErrorEvent( Sender: TObject;  DataSet: TClientDataSet;  E: EUpdateError;  UpdateKind: TUpdateKind; var Response: TResolverResponse);
...
procedure TatProviderDispatcher.__TProviderDataEvent( Sender: TObject;  DataSet: TClientDataSet);
begin
  if DoOnExecuteEvent then
  begin
    if AssignedMethod(BeforeCall) then
...
procedure TatProviderDispatcher.__TBeforeUpdateRecordEvent( Sender: TObject;  SourceDS: TDataSet;  DeltaDS: TClientDataSet;  UpdateKind: TUpdateKind; var Applied: Boolean);
var
...
procedure TatProviderDispatcher.__TAfterUpdateRecordEvent( Sender: TObject;  SourceDS: TDataSet;  DeltaDS: TClientDataSet;  UpdateKind: TUpdateKind);
var
  UpdateKindTemp: variant;
begin
  if DoOnExecuteEvent then
...
procedure TatProviderDispatcher.__TResolverErrorEvent( Sender: TObject;  DataSet: TClientDataSet;  E: EUpdateError;  UpdateKind: TUpdateKind; var Response: TResolverResponse);
var
  UpdateKindTemp: variant;
