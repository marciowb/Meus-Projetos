...
begin
  with AMachine do
  begin
AResult := WinInet.CreateUrlCacheEntryW(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),StringToWideChar(VarToStr(GetInputArg(3)),Param3Buf,Length(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryStreamA(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryStreamW(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryStream(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
