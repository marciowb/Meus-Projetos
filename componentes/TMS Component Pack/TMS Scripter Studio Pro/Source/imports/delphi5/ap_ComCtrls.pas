...
type
  TatComCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __TStatusBarCreate(AMachine: TatVirtualMachine);
    procedure __TStatusBarDestroy(AMachine: TatVirtualMachine);
    procedure __TStatusBarExecuteAction(AMachine: TatVirtualMachine);
    procedure __TStatusBarFlipChildren(AMachine: TatVirtualMachine);
    procedure __GetTStatusBarCanvas(AMachine: TatVirtualMachine);
    ...
    procedure __THeaderControlCreate(AMachine: TatVirtualMachine);
    procedure __THeaderControlDestroy(AMachine: TatVirtualMachine);
    procedure __THeaderControlFlipChildren(AMachine: TatVirtualMachine);
    procedure __GetTHeaderControlCanvas(AMachine: TatVirtualMachine);
    ...
    procedure __GetTListColumnsOwner(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
    TPageControl(CurrentObject).SelectNextPage(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TStatusPanelsClass(CurrentClass.ClassRef).Create(TStatusBar(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatComCtrlsLibrary.__TStatusBarCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TStatusBarClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatComCtrlsLibrary.__TStatusBarDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TStatusBar(CurrentObject).Destroy;
  end;
end;

procedure TatComCtrlsLibrary.__TStatusBarExecuteAction(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TStatusBar(CurrentObject).ExecuteAction(TBasicAction(Integer(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatComCtrlsLibrary.__TStatusBarFlipChildren(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TStatusBar(CurrentObject).FlipChildren(GetInputArg(0));
  end;
end;

procedure TatComCtrlsLibrary.__GetTStatusBarCanvas(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TStatusBar(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(THeaderSectionsClass(CurrentClass.ClassRef).Create(THeaderControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatComCtrlsLibrary.__THeaderControlCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(THeaderControlClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatComCtrlsLibrary.__THeaderControlDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    THeaderControl(CurrentObject).Destroy;
  end;
end;

procedure TatComCtrlsLibrary.__THeaderControlFlipChildren(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    THeaderControl(CurrentObject).FlipChildren(GetInputArg(0));
  end;
end;

procedure TatComCtrlsLibrary.__GetTHeaderControlCanvas(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(THeaderControl(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TTreeNode(CurrentObject).AlphaSort;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomTreeView(CurrentObject).AlphaSort;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TConversion(CurrentObject).ConvertReadStream(TStream(Integer(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TConversion(CurrentObject).ConvertWriteStream(TStream(Integer(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatComCtrlsLibrary.__GetTListColumnsOwner(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TListColumns(CurrentObject).Owner));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SelectNextPage',1,tkNone,nil,__TPageControlSelectNextPage,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TStatusBar,__TStatusBarCreate,true,0);
    DefineMethod('Destroy',0,tkNone,nil,__TStatusBarDestroy,false,0);
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TStatusBarExecuteAction,false,0);
    DefineMethod('FlipChildren',1,tkNone,nil,__TStatusBarFlipChildren,false,0);
    DefineProp('Canvas',tkClass,__GetTStatusBarCanvas,nil,TCanvas,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,THeaderControl,__THeaderControlCreate,true,0);
    DefineMethod('Destroy',0,tkNone,nil,__THeaderControlDestroy,false,0);
    DefineMethod('FlipChildren',1,tkNone,nil,__THeaderControlFlipChildren,false,0);
    DefineProp('Canvas',tkClass,__GetTHeaderControlCanvas,nil,TCanvas,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('AlphaSort',0,tkVariant,nil,__TTreeNodeAlphaSort,false,0);
  ...
  begin
    ...
    DefineMethod('AlphaSort',0,tkVariant,nil,__TCustomTreeViewAlphaSort,false,0);
  ...
  begin
    ...
    DefineProp('Owner',tkClass,__GetTListColumnsOwner,nil,TCustomListView,false,0);
