...
begin
  with AMachine do
  begin
AResult := Integer(EDBEngineErrorClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(TDBErrorClass(CurrentClass.ClassRef).Create(EDBEngineError(Integer(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).SetParams(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetCurrentRecord',1,tkVariant,nil,__TBDEDataSetGetCurrentRecord,false,0);
  ...
  begin
    ...
    DefineMethod('SetParams',1,tkNone,nil,__TUpdateSQLSetParams,false,0);
