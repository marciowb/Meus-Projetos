...
begin
  with AMachine do
  begin
AResult := Classes.CheckSynchronize;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('QueryInterface',2,tkInteger,nil,__TInterfacedPersistentQueryInterface,false,0).SetVarArgs([1]);
  ...
  begin
    ...
    DefineMethod('CheckSynchronize',0,tkVariant,nil,__CheckSynchronize,false,0);
