...
begin
  with AMachine do
  begin
AResult := Integer(TStaticListActionClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TStaticListAction,__TStaticListActionCreate,true,0);
