...
begin
  ...
  begin
    ...
    DefineMethod('PropChanged',1,tkNone,nil,__TActiveXControlPropChanged,false,0);
    DefineMethod('PropRequestEdit',1,tkVariant,nil,__TActiveXControlPropRequestEdit,false,0);
