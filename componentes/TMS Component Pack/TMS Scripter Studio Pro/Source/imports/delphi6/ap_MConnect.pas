...
procedure TatMConnectLibrary.__TLocalConnectionCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
procedure TatMConnectLibrary.__TLocalConnectionDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatMConnectLibrary.__GetTLocalConnectionProviders(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatMConnectLibrary.__GetTLocalConnectionProviderCount(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
