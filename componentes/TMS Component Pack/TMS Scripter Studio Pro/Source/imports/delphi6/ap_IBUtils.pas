...
begin
  with AMachine do
  begin
AResult := IBUtils.QuoteIdentifier(VarToInteger(GetInputArg(0)),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := IBUtils.AddIBParamSQLForDetail(TParams(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('QuoteIdentifier',2,tkVariant,nil,__QuoteIdentifier,false,0);
    DefineMethod('AddIBParamSQLForDetail',4,tkVariant,nil,__AddIBParamSQLForDetail,false,0);
