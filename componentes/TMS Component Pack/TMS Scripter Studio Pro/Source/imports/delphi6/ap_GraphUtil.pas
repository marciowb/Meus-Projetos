...
begin
  with AMachine do
  begin
AResult := GraphUtil.GetHighLightColor(GetInputArg(0));
...
begin
  with AMachine do
  begin
AResult := GraphUtil.GetShadowColor(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(GraphUtil.ColorAdjustLuma(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetHighLightColor',1,tkEnumeration,nil,__GetHighLightColor,false,0);
    DefineMethod('GetShadowColor',1,tkEnumeration,nil,__GetShadowColor,false,0);
