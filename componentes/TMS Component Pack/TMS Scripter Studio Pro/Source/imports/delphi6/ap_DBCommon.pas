...
begin
  with AMachine do
  begin
AResult := DBCommon.AddParamSQLForDetail(TParams(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('AddParamSQLForDetail',3,tkVariant,nil,__AddParamSQLForDetail,false,0);
