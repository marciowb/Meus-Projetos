...
begin
  with AMachine do
  begin
AResult := Integer(UrlMon.RegisterMediaTypes(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(UrlMon.ObtainUserAgentString(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
