...
begin
  ...
  begin
    ...
    DefineMethod('QueryInterface',2,tkInteger,nil,__TAutoDispatchQueryInterface,false,0).SetVarArgs([1]);
    ...
    DefineMethod('GetTypeInfoCount',1,tkInteger,nil,__TAutoDispatchGetTypeInfoCount,false,0).SetVarArgs([0]);
    DefineMethod('GetTypeInfo',3,tkInteger,nil,__TAutoDispatchGetTypeInfo,false,0).SetVarArgs([2]);
  ...
  begin
    ...
    DefineMethod('DllGetClassObject',3,tkInteger,nil,__DllGetClassObject,false,0).SetVarArgs([2]);
