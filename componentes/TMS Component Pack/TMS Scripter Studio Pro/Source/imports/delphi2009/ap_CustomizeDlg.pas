...
begin
  ...
  begin
Param1 := TDragObject(Integer(GetInputArg(1)));
    TCustomizeFrm(CurrentObject).SeparatorBtnStartDrag(TObject(Integer(GetInputArg(0))),Param1);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomizeFrm(CurrentObject).ApplyToAllActnUpdate(TObject(Integer(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SeparatorBtnStartDrag',2,tkNone,nil,__TCustomizeFrmSeparatorBtnStartDrag,false,0).SetVarArgs([1]);
    DefineMethod('ApplyToAllActnUpdate',1,tkNone,nil,__TCustomizeFrmApplyToAllActnUpdate,false,0);
