...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStream(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamA(PAnsiChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntry(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryA(PAnsiChar(VarToStr(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryW(StringToWideChar(VarToStr(GetInputArg(0)),Param0Buf,Length(VarToStr(GetInputArg(0)))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  ...
  begin
    ...
    DefineMethod('RetrieveUrlCacheEntryStream',5,tkInteger,nil,__RetrieveUrlCacheEntryStream,false,0).SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryStreamA',5,tkInteger,nil,__RetrieveUrlCacheEntryStreamA,false,0).SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryStreamW',5,tkInteger,nil,__RetrieveUrlCacheEntryStreamW,false,0).SetVarArgs([1,2]);
    ...
    DefineMethod('FindFirstUrlCacheEntry',3,tkInteger,nil,__FindFirstUrlCacheEntry,false,0).SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryA',3,tkInteger,nil,__FindFirstUrlCacheEntryA,false,0).SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryW',3,tkInteger,nil,__FindFirstUrlCacheEntryW,false,0).SetVarArgs([1,2]);
