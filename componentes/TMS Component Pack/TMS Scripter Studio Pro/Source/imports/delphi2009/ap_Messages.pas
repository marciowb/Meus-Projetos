...
begin
  ...
  begin
    DefineMethod('SendTextMessage',4,tkInteger,nil,__SendTextMessage,false,0);
    DefineMethod('SendStructMessage',4,tkInteger,nil,__SendStructMessage,false,0);
    DefineMethod('SendGetStructMessage',5,tkInteger,nil,__SendGetStructMessage,false,1).SetVarArgs([3]);
    DefineMethod('SendGetIntMessage',4,tkInteger,nil,__SendGetIntMessage,false,0).SetVarArgs([2,3]);
