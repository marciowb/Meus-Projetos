...
AResult := Integer(oleacc.CreateStdAccessibleProxy(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Integer(oleacc.CreateStdAccessibleProxyA(VarToInteger(GetInputArg(0)),PAnsiChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Integer(oleacc.CreateStdAccessibleProxyW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),Param1Buf,Length(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('CreateStdAccessibleProxyA',5,tkInteger,nil,__CreateStdAccessibleProxyA,false,0).SetVarArgs([4]);
    DefineMethod('CreateStdAccessibleProxyW',5,tkInteger,nil,__CreateStdAccessibleProxyW,false,0).SetVarArgs([4]);
