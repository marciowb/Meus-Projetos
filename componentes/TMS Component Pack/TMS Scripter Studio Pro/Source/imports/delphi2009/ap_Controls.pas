...
begin
  with AMachine do
  begin
AResult := TCustomPanningWindow(CurrentObject).StartPanning(VarToInteger(GetInputArg(0)),TControl(Integer(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Controls.GetAlignControlList(TWinControl(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetAlignControlList',1,tkClass,TList,__GetAlignControlList,false,0);
