...
begin
  with AMachine do
  begin
    TParam(CurrentObject).SetStream(TStream(Integer(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamObjectClass(CurrentClass.ClassRef).Create(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamObject(CurrentObject).GetImplementation);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamDataSetObjectClass(CurrentClass.ClassRef).Create(TDataSet(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParamDataSetObject(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamParamsObjectClass(CurrentClass.ClassRef).Create(TParams(Integer(GetInputArg(0))),GetInputArg(1),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParamParamsObject(CurrentObject).Params));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TParamStreamObjectClass(CurrentClass.ClassRef).Create(TStream(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),GetInputArg(2),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParamStreamObject(CurrentObject).Stream));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SetStream',2,tkNone,nil,__TParamSetStream,false,0);
  ...
  begin
    DefineMethod('Create',2,tkClass,TParamObject,__TParamObjectCreate,true,0);
  ...
  begin
    DefineMethod('Create',3,tkClass,TParamDataSetObject,__TParamDataSetObjectCreate,true,0);
  ...
  begin
    DefineMethod('Create',3,tkClass,TParamParamsObject,__TParamParamsObjectCreate,true,0);
  ...
  begin
    DefineMethod('Create',4,tkClass,TParamStreamObject,__TParamStreamObjectCreate,true,0);
