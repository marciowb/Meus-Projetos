...
begin
  with AMachine do
  begin
AResult := Integer(ExtDlgs.StandardEncodingFromName(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Execute',1,tkVariant,nil,__TSavePictureDialogExecute,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('Execute',1,tkVariant,nil,__TSaveTextFileDialogExecute,false,0);
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('StandardEncodingFromName',1,tkClass,TEncoding,__StandardEncodingFromName,false,0);
  end;
end;
