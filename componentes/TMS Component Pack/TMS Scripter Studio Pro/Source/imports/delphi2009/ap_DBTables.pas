...
begin
  with AMachine do
  begin
AResult := Integer(TDBErrorClass(CurrentClass.ClassRef).Create(EDBEngineError(Integer(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
