...
type
  ...
  private
    ...
    procedure __TParseSqlEvent(var FieldNames: TStrings;  SQL: string; var TableName: string);
    procedure __TParseInsertSqlEvent(var FieldNames: TStrings;  SQL: string; var BindAllFields: Boolean; var TableName: string);
  end;
...
procedure TatSqlExprDispatcher.__TParseSqlEvent(var FieldNames: TStrings;  SQL: string; var TableName: string);
var
...
begin
  ...
  begin
    ...
    FieldNames := TStrings(Integer(FieldNamesTemp));
...
procedure TatSqlExprDispatcher.__TParseInsertSqlEvent(var FieldNames: TStrings;  SQL: string; var BindAllFields: Boolean; var TableName: string);
var
  FieldNamesTemp: variant;
