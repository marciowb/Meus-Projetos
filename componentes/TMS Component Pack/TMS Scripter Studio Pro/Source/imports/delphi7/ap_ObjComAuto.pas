...
begin
  ...
  begin
    DefineMethod('GetTypeInfo',3,tkInteger,nil,__TObjectDispatchGetTypeInfo,false,0).SetVarArgs([2]);
    DefineMethod('GetTypeInfoCount',1,tkInteger,nil,__TObjectDispatchGetTypeInfoCount,false,0).SetVarArgs([0]);
