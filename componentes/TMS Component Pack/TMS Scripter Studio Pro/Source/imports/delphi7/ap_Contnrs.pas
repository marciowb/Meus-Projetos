...
begin
  ...
  begin
    ...
    DefineMethod('Extract',1,tkClass,TObject,__TObjectListExtract,false,0);
  ...
  begin
    DefineMethod('Push',1,tkClass,TObject,__TObjectStackPush,false,0);
  ...
  begin
    DefineMethod('Push',1,tkClass,TObject,__TObjectQueuePush,false,0);
  ...
  begin
    DefineMethod('Add',2,tkClass,TObject,__TObjectBucketListAdd,false,0);
    DefineMethod('Remove',1,tkClass,TObject,__TObjectBucketListRemove,false,0);
