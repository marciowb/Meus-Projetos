...
// (DO NOT EDIT: machine generated header) 'Inspdd.pas' rev: 21.00
...
private:
	...
	System::UnicodeString __fastcall SomeURL(System::Word Format);
...
public:
	...
	System::UnicodeString __fastcall URL(void);
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TInspectorDropSource* DropSource, System::UnicodeString stxt, System::UnicodeString srtf, int dwOKEffects, int &dwEffect);
