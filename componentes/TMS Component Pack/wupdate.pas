...
procedure ExpandFile(SrcName:ansistring);
var
  rbuf: TOFSTRUCT;
  src,dst: Integer;
...
begin
  ...
  {$IFDEF FREEWARE}
  ShowMessage('Starting application update with'#13#10'TWebUpdate © 1998-2009 by tmssoftware.com');
  {$ENDIF}
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if DoVersionCheck = WU_UNCONDITIONALNEWVERSION then
        begin
