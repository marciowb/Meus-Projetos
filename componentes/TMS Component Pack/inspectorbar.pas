...
const
  ...
  BLD_VER = 1; // Build nr.
  DATE_VER = 'Jun, 2010'; // Month version
...
{$ENDIF}
{$IFDEF TMSDOTNET}
          FInspectorDateTimePicker.DateTime := InspectorItem.DateValue;
{$ENDIF}
{$IFDEF DELPHI6_LVL}
...
{$ENDIF}
{$IFDEF TMSDOTNET}
          FInspectorDateTimePicker.DateTime := InspectorItem.TimeValue;
{$ENDIF}
{$IFDEF DELPHI6_LVL}
