...
type
  ...
  published
    ...
    property ColumnType
      : TColumnType read FColumnType write FColumnType default ctText;
...
{$ENDIF}
  ...
  public
    constructor Create(AOwner: TPersistent);
    property Items[Index: Integer]: TDropDownItem read GetItem write SetItem;
    default;
...
{$ENDIF}
  ...
  TLookupMethod = (lmLookup, lmNarrowDown);
  ...
  protected
    ...
    procedure SetSelectionColorStyle(const Value: TSelectionColorStyle);
      override;
    procedure SetCenterControl; override;

    procedure OnDropDownControlKeyDown(var Key: Word; Shift: TShiftState);
      override;
    procedure OnDropDownControlKeyUp(var Key: Word; Shift: TShiftState);
      override;
    ...
    function LookupInColumn(Value: string; var lookup: string; var Row: Integer)
      : Boolean;
  ...
  public
    ...
    property MatchStart
      : Boolean read FMatchStart write FMatchStart default true;
  published
    property AutoShowDropDown
      : Boolean read FAutoShowDropDown write FAutoShowDropDown default False;
    property CaseSensitive
      : Boolean read FCaseSensitive write FCaseSensitive default False;
    property DropDownAutoWidth
      : Boolean read FDropDownAutoWidth write FDropDownAutoWidth default true;
    property DropDownRowHeight
      : Integer read FDropDownRowHeight write FDropDownRowHeight default 22;
    property LineColor
      : TColor read FLineColor write SetLineColor default clGray;
    ...
    property ColumnSizing
      : Boolean read FColumnSizing write FColumnSizing default False;
    property ColumnMoving
      : Boolean read FColumnMoving write FColumnMoving default False;
    ...
    property GridEditable
      : Boolean read FGridEditable write FGridEditable default False;
    ...
    property HoverRowColor
      : TColor read FHoverRowColor write FHoverRowColor default clInfoBk;
    property HoverRowColorTo
      : TColor read FHoverRowColorTo write FHoverRowColorTo default clNone;
    property Items: TDropDownItems read FItems write SetItems;
    property ItemIndex: Integer read FItemIndex write SetItemIndex default - 1;
    property LookupColumn
      : Integer read FLookupColumn write SetLookupColumn default 0; // column used to show text of selected item in edit control and column in which lookup while typing is performed, ie. type 'M' , 'e' , 'r' and the item in LookupColumn in the dropdown will become selected.
    property LookupMethod: TLookupMethod read FLookupMethod write
      SetLookupMethod default lmLookup;
    property MouseActions: TMouseActions read FMouseActions write
      SetMouseActions;
    ...
    property SelectionTextColor
      : TColor read FSelectionTextColor write FSelectionTextColor default
      clBlack;
    property RowSelect: Boolean read FRowSelect write FRowSelect default true;
    property SearchFooter: TSearchFooter read FSearchFooter write
      SetSearchFooter;
    property Sorting
      : TGridSorting read FSorting write SetSorting default gsNone;
...
{$ENDIF}
    ...
    property OnGridCanInsertRow
      : TCanInsertRowEvent read FOnCanInsertRow write FOnCanInsertRow;

    property OnGridButtonClick
      : TButtonClickEvent read FOnButtonClick write FOnButtonClick;

    property OnGridCanEditCell
      : TCanEditCellEvent read FOnCanEditCell write FOnCanEditCell;
    property OnGridCheckBoxClick
      : TCheckBoxClickEvent read FOnCheckBoxClick write FOnCheckBoxClick;
    property OnGridCanSort: TCanSortEvent read FOnCanSort write FOnCanSort;
    property OnGridClickSort
      : TClickSortEvent read FOnClickSort write FOnClickSort;
    property OnGridCustomCompare
      : TCustomCompareEvent read FOnCustomCompare write FOnCustomCompare;
    property OnGridRawCompare
      : TRawCompareEvent read FOnRawCompare write FOnRawCompare;
    property OnGridColumnSize
      : TColumnSizeEvent read FOnColumnSize write FOnColumnSize;
    property OnGridEndColumnSize
      : TEndColumnSizeEvent read FOnEndColumnSize write FOnEndColumnSize;
    property OnGridColumnSizing
      : TColumnSizingEvent read FOnColumnSizing write FOnColumnSizing;
    property OnGridRowSize: TRowSizeEvent read FOnRowSize write FOnRowSize;
    property OnGridRowSizing
      : TRowSizingEvent read FOnRowSizing write FOnRowSizing;
    property OnGridEndRowSize
      : TEndRowSizeEvent read FOnEndRowSize write FOnEndRowSize;

    property OnGridRowMove: TRowSizeEvent read FOnRowMove write FOnRowMove;
    property OnGridRowMoving
      : TRowSizeEvent read FOnRowMoving write FOnRowMoving;
    property OnGridRowMoved: TMovedEvent read FOnRowMoved write FOnRowMoved;

    property OnGridColumnMove
      : TColumnSizeEvent read FOnColumnMove write FOnColumnMove;
    property OnGridColumnMoving
      : TColumnSizeEvent read FOnColumnMoving write FOnColumnMoving;
    property OnGridColumnMoved
      : TMovedEvent read FOnColumnMoved write FOnColumnMoved;

    property OnGridCustomCellDraw
      : TCustomCellDrawEvent read FOnCustomCellDraw write FOnCustomCellDraw;
    property OnGridCustomCellBkgDraw
      : TCustomCellDrawEvent read FOnCustomCellBkgDraw write
      FOnCustomCellBkgDraw;
    property OnGridGetAlignment
      : TGridAlignEvent read FOnGetAlignment write FOnGetAlignment;
    property OnGridGetCellColor
      : TGridColorEvent read FOnGetCellColor write FOnGetCellColor;
    property OnGridGetCellGradient
      : TGridGradientEvent read FOnGetCellGradient write FOnGetCellGradient;
    property OnGridGetFloatFormat
      : TFloatFormatEvent read FOnGetFloatFormat write FOnGetFloatFormat;

    property OnGridGetEditorType
      : TGetEditorTypeEvent read FOnGetEditorType write FOnGetEditorType;
    property OnGridGetEditorProp
      : TClickCellEvent read FOnGetEditorProp write FOnGetEditorProp;
    property OnGridEllipsClick
      : TEllipsClickEvent read FOnEllipsClick write FOnEllipsClick;

    property OnGridGetDiplText
      : TGetDisplTextEvent read FOnGetDisplText write FOnGetDisplText;
    property OnGridGetFormat
      : TGridFormatEvent read FOnGetFormat write FOnGetFormat;
    property OnGridHint: TGridHintEvent read FOnGridHint write FOnGridHint;

    {$IFDEF TMSGDIPLUS}
    property OnGridOfficeHint
      : TOfficeHintEvent read FOnOfficeHint write FOnOfficeHint;
    {$ENDIF}

    property OnGridCellBalloon
      : TGridBalloonEvent read FOnCellBalloon write FOnCellBalloon;

    property OnGridMouseMove
      : TMouseMoveEvent read FOnMouseMove write FOnMouseMove;
    ...
    property OnGridRightClickCell
      : TClickCellEvent read FOnRightClickCell write FOnRightClickCell;
    property OnGridScrollHint
      : TScrollHintEvent read FOnScrollHint write FOnScrollHint;
    property OnGridTopLeftChanged
      : TNotifyEvent read FOnTopLeftChanged write FOnTopLeftChanged;
    property OnGridSearchEditChange
      : TSearchEditChangeEvent read FOnSearchEditChange write
      FOnSearchEditChange;
    property OnGridSpinClick
      : TSpinClickEvent read FOnSpinClick write FOnSpinClick;
  end;
...
type
  ...
  published
    ...
    property HeaderHeight
      : Integer read FHeaderHeight write SetHeaderHeight default 25;
    property HeaderFont: TFont read FHeaderFont write SetHeaderFont;
    property GridLineWidth
      : Integer read FGridLineWidth write SetGridLineWidth default 1;
    property Images: TCustomImageList read FImages write SetImages;

    property OnGetCellText
      : TGetCellTextEvent read FOnGetCellText write FOnGetCellText;
    property OnDrawCell: TDrawCellEvent read FOnDrawCell write FOnDrawCell;
    property OnGetCellProp
      : TGetCellPropEvent read FOnGetCellProp write FOnGetCellProp;
    property OnSelect: TNotifyEvent read FOnSelect write FOnSelect;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      idx := GetRowFromItemIndex(ItemIndex);
      if (idx >= FAdvColGrid.FixedRows) and (idx < FAdvColGrid.RowCount) then
        FAdvColGrid.Row := idx;
    end
    else
    begin
...
begin
  inherited; (FAdvColGrid as TAdvColGrid)
  .RemoveAllFilters;
  FLookupEntry := '';
end;
...
begin
  ...
  begin
    ...
    if (r <> -1) and (r < FAdvColGrid.RowCount) then
    begin
...
begin
  ...
  begin
    outputdebugstring(pchar(inttostr(Items[i].Text.Count)));
