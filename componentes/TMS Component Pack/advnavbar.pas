...
type
  ...
  TAdvNavBarStyle = (esOffice2003Blue, esOffice2003Silver, esOffice2003Olive, esOffice2003Classic, esOffice2007Luna, esOffice2007Obsidian, esWindowsXP, esWhidbey, esCustom, esOffice2007Silver, esWindowsVista, esWindows7, esTerminal, esOffice2010Blue, esOffice2010Silver, esOffice2010Black);
...
begin
  ...
  begin
    ...
    if Collapsed then
    begin
      FImages.Draw(Canvas, TabR.left, TabR.Top + tp, TAdvNavBarPanel(FAdvNavBarPanel[Index]).ImageIndex);
    end
    else
    case CaptionAlignment of
    taLeftJustify:
