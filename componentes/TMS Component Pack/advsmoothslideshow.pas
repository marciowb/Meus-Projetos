...
begin
    ...
    begin
      ...
      case FOwner.effect of
        ...
        22: // spin
          begin
            if Opacity = 0 then
              outputdebugstring(pchar(inttostr(Opacity)));
            Rotation := 360 * animval;
            cw := R.X + imgwr / 2;
            ch := R.Y + imghr / 2;
  ...
  // item description
  if FOwner.ShowDescription and (Index = FOwner.FCurrentItemIndex) then
...
procedure TAdvSmoothSlideShowItem.GetAspectSize
  (var w, h: Double; ow, oh, nw, nh: Double);
begin
