...
// (DO NOT EDIT: machine generated header) 'atBaseParser.pas' rev: 22.00

#ifndef AtbaseparserHPP
#define AtbaseparserHPP
...
class DELPHICLASS TatBaseParser;
typedef void __fastcall (__closure *TExtractRemarkEvent)(TatBaseParser* AParser, int AStartPos, int AFinalPos);

typedef void __fastcall (__closure *TRefuseNodeEvent)(TNoTerminalNode* Node);

class DELPHICLASS TInclude;
typedef void __fastcall (__closure *TRefuseInputEvent)(TInclude* AInclude, int AInputPos);

typedef void __fastcall (__closure *TIncludeInputEvent)(const TatBaseParser* AParser, const System::UnicodeString AName, System::UnicodeString &AInputBuffer, System::TObject* &AInfoObject);
...
private:
	...
	void __fastcall CheckBoundaries(int i, int f);
	TNoTerminalNode* __fastcall ShiftSubsequentNode(int p, int delta);
	void __fastcall CheckInsertBoundaries(int i);
...
public:
	...
	void __fastcall ChangeSubString(System::UnicodeString s, int i, int f);
	void __fastcall FindAndReplaceSubString(System::UnicodeString s, System::UnicodeString s1);
	TNoTerminalNode* __fastcall InsertSubNodeString(System::UnicodeString s, int p, int noterm);
	void __fastcall InsertPrefixSubString(System::UnicodeString s);
	void __fastcall InsertSufixSubString(System::UnicodeString s);
	void __fastcall InsertSubString(System::UnicodeString s, int p);
	void __fastcall DeleteSubNode(int i);
	void __fastcall DeletePrefixSubstring(int n);
	void __fastcall DeleteSufixSubString(int n);
	void __fastcall MoveToPosition(TNoTerminalNode* refnode, int p);
	...
	__property TatBaseParser* atSyntaxParser = {read=FatSyntaxParser};
...
class PASCALIMPLEMENTATION TatBaseParser : public Classes::TComponent
{
	typedef Classes::TComponent inherited;
	
private:
	typedef System::StaticArray<System::UnicodeString, 10> _TatBaseParser__1;
...
public:
	__fastcall virtual TatBaseParser(Classes::TComponent* AOwner);
	__fastcall virtual ~TatBaseParser(void);
	...
	__property TRefuseNodeEvent OnRefuseNode = {read=FOnRefuseNode, write=FOnRefuseNode};
