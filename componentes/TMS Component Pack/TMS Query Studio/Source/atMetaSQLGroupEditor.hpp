...
// (DO NOT EDIT: machine generated header) 'atMetaSQLGroupEditor.pas' rev: 22.00

#ifndef AtmetasqlgroupeditorHPP
#define AtmetasqlgroupeditorHPP
...
namespace Atmetasqlgroupeditor
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TfmMetaSQLGroupEditor;
class PASCALIMPLEMENTATION TfmMetaSQLGroupEditor : public Atmetasqlcustomeditor::TfmMetaSQLCustomEditor
{
...
public:
	/* TCustomFrame.Create */ inline __fastcall virtual TfmMetaSQLGroupEditor(Classes::TComponent* AOwner) : Atmetasqlcustomeditor::TfmMetaSQLCustomEditor(AOwner) { }
	
public:
	/* TScrollingWinControl.Destroy */ inline __fastcall virtual ~TfmMetaSQLGroupEditor(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfmMetaSQLGroupEditor(HWND ParentWindow) : Atmetasqlcustomeditor::TfmMetaSQLCustomEditor(ParentWindow) { }
...
using namespace Atmetasqlgroupeditor;
#endif
#pragma pack(pop)
#pragma option pop
