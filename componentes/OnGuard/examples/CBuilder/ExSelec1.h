...
#include <Menus.hpp>
 ...
 //     Feature masks
  ...
  String ModifyStr        = "Modify Registration to enable this feature";
...
__published:	// IDE-managed Components
        ...
        void __fastcall OgUsageCode1Checked(TObject *Sender,
          TCodeStatus Status);
        void __fastcall OgUsageCode1ChangeCode(TObject *Sender,
          TCode &Code);
        void __fastcall OgSpecialCode1GetKey(TObject *Sender, TKey &Key);
        void __fastcall OgSpecialCode1GetCode(TObject *Sender,
          TCode &Code);
        void __fastcall OgSpecialCode1GetModifier(TObject *Sender,
          int &Value);
        void __fastcall OgSpecialCode1Checked(TObject *Sender,
          TCodeStatus Status);
