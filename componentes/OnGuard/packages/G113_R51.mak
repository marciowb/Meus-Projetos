...
OBJFILES = ..\source\OgNetWrk.obj ..\source\OgUtil.obj ..\source\OgConst.obj \
    ...
    ..\source\OnGuard3.obj ..\source\OnGuard4.obj ..\source\OgProExe.obj \
    ..\source\OgFirst.obj ..\source\OgSrmgr.obj G113_R51.obj
RESFILES = G113_R51.res
MAINSOURCE = G113_R51.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
PACKAGES = vclx50.bpi vcl50.bpi
SPARELIBS = vcl50.lib
DEFFILE = 
# ---------------------------------------------------------------------------
PATHCPP = .;
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower OnGuard 1.13 Runtime package - VCL51" -aa -Tpp -Gpr -x -Gl \
    -Gi -w
# ---------------------------------------------------------------------------
