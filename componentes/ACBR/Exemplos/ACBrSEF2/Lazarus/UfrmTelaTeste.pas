...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, ComCtrls, FileUtil, inifiles, ACBrSEF2,
  ACBrSEF2Conversao, ACBrSEF2_eDoc_BlocoC, ACBrSef2_BlocoE;
...
I : Integer;
begin
  if Not FileExistsUTF8(ExtractFilePath(Application.ExeName)+'REG_030.ini') { *Converted from FileExists* } then
    Exit;
