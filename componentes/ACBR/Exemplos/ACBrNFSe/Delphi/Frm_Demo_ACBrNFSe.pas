...
uses IniFiles, ShellAPI,
  ...
  ACBrNFSe, ACBrNFSeDANFSeClass, ACBrNFSeDANFSeFR, pnfsNFSe;
type
  TfrmDemo_ACBrNFSe = class(TForm)
    ...
    Label29: TLabel;
    ACBrNFSe1: TACBrNFSe;
    ACBrNFSeDANFSeQR1: TACBrNFSeDANFSeFR;
    Label20: TLabel;
    edtUserWeb: TEdit;
...
begin
 ...
 if OpenDialog1.Execute then
  begin
   ACBrNFSeDANFSeQR1.FastFile := 'D:\Meus Projetos\componentes\ACBR\Exemplos\ACBrNFSe\Delphi\Report\DANFSE.fr3';
   ACBrNFSe1.NotasFiscais.Clear;
   ACBrNFSe1.NotasFiscais.LoadFromFile(OpenDialog1.FileName);
