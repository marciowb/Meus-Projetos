...
// (DO NOT EDIT: machine generated header) 'Uflexcelimport.pas' rev: 11.00
...
private:
	...
	Byte __fastcall GetPrintOptions(void);
	...
	void __fastcall SetPrintOptions(const Byte Value);
	WideString __fastcall GetCellFormula(int aRow, int aCol);
	void __fastcall SetCellFormula(int aRow, int aCol, const WideString Value);
	void __fastcall FindOnePart(const WideString Text, const int P1, const int P2, const int P3, /* out */ WideString &Part);
	...
	WideString __fastcall GetRangeName(int index);
	...
	Variant __fastcall GetCellValue(int Row, int Col);
	void __fastcall SetCellValue(int Row, int Col, const Variant &Value);
	...
	Variant __fastcall GetComments(int Row, int Pos);
	void __fastcall SetComments(int Row, int Pos, const Variant &Value);
	int __fastcall GetCommentsCount(int Row);
	WideString __fastcall GetActiveSheetName();
	void __fastcall SetActiveSheetName(const WideString Value);
	WideString __fastcall GetActiveSheetCodeName();
	void __fastcall SetActiveSheetCodeName(const WideString Value);
...
public:
	...
	void __fastcall OpenText(const AnsiString FileName, const char Delimiter)/* overload */;
	void __fastcall OpenText(const AnsiString FileName, const char Delimiter, Utextdelim::XLSColumnImportTypes const * ColumnFormats, const int ColumnFormats_Size)/* overload */;
	void __fastcall LoadFromStream(const Classes::TStream* DataStream);
	void __fastcall LoadFromTextStream(const Classes::TStream* DataStream, const char Delimiter)/* overload */;
	void __fastcall LoadFromTextStream(const Classes::TStream* DataStream, const char Delimiter, Utextdelim::XLSColumnImportTypes const * ColumnFormats, const int ColumnFormats_Size)/* overload */;
	void __fastcall Save(const AnsiString FileName);
	void __fastcall SaveToStream(const Classes::TStream* DataStream);
	void __fastcall SaveAsText(const AnsiString FileName, const char Delimiter);
	void __fastcall SaveToStreamAsText(const Classes::TStream* DataStream, const char Delimiter);
	...
	__property Variant CellValue[int Row][int Col] = {read=GetCellValue, write=SetCellValue};
	...
	void __fastcall SetCellString(int Row, int Col, const WideString Text)/* overload */;
	void __fastcall SetCellString(int Row, int Col, const WideString Text, const Uflxformats::TFlxFormat &Fm)/* overload */;
	...
	void __fastcall AssignCellFormulaX(const int aRow, const int aCol, const WideString Formula, const Variant &FormulaResult);
	...
	Uflxmessages::BooleanArray __fastcall GetUsedPaletteColors();
	...
	__property Variant Comments[int Row][int Pos] = {read=GetComments, write=SetComments};
	WideString __fastcall GetCellComment(int Row, int Col);
	void __fastcall SetCellComment(int Row, int Col, const WideString Value)/* overload */;
	void __fastcall SetCellComment(int Row, int Col, const WideString Value, const Uflxmessages::TImageProperties &Properties)/* overload */;
	__property int PicturesCount = {read=GetPicturesCount, nodefault};
	__property WideString PictureName[int aPos] = {read=GetPictureName};
	...
	void __fastcall FillPageHeaderFooter(const WideString Text, /* out */ WideString &Left, /* out */ WideString &Center, /* out */ WideString &Right);
	...
	__property AnsiString ActiveFileName = {read=FActiveFileName};
	...
	void __fastcall DeleteHPageBreak(const Word aRow);
	void __fastcall DeleteVPageBreak(const Word aCol);
	void __fastcall InsertHPageBreak(const Word aRow);
	void __fastcall InsertVPageBreak(const Word aCol);
	...
	void __fastcall AutofitRow(const int row1, const int row2, const bool AutofitNotAutofittingRows, const bool keepHeightAutomatic, const Extended adjustment)/* overload */;
	void __fastcall AutofitRow(const int row, const bool keepHeightAutomatic, const Extended adjustment)/* overload */;
	void __fastcall AutofitCol(const int Col, const bool IgnoreStrings, const Extended Adjustment)/* overload */;
	void __fastcall AutofitCol(const int Col1, const int Col2, const bool IgnoreStrings, const Extended Adjustment)/* overload */;
	void __fastcall AutofitRowsOnWorkbook(const bool AutofitNotAutofittingRows, const bool KeepSizesAutomatic, const Extended Adjustment);
	...
	Uflxmessages::TXlsCellRange __fastcall GetAutoFilterRange();
