...
// (DO NOT EDIT: machine generated header) 'Uescherrecords.pas' rev: 21.00
...
public:
	...
	int __fastcall Row(void);
	int __fastcall Col(void);
	Uflxmessages::TClientAnchor __fastcall GetAnchor(void);
...
public:
	...
	__fastcall TEscherOPTRecord(const Uflxmessages::ByteArray aPict, const Uflxmessages::TXlsImgTypes aPicType, const System::UnicodeString PicName, const PEscherDwgGroupCache aDwgGroupCache, const PEscherDwgCache aDwgCache, const TEscherContainerRecord* aParent);
