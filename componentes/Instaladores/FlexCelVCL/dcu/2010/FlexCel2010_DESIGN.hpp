...
// (DO NOT EDIT: machine generated header) 'Flexcel2010_design.pas' rev: 21.00

#ifndef Flexcel2010_designHPP
#define Flexcel2010_designHPP
...
#include <Uflexcelreg.hpp>	// Pascal unit
#include <Utemplateedit.hpp>	// Pascal unit
#include <Dflexcelreporteditor.hpp>	// Pascal unit
#include <Uchecktemplate.hpp>	// Pascal unit
#include <Uexceledit.hpp>	// Pascal unit
#include <Uflexceldbmemeditor.hpp>	// Pascal unit
#include <Uflexceltemplateeditor.hpp>	// Pascal unit
...
namespace Flexcel2010_design
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Flexcel2010_design */
using namespace Flexcel2010_design;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Flexcel2010_designHPP
