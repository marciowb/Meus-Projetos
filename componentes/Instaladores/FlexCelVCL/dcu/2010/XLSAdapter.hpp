...
// (DO NOT EDIT: machine generated header) 'Xlsadapter.pas' rev: 21.00
...
private:
	...
	Uflxmessages::ByteArray FOtherStreams;
	int FirstColumn;
	int LastColumn;
	...
	void __fastcall InternalSetCellString(const int aRow, const int aCol, const System::UnicodeString Text, const Uflxformats::PFlxFormat Fm, const System::UnicodeString DateFormat, const System::UnicodeString TimeFormat, const Uflxmessages::PFormatSettings FormatSettings);
	void __fastcall SetCellValueAndFmt(const int aRow, const int aCol, const System::Variant &v, const Uflxformats::PFlxFormat Fm);
	System::UnicodeString __fastcall SkipThousands(const System::UnicodeString s, const Uflxmessages::PFormatSettings FormatSettings);
...
protected:
	...
	virtual Uflxmessages::TXlsMargins __fastcall GetMargins(void);
	...
	virtual Uflxmessages::TPrinterDriverSettings __fastcall GetPrinterDriverSettings(void);
...
public:
	...
	virtual void __fastcall Save(const bool AutoClose, const System::UnicodeString FileName, const Uflxmessages::TOnGetFileNameEvent OnGetFileName, const Uflxmessages::TOnGetOutStreamEvent OnGetOutStream = 0x0, const Classes::TStream* DataStream = (Classes::TStream*)(0x0));
	...
	virtual void __fastcall SetCellComment(int Row, int Col, const System::UnicodeString Value, const Uflxmessages::TImageProperties &Properties);
	...
	virtual void __fastcall SetCellString(const int aRow, const int aCol, const System::UnicodeString Text, const Uflxformats::TFlxFormat &Fm, const System::UnicodeString DateFormat = L"", const System::UnicodeString TimeFormat = L"")/* overload */;
	...
	void __fastcall CopyToClipboardFormat(const Uflxmessages::TXlsCellRange &Range, /* out */ System::UnicodeString &textString, const Classes::TStream* xlsStream);
	...
	virtual Uflxmessages::BooleanArray __fastcall GetUsedPaletteColors(void);
	...
	virtual Uflxmessages::TXlsCellRange __fastcall GetAutoFilterRange(void);
};
