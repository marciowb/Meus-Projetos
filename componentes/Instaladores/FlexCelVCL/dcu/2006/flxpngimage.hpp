...
// (DO NOT EDIT: machine generated header) 'Flxpngimage.pas' rev: 10.00

#ifndef FlxpngimageHPP
#define FlxpngimageHPP
...
namespace Flxpngimage
{
//-- type declarations -------------------------------------------------------
typedef AnsiString flxpngimage__1[9];
