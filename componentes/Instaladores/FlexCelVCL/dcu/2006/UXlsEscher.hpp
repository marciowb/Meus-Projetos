...
// (DO NOT EDIT: machine generated header) 'Uxlsescher.pas' rev: 10.00
...
public:
	...
	/* TBaseRecord.Create */ inline __fastcall virtual TXlsEscherRecord(const Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : Uxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingGroupRecord(const Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingRecord(const Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TBaseRecord.Create */ inline __fastcall virtual TDrawingSelectionRecord(const Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TXlsEscherRecord(aId, aData, aDataSize) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	void __fastcall DeleteRows(const Word aRow, const Word aCount, const Xlsmessages::TSheetInfo &SheetInfo, const System::TObject* dSheet);
	void __fastcall DeleteCols(const Word aCol, const Word aCount, const Xlsmessages::TSheetInfo &SheetInfo, const System::TObject* dSheet);
	Uescherrecords::TEscherClientDataRecord* __fastcall FindObjId(const Word ObjId);
