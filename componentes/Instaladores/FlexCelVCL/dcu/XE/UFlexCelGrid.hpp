...
// (DO NOT EDIT: machine generated header) 'UFlexCelGrid.pas' rev: 22.00
...
{
//-- type declarations -------------------------------------------------------
typedef System::DynamicArray<Uflxmessages::TRTFRunList> TRTFRunListList;
...
struct DECLSPEC_DRECORD TSavedFont
{
