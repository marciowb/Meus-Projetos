...
// (DO NOT EDIT: machine generated header) 'UXlsSST.pas' rev: 22.00
...
public:
	/* {Generics_Collections}TList<System_Integer>.Destroy */ inline __fastcall virtual ~TSST(void) { }
...
private:
	...
	Uflxmessages::TRichString __fastcall GetAsRichString(void);
