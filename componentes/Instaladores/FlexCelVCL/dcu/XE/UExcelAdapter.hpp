...
// (DO NOT EDIT: machine generated header) 'UExcelAdapter.pas' rev: 22.00
...
public:
	...
	virtual void __fastcall Save(const bool AutoClose, const System::UnicodeString FileName, const Uflxmessages::TOnGetFileNameEvent OnGetFileName, const Uflxmessages::TOnGetOutStreamEvent OnGetOutStream = 0x0, const Classes::TStream* DataStream = (Classes::TStream*)(0x0)) = 0 ;
	...
	virtual void __fastcall SetCellComment(int Row, int Col, const System::UnicodeString Value, const Uflxmessages::TImageProperties &Properties) = 0 ;
	...
	virtual void __fastcall SetCellString(const int aRow, const int aCol, const System::UnicodeString Text, const Uflxformats::TFlxFormat &Fm, const System::UnicodeString DateFormat = L"", const System::UnicodeString TimeFormat = L"") = 0 /* overload */;
