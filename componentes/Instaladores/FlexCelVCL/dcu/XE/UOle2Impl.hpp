...
// (DO NOT EDIT: machine generated header) 'UOle2Impl.pas' rev: 22.00
...
typedef Generics_collections::TList__1<unsigned>* UInt32List;
...
typedef Generics_collections::TObjectList__1<TOneDirEntry*>* TDirEntryList;
...
private:
	Uflxmessages::ByteArray FileSignature;
	__classmethod bool __fastcall CompareArray(const Uflxmessages::ByteArray a1, const Uflxmessages::ByteArray a2, const int length);
...
public:
	...
	__int64 __fastcall FindSector(const __int64 StartSect, const __int64 SectOfs);
public:
	/* {Generics_Collections}TList<System_Cardinal>.Destroy */ inline __fastcall virtual ~TOle2MiniFAT(void) { }
...
public:
	...
	void __fastcall Save(const Classes::TStream* aStream);
	__classmethod int __fastcall GetNameSize(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod System::UnicodeString __fastcall GetName(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod STGTY __fastcall GetType(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod __int64 __fastcall GetSectStart(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetSectStart(const Uflxmessages::ByteArray Data, const int StartPos, const __int64 value);
	__classmethod __int64 __fastcall GetSize(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetSize(const Uflxmessages::ByteArray Data, const int StartPos, const __int64 value);
	__classmethod void __fastcall Clear(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod int __fastcall GetLeftSid(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetLeftSid(const Uflxmessages::ByteArray Data, const int StartPos, const int value);
	__classmethod int __fastcall GetRightSid(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetRightSid(const Uflxmessages::ByteArray Data, const int StartPos, const int value);
	__classmethod int __fastcall GetChildSid(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetChildSid(const Uflxmessages::ByteArray Data, const int StartPos, const int value);
	__classmethod DECOLOR __fastcall GetColor(const Uflxmessages::ByteArray Data, const int StartPos);
	__classmethod void __fastcall SetColor(const Uflxmessages::ByteArray Data, const int StartPos, const DECOLOR value);
