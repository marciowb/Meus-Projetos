...
// (DO NOT EDIT: machine generated header) 'Uxlsbaserecords.pas' rev: 20.00
...
public:
	__fastcall virtual TBaseRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TContinueRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	...
	virtual void __fastcall SaveToStream(const Uole2impl::TOle2File* Workbook);
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TIgnoreRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	...
	virtual void __fastcall SaveToStream(const Uole2impl::TOle2File* Workbook);
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TSubListRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	...
	__fastcall virtual TBaseRowColRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	/* TBaseRowColRecord.Create */ inline __fastcall virtual TCellRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRowColRecord(aId, aData, aDataSize) { }
...
public:
	__fastcall virtual TRowRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TDimensionsRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TStringRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	...
	virtual void __fastcall SaveToStream(const Uole2impl::TOle2File* Workbook);
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TWindow1Record(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TWindow2Record(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TSCLRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	...
	virtual void __fastcall SaveToStream(const Uole2impl::TOle2File* Workbook);
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TDefColWidthRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	System::Word __fastcall Width(void);
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TStandardWidthRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TDefRowHeightRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPageHeaderFooterRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPageHeaderRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TPageHeaderFooterRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPageFooterRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TPageHeaderFooterRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPrintGridLinesRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TMarginRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TSetupRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPlsRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPrintCenteredRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TWsBoolRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual T1904Record(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TRefModeRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TPrecisionRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TBookBoolRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TAutoFilterInfoRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : TBaseRecord(aId, aData, aDataSize) { }
