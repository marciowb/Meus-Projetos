...
// (DO NOT EDIT: machine generated header) 'Uxlscondfmt.pas' rev: 20.00
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TCondFmtRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : Uxlsotherrecords::TRangeRecord(aId, aData, aDataSize) { }
...
public:
	__fastcall virtual TCFRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize);
