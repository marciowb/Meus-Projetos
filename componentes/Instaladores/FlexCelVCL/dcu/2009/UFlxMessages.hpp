...
// (DO NOT EDIT: machine generated header) 'Uflxmessages.pas' rev: 20.00
...
extern PACKAGE bool __fastcall FlxTryStrToDateTime(const System::UnicodeString S, /* out */ System::TDateTime &Value, /* out */ System::UnicodeString &dFormat, /* out */ bool &HasDate, /* out */ bool &HasTime, const System::UnicodeString DateFormat = L"", const System::UnicodeString TimeFormat = L"", const PFormatSettings FormatSettings = (void *)(0x0));
extern PACKAGE System::UnicodeString __fastcall TryFormatDateTime(const System::UnicodeString Fmt, System::TDateTime value);
