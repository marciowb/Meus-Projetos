...
// (DO NOT EDIT: machine generated header) 'Uflexcelimport.pas' rev: 20.00
...
private:
	...
	System::UnicodeString __fastcall GetActiveSheetName();
	void __fastcall SetActiveSheetName(const System::UnicodeString Value);
	System::UnicodeString __fastcall GetActiveSheetCodeName();
