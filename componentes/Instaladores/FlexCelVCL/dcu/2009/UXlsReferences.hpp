...
// (DO NOT EDIT: machine generated header) 'Uxlsreferences.pas' rev: 20.00
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TExternNameRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : Uxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
...
public:
	__fastcall virtual TSupBookRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize);
...
public:
	/* TBaseRecord.Create */ inline __fastcall virtual TExternSheetRecord(const System::Word aId, const Xlsmessages::PArrayOfByte aData, const int aDataSize) : Uxlsbaserecords::TBaseRecord(aId, aData, aDataSize) { }
