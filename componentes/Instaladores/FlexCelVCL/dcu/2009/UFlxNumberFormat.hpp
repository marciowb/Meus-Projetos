...
// (DO NOT EDIT: machine generated header) 'Uflxnumberformat.pas' rev: 20.00
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE System::UnicodeString __fastcall XlsFormatValue(const System::Variant &V, const System::UnicodeString Format, int &Color);
