...
var
  FDatabaseReports: TFDatabaseReports;
...
procedure TFDatabaseReports.ActionCloseExecute(Sender: TObject);
begin
  Close;
end;

procedure TFDatabaseReports.ActionRunExecute(Sender: TObject);
var
...
procedure TFDatabaseReports.EmpsCalcFields(DataSet: TDataSet);
begin
  EmpsFullName.Value := EmpsLastName.Value + ' ' + EmpsFirstName.Value;
end;

procedure TFDatabaseReports.FormCreate(Sender: TObject);
begin
  Cust.Active := true;
end;

procedure TFDatabaseReports.ItemsCalcFields(DataSet: TDataSet);
begin
