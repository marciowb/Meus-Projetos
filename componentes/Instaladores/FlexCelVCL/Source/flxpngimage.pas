...
{Copy images with palette using bit depths 1, 4 or 8}
...
{Copy images with palette using bit depth 2}
...
{Copy images with grayscale using bit depth 2}
...
{Copy images with palette using 2 bytes for each pixel}
