...
procedure SIB_EventCounts(ClientLibrary:IIBClientLibrary;Status: SIB_PStatusVector; Length: SIB_UShort; EventBuffer, ResultBuffer: PChar);
...
function SIB_QueEvents(ClientLibrary:IIBClientLibrary;Status: SIB_PStatusVector;
 ...
 EventBuffer: PChar; Callback: SIB_EventCallback; CallbackArg: Pointer): SIB_Status;
begin
