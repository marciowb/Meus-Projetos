...
Blob or to a page of pointers to Blob fragments}
  ...
  TISC_ARRAY_DESC = record
    ...
    array_desc_field_name       : array[0..LENGTH_METANAMES-1] of Char;
    array_desc_relation_name    : array[0..LENGTH_METANAMES-1] of Char;
...
{$ENDIF}        
    ...
    sqlname                     : array[0..LENGTH_METANAMES-1] of Char;
    relname_length              : Short;     (** length of relation name **)
    (** field's relation name + space for NULL **)
    relname                     : array[0..LENGTH_METANAMES-1] of Char;
    ...
    aliasname                   : array[0..LENGTH_METANAMES-1] of Char;
  end;  // TXSQLVAR
  PXSQLVAR                      = ^TXSQLVAR;
  PPXSQLVAR                     = ^PXSQLVAR;  
...
(********************************)
Tisc_get_client_version = procedure(buffer : PChar); {$I pFIBMacroComp.inc}
...
T  = function       (status_vector             : PISC_STATUS;
                                 blob_handle               : PISC_BLOB_HANDLE;
                                 isc_arg3                  : Short;
                                 isc_arg4                  : ISC_LONG;
