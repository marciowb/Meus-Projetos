...
uses
  ...
  ibase, IB_Intf, IB_Externals, DB, pFIBDataInfo, FIBQuery,Windows;
...
type
  ...
  public
    ...
    procedure DoOnLostConnect(DataBase:TFIBDatabase;ErrorValue: EFIBError);
...
begin
  case IBErrorCode of
    isc_shutdown, isc_lost_db_connection, isc_network_error,isc_net_connect_err,
    isc_net_connect_listen_err, isc_net_event_connect_err,
    isc_net_event_listen_err,isc_net_read_err, isc_net_write_err:
...
begin
  ...
  with ErrorValue do
   case SQLCode of
    ...
    if IsConnectionLost(IBErrorCode) then
    begin
