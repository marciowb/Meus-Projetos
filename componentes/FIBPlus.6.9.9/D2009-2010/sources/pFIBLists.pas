...
// Note : Only for Items compatibled with Integer
     ...
     private
      FData      :array of array of Ansistring;
      FHighBounds:integer;
      FCount     :integer;
      FCapacity  :integer;
      procedure   Grow;
      procedure   SetCapacity(NewCapacity:integer);
      function    GetValue(X, Y: integer): Ansistring;
      procedure   SetValue(X, Y: integer; const Value: Ansistring);
      function    GetPValue(X, Y: integer): PAnsiString;
     public
      ...
      property    PValue[X,Y:integer]:PAnsiString read GetPValue;
      property    Value[X,Y:integer]:Ansistring read GetValue write SetValue; default;
...
function TStringCollection.GetPValue(X, Y: integer): PAnsiString;
begin
...
function TStringCollection.GetValue(X, Y: integer): Ansistring;
begin
 Assert(X<=FHighBounds,'Can''t read value to StrCollection. Bad X-Index');
 Assert(Y<FCount,'Can''t read value to StrCollection. Bad Y-Index');
 Result:=FData[X][Y]
...
procedure TStringCollection.SetValue(X, Y: integer; const Value: Ansistring);
var
  Len:Integer;
begin
