...
uses
 ...
 type TpFIBArray=class
      private
       ...
       procedure VariantToBuffer(Value:Variant;var ToBuffer:PAnsiChar);
       procedure PutArrayBuf(var Buffer,ToBuffer:PAnsiChar;
        DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
       );
       function GetElementBuf(Buffer:PAnsiChar;
         aISC_ARRAY_DESC:TISC_ARRAY_DESC;
         DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
       ):Variant;
       procedure PutElementBuf(Value:Variant;var ToBuffer:PAnsiChar;
        aISC_ARRAY_DESC:TISC_ARRAY_DESC;
        DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
       );

       function GetFieldData(Field:TField;var ToBuffer:PAnsiChar):boolean;
      ...
      public
       ...
       function GetArrayValues(bufData:PAnsiChar;
         DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
       ):Variant;                         // for Internal use from FibQuery
       procedure SetArrayValue(Value:Variant;var ToBuffer:PAnsiChar;
         DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
...
function TpFIBArray.GetArrayValues(
  bufData:PAnsiChar; DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
):Variant;
var i,j:integer;
    ArrSize:integer;
    Buffer: PAnsiChar;
...
function TpFIBArray.GetFieldData(Field:TField;var ToBuffer:PAnsiChar):boolean;
begin
  ToBuffer:=nil;
...
procedure TpFIBArray.VariantToBuffer(Value:Variant;var ToBuffer:PAnsiChar);
var
  ArrSize:integer;
begin
...
function TpFIBArray.GetElementBuf(Buffer:PAnsiChar;
         aISC_ARRAY_DESC:TISC_ARRAY_DESC;
         DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
       ):Variant;
var
...
procedure TpFIBArray.PutElementBuf(Value:Variant;var ToBuffer:PAnsiChar;
        aISC_ARRAY_DESC:TISC_ARRAY_DESC;
        DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
);
var
...
procedure TpFIBArray.PutArrayBuf(var Buffer,ToBuffer:PAnsiChar;
        DBHandle:PISC_DB_HANDLE;TRHandle: PISC_TR_HANDLE
);
var
  ArrSize:integer;
