...
begin
  Buf := '';
  GetLocaleInfoA(LOCALE_USER_DEFAULT, LOCALE_IDEFAULTANSICODEPAGE, Buf, 6);
...
function LanguageStringToWideString(const S: AnsiString; Charset: DWord): WideString;
var
  L: Integer;
  CodePage: Cardinal;
begin
...
function LanguageMessageBox(hWnd: HWND; lpText, lpCaption: PAnsiChar; uType: UINT): Integer;
begin
