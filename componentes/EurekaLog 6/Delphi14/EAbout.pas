...
begin
  ...
  EurekaLogLabel.Caption := string(GetEurekaLogLabel);
  OKBtn.Caption := EOK;
  WhatBtn.Caption := EWhatIs;
  CopyrightLabel.Caption := (ECopyrightCaption + IntToStr(Y));
...
procedure TAboutForm.OrderBtnClick(Sender: TObject);
begin
{$IFDEF EUREKALOG_DEMO}
