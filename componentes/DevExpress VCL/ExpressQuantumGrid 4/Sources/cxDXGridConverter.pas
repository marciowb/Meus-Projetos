...
begin
  ...
  try
    Converter.EnablePropertyException;
    try
      Converter.GetSetProperty(nil, 'OptionsDB_', AList);
      AList.Sort;
      with cxGridView do
      begin
...
var
  ...
  ASummaryType: string;
  ASummaryGroup: TcxDataSummaryGroup;
  ASummaryItem: TcxGridDBBandedTableSummaryItem;
  ALink: TcxGridTableSummaryGroupItemLink;
  AIndex: Integer;
  I: Integer;
begin
  ...
  try
    ...
    begin
      ...
      begin
        ASummaryGroup := cxGridView.DataController.Summary.SummaryGroups.Add;
        ASummaryItem := TcxGridDBBandedTableSummaryItem(ASummaryGroup.SummaryItems.Add);
        ASummaryItem.FieldName := ASummaryField;
        ASummaryItem.Format := ASummaryFormat;
        ASummaryItem.Kind := GetSummaryKind(ASummaryType);
        ALink := TcxGridTableSummaryGroupItemLink(ASummaryGroup.Links.Add);
...
var
  ASummaryFooterType: string;
  AcxSummaryFooterItem: TcxGridDBBandedTableSummaryItem;
begin
  ...
  begin
    ...
    AcxSummaryFooterItem.Kind := GetSummaryKind(ASummaryFooterType);
    AcxSummaryFooterItem.Column := TcxGridDBBandedColumn(AColumn);
  end;
end;
...
var
  ...
  ASummaryItems: TObject;
  AcxSummaryGroup: TcxDataSummaryGroup;
  AcxSummaryItem: TcxGridDBBandedTableSummaryItem;
  I, J, K: Integer;
  ASeparator: string;
  AFieldName: string;
  AIsDefaultGroup: Boolean;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              if AIsDefaultGroup then
                AcxSummaryItem := TcxGridDBBandedTableSummaryItem(cxGridView.DataController.Summary.DefaultGroupSummaryItems.Add)
              else
                AcxSummaryItem := TcxGridDBBandedTableSummaryItem(AcxSummaryGroup.SummaryItems.Add);
              AcxSummaryItem.Column := nil;
              AdxColumn := GetColumn(Converter.GetStringProperty(Items[J], 'ColumnName', ''));
              if AdxColumn <> nil then
              begin
