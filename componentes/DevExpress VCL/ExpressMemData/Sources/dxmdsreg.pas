...
{$ELSE}
  DsgnIntf,
{$ENDIF}
  Windows, Classes, DB, dxmdaset, dxmdsedt, dxmdatps, ShellAPI, dxCoreReg;

const
  dxMemDataMajorVersion = '1';
...
function TdxMemDataComponentEditor.GetProductMajorVersion: string;
begin
  Result := dxMemDataMajorVersion;
end;
