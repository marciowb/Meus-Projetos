...
uses
  DesignEditors, DesignIntf, DesignMenus, VCLEditors, dxCoreReg, cxLibraryReg,
  cxGridReg, Classes, cxGridLayoutView, cxLayoutViewEditor {$IFNDEF NONDB}, cxGridDBLayoutView {$ENDIF};
...
{$ENDIF}
  HideClassProperties(TcxGridLayoutViewItem, ['LayoutItem']);
  HideClassProperties(TcxGridLayoutItem, ['LayoutLookAndFeel', 'Visible', 'Name', 'ControlOptions']);
end;
