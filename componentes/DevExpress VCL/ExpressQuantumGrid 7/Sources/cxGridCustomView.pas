...
type
  ...
  private
    ...
    function GetLookAndFeelPainter: TcxCustomLookAndFeelPainterClass; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetPainter: TcxCustomGridPainter; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetSite: TcxGridSite;
    function GetViewData: TcxCustomGridViewData; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetViewInfo: TcxCustomGridViewInfo; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
