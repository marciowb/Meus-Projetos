...
begin
  inherited;
  if (Properties.Levels[ATabViewInfo.Index] = nil) or (GetLookAndFeel.SkinPainter <> nil) then Exit;
...
begin
  ...
  TabsProperties.ActiveLevel := AActiveLevel;
end;
...
begin
  ...
  TabsProperties.Images := ATabsInfo.Images;
