...
type
  ...
  {$IFDEF DELPHI7}
    function DoCustomDrawCaption(ACanvas: TcxCanvas; const ABounds: TRect; APainter: TcxCustomLookAndFeelPainterClass): Boolean; virtual;
    function DoCustomDrawContentBackground(ACanvas: TcxCanvas; const ABounds: TRect; APainter: TcxCustomLookAndFeelPainterClass): Boolean; virtual;
    procedure DoMeasureCaptionHeight(APainter: TcxCustomLookAndFeelPainterClass; var ACaptionHeight: Integer);
  {$ENDIF}
...
begin
  ...
  try
    ...
    if (Edit.Caption = '') {$IFDEF DELPHI7}or Edit.DoCustomDrawCaption(ACanvas, CaptionRect, Painter){$ENDIF} then
      Exit;
  ...
  begin
    ...
    begin
      if IsPanelStyle then
        ...
        TcxWinXPLookAndFeelPainter.DrawGroupBoxFrame(
  ...
  begin
    ...
    begin
      case BorderStyle of
        ...
        ebsFlat:
          TcxFlatLookAndFeelPainter.DrawGroupBoxFrame(
            ACanvas, R, Enabled, cxgpCenter, Edit.ActiveStyle.Edges);
        ebs3D:
          if Edit.Ctl3D then
            TcxStandardLookAndFeelPainter.DrawGroupBoxFrame(
              ACanvas, R, Enabled, cxgpCenter, Edit.ActiveStyle.Edges)
          else
          begin
...
begin
  ...
  if not ViewInfo.UseSkins and IsNativeStyle then
    APainter := TcxWinXPLookAndFeelPainter;
...
{$IFDEF DELPHI7}
function TcxCustomGroupBox.DoCustomDrawCaption(ACanvas: TcxCanvas; const ABounds: TRect; APainter: TcxCustomLookAndFeelPainterClass): Boolean;
begin
  Result := False;
...
function TcxCustomGroupBox.DoCustomDrawContentBackground(ACanvas: TcxCanvas; const ABounds: TRect; APainter: TcxCustomLookAndFeelPainterClass): Boolean;
begin
  Result := False;
...
procedure TcxCustomGroupBox.DoMeasureCaptionHeight(APainter: TcxCustomLookAndFeelPainterClass; var ACaptionHeight: Integer);
begin
