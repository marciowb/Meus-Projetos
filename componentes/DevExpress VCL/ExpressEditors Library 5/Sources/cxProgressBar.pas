...
begin
  ADrawDelta := GetDrawDelta;
  FUsualBitmap.SetSize(RectWidth(BarRect) + ADrawDelta, RectHeight(BarRect) + ADrawDelta);
  ChangedBoundsBarRect := False;
end;
...
begin
  ...
  OffsetRect(ATextRect,
    GetDrawDelta + (RectWidth(ABarRect) - RectWidth(ATextRect)) div 2,
    GetDrawDelta + (RectHeight(ABarRect) - RectHeight(ATextRect)) div 2);
  GetPainter.DrawProgressBarText(ACanvas, TextOrientation = cxorVertical,
