...
type
  ...
  TcxSchedulerResourceColors = array[0..5] of TColor;
  ...
  public
    ...
    class function RoundTime(const ADateTime: TDateTime): TDateTime;
  ...
  public
    ...
    class function LoadImages(AWidth, AHeight: Integer; const AResName: string;
      AHasPalette: Boolean = False): TImageList;
...
var
  I: Integer;
const
  LightValues: array[0..5] of Integer = (80, 65, 85, 70, 90, 100);
begin
  for I := 0 to 5 do
    AColors[I] := GetColorValue(AColor, LightValues[I]);
end;                                                                      

class procedure TcxSchedulerPainterHelper.InitSchedulerGraphics;
begin
  CreateStateBrushes;
  PrevResourceColor := ResourceColors[0, 3];
