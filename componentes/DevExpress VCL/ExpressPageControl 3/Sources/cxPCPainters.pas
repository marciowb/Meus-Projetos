...
type
  ...
  protected
    ...
    function GetPageFrameRectOffset: TRect; override;
...
function TcxPCTabsPainter.GetPageFrameRectOffset: TRect;
begin
  Result := inherited GetPageFrameRectOffset;
...
function TcxPCTabsPainter.GetLookAndFeelPainterClass: TcxCustomLookAndFeelPainterClass;
begin
  if IsNativePainting then
...
begin
  if UseLookAndFeelCloseButton then
    Result := GetLookAndFeelPainterClass.SmallCloseButtonSize
  else
...
function TcxPCButtonedPainter.GetLookAndFeelPainterClass: TcxCustomLookAndFeelPainterClass;
begin
  Result := TcxStandardLookAndFeelPainter;
end;

function TcxPCButtonedPainter.GetPageFrameRectOffset: TRect;
begin
  Result := inherited GetPageFrameRectOffset;
  if not ViewInfo.HideTabs and (ViewInfo.RowCount > 0) then
...
function TcxPCExtraFlatPainter.GetPageFrameRectOffset: TRect;
begin
  Result := inherited GetPageFrameRectOffset;
  if not ViewInfo.HideTabs and ViewInfo.IsTabsOnBothSides then
...
function TcxPCFlatPainter.GetLookAndFeelPainterClass: TcxCustomLookAndFeelPainterClass;
begin
