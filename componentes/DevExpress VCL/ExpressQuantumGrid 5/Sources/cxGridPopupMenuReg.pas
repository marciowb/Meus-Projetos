...
type
  TcxGridPopupMenuEditor = class(TdxComponentEditor)
  protected
...
function TcxGridPopupMenuEditor.GetProductMajorVersion: string;
begin
  Result := cxGridMajorVersion;
end;

function TcxGridPopupMenuEditor.GetProductName: string;
begin
