...
type
  ...
  protected
    function GetDeleteItemsCaption: string; override;
...
function TcxCardViewEditor.GetDeleteItemsCaption: string;
begin
  Result := 'Delete existing rows?';
end;

function TcxCardViewEditor.GetItemName: string;
begin
  Result := 'Row';
end;
