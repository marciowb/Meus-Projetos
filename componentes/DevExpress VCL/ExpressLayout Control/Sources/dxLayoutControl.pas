...
uses
  ...
  dxCore, dxMessages, cxClasses, cxGraphics, cxControls, cxLookAndFeels,
...
type
  ...
  {$ENDIF}
    ...
    procedure CMPlaceControls(var Message: TMessage); message DXM_LAYOUT_PLACECONTROLS;
  protected
  ...
  begin
    ...
    if Value then
      if (LookAndFeel <> nil) and TLookAndFeelAccess(LookAndFeel).ForceControlArrangement then
        SendMessage(Handle, DXM_LAYOUT_PLACECONTROLS, 0, 0)
      else
