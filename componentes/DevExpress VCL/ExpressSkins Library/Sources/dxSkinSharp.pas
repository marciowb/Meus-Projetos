...
type
  { TdxSharpPainter }
  TdxSharpPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxSharpPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxSharpPainter.InternalUnitName: string;
begin
  Result := 'dxSkinSharp';
end;
