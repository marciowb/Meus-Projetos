...
type
  { TdxOffice2010BlackPainter }
  TdxOffice2010BlackPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxOffice2010BlackPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxOffice2010BlackPainter.InternalUnitName: string;
begin
  Result := 'dxSkinOffice2010Black';
end;
