...
type
  { TdxDarkroomPainter }
  TdxDarkroomPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxDarkroomPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxDarkroomPainter.InternalUnitName: string;
begin
  Result := 'dxSkinDarkRoom';
end;
