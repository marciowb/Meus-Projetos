...
type
  ...
  protected
    procedure InternalExecuteVerb(Index: Integer); override;
...
procedure TGridViewRepositoryEditor.InternalExecuteVerb(Index: Integer);
begin
  ShowViewRepositoryEditor(Designer, GridViewRepository);
end;

function TGridViewRepositoryEditor.InternalGetVerb(Index: Integer): string;
begin
  Result := 'Editor...';
end;
