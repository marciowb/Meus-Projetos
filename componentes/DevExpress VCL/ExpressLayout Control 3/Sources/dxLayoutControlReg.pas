...
uses
  ...
  dxCoreReg, cxLibraryReg, cxDesignWindows, dxRegEd, cxPC,
...
begin
  ...
  Result := TdxCustomLayoutItemCaptionOptionsAccess(AOptions).Item.Container.ILayout.GetItemsParent as TdxCustomLayoutControl;
end;
