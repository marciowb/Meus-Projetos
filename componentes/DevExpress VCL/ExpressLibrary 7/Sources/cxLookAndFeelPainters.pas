...
type
  ...
  public
    ...
    class function GetEditPopupWindowBorderWidth(AStyle: TcxEditPopupBorderStyle): Integer; virtual;
    class function GetEditPopupWindowClientEdgeWidth(AStyle: TcxEditPopupBorderStyle): Integer; virtual;
    ...
    class function GetContainerBorderWidth(ABorderStyle: TcxContainerBorderStyle): Integer; virtual;
    // DateNavigator
...
class procedure TcxCustomLookAndFeelPainter.DrawContainerBorder(ACanvas: TcxCanvas; const R: TRect; AStyle: TcxContainerBorderStyle;
...
class procedure TcxCustomLookAndFeelPainter.DrawEditPopupWindowBorder(ACanvas: TcxCanvas; var R: TRect;
...
class function TcxCustomLookAndFeelPainter.GetEditPopupWindowBorderWidth(AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := cxEditPopupWindowFrameWidthA[AStyle];
end;

class function TcxCustomLookAndFeelPainter.GetEditPopupWindowClientEdgeWidth(AStyle: TcxEditPopupBorderStyle): Integer;
begin
...
class function TcxCustomLookAndFeelPainter.GetContainerBorderWidth(
...
class procedure TcxWinXPLookAndFeelPainter.DrawEditPopupWindowBorder(ACanvas: TcxCanvas; var R: TRect;
  ABorderStyle: TcxEditPopupBorderStyle; AClientEdge: Boolean);
begin
  if IsWinVistaOrLater then
...
class function TcxWinXPLookAndFeelPainter.GetEditPopupWindowBorderWidth(AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := 1;
end;

class function TcxWinXPLookAndFeelPainter.GetEditPopupWindowClientEdgeWidth(AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := 2;
end;
