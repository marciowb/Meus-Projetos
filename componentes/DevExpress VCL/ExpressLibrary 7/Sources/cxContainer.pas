...
function cxContainerGetBorderWidthByPainter(ABorderStyle: TcxContainerBorderStyle;
  ...
  begin
    Result := APainter.GetContainerBorderWidth(ABorderStyle);
  end;
...
begin
  Result := TcxCustomLookAndFeelPainter.GetContainerBorderWidth(ABorderStyle);
end;
...
begin
  Result := TcxCustomLookAndFeelPainter.GetContainerBorderWidth(BorderStyle[ALookAndFeelKind]);
end;
