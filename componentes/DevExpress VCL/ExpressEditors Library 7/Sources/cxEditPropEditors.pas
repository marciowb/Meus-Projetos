...
const
  cxEditPropEditorsMajorVersion = '7';
  cxEditorsLibraryProductName = 'ExpressEditors Library';
  cxEditorsLibraryProductPage = 'Express Editors ' + cxEditPropEditorsMajorVersion;
  cxEditorsDBLibraryProductPage = 'Express DBEditors ' + cxEditPropEditorsMajorVersion;
