...
uses
  ...
  cxFontNameComboBox, cxColorComboBox, cxCheckComboBox,
{$IFDEF REGISTERCXSHELLCTRLS}
  cxShellComboBox,
{$ENDIF}
  cxSpinButton, cxCheckGroup, cxRichEdit, cxLookAndFeelPainters,
  dxPSContainerLnk, dxPScxExtCommon, dxPScxEditorProducers, dxPSCore;
...
uses
  ImgList, SysUtils,
  dxPSGlbl, dxPSUtl, dxPScxCheckListBoxLnk, {dxPScxImgLnk,} dxPScxMCListBoxLnk,
{$IFDEF REGISTERCXSHELLCTRLS}
  dxPScxExtComCtrlsLnk,
{$ENDIF}
  cxCheckBox, dxPSRELnk;
