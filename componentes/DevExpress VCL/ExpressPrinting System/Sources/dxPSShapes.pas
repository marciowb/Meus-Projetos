...
begin
  ...
  SW := ShapeWidth;
  with ShapeCenter do
    Result := MakeBounds(X - SW div 2, Y - SH div 2, SW, SH);
end;
...
procedure TCustomdxReportCellEllipseShape.DrawContent(DC: HDC; AStage: TdxPSRenderStages);
begin
  Renderer.DrawEllipse(DC, ShapeRect, ShapeColor, ContentBkColor, ContentPattern, 
    ShapeBorderColor, ShapeBorderThickness);
end;
...
procedure TCustomdxReportCellRectangle.DrawContent(DC: HDC; AStage: TdxPSRenderStages);
begin
  Renderer.DrawRectangle(DC, ShapeRect, ShapeColor, ContentBkColor, ContentPattern, 
    ShapeBorderColor, ShapeBorderThickness);
end;
...
procedure TdxReportCellRoundRect.DrawContent(DC: HDC; AStage: TdxPSRenderStages);
begin
  Renderer.DrawRoundRect(DC, ShapeRect, EllipseWidth, EllipseHeight, ShapeColor,
    ContentBkColor, ContentPattern, ShapeBorderColor, ShapeBorderThickness);
end;
