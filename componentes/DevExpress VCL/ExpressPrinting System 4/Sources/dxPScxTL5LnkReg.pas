...
uses
  ...
  cxImage, dxPSRes, dxPScxTL5Lnk, dxPScxCommon, dxPSReg;
...
{$ENDIF}  
  ...
  dxPSRegisterReportLinkUnit('dxPScxTL5Lnk', TcxVirtualTreeListReportLink);
  dxPSRegisterReportLinkUnit('dxPScxTL5Lnk', TcxTreeListReportLink);
end;
