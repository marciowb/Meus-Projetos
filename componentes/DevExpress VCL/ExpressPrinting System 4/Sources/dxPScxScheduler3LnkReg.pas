...
uses
  ...
  dxPSCore, dxPScxScheduler3Lnk, cxSchedulerCustomControls, dxPSReg;
...
{$ENDIF}  
  ...
  dxPSRegisterReportLinkUnit('dxPScxScheduler3Lnk', TcxSchedulerReportLink);
