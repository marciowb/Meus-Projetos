...
uses
  ...
  dxPSReportRenderCanvas, cxGeometry, cxGraphics;
...
type
  ...
  private
    function GetLayoutGroup: TdxLayoutGroup;
  protected
    function CreateTextCell(AReportLink: TdxLayoutControlReportLink): TdxReportLayoutCaptionTextCell; override;
    function CreateImageCell(AReportLink: TdxLayoutControlReportLink): TdxReportCellImage; override;
  ...
  public
    property LayoutGroup: TdxLayoutGroup read GetLayoutGroup;
  end;
...
function GetLayoutItemRelativeBounds(ALayoutItem: TdxCustomLayoutItem): TRect;
  ...
  begin
    Result := TdxCustomLayoutControlAccess(ALayoutItem.Container.ILayout.GetItemsParent);
  end;
...
begin
  ...
  (Result as TdxReportLayoutGroupCaptionTextCell).CaptionLayout := LayoutGroup.CaptionOptions.Layout;
  Result.AdjustFont := True;
end;

function TdxReportLayoutGroupCaptionCell.CreateImageCell(AReportLink: TdxLayoutControlReportLink): TdxReportCellImage;
const
...
begin
  ...
  begin
    ...
    try
      dxDrawItemGlyph(ABitmap.cxCanvas, LayoutItem, ABitmap.ClientRect, ARotationAngleMap[LayoutGroup.CaptionOptions.Layout]);
...
function TdxReportLayoutGroupCaptionCell.GetLayoutGroup: TdxLayoutGroup;
begin
  Result := TdxLayoutGroup(inherited LayoutItem);
end;
...
begin
  Result := ResultMap[LayoutGroup.CaptionOptions.Layout];
end;

function TdxReportLayoutGroup.GetLayoutGroup: TdxLayoutGroup;
begin
  Result := TdxLayoutGroup(LayoutItem);
end;
