...
type
  ...
  private
    ...
    function GetStyleLookAndFeelPainter: TcxCustomLookAndFeelPainterClass;
  ...
  public
    ...
    property StyleLookAndFeelPainter: TcxCustomLookAndFeelPainterClass read GetStyleLookAndFeelPainter;
...
begin
  ...
  if not IsRectEmpty(R) then
    Renderer.DrawTextEx(ACanvas, R, 0, 0, 0, GetText, Font, DTFormat);
end;
...
begin
  ...
  Height := Max(Canvas.TextHeight('Wq'), AHeight) + 2;
end;
...
function TdxStylesListBox.GetStyleLookAndFeelPainter: TcxCustomLookAndFeelPainterClass;
begin
