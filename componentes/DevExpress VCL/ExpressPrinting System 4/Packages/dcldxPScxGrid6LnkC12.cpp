...
#include <vcl.h>
#pragma hdrstop
USERES("dcldxPScxGrid6LnkC12.res");
USEPACKAGE("designide.bpi");
USEPACKAGE("dclcxLibraryC12.bpi");
USEPACKAGE("dxPScxGrid6LnkC12.bpi");
USEPACKAGE("rtl.bpi");
USEPACKAGE("vcl.bpi");
...
USEFORMNS("dxPScxGrid6LnkPredefinedStyleSheets.pas", dxPScxGrid6LnkPredefinedStyleSheets, dxdmPScxGridLnkPredefinedStyles);
//---------------------------------------------------------------------------
