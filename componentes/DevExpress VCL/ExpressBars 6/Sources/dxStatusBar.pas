...
type
  ...
  protected
    ...
    property PaintStyle: TdxStatusBarPaintStyle read FPaintStyle write SetPaintStyle stored IsPaintStyleStored;
...
const
  dxStatusBarDefaultStyle = {$IFDEF USENATIVELOOKANDFEELASDEFAULT}stpsUseLookAndFeel{$ELSE}stpsStandard{$ENDIF};
...
begin
  ...
  FPaintStyle := dxStatusBarDefaultStyle;
  PaintStyleChanged;
...
function TdxCustomStatusBar.IsPaintStyleStored: Boolean;
begin
  Result := FPaintStyle <> dxStatusBarDefaultStyle;
end;
