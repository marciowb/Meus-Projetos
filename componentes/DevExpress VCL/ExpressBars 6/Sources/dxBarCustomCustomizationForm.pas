...
uses
  ...
  dxMessages, cxClasses, dxBar, cxLookAndFeelPainters, cxLookAndFeels;
...
begin
  ...
  if Message.Msg = DXM_BAR_LB_SYNCHRONIZESELECTION then
    Owner.SynchronizeListBoxSelection(ListBox);
  if Message.Msg = DXM_BAR_LB_UPDATEEVENTS then
