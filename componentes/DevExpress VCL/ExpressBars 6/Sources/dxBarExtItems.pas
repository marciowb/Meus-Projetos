...
uses
  ...
  StdCtrls, ComCtrls, ImgList, Types,
...
{$ENDIF}  
  ...
  protected
    procedure DoAddListedItemLinks(AItemLinks: TdxBarItemLinks; ALinkData: TObject; AIndex: Integer); override;
...
procedure TdxBarInPlaceSubItem.DoAddListedItemLinks(AItemLinks: TdxBarItemLinks; ALinkData: TObject; AIndex: Integer);
begin
  if FExpanded then
    inherited;
end;
