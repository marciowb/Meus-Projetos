...
type
  ...
  TdxInSubmenuGalleryOptions = class;
  ...
  private
    ...
    //function GetNewParentOptions: TdxCustomRibbonGalleryOptions;
  ...
  protected
    ...
    //property NewParentOptions: TdxCustomRibbonGalleryOptions read GetNewParentOptions;
    property ParentOptions: TdxRibbonGalleryBaseOptions read FParentOptions;
  public
    constructor Create(AParentOptions: TdxRibbonGalleryBaseOptions; AGroup: TdxRibbonGalleryGroup);
    //procedure Assign(Source: TPersistent); override;
  published
  ...
  private
    ...
    function GetInSubmenuOptions: TdxInSubmenuGalleryOptions;
    function GetItemSizeInRibbon: TcxItemSize;
    function GetItemSizeInSubmenu: TcxItemSize;
  ...
  protected
    ...
    property InSubmenuOptions: TdxInSubmenuGalleryOptions read GetInSubmenuOptions;
    ...
    property ItemSizeInSubMenu: TcxItemSize read GetItemSizeInSubMenu;
  ...
  public
    constructor Create(AOwner: TdxCustomRibbonGalleryItem); virtual;
    procedure Assign(Source: TPersistent); override;
  end;
  ...
  published
    ...
    property AlwaysShowItemCaption: Boolean read FAlwaysShowItemCaption
      write SetAlwaysShowItemCaption default False;
  end;

  { TdxInSubMenuGalleryOptions }

  TdxInSubMenuGalleryOptions = class(TPersistent)
  private
    FCollapsed: Boolean;
  ...
  protected
    ...
    property ItemSize: TcxItemSize read FItemSize write SetItemSize; //TODO:
  public
    constructor Create;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  published
    property Collapsed: Boolean read FCollapsed write SetCollapsed default True;
  ...
  private
    ...
    FGalleryInSubmenuOptions: TdxInSubMenuGalleryOptions;
    ...
    procedure SetGalleryInSubmenuOptions(Value: TdxInSubMenuGalleryOptions);
  ...
  protected
    ...
    property GalleryInSubmenuOptions: TdxInSubMenuGalleryOptions read FGalleryInSubmenuOptions write SetGalleryInSubmenuOptions;
...
constructor TdxRibbonGalleryBaseOptions.Create;
begin
  inherited Create;
...
begin
  ...
  begin
    ...
    ItemTextKind := TdxRibbonGalleryBaseOptions(Source).ItemTextKind;
    ItemSize := TdxRibbonGalleryBaseOptions(Source).ItemSize;
    ItemPullHighlighting := TdxCustomRibbonGalleryOptions(Source).ItemPullHighlighting;
...
function TdxRibbonGalleryBaseOptions.IsItemSizeStored: Boolean;
begin
  Result := (FItemSize.Width <> 0) or (FItemSize.Height <> 0);
end;

function TdxRibbonGalleryBaseOptions.IsItemTextKindStored: Boolean;
begin
  Result := FItemTextKind <> itkCaption;
end;

function TdxRibbonGalleryBaseOptions.IsItemPullHighlightingStored: Boolean;
begin
...
procedure TdxRibbonGalleryBaseOptions.ItemSizeChange(Sender: TObject);
begin
  Changed;
end;
...
{function TdxRibbonGalleryGroupOptions.GetNewParentOptions: TdxCustomRibbonGalleryOptions;
begin
  Result := TdxCustomRibbonGalleryOptions(ParentOptions);
end;}
...
begin
  ...
  begin
    ...
    //ItemTextKind := TdxCustomRibbonGalleryOptions(Source).ItemTextKind;
...
begin
  Result := InSubmenuOptions.EqualItemSizeInAllGroups;
end;

function TdxCustomRibbonGalleryOptions.GetInRibbonOptions: TdxInRibbonGalleryOptions;
begin
  Result := FGalleryItem.GalleryInRibbonOptions;
end;

function TdxCustomRibbonGalleryOptions.GetInSubmenuOptions: TdxInSubmenuGalleryOptions;
begin
  Result := FGalleryItem.GalleryInSubmenuOptions;
end;
...
function TdxCustomRibbonGalleryOptions.GetItemSizeInSubmenu: TcxItemSize;
begin
  Result := InSubmenuOptions.ItemSize;
end;

function TdxCustomRibbonGalleryOptions.GetRowCount: Integer;
begin
  Result := InSubmenuOptions.RowCount;
end;

function TdxCustomRibbonGalleryOptions.GetSubMenuResizing: TdxRibbonGallerySubMenuResizing;
begin
  Result := InSubmenuOptions.SubMenuResizing;
end;

{function TdxCustomRibbonGalleryOptions.IsItemTextKindStored: Boolean;
begin
  Result := FItemTextKind <> itkCaption;
end;}
...
begin
  InSubmenuOptions.EqualItemSizeInAllGroups := Value;
end;
...
begin
  InSubmenuOptions.RowCount := Value;
end;
...
begin
  InSubmenuOptions.SubMenuResizing := Value;
end;
...
procedure TdxCustomRibbonGalleryOptions.MinColumnCountChanged;
begin
...
constructor TdxInSubMenuGalleryOptions.Create;
begin
  inherited Create;
  FCollapsed := True;
...
destructor TdxInSubMenuGalleryOptions.Destroy;
begin
  FreeAndNil(FItemSize);
  inherited Destroy;
end;

procedure TdxInSubMenuGalleryOptions.Assign(Source: TPersistent);
begin
  if Source is TdxInSubMenuGalleryOptions then
  begin
    Collapsed := TdxInSubMenuGalleryOptions(Source).Collapsed;
    EqualItemSizeInAllGroups := TdxInSubMenuGalleryOptions(Source).EqualItemSizeInAllGroups;
    RowCount := TdxInSubMenuGalleryOptions(Source).RowCount;
    SubMenuResizing := TdxInSubMenuGalleryOptions(Source).SubMenuResizing;
  end
  else
    inherited Assign(Source);
end;

procedure TdxInSubMenuGalleryOptions.Changed;
begin
  if Assigned(FOnChanged) then
    FOnChanged(Self);
end;

procedure TdxInSubMenuGalleryOptions.SetCollapsed(Value: Boolean);
begin
  if Value <> FCollapsed then
  begin
    FCollapsed := Value;
...
procedure TdxInSubMenuGalleryOptions.SetEqualItemSizeInAllGroups(Value: Boolean);
begin
...
procedure TdxInSubMenuGalleryOptions.SetItemSize(Value: TcxItemSize);
begin
  FItemSize.Assign(Value);
end;

procedure TdxInSubMenuGalleryOptions.SetRowCount(Value: Integer);
begin
...
procedure TdxInSubMenuGalleryOptions.ItemSizeChange(Sender: TObject);
begin
  Changed;
end;
...
begin
  ...
  FGalleryOptions.OnMinColumnCountChanged := MinColumnCountChanged;
  FGalleryInRibbonOptions := TdxInRibbonGalleryOptions.Create;
  FGalleryInRibbonOptions.OnChanged := OptionsChanged;
  FGalleryInSubmenuOptions := TdxInSubmenuGalleryOptions.Create;
  FGalleryInSubmenuOptions.OnChanged := OptionsChanged;
end;
...
begin
  ...
  FreeAndNil(FGalleryInSubmenuOptions);
  inherited Destroy;
end;
...
procedure TdxCustomRibbonGalleryItem.SetGalleryInSubmenuOptions(Value: TdxInSubMenuGalleryOptions);
begin
  FGalleryInSubmenuOptions.Assign(Value);
end;
...
begin
  Result := FGroupItem.Enabled and Options.ItemPullHighlighting.Active and
...
begin
  ...
  begin
    Result := ((not IsInplaceGallery or not IsImageVisible) and
      (Options.ItemTextKind in [itkCaption, itkCaptionAndDescription]) or
      IsInplaceGallery and GroupItem.Group.GalleryItem.GalleryInRibbonOptions.AlwaysShowItemCaption) and
...
begin
  Result := GalleryItem.GalleryInSubmenuOptions.Collapsed;
end;
