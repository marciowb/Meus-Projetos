inherited frmLst_TipoPatrimonio: TfrmLst_TipoPatrimonio
  ...
  inherited Panel1: TPanel
    ...
    inherited Panel3: TPanel
      ...
      object chkFLAGCONTROLACONTADOR: TDBCheckBox
        Left = 16
        Top = 112
        Width = 241
        Height = 17
        Caption = 'Usa controle de contador'
        DataField = 'FLAGCONTROLACONTADOR'
        DataSource = DataCadastro
        TabOrder = 2
        ValueChecked = 'Y'
        ValueUnchecked = 'N'
        OnClick = chkFLAGCONTROLACONTADORClick
      end
      object edtUnidade: TEditPesquisa
        ...
        LblTitulo.Width = 85
        LblTitulo.Height = 13
        LblTitulo.Caption = 'Unidade contador'
  ...
  object CdsEventos: TpFIBClientDataSet
    ...
    Filtered = True
    Params = <>
    BeforePost = CdsEventosBeforePost
    BeforeDelete = CdsEventosBeforeDelete
