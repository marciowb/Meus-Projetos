inherited frmCad_CFOP: TfrmCad_CFOP
        ...
        inherited pnlGeral: TPanel
          ...
          object cxPageControl1: TcxPageControl
            ...
            object cxTabSheet3: TcxTabSheet
              Caption = 'CSOSNs usados nesse CFOP'
              ImageIndex = 2
              ...
              object cxGrid3: TcxGrid
                ...
                object cxGridDBTableView2: TcxGridDBTableView
                  NavigatorButtons.ConfirmDelete = False
                  DataController.DataSource = DataCSOSN_CFOP
                  DataController.Summary.DefaultGroupSummaryItems = <>
                  DataController.Summary.FooterSummaryItems = <>
                  DataController.Summary.SummaryGroups = <>
                  OptionsView.GroupByBox = False
  ...
  object DataCSOSN_CFOP: TDataSource
    DataSet = CdsCSOSN_CFOP
    Left = 232
    Top = 360
  end
  object CdsCSOSN_CFOP: TpFIBClientDataSet
    Aggregates = <>
    Filter = 'FlagEDICAO <> '#39'D'#39
    Filtered = True
    Params = <>
    OnNewRecord = CdsCSOSN_CFOPNewRecord
    Left = 312
    Top = 336
  end
end
