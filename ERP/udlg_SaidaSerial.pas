...
type
  ...
  private
    ...
    procedure SetIdProduto(const Value: TipoCampoChave);
    { Private declarations }
  public
    { Public declarations }
    property IdProduto: TipoCampoChave read FIdProduto write SetIdProduto;
  end;
...
procedure TfrmDlg_SaidaSerial.SetIdProduto(const Value: TipoCampoChave);
begin
  FIdProduto := Value;
  SetCds(CdsSeriais,tpERPSerialProdutoAtivo,' idproduto = '+TipoCampoChaveToStr(Value));
end;
