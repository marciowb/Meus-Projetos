...
begin
  ...
  Parcelas := TRegrasCondicaoPagamento.GeraParcela(edtCondicaoPagamento.ValorChave,edtValor.AsCurrency, edtTotalParcela.AsInteger);
...
begin
  inherited;
  edtTotalParcela.Enabled := TRegrasCondicaoPagamento.PodeParcelar(edtCondicaoPagamento.ValorChave);
