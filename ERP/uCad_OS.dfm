inherited frmCad_OS: TfrmCad_OS
      ...
      inherited TsPrincipal: TcxTabSheet
        ...
        inherited pnlGeral: TPanel
          ...
          object Panel2: TPanel
            ...
            object EdtCompetenciaContrato: TEditPesquisa
              Left = 357
              Top = 64
              Width = 76
              Height = 21
              ...
              AutoPesquisa = True
              AutoCompletar = True
              OnRegAchado = EdtCompetenciaContratoRegAchado
              UsaBtnNovo = False
              UsaBtnEditar = False
              UsaDisplay = True
              LblTitulo.Left = 357
              ...
              LblTitulo.Width = 43
              LblTitulo.Height = 13
              LblTitulo.Caption = 'Contrato'
              BtnPesquisa.Left = 435
              BtnPesquisa.Top = 64
              BtnPesquisa.Width = 25
              BtnPesquisa.Height = 21
              BtnPesquisa.Hint = 'F2 para pesquisar'
  ...
  object CdsServicoEquipamento: TpFIBClientDataSet
    ...
    Filtered = True
    Params = <>
    AfterOpen = CdsServicoEquipamentoAfterOpen
