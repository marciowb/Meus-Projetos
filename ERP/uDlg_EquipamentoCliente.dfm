inherited frmDlg_EquipamentoCliente: TfrmDlg_EquipamentoCliente
  ...
  inherited Panel2: TPanel
    Height = 255
    ExplicitHeight = 255
    object edtEquipamento: TLabelDBEdit
      Left = 24
      Top = 69
      Width = 176
      Height = 21
    ...
    object edtProduto: TEditPesquisa
      ...
      AutoPesquisa = True
      AutoCompletar = True
      OnRegNaoAchado = edtProdutoRegNaoAchado
      UsaBtnNovo = False
      UsaBtnEditar = False
      UsaDisplay = True
      LblTitulo.Left = 24
      ...
      LblTitulo.Width = 314
      LblTitulo.Height = 13
      LblTitulo.Caption = 'Produto(informe caso possua esse equipamento no seu cadastro)'
      BtnPesquisa.Left = 91
      BtnPesquisa.Top = 24
    ...
    object edtIdentificador: TLabelDBEdit
      ...
      Titulo.Width = 62
      Titulo.Height = 13
      Titulo.Caption = 'Identifica'#231#227'o'
      IsNull = False
      PodeRepetir = True
      CorPrincipal = clWhite
      CorSecundaria = 11592447
    ...
    object GroupBox1: TGroupBox
      ...
      object cxDBMemo1: TcxDBMemo
        ...
        Top = 15
        Align = alClient
        DataBinding.DataField = 'DESCRICAOCOMPLETA'
        DataBinding.DataSource = DataEquipamento
