inherited frmCad_ContaReceber: TfrmCad_ContaReceber
  ...
  object DataCr: TDataSource
    Left = 448
    Top = 56
  end
  object DataQuitacoes: TDataSource
    DataSet = CdsQuitacoes
    Left = 528
    Top = 56
  end
  object CdsQuitacoes: TpFIBClientDataSet
    Aggregates = <>
    Params = <>
    AfterOpen = CdsQuitacoesAfterOpen
    Left = 376
    Top = 56
  end
end
