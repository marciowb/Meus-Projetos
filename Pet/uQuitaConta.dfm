inherited frmDlg_QuitaConta: TfrmDlg_QuitaConta
  ActiveControl = LabelDBEdit1
  Caption = 'Quita'#231#227'o de conta'
  ClientHeight = 141
  ClientWidth = 298
  ExplicitWidth = 306
  ExplicitHeight = 175
  ...
  inherited Panel2: TPanel
    ...
    object edtFP: TEditPesquisa
      ...
      LblTitulo.Width = 102
      LblTitulo.Height = 13
      LblTitulo.Caption = 'Forma de pagamento'
      BtnPesquisa.Left = 83
      BtnPesquisa.Top = 64
  ...
  object DataRec: TDataSource
    DataSet = CdsRec
    Left = 232
    Top = 16
  end
  object CdsRec: TpFIBClientDataSet
    Aggregates = <>
    Params = <>
    AfterOpen = CdsRecAfterOpen
    AfterPost = CdsRecAfterPost
    OnNewRecord = CdsRecNewRecord
    Left = 272
    Top = 24
  end
end
